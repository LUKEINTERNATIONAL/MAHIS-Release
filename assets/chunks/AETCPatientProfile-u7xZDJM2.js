import { q as defineComponent, aH as useRouter, cs as useRoute, r as ref, d as computed, a2 as onMounted, w as watch, v as resolveComponent, O as createBlock, y as openBlock, A as withCtx, z as createVNode, E as unref, H as IonContent, G as createCommentVNode, x as createElementBlock, cO as defineAsyncComponent, af as IonRow, ay as IonCol, bI as IonCard, b9 as IonCardContent, B as createBaseVNode, L as IonIcon, d$ as ellipsisVerticalSharp, a4 as normalizeClass, d1 as person, C as toDisplayString, a5 as createTextVNode, F as closeCircleOutline, df as IonSegment, dg as IonSegmentButton, a7 as IonLabel, P as normalizeStyle, an as IonItem, aX as personOutline, s as documentTextOutline, cH as idCardOutline, aZ as printOutline, J as Fragment, R as renderList, d2 as add, br as IonPage, cG as __vitePreload } from './vendor-BPW-J91F.js';
import { s as storeToRefs } from './pinia-D-q2_lrU.js';
import { u as useANCEnrollmentStore, A as ArtCard } from './PatientProfile-Ckz1fJHk.js';
import { aY as AppEncounterService, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cM as PatientOpdList, o as createModal, t as toastWarning, ai as ProgramService, K as ObservationService, _ as _export_sfc } from '../index-BaBlba8w.js';
import { u as usePatientProfile } from './usePatientProfile-DJ4_pG0Y.js';
import { c as formatRadioButtonData } from './formatServerData-CdGz1GHl.js';
import { D as DemographicBar } from './DemographicBar-_xoIVYXa.js';
import { C as CPR } from './CPR-DHiDGS2A.js';

class ConfirmPregnancyService extends AppEncounterService {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-Dg7EpubE.js'),true              ?[]:void 0,import.meta.url));
    ...
    const AncEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./AncEnrollmentModal-Bc-9h6fX.js'),true              ?[]:void 0,import.meta.url));
    ...
    const filteredPrograms = computed(() => {
      return [
        ...
        },
        {
          ...
          url: `/aetc/PrimarySurvey`
        },
        {
          label: "SAMPLE History",
          url: `/aetc/medicalHistory`
        },
        {
          label: "Secondary Survey",
          url: `/aetc/SecondarySurvey`
        },
        {
        ...
        },
        {
          ...
          url: `/aetc/PatientManagementPlan`
        },
        {
          label: "Continuation Sheet",
          url: `/aetc/continuationSheet`
        },
        ...
        },
        {
          ...
          url: `/aetc/templateForms/medicalAdmission`,
          isChild: true
        },
        {
          label: "Surgical Notes",
          url: `/aetc/templateForms/surgicalNotes`,
          isChild: true
        }
      ];
    });
    ...
    const handleANCEnrollmentYes = async () => {
      ...
      if (!encounter) return toastWarning("Unable to create quickCheck encounter");
      ...
      try {
        ...
        toastSuccess("Already Enrolled");
      }
      if (!patientStatus) return toastWarning("Unable to create quickCheck details!");
    ...
    const buildANCEnrollment = async () => {
      return await formatRadioButtonData(ConfirmPregnancy.value);
    };
    onMounted(async () => {
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createVNode(unref(AncEnrollmentModal), {
                closeModalFunc: closeEnrollmentModal,
                onYes: handleANCEnrollmentYes,
                onNo: handleEnrollmentNo,
                isOpen: isEnrollmentModalOpen.value,
                title: enrollModalTitle.value,
                showUnderageWarning: showUnderageWarning.value
              }, null, 8, ["isOpen", "title", "showUnderageWarning"]),
              ...
              unref(activeProgram).program_id == 33 ? (openBlock(), createBlock(unref(PatientProfile), {
                key: 1,
                updateData: unref(patient)
              }, null, 8, ["updateData"])) : createCommentVNode("", true),
              unref(activeProgram).program_id == 18 ? (openBlock(), createBlock(unref(HTSPatientProfile), {
                key: 2,
                updateData: unref(patient)
              }, null, 8, ["updateData"])) : createCommentVNode("", true),
              unref(activeProgram).program_id !== 33 && unref(activeProgram).program_id !== 18 && unref(activeProgram).program_id != "" ? (openBlock(), createElementBlock("div", _hoisted_1, [
...
const AETCPatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c03ddec3"]]);
