...
const BroughtInDeadTable = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-f7df1584"]]);
                  ...
                  createVNode(_component_ion_row, { class: "centered-row" }, {
                    default: withCtx(() => [
                      _ctx.hasWaitingList("Total Patients Today") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[0] || (_cache[0] = ($event) => _ctx.openAllModal("All patients today", "View profile", "/patient-profile"))
                      ...
                      _ctx.hasWaitingList("Waiting for Vitals") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[2] || (_cache[2] = ($event) => _ctx.openPatientsListModal("Patients waiting for vitals", "VITALS", "Vitals", "/opd/vitals"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Consultation") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[3] || (_cache[3] = ($event) => _ctx.openPatientsListModal(
                      ...
                      _ctx.hasWaitingList("Waiting for Laboratory") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[4] || (_cache[4] = ($event) => _ctx.openPatientsListModal("Patients waiting for lab", "LAB", "Lab", "/opd/consultation-plan"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Dispensation") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[5] || (_cache[5] = ($event) => _ctx.openPatientsListModal("Patients waiting for dispensation", "DISPENSATION", "Dispensation", "/ncd/dispensations"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true)
                    ]),
                    _: 1
                  })
...
const OPDDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$5], ["__scopeId", "data-v-c1565a37"]]);
