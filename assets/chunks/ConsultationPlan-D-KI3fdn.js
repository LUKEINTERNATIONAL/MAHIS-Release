...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bj as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bl as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-yRu5EhmF.js';
import { D as DemographicBar } from './DemographicBar-0uNt3MoR.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CMvIQaEO.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-Ph7S0Kr2.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-Dbwag3Gk.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CFVc-KuN.js';
import { I as Investigations } from './Investigations-CIQ79VWt.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-0CQLE8vS.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-CCC3zVZf.js';
import { P as PreviousTreatment } from './treatment-DmXjnZ4U.js';
import { l as lodashExports } from './lodash-Ba28qa7J.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-Bd11d_7z.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DiE2eToE.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-Dhi6puC1.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BrbgZLX_.js';
