import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, J as Fragment, R as renderList, B as createBaseVNode, C as toDisplayString, v as resolveComponent, O as createBlock, A as withCtx, G as createCommentVNode, ag as close, L as IonIcon, Q as alertCircleOutline, a5 as createTextVNode, N as IonButton, aj as onBeforeUnmount, H as IonContent, br as IonPage, aH as useRouter, cs as useRoute, a as reactive, bW as chevronBackOutline, eT as provide } from './vendor-BPW-J91F.js';
import { s as storeToRefs } from './pinia-D-q2_lrU.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-C6u5KmBv.js';
import { D as DemographicBar } from './DemographicBar-C9iuwkvv.js';
import { l as neonatalTriageFormKey, u as useNeonatalTriageStore, m as neonatalTriageSections, N as NeonatalStepper, o as defaultNeonatalTriageForm, t as triageConceptMapping } from './NeonatalStepper-5TUHzpWu.js';
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[5];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const CentralCyanosisSection = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-abd332bf"]]);
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[6];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const ConvulsionsSection = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-9d6ac846"]]);
...
const _sfc_main$r = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[21];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
...
const VitalSectionTwo = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-26347732"]]);
...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[25];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
...
const VitalSectionThree = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-6776f6c5"]]);
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[31];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
    ...
    const calculatePercentage = (values) => {
      ...
      const config = neonatalTriageSections[31].formData;
      ...
      return openBlock(), createBlock(_component_ion_card, { class: "triage-section-wrapper" }, {
        default: withCtx(() => [
          createVNode(StandardForm, {
            ...
            percentage: withCtx(() => [
              calculatedWeightPercentage.value !== null ? (openBlock(), createElementBlock("div", _hoisted_1$o, toDisplayString(calculatedWeightPercentage.value >= 0 ? "Weight loss percentage:" : "Weight gain percentage:") + " " + toDisplayString(Math.abs(calculatedWeightPercentage.value)) + "% ", 1)) : createCommentVNode("", true)
            ]),
            _: 1
...
const VitalSectionFour = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-2ab22edc"]]);
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[27];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const TemperatureHigh = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-e926f199"]]);
...
const _hoisted_4$1 = { class: "triage-dialog-card" };
const _hoisted_5 = { class: "triage-dialog-header" };
const _hoisted_6 = { class: "triage-dialog-icon" };
const _hoisted_7 = { class: "triage-dialog-actions" };
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[28];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$m, [
        ...
        showDialog.value ? (openBlock(), createElementBlock("div", _hoisted_3$1, [
...
const VitalBloodSugar = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-34b1e406"]]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[2];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const EmergencyTriage = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-f069fb13"]]);
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[32];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
...
const BabyDemographics = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-d71d54e3"]]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[29];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const HypoglycemiaSymptomatic = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-69876183"]]);
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[30];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const HypoglycemiaAsymptomatic = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-0c0c7579"]]);
...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[4];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const EmergencyManagementTwo = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-69b70803"]]);
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[18];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const EmergencyManagementSix = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-3c17cf16"]]);
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[22];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const EmergencyManagementSeven = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-8a977f1f"]]);
...
const EmergencyManagementEight = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-61d38aae"]]);
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[props.stepIndex];
    const formData = sectionConfig?.formData || [];
    const conditionalRules = sectionConfig?.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const BabyRecoveredStillSevereRespiratory = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-f593ff59"]]);
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[20];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const ConvulsionsVitalsSection = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-142970f1"]]);
...
const SelectPresentSignsSection = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-d75f3f39"]]);
...
const TrunkFeelsColdSection = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-0736fcc7"]]);
...
const KeepWarmSection = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-d91f423d"]]);
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[17];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
...
const VitalsSignsSection = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3e060278"]]);
...
const RespiratoryDistressSection = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-817c3a74"]]);
...
const TemperatureHighSection = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-5dd8c3b2"]]);
...
const SecondVitalSignsSection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e2e84068"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[19];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const ReferralInstructionsSection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b731aee0"]]);
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    if (source === "dashboard" && !hasPatient) {
      triageStore.initializeForPatient(null);
    } else if (hasPatient) {
    ...
    const allStepperData = [
      ...
      { title: "Central Cyanosis", value: "8", component: ObservationsSection, configIndex: 7 },
      // Index 7
      { title: "Convulsions/Twitching", value: "9", component: DangerSignsSection, configIndex: 8 },
      // Index 8
      { title: "Danger Signs 2", value: "10", component: SelectPresentSignsSection, configIndex: 14 },
      // Index 14
      {
      ...
      { title: "Danger Signs", value: "14", component: RespiratoryDistressSection, configIndex: 13 },
      // Index 13
      { title: "Temperature High", value: "15", component: TemperatureHighSection, configIndex: 27 },
      // Index 27
      {
      ...
      },
      {
        ...
        value: "17",
        component: SecondVitalSignsSection,
        configIndex: 16
      },
      { title: "Vital Signs", value: "18", component: VitalsSignsSection, configIndex: 17 },
      // Index 17
      { title: "Emergency Management", value: "19", component: EmergencyManagementSix, configIndex: 18 },
      // Index 18
      { title: "Referral Instructions", value: "19", component: ReferralInstructionsSection, configIndex: 19 },
      // Index 19
      {
        title: "Emergency Management",
        value: "20",
      ...
      { title: "Vital Signs", value: "21", component: VitalSectionTwo, configIndex: 21 },
      // Index 21: Vital Signs 2
      { title: "Emergency Management", value: "21", component: EmergencyManagementSeven, configIndex: 22 },
      ...
      { title: "Respiratory Distress", value: "23", component: BabyRecoveredStillSevereRespiratory, configIndex: 24 },
      // Index 24: "Respiratory Distress" (Baby Recovered)
      { title: "Vital Signs", value: "24", component: VitalSectionThree, configIndex: 25 },
      // Index 25: Vital Signs 3
      {
        title: "Emergency Management",
        value: "25",
        component: EmergencyManagementEight,
        configIndex: 26
        // Index 26: Temperature Low - Warm The Baby
      },
      { title: "Temperature High", value: "26", component: TemperatureHigh, configIndex: 27 },
      // Index 27
      {
        ...
        configIndex: 28,
        // Index 28: Emergency Triage Blood Sugar
        hasDialog: true
      },
      { title: "Hypoglycemia Symptomatic", value: "28", component: HypoglycemiaSymptomatic, configIndex: 29 },
      // Index 29
      {
      ...
      { title: "Vital Signs", value: "30", component: VitalSectionFour, configIndex: 31 },
      // Index 31: Vital Signs Four
      { title: "Triage Summary", value: "31", component: SummarySection, configIndex: 38 },
      // Index 38
      { title: "Demographics", value: "32", component: BabyDemographics, configIndex: 32 }
      // Index 32
    ];
      ...
      if (currentIndex === summaryStepIndex && hasPatient2 || shouldSaveOnDemographics || isFinalStep && hasPatient2) {
        return async () => {
          try {
            ...
            source2 == "dashboard" ? router.push("/home") : router.push("/neonatal/checkpoint");
          } catch (error) {
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b55882a6"]]);
