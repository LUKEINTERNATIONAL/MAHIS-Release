import { c as computed, s as defineComponent, a3 as onMounted, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, bM as IonCard, f as ref } from './vendor-BcieWP-_.js';
import { y as StandardValidations, n as icons, z as StandardForm, K as ObservationService, b as EncounterTypeId, t as toastWarning, G as toastSuccess, _ as _export_sfc } from '../index-D-gMOJ4F.js';
  ...
  const otherExamsForm = computed(() => [
    {
      ...
      header: "Fetal heart rate (normal: 110-160 bpm)",
      type: "number",
      unit: "bpm",
      obsValueType: "value_numeric",
      grid: { xs: "12", md: "12" },
      validation: (value) => {
        return StandardValidations.isNotEmptyandNumber(value) || StandardValidations.checkMinMax(value, 110, 160);
      }
    },
    {
      componentType: "Alert",
      ...
      condition: async (formValues) => {
        ...
        if (fhr < 110) {
          return {
            ...
            textColor: "#B42318",
            value: "Fetal bradycardia: fetal heart rate is below 110 bpm.",
            name: "Fetal bradycardia alert"
          };
        }
        if (fhr > 160) {
          return {
            ...
            textColor: "#B54708",
            value: "Fetal tachycardia: fetal heart rate is above 160 bpm.",
            name: "Fetal tachycardia alert"
          };
        }
        return false;
      }
