import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bq as V, c_ as DataTable, bN as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aM as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bR as IonChip, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bw as IonPage, cv as IonMenuButton, I as IonHeader, aH as IonContent, a$ as medkitOutline, Q as normalizeClass, H as createCommentVNode, bM as IonCard, a6 as IonInput, aw as searchOutline, ae as IonCheckbox, be as IonCardContent, bb as IonCardTitle, N as IonButton, bc as IonCardHeader, b7 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dc as timeOutline, eB as moon, eC as partlySunny, eD as sunny, cj as medkit, au as script, al as IonPopover, aG as IonMenu, bg as IonFooter, bd as checkmark, ca as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, b_ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-CXFd4I0A.js';
import { s as storeToRefs, m as mapState } from './pinia-eByuf_Uz.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, N as ConceptService, bb as checkIfSamePatient, bc as setCurrentPatientID, bd as getAntiHypertensivesMedication, be as getDiabetesDrugs, bf as clearMedicationData, B as BasicInputField, bg as useNCDMedicationsStore, bh as useOtherNCDMedicationStore, bi as formMedicationObject, x as toastDanger, b4 as useTreatmentPlanStore, a2 as DrugService, d as _sfc_main$f, bj as addOtherMedicationToNCDMedicationList, T as Toolbar, bk as useVitalsStore, bl as useInvestigationStore, bm as useDiagnosisStore, e as useGeneralStore, b5 as useOutcomeStore, i as useEnrollementStore, ac as useConfigStore, f as useStatusStore, a4 as getFieldValue, a$ as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b6 as confirmModal, bp as useAllegyStore, a8 as useUserStore, S as Service } from '../index-D3ME6BhP.js';
import { D as DemographicBar } from './DemographicBar-Dvo3jz4r.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-8N0dHr_n.js';
import { u as useComplicationsStore } from './ComplicationsStore-rYwlnOU6.js';
import { B as BasicForm } from './BasicForm-DIqpFuHg.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-DOpAMfx5.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-4ROpvugY.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-BQbeYfey.js';
import { P as PreviousAllergies } from './PreviousAllergies-BSHsDkhS.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-dSO6A0fZ.js';
import { V as Vitals } from './Vitals-1fcmVij7.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-DS74CJ9q.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-C8ZFK1y8.js';
import { l as lodashExports } from './lodash-CbOIehv2.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-DlqqozdS.js';
