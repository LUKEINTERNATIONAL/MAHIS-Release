import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, b9 as IonCardTitle, dZ as IonSkeletonText, z as createElementBlock, L as IonIcon, aR as medicalOutline, a5 as createTextVNode, J as Fragment, ba as IonCardHeader, ao as IonList, R as renderList, ap as IonItem, a7 as IonLabel, b7 as calendarOutline, C as createBaseVNode, D as toDisplayString, cJ as idCardOutline, c7 as folderOutline, c4 as checkmarkCircleOutline, bc as IonCardContent, f as ref, p as dayjs, a2 as onMounted, aA as IonGrid, af as IonRow, az as IonCol, a4 as normalizeClass, d_ as checkboxOutline, H as createCommentVNode, c9 as clipboardOutline, d$ as statsChartOutline, K as modalController, aK as useRouter, cu as useRoute, x as resolveComponent, aF as IonContent, e0 as ellipsisVerticalSharp, d3 as person, aH as IonAccordionGroup, aG as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, a_ as personOutline, v as documentTextOutline, b0 as printOutline, d4 as add, bt as IonPage, cS as defineAsyncComponent, cI as __vitePreload, c as computed } from './vendor-BIA1Qh8a.js';
import { s as storeToRefs } from './pinia-BgytB2RM.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, ab as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-DJyJhMgX.js';
...
import { i as isTaskPermitted } from './tasks-DkW4mp9P.js';
import { A as ANCRedirection } from './anc_service-DEofnNbi.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-CfYwoOoJ.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Dzr2pf1s.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-k6CJpfSC.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-Ca2gX-3y.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-BWR98biB.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-CTn5kSgJ.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-B0HMiG5H.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-CrAwYcp1.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-BFJicwdY.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-_k_zM960.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-Cwb5hkrh.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-DJyJhMgX.js').then(n => n.cS),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-BG6Dw2_y.js'),true              ?[]:void 0,import.meta.url));
