...
import { n as icons, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-xpeKIrss.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("StartMeasuringOxygenSaturation"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ],
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        header: "",
        displayMode: "visual",
        helperText: "This baby has severe respiratory distress and WILL require referral",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
    ...
    formData: [
      {
        ...
        header: "Baby",
        helperText: "The baby has recovered but still has severe respiratory distress and WILL require referral.",
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
