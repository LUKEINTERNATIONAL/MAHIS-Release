import { s as defineComponent, y as openBlock, O as createBlock, f as ref, c as computed, w as watch, F as unref, z as createElementBlock, H as createCommentVNode, A as createVNode, B as withCtx, bK as IonCard, J as Fragment, bF as IonModal, I as IonHeader, aD as IonToolbar, aE as IonTitle, C as createBaseVNode, L as IonIcon, eX as eggOutline, a5 as createTextVNode, D as toDisplayString, be as IonButtons, N as IonButton, G as closeCircleOutline, a7 as IonLabel, aG as IonContent, bf as IonFooter, bH as saveOutline, R as renderList, a4 as normalizeClass, co as checkmarkCircle, e3 as createOutline, bG as addOutline, a_ as medkitOutline, a2 as onMounted, x as resolveComponent, aL as useRouter, bY as chevronBackOutline, S as withDirectives, T as vShow, bd as IonCardContent, bu as IonPage } from './vendor-DpSS1aB1.js';
import { x as toastDanger, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, C as useExposeFromStandardForm, S as Service, ar as ConceptService, J as savePatientRecord, t as toastWarning, o as createModal, y as StandardValidations, T as Toolbar } from '../index-D_ZMN7Zv.js';
import { D as DemographicBar } from './DemographicBar-66N_YgZT.js';
import { _ as _sfc_main$k, u as useFormWizard } from './useFormWizard-Dr62DgT-.js';
import { V as Vitals } from './Vitals-Cw0-5JkD.js';
import { d as defineStore, s as storeToRefs } from './pinia-CbGjwPb6.js';
import { s as syncChildUIs } from './StandardUtils-CB1NXgjt.js';
import { A as AddLabTestModal } from './AddLabTestModal-DfJvxdkK.js';
import { _ as _sfc_main$j } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-7E1EdhpG.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const breastExaminationsResults = computed(() => {
      return [
        ...
        //     condition: (vals: any) => vals["Is vaginal examination done?"] === "Yes",
        // },
        {
...
const MaternalExam = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-e96424e7"]]);
...
const FetusModal = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-a2a0422e"]]);
...
const FetusSelector = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-10b5a9e9"]]);
      ...
      try {
        ...
        const fetusObsArray = await Promise.all(
          Object.entries(allFetuses || {}).map(async ([key, fetus]) => {
            return {
              "concept_id": await ConceptService.getConceptID("Register Number", true),
...
const AbdominalInspection = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-4886ff2c"]]);
...
const respiratoryExamFindings = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-535d251f"]]);
...
const MUAC = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c39448dc"]]);
...
const GeneralExamination = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-752ce4bd"]]);
...
const VulvaInspection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a288ec07"]]);
  ...
  setup(__props) {
    ...
    const getActiveTabs = () => {
      return [
        ...
        { title: "Abdominal Inspection", icon: "" },
        { title: "Vulva Inspection", icon: "" },
    ...
    const onChangeCurrentTab = async (index, _oldIndex) => {
      ...
      if (value == "Abdominal Inspection") AbdominalExaminationRef.value?.validateForm();
      if (value == "Presenting signs for IPV") PresentingSignsRef.value?.validateForm();
      if (value == "Vulva Inspection") VulvaInspectionRef.value?.validateForm();
    };
    onMounted(async () => {
                  ...
                  showWizard.value ? (openBlock(), createBlock(_sfc_main$k, {
                    ...
                    default: withCtx(() => [
                      ...
                      withDirectives(createBaseVNode("div", null, [
                        ...
                        [vShow, getActiveComponent() == "VulvaInspection"]
                      ])
                    ]),
                    _: 1
...
const PhysicalExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04a53a1e"]]);
