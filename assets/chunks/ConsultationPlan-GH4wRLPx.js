...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, C as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, o as createModal, b4 as confirmModal, B as BasicInputField, aI as _sfc_main$b, c as HorizontalLine, aC as areFieldsValid, x as toastDanger, aD as getFieldsValuesObj, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, v as usePatientList, r as closeVisit } from '../index-DihysMBN.js';
import { D as DemographicBar } from './DemographicBar-45092v_o.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$8 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-C7b-w7ex.js';
import { P as PresentingComplaints, _ as _sfc_main$9, a as _sfc_main$a } from './PresentingComplaints-CaLf8OiI.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-AMYyPpwQ.js';
import { I as Investigations } from './Investigations-BFmvUs2t.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-B6no9GVW.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-mIwYx1Kf.js';
import { P as PreviousTreatment } from './treatment-BJ1k0L-S.js';
import { l as lodashExports } from './lodash-BxWMU_OR.js';
import { _ as _sfc_main$c, D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-lJDOEQwS.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CJqRLvAo.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DpiFOp3E.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BDQZyvWM.js';
import { u as useUserActivities } from './useUserActivities-DbBBWhfn.js';
