import { q as defineComponent, r as ref, w as watch, N as createBlock, y as openBlock, E as unref, bJ as IonCard, B as withCtx, z as createVNode, b7 as IonCardTitle, x as createElementBlock, dY as IonSkeletonText, a4 as createTextVNode, K as IonIcon, aP as medicalOutline, H as Fragment, b8 as IonCardHeader, am as IonList, Q as renderList, an as IonItem, a6 as IonLabel, b5 as calendarOutline, A as createBaseVNode, C as toDisplayString, cI as idCardOutline, c6 as folderOutline, c3 as checkmarkCircleOutline, ba as IonCardContent, l as dayjs, a1 as onMounted, ax as IonGrid, ae as IonRow, ay as IonCol, a3 as normalizeClass, dZ as checkboxOutline, G as createCommentVNode, c8 as clipboardOutline, d_ as statsChartOutline, J as modalController, aI as useRouter, d as computed, d$ as warning, ct as useRoute, v as resolveComponent, aD as IonContent, cP as defineAsyncComponent, e0 as ellipsisVerticalSharp, d2 as person, aF as IonAccordionGroup, aE as IonAccordion, O as normalizeStyle, F as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, aY as personOutline, s as documentTextOutline, a_ as printOutline, d3 as add, bs as IonPage, cH as __vitePreload } from './vendor-DUNDjU_C.js';
import { s as storeToRefs } from './pinia-CzgPmrQI.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, aa as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$4, al as ArtTasks, z as useExposeFromStandardForm, y as StandardValidations, C as StandardForm, F as DynamicButton, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, am as router, k as alertConfirmation, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, M as ProgramId, S as Service, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-cEgpSt1H.js';
import { u as useUserActivities } from './useUserActivities-Bky2SQXJ.js';
import { u as usePatientProfile } from './usePatientProfile-7C3kZxEe.js';
import { D as DemographicBar } from './DemographicBar-BLY5w8CH.js';
import { i as isTaskPermitted } from './tasks-CfhUnThb.js';
...
const LabourEnrollment = async (personInfo) => {
  ...
  if (result) {
    ...
    await ObservationService.buildSaveObs([obs], EncounterTypeId.Labour_and_delivery_visit);
    toastSuccess("Patient enrolled successful");
    router.push("labourProfile");
  } else {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-D7lUy9xs.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Cg1cJqYF.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CFkjh9sk.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-KCKUTiPL.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-C2P_d8Fl.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-BfyyYlpp.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-D_W67J8N.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-zQMvjxZV.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-YGkNjGtF.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-HKaSJcPS.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-DwMG5IKZ.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-cEgpSt1H.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-CVcLRqE6.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-z-tvg7hE.js'),true              ?[]:void 0));
    const router = useRouter();
...
const PatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35b25bb7"]]);
