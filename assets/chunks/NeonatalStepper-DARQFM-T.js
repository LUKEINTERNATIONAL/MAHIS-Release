...
import { n as icons, H as HisDate, S as Service, u as useDemographicsStore, y as StandardValidations, M as ConceptService, E as EncounterService, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-zVTyLhXp.js';
import { S as SaveProgressModal } from './SaveProgressModal-Bbxz_Rhu.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-B6oMgo8c.js';
import { getInfographicByKey, getAllInfographicKeys } from './infographics-DsBx67Jk.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-CmT9zwJR.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-BowSlUSj.js';
import { d as defineStore } from './pinia-BqgWZabu.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (vitalsData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (vitalsData) => {
      ...
      formData: [
        {
          ...
          infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey(key))
        }
      ],
      skipCondition: (formValues) => {
        const allDiagnoses = [];
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("JaundiceManagement"))
      },
      {
        componentType: "listSelectionField",
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DsBx67Jk.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalMoroReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "moroReflex",
