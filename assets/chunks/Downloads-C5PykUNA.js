import { s as defineComponent, aL as useRouter, a2 as onMounted, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aG as IonContent, C as createBaseVNode, du as IonImg, aE as IonTitle, a5 as createTextVNode, D as toDisplayString, z as createElementBlock, H as createCommentVNode, J as Fragment, R as renderList, bK as IonCard, bd as IonCardContent, P as normalizeStyle, L as IonIcon, N as IonButton, a4 as normalizeClass, cn as checkmarkCircle, dv as downloadOutline, a8 as withModifiers, dw as arrowBack, bu as IonPage, f as ref, dx as desktopOutline, dy as logoApple, dz as phonePortraitOutline } from './vendor-BO7XRaEo.js';
import { i as img } from './Img-B85mlUNz.js';
import { _ as _export_sfc } from '../index-C1ltxM1o.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleDownload = (file, platform) => {
      ...
      const baseUrl = mode.value === "production" ? `https://github.com/LUKEINTERNATIONAL/MAHIS-Production/releases/download/${latestVersion.value}` : `https://github.com/LUKEINTERNATIONAL/MAHIS-Release/releases/download/${latestVersion.value}`;
              ...
              createBaseVNode("div", _hoisted_1, [
                createBaseVNode("div", _hoisted_2, [
                  ...
                  createVNode(unref(IonTitle), { class: "page-title" }, {
                    default: withCtx(() => [
                      createTextVNode("Download MaHIS " + toDisplayString(mode.value), 1)
                    ]),
                    _: 1
                  }),
                  _cache[0] || (_cache[0] = createBaseVNode("p", { class: "page-subtitle" }, "Malawi Health Information System - Access healthcare data anywhere, anytime", -1)),
                          ...
                          default: withCtx(() => [
                            ...
                            createBaseVNode("div", _hoisted_11, [
                              createBaseVNode("p", _hoisted_12, [
                                _cache[1] || (_cache[1] = createBaseVNode("span", { class: "detail-label" }, "File:", -1)),
                                createTextVNode(" " + toDisplayString(item.file), 1)
                              ]),
                              item.size ? (openBlock(), createElementBlock("p", _hoisted_13, [
                                _cache[2] || (_cache[2] = createBaseVNode("span", { class: "detail-label" }, "Size:", -1)),
                ...
                createVNode(unref(IonCard), { class: "help-card" }, {
                  default: withCtx(() => [
                    createVNode(unref(IonCardContent), null, {
                      default: withCtx(() => [
                        _cache[8] || (_cache[8] = createBaseVNode("h2", { class: "section-title" }, "Need Help Installing?", -1)),
                        _cache[9] || (_cache[9] = createBaseVNode("p", { class: "help-text" }, "Follow our step-by-step installation guides for your platform:", -1)),
                ...
                createBaseVNode("div", _hoisted_17, [
                  createBaseVNode("a", {
                    ...
                    _cache[10] || (_cache[10] = createTextVNode(" Back to Login ", -1))
                  ])
                ])
              ])
            ]),
...
const Downloads = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9618f18"]]);
