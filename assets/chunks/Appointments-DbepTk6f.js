import { q as defineComponent, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, v as resolveComponent, x as createElementBlock, y as openBlock, z as createVNode, B as withCtx, A as createBaseVNode, H as Fragment, Q as renderList, N as createBlock, a4 as createTextVNode, C as toDisplayString, G as createCommentVNode, O as normalizeStyle, bs as IonPage, bW as chevronBackOutline, bv as eye, dq as calendar, bp as pulseOutline, b9 as checkmark } from './vendor-DGIzCW4f.js';
import { F as DynamicButton, b8 as BMIService, H as HisDate, o as createModal, aq as ConceptService, E as EncounterService, P as PatientService, u as useDemographicsStore, bb as useInvestigationStore, n as icons, _ as _export_sfc, T as Toolbar, K as ObservationService } from '../index-D_1ZD1MC.js';
import { D as DemographicBar } from './DemographicBar-BNmwp08x.js';
import { N as NextAppointmentModal, L as LandingPage, u as useScheduleNextAppointmentStore } from './NextAppointmentModal-C9p-cyEQ.js';
import { U as UpcomingFeature, I as InvestigationsModal, F as FeatusModal } from './UpcomingFeature-BmpARHKo.js';
