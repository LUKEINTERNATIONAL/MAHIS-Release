import { s as defineComponent, aL as useRouter, w as watch, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, F as unref, aA as IonCol, a5 as createTextVNode, af as IonRow, J as Fragment, R as renderList, O as createBlock, D as toDisplayString, N as IonButton, L as IonIcon, di as eyeOutline, H as createCommentVNode, bG as addOutline, aR as syncOutline, bT as trashOutline, I as IonHeader, aD as IonToolbar, aE as IonTitle, be as IonButtons, aG as IonContent, bF as IonModal, f as ref, c as computed, a4 as normalizeClass, db as timeOutline, bu as IonPage } from './vendor-CLJC7Gvp.js';
import { u as useDemographicsStore, S as Service, g as getPouchDBRecords, O as OrderService, z as StandardForm, aq as ConceptService, o as createModal, J as savePatientRecord, aY as AppEncounterService, b as EncounterTypeId, t as toastWarning, n as icons, y as StandardValidations, _ as _export_sfc, T as Toolbar } from '../index-C9W3jvb3.js';
import { K as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-tFvh_uOd.js';
import { s as storeToRefs } from './pinia-D5Z686-t.js';
import { _ as _sfc_main$3 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-tclgFOxE.js';
...
const _hoisted_11$1 = { class: "queue-header" };
const _hoisted_12 = {
  key: 0,
  class: "report-card"
};
const _hoisted_13 = { class: "report-header" };
const _hoisted_14 = { class: "report-title-row" };
const _hoisted_15 = { class: "report-meta" };
const _hoisted_16 = { key: 0 };
const _hoisted_17 = { class: "results-table" };
const _hoisted_18 = { class: "indicator-name" };
const _hoisted_19 = { class: "indicator-value" };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const addResults = async (investigation) => {
      await createModal(_sfc_main$3, { class: "large-medium-width-modal " }, true, { test_data: investigation });
    };
    ...
    function removeQueuedTest(localId) {
      queuedTests.value = queuedTests.value.filter((r) => r.localId !== localId);
    }
    const syncQueuedTests = async () => {
      ...
      try {
        ...
        try {
          ...
          console.error("Failed to create LAB_ORDERS encounter", e);
        }
        await loadLabOrders();
        queuedTests.value = [];
        formRef.value?.resetForm?.();
      } catch (error) {
        console.log("🚀 ~ syncQueuedTests ~ error:", error);
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("section", _hoisted_9$1, [
            _cache[18] || (_cache[18] = createBaseVNode("h6", { class: "section-title" }, "Current Investigations", -1)),
                  ...
                  default: withCtx(() => [
                    createVNode(unref(IonButton), {
                      ...
                      default: withCtx(() => [
                        ...
                        createTextVNode(" " + toDisplayString(isSubmitting.value ? "Adding..." : "Add Test"), 1)
                      ]),
                      _: 1
                    }, 8, ["disabled"])
                  ]),
            ...
            queuedTests.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
              createBaseVNode("div", _hoisted_11$1, [
                _cache[14] || (_cache[14] = createBaseVNode("h6", {
                  class: "section-title",
                  style: { "margin": "0" }
                }, "Tests to Sync", -1)),
                createVNode(unref(IonButton), {
                  ...
                  disabled: isSubmitting.value || queuedTests.value.length === 0
                }, {
                  default: withCtx(() => [
                    createVNode(unref(IonIcon), {
                    ...
                    createTextVNode(" " + toDisplayString(isSubmitting.value ? "Syncing..." : `Sync (${queuedTests.value.length})`), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"])
              ]),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(queuedTests.value, (row) => {
                return openBlock(), createBlock(unref(IonRow), {
                  key: row.localId,
                  class: "table-row"
                }, {
        ...
        createVNode(unref(IonModal), {
          ...
          default: withCtx(() => [
            ...
            createVNode(unref(IonContent), { class: "ion-padding report-content" }, {
              default: withCtx(() => [
                selectedInvestigation.value && selectedTest.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
                  createBaseVNode("div", _hoisted_13, [
                    ...
                    createBaseVNode("div", _hoisted_15, [
                      ...
                      selectedInvestigation.value.accession_number ? (openBlock(), createElementBlock("p", _hoisted_16, [
                  ...
                  createBaseVNode("div", _hoisted_17, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(selectedTest.value.result, (result) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("span", _hoisted_18, toDisplayString(indicatorNames.value[result.indicator.concept_id] || "Loading..."), 1),
                        createBaseVNode("span", _hoisted_19, toDisplayString(result.value), 1)
                      ]);
                    }), 128))
                  ])
                ])) : createCommentVNode("", true)
...
const Investigation = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1787ab29"]]);
      ...
      if (stepIndex === finalStepIndex) {
        return async () => {
          try {
            ...
            console.error("Failed to save investigation completion encounter", error);
          }
