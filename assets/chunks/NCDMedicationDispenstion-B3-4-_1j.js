import { q as defineComponent, L as IonIcon, N as IonButton, ay as IonCol, af as IonRow, aB as IonTitle, br as IonPage, bb as IonFooter, I as IonHeader, H as IonContent, ag as close, ch as medkit, K as modalController, v as resolveComponent, x as createElementBlock, y as openBlock, z as createVNode, A as withCtx, B as createBaseVNode, C as toDisplayString, a5 as createTextVNode, J as Fragment, aH as useRouter, cs as useRoute, r as ref, d as computed, aj as onBeforeUnmount, w as watch, a2 as onMounted, O as createBlock, E as unref, Q as alertCircleOutline, R as renderList, bI as IonCard, b9 as IonCardContent, G as createCommentVNode, a6 as IonInput, a4 as normalizeClass, dn as checkmarkDoneCircleOutline, bu as eye, b7 as IonCardHeader, b6 as IonCardTitle } from './vendor-BizyHS9K.js';
...
import { n as icons, _ as _export_sfc, aY as AppEncounterService, P as PatientService, S as Service, u as useDemographicsStore, J as savePatientRecord, G as toastSuccess, bZ as toastDanger, bH as DrugOrderService, e as useGeneralStore, v as usePatientList, aM as PrintoutService, r as closeVisit, k as alertConfirmation, x as toastDanger$1, o as createModal, b_ as checkLiveAPIStatus, g as getPouchDBRecords } from '../index-B8cwm10e.js';
import { a as DRUG_FREQUENCIES } from './drug_prescription_service-6J-_gRE-.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    computed(() => {
      return medications.value.reduce((groups, medication) => {
...
const NCDMedicationDispenstion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d7e6a4a3"]]);
