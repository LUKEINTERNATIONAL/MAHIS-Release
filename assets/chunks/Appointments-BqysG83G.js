import { q as defineComponent, ay as IonToolbar, az as IonTitle, aA as IonMenu, am as IonList, an as IonItem, I as IonHeader, H as IonContent, v as resolveComponent, x as createElementBlock, y as openBlock, z as createVNode, A as withCtx, B as createBaseVNode, J as Fragment, R as renderList, O as createBlock, a5 as createTextVNode, C as toDisplayString, G as createCommentVNode, P as normalizeStyle, bq as IonPage, bV as chevronBackOutline, bt as eye, dp as calendar, bn as pulseOutline, b6 as checkmark } from './vendor-Cy_N32Zh.js';
import { F as DynamicButton, b8 as BMIService, H as HisDate, o as createModal, aq as ConceptService, E as EncounterService, P as PatientService, u as useDemographicsStore, bb as useInvestigationStore, n as icons, _ as _export_sfc, T as Toolbar, K as ObservationService } from '../index-CZxb0S4T.js';
import { D as DemographicBar } from './DemographicBar-DAXqTa_p.js';
import { N as NextAppointmentModal, L as LandingPage, u as useScheduleNextAppointmentStore } from './NextAppointmentModal-RpvnXDwm.js';
import { U as UpcomingFeature, I as InvestigationsModal, F as FeatusModal } from './UpcomingFeature-z_mUjw_6.js';
