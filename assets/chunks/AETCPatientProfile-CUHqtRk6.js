import { s as defineComponent, aN as useRouter, bO as useRoute, a3 as onMounted, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aI as IonContent, H as createCommentVNode, C as createBaseVNode, af as IonRow, aB as IonCol, bN as IonCard, bf as IonCardContent, L as IonIcon, e2 as ellipsisVerticalSharp, Q as normalizeClass, d4 as person, D as toDisplayString, a5 as createTextVNode, G as closeCircleOutline, di as IonSegment, dj as IonSegmentButton, a7 as IonLabel, z as createElementBlock, P as normalizeStyle, aq as IonItem, b1 as personOutline, v as documentTextOutline, cK as idCardOutline, b3 as printOutline, J as Fragment, S as renderList, d5 as add, bx as IonPage, cT as defineAsyncComponent, cJ as __vitePreload, f as ref, c as computed } from './vendor-8vOj_QAN.js';
import { s as storeToRefs } from './pinia-Drf8jDfn.js';
import { A as ArtCard } from './PatientProfile-DmJy9qJt.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, as as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, aq as iconBMI, k as alertConfirmation, ar as openVisit, q as usePatientList, G as toastSuccess, v as closeVisit, cS as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-Bn2sysQf.js';
...
import { C as CPR } from './CPR-CBk5-Mdh.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BDUB4OzA.js'),true              ?[]:void 0));
