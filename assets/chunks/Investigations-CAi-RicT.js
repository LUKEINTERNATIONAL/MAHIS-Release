import { O as OrderService, bq as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, br as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, S as Service, F as DynamicButton, a_ as List, B as BasicInputField, ba as SelectionPopover, g as getPouchDBRecords, aq as ConceptService, bm as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as useExposeFromStandardForm, C as StandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, q as StandardModal, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-BBSKuWmW.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-BmV_6_tV.js';
import LabOrdersList from './LabOrdersList-BRKF-Pfo.js';
import { v as validateInputFiledData } from './group_validation-kxnvbDNL.js';
import { u as useRadiologyStore } from './RadiologyStore-BI8nPQ4R.js';
import { B as BasicForm } from './BasicForm-DXf9I_la.js';
import { v as defineComponent, a3 as onMounted, y as resolveComponent, P as createBlock, A as openBlock, D as withCtx, B as createVNode, C as createBaseVNode, f as ref, z as createElementBlock, K as Fragment, S as renderList, J as createCommentVNode, G as unref, w as watch, bo as IonPopover, a7 as IonInput, aC as IonToolbar, aD as IonTitle, aE as IonMenu, ao as IonList, ap as IonItem, I as IonHeader, aF as IonContent, br as pulseOutline, bb as checkmark, a6 as createTextVNode, c as computed, bL as IonCard, r as reactive, az as IonGrid, ag as IonRow, aA as IonCol, aH as IonAccordionGroup, aG as IonAccordion, a8 as IonLabel, E as toDisplayString, bP as IonChip, af as IonCheckbox, by as IonText, bc as IonCardContent, q as dayjs, aK as useRouter, cv as useRoute, T as withDirectives, U as vShow, L as modalController } from './vendor-CJ5LqAxe.js';
import { l as lodashExports } from './lodash-BxWMU_OR.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-BXXyX11U.js';
import { D as DashBox } from './DashBox-BKWxwRfy.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-DvvAe7Di.js';
import { P as PatientComplaintsService } from './patient_complaints_service-BQdXtZUZ.js';
import { u as useFormWizard, _ as _sfc_main$8 } from './useFormWizard-DaQAwIrH.js';
import { a as isClinician } from './user_role_management-BvrBOXXC.js';
