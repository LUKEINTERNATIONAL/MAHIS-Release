import { s as defineComponent, ae as IonCheckbox, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aI as IonContent, x as resolveComponent, y as openBlock, O as createBlock, bI as IonModal, a7 as IonLabel, aK as IonAccordionGroup, aJ as IonAccordion, bc as IonCardTitle, cF as IonCardSubtitle, bd as IonCardHeader, bf as IonCardContent, bN as IonCard, N as IonButton, bx as IonPage, cw as IonMenuButton, eG as list, dc as grid, eH as arrowForwardCircle, be as checkmark, b$ as chevronBackOutline, B as withCtx, A as createVNode, C as createBaseVNode, Q as normalizeClass, z as createElementBlock, H as createCommentVNode } from './vendor-8vOj_QAN.js';
import { aU as modifyCheckboxInputField, bM as getRadioSelectedValue, a3 as modifyFieldValue, i as useEnrollementStore, o as createModal, n as icons, _ as _export_sfc, F as DynamicButton, a5 as ToolbarSearch, T as Toolbar, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, a4 as getFieldValue, t as toastWarning, y as StandardValidations, ad as GlobalPropertyService, $ as IdentifierService, P as PatientService, bo as resetNCDPatientData, S as Service, k as alertConfirmation, bN as resetPatientData, e as useGeneralStore, bm as useDiagnosisStore, bl as useInvestigationStore, b3 as useVitalsStore, u as useDemographicsStore, f as useStatusStore } from '../index-Bn2sysQf.js';
...
import { F as FamilyHistoryNCDNumber, S as SubstanceDiagnosis, P as PatientHistory } from './NCDNumber-BcQbHfNm.js';
import { D as DispositionModal } from './OutcomeModal-_FjAa7Av.js';
import { B as BasicForm } from './BasicForm-DVQSxZ-F.js';
import { B as BasicCard, u as useConfigurationStore } from './BasicCard-CxQA_idX.js';
import { _ as _sfc_main$6 } from './RiskAssessment.vue_vue_type_script_setup_true_lang-D6GVJTMI.js';
import { b as formatCheckBoxData, c as formatRadioButtonData } from './formatServerData-C9U6QMid.js';
...
const _sfc_main = defineComponent({
  ...
  methods: {
    async checkEnrollment() {
      ...
      if (!result) this.nav("/ncd/consultation-plan");
    },
    setCurrentStep(name) {
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", {
              ...
              onClick: _cache[0] || (_cache[0] = ($event) => _ctx.nav("/patient-profile"))
            }, [
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_10, [
            _ctx.currentStep == "NCD Number, Patient Type & Family History" ? (openBlock(), createBlock(_component_DynamicButton, {
              ...
              name: "Cancel",
              color: "danger",
              onClick: _cache[4] || (_cache[4] = ($event) => _ctx.nav("/patient-profile"))
...
const Enrollment = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-ffde9a58"]]);
