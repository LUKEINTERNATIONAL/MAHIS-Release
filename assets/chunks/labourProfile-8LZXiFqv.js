import { c as computed, s as defineComponent, w as watch, a3 as onMounted, n as nextTick, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, O as createBlock, bM as IonCard, f as ref, C as createBaseVNode, J as Fragment, S as renderList, D as toDisplayString, H as createCommentVNode, aM as useRouter, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-XNfOCpdb.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-CHTmU_LN.js';
import { u as useDemographicsStore, z as StandardForm, K as ObservationService, b as EncounterTypeId, t as toastWarning, G as toastSuccess, _ as _export_sfc, H as HisDate, T as Toolbar, F as DynamicButton } from '../index-DjgSdAC3.js';
import { D as DemographicBar } from './DemographicBar-CiE0FKyt.js';
import { s as storeToRefs } from './pinia-CtfxbWof.js';
import { L as LabourPastPregnancyComplications, e as LabourWomanBehaviour, a as LabourAllergies, d as LabourChronicHealthConditions, c as LabourVaccineHistory, b as LabourMedications } from './LabourComplications-DwQuZsq7.js';
