import { r as ref, d as computed, cF as __vitePreload, q as defineComponent, L as IonIcon, M as IonSpinner, af as IonRow, aw as IonCol, b7 as IonCardContent, bH as IonCard, N as IonButton, cE as arrowForward, fe as download, h as inject, du as arrowBack, ff as closeOutline, bV as chevronBackOutline, eT as provide, v as resolveComponent, O as createBlock, y as openBlock, A as withCtx, z as createVNode, x as createElementBlock, J as Fragment, R as renderList, S as withDirectives, G as createCommentVNode, B as createBaseVNode, a4 as normalizeClass, C as toDisplayString, c0 as resolveDynamicComponent, a5 as createTextVNode, T as vShow } from './vendor-BK8x96Ok.js';
import { n as icons, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-dAcYVh-O.js';
import { S as SaveProgressModal } from './SaveProgressModal-ByT-Guwg.js';
import { d as defineStore } from './pinia-C47my0-I.js';
import { n as neonatalEnrollmentFormKey } from './enrollment-mxrpHf67.js';
...
const neonatalTriageSections = [
  {
    ...
    formData: [
      ...
      },
      {
        ...
        optionsToDiselectOthersSelections: ["stable", "not_breathing"],
        validation: (value) => !value ? "Please select one option" : null,
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("StartMeasuringOxygenSaturation"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        showCheckmark: true,
        options: [
          { label: "Grunting or Severe chest indrawing's", value: "grunting" },
    ...
    formData: [
      {
        ...
        header: "Grunting or severe chest indrawings",
        helperText: "If not already on oxygen",
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
  ...
  },
  {
    ...
    subtitle: "Check for central cyanosis",
    formData: [
      {
        componentType: "radioButtonField",
        name: "central_cyanosis",
        header: "Is central cyanosis present?",
        type: "standard",
        allowDeselect: false,
        options: [
          { label: "Yes", value: "yes" },
    ...
    skipCondition: (triageData) => {
      const isCrying = triageData.crying === "yes";
      const hasCriticalBreathing = isCriticalBreathing(triageData.breathing);
      return isCrying || !hasCriticalBreathing;
    }
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ],
    skipCondition: (triageData) => isCriticalBreathing(triageData.breathing)
  },
  {
    title: "Danger Signs 2",
    ...
    // skipCondition: (triageData: Record<string, any>) => isCriticalBreathing(triageData.breathing),
  },
  {
    title: "Trunk Feels Cold",
    ...
    formData: [
      {
        ...
        header: "Hypothermia Alert",
        subtitle: "Baby's trunk is cold - immediate warming needed",
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (triageData) => !triageData.present_signs?.includes("trunk_cold")
  },
  {
    title: "Emmergency Management 4",
    subtitle: "Temperature management required",
    description: `This baby may be in Shock! See pg 74 COIN
(NB. Don't give a bolus to a baby that has not responded to resuscitation)`,
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => !triageData.present_signs?.includes("capillary_refill") && !triageData.present_signs?.includes("weak_pulse")
  },
  {
    title: "Vital Signs",
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
      ...
      if (respiratoryRate > 60) return false;
      return true;
    }
  },
  // {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (triageData) => {
      ...
      const hasSevereRespiratoryDistress = satsMonAvailable && satsAir < 90 || satsMonAvailable && rr > 80;
  ...
  },
  {
    ...
    skipCondition: (formValues) => {
      ...
      const rr = Number(formValues.respiratory_rate);
      const shouldShow = satsMonAvailable && satsAir < 90 || satsMonAvailable && rr > 80;
      return !shouldShow;
    }
  },
  {
    ...
    skipCondition: (triageData) => {
      ...
      if (heartRate && heartRate < 60 || satsO2 && satsO2 < 80) {
        return false;
      }
      return true;
    }
  },
  {
    ...
    subtitle: "This baby has severe respiratory distress and WILL require referral",
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
  ...
  {
    title: "Baby Recovered",
    subtitle: "Sats in O2 have recovered but this baby still has Respiratory Distress and WILL require referral",
    description: "Baby has recovered oxygen saturation but still requires referral",
    formData: [
      {
        componentType: "infographicField",
    ...
    formData: [
      {
        componentType: "infographicField",
        name: "keep_the_baby_warm",
        header: "Warm The Body",
        subtitle: "Temperature is too low",
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ...
    formData: [
      {
        ...
        header: "Admission Weight(g)",
        type: "number",
        placeholder: "",
        validation: (value) => {
          if (!value) return "Admission weight is required";
          const weight = Number(value);
          if (Number.isNaN(weight)) {
            return "Weight must be a number";
          }
          if (weight < 500 || weight > 6e3) {
            return "Enter a valid neonatal admission weight (500–6000 g)";
          }
          return null;
        }
      },
      ...
      },
      {
        ...
        initialValue: [],
        condition: (formValues) => {
          return Boolean(Number(formValues.admission_weight) < Number(formValues.birth_weight));
        }
      },
      {
        componentType: "inputField",
  ...
  },
  {
    ...
    subtitle: "High respiratory rate detected",
    description: "Respiratory rate >60 requires additional assessment",
    formData: [
      {
        componentType: "checkboxField",
  ...
  {
    title: "Second Vital Signs",
    subtitle: "Repeat vital signs measurement",
    description: "Record second set of vital signs for monitoring",
    formData: [
      {
        componentType: "inputField",
        name: "respiratory_rate_2",
        header: "Respiratory Rate (breaths/min)",
        type: "number",
        placeholder: "Count for 60 seconds",
        validation: (value) => {
...
const neonatalEnrollmentSections = [
  {
    ...
    formData: [
      ...
      },
      {
        ...
        placeholder: "Select type",
        icon: icons.search,
        options: multiSelectOptions(["Singleton", "Twin", "Triplet"]),
        trackBy: "value",
        label: "label",
        padding: true,
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        icon: icons.search,
        options: multiSelectOptions(["Fundal height", "LMP", "Ultrasound", "Ballad Score"]),
        trackBy: "value",
        label: "label",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        validation: (value) => value ? null : "Specify whether mother was treated"
      },
      {
        componentType: "radioButtonField",
  ...
  },
  {
    ...
    subtitle: "Tetanus vaccination history",
    formData: [
      {
        componentType: "multiSelectInputField",
        ...
        trackBy: "value",
        label: "label",
        validation: (value) => value?.value || value ? null : "Select Tetanus Diphtheria status"
      }
    ]
  }
];
...
const umbilicalConditionLabels = {
  hernia: "Hernia",
  swelling: "Swelling",
  discharge_pus_blood: "Discharge (Pus/Blood)"
};
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        showCheckmark: true,
        options: [
          { label: umbilicalConditionLabels.hernia, value: "hernia" },
          { label: umbilicalConditionLabels.swelling, value: "swelling" },
          { label: umbilicalConditionLabels.discharge_pus_blood, value: "discharge_pus_blood" }
        ],
      ...
      },
      {
        ...
        builder: (formValues) => {
          ...
          pushRow(
            ...
            formatLabel(formValues.frequency_of_feeding, feedingFrequencyLabels)
          );
          pushRow("Feeding History", "Duration of feeding", withUnit(formValues.duration_of_feeding, "minutes"));
          pushRow(
            "Feeding History",
            "Effort during feeding",
            formatLabel(formValues.effort_during_feeding, feedingEffortLabels)
          );
          ...
          pushRow(
            "Bowel Movements",
            "Passage of meconium",
            formatLabel(formValues.passage_of_meconium, meconiumTimingLabels)
          );
          pushRow("Bowel Movements", "Frequency of stooling", withUnit(formValues.frequency_of_stooling, "minutes"));
          pushRow(
            "Bowel Movements",
            "Color of stools",
            formatLabel(formValues.color_of_stools, stoolColorLabels)
          );
          pushRow(
            "Bowel Movements",
            "Consistency of stools",
            formatLabel(formValues.consistency_of_stools, stoolConsistencyLabels)
          );
          ...
          pushRow(
            "Urine Output",
            "Color of urine",
            formatLabel(formValues.color_of_urine, urineColorLabels)
          );
          pushRow("Urine Output", "Volume (ml)", formValues.volume_ml);
          pushRow(
            "Growth",
            "Weight trend since birth",
            formatLabel(formValues.weight_trend_since_birth, weightTrendLabels)
          );
          ...
          pushRow(
            "Abdomen",
            "Umbilical findings",
            formatLabel(formValues.umbilical_condition, umbilicalConditionLabels)
          );
...
const neonatalDischargeSections = [
  ...
  {
    title: "Print Summary",
    subtitle: "Print discharge summary for your records.",
    formData: [
      {
        componentType: "Slot",
        name: "printSlot",
...
function getNextDischargeSectionIndex(currentIndex, dischargeData) {
  if (currentIndex < neonatalDischargeSections.length - 1) {
    ...
    formData: [
      {
        ...
        header: "Heart sounds",
        subtitle: "Auscultate the heart sounds",
        titleStyle: "tonal",
        type: "single",
        allowDeselect: false,
        options: [
          { label: "Normal heart sounds", value: "normal" },
          { label: "Murmur detected", value: "murmur" },
          { label: "Muffled heart sounds", value: "muffled" },
          { label: "Unable to assess", value: "unable" }
        ],
      ...
      },
      {
        ...
        subtitle: "Palpate femoral pulse",
        titleStyle: "tonal",
        type: "single",
        allowDeselect: false,
        options: [
          { label: "Normal and equal bilaterally", value: "normal" },
      ...
      {
        componentType: "radioButtonField",
        name: "hasCardiacAbnormality",
        header: "Any cardiac abnormality suspected?",
        type: "standard",
        allowDeselect: false,
        options: [
          { label: "Yes", value: "yes" },
        ...
        validation: (value) => !value ? "Please indicate if cardiac abnormality is suspected" : null,
        showClearButton: true
      }
    ]
  },
    ...
    formData: [
      {
        ...
        options: [
          ...
          { label: "Ambiguous genitalia", value: "Ambiguous" },
          { label: "Hypospadias", value: "Hypospadias" },
          { label: "Undescended testes", value: "Undescended testes" },
          { label: "Other abnormality", value: "Abnormal" }
        ],
      ...
      },
      {
        ...
        validation: (value) => !value ? "Please indicate if the anus is patent" : null,
        showClearButton: true
      },
      {
        componentType: "radioButtonField",
        name: "hasMeconiumPassed",
        header: "Has meconium been passed?",
        type: "standard",
        allowDeselect: true,
        options: [
          { label: "Yes", value: "yes" },
        ...
        validation: (value) => !value ? "Please indicate if meconium has been passed" : null,
        showClearButton: true
      }
    ]
  },
    ...
    formData: [
      {
        ...
        builder: (formValues) => {
          ...
          pushRow("Color", "Pallor Pink", formValues.isBabyPallorPink === "yes" ? "Yes" : formValues.isBabyPallorPink === "no" ? "No" : void 0);
          pushRow("Color", "Cyanosis", formValues.hasBabyCyanosis === "yes" ? "Yes" : formValues.hasBabyCyanosis === "no" ? "No" : void 0);
          ...
          pushRow("Cardiovascular", "Cardiac Abnormality", formValues.hasCardiacAbnormality === "yes" ? "Yes" : formValues.hasCardiacAbnormality === "no" ? "No" : void 0);
          ...
          pushRow("Genital & Anus", "Anus Patent", formValues.anusPatent === "yes" ? "Yes" : formValues.anusPatent === "no" ? "No" : void 0);
          pushRow("Genital & Anus", "Meconium Passed", formValues.hasMeconiumPassed === "yes" ? "Yes" : formValues.hasMeconiumPassed === "no" ? "No" : void 0);
          pushRow("Oral Cavity", "Cleft Lip", formValues.hasCleftLip === "yes" ? "Yes" : formValues.hasCleftLip === "no" ? "No" : void 0);
          pushRow("Oral Cavity", "Cleft Palate", formValues.hasCleftPalate === "yes" ? "Yes" : formValues.hasCleftPalate === "no" ? "No" : void 0);
          pushRow("Abnormalities", "Congenital Abnormalities", formValues.hasCongenitalAbnormalities === "yes" ? "Yes" : formValues.hasCongenitalAbnormalities === "no" ? "No" : void 0);
...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    previousStep(currentIndex) {
      ...
      const prevConfigIndex = this.getPreviousSectionIndex(minCurrentConfigIndex, formData);
      if (prevConfigIndex !== null && prevConfigIndex >= 0) {
        const prevStepperIndex = this.findStepperIndexForConfig(prevConfigIndex);
                ...
                return withDirectives((openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_1, [
                    (openBlock(), createBlock(resolveDynamicComponent(item.component), {
                      ...
                      stepIndex: index,
                      goToNext: () => _ctx.nextStep(index),
                      goToPrevious: () => _ctx.previousStep(index),
                      goToStep: _ctx.goToStep
                    }, null, 8, ["stepIndex", "goToNext", "goToPrevious", "goToStep"]))
                  ]),
                  createBaseVNode("div", _hoisted_2, [
                    createBaseVNode("div", _hoisted_3, [
                      index === 0 ? (openBlock(), createBlock(_component_ion_button, {
                        key: 0,
                        class: "cancel-button",
                        ...
                        onClick: ($event) => _ctx.previousStep(index)
                      }, {
                        default: withCtx(() => [
                          createVNode(_component_ion_icon, {
                            icon: _ctx.arrowBack,
                          ...
                          _cache[1] || (_cache[1] = createTextVNode(" Back ", -1))
                        ]),
                        _: 1
                      }, 8, ["onClick"]))
                    ]),
                    createBaseVNode("div", _hoisted_4, [
                      createVNode(_component_ion_button, {
                        class: "next-button",
                        onClick: ($event) => _ctx.handleNextClick(index),
                        disabled: _ctx.isProcessing
                      }, {
                        default: withCtx(() => [
                          _ctx.isProcessing && index === _ctx.StepperData.length - 1 ? (openBlock(), createBlock(_component_ion_spinner, {
                            key: 0,
                            name: "crescent",
                            slot: "start",
                            class: "button-spinner"
                          })) : createCommentVNode("", true),
                          createTextVNode(" " + toDisplayString(_ctx.getButtonText(index)) + " ", 1),
                          !_ctx.isProcessing ? (openBlock(), createBlock(_component_ion_icon, {
                            key: 1,
                            icon: _ctx.getButtonIcon(index),
                            slot: "end"
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-e34c9016"]]);

export { neonatalTreatmentPlanFormKey as A, treatmentPlanPrescriptionFieldConfig as B, defaultNeonatalTreatmentPlanForm as C, NeonatalStepper as N, defaultNeonatalReviewOfSystemsForm as a, defaultNeonatalSignsSymptomsForm as b, neonatalEnrollmentSections as c, defaultNeonatalVitalsForm as d, neonatalVitalsSections as e, neonatalVitalsFormKey as f, neonatalDischargeFormKey as g, neonatalDischargeSections as h, defaultNeonatalDischargeForm as i, neonatalAdmissionOutcomesFormKey as j, neonatalAdmissionSignOffSections as k, neonatalTriageSections as l, neonatalTriageFormKey as m, neonatalGeneralExaminationSections as n, defaultNeonatalTriageForm as o, neonatalSignsSymptomsSections as p, neonatalSignsSymptomsFormKey as q, neonatalReviewOfSystemsSections as r, neonatalReviewOfSystemsFormKey as s, triageConceptMapping as t, useNeonatalTriageStore as u, neonatalAdmissionOutcomeSections as v, neonatalAdmissionOutcomesSections as w, defaultNeonatalAdmissionOutcomesForm as x, neonatalInvestigationSections as y, neonatalTreatmentPlanSections as z };
