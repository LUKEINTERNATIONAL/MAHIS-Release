import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, a3 as onMounted, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, bO as useRoute, bW as IonSearchbar, L as IonIcon, ey as qrCode, N as IonButton, bJ as addOutline, a5 as createTextVNode, ez as Transition, M as IonSpinner, bS as IonChip, a7 as IonLabel, J as Fragment, S as renderList, eA as cloudOfflineOutline, eB as callOutline, b$ as chevronBackOutline, dh as chevronForwardOutline, aw as searchOutline, cQ as closeCircle, bf as IonCardContent, c as computed, cm as onBeforeUnmount, aI as IonContent, bx as IonPage, aN as useRouter, fm as onIonViewWillEnter, r as reactive, f3 as provide } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, K as ObservationService, W as useGlobalPropertyStore, a as useProgramStore, D as PatientSearchService, n as icons, y as StandardValidations, C as useExposeFromStandardForm, t as toastWarning, S as Service, ba as scannedData, o as createModal, T as Toolbar, al as ProgramService, M as ProgramId, H as HisDate, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, k as alertConfirmation } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { c as neonatalTriageFormKey, N as NeonatalStepper, H as defaultNeonatalTriageForm } from './NeonatalStepper-DJUdVdam.js';
import { b as getSectionById, u as useNeonatalTriageStore, c as getSectionIndexById, n as neonatalTriageSections, t as triageConceptMapping } from './triage-CxFMIncp.js';
import { R as RegistrationService } from './useSetRegistrationValues-DqT4b5dz.js';
...
import { R as Registration } from './Registration-Dl3oxXRe.js';
