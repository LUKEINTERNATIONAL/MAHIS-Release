import { f as ref, c as computed, cH as __vitePreload, s as defineComponent, L as IonIcon, M as IonSpinner, af as IonRow, aA as IonCol, bd as IonCardContent, bK as IonCard, N as IonButton, cG as arrowForward, ff as download, h as inject, dw as arrowBack, G as closeCircleOutline, bX as chevronBackOutline, eT as provide, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, R as renderList, S as withDirectives, a4 as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c1 as resolveDynamicComponent, T as vShow } from './vendor-CCA5uLDN.js';
import { n as icons, H as HisDate, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-4BtwP8vl.js';
import { S as SaveProgressModal } from './SaveProgressModal-CXgU9laF.js';
import { d as defineStore } from './pinia-D-2CL6iz.js';
import { getInfographicByKey } from './infographics-c_0oATqD.js';
import { k as feedingTypeLabels, f as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, e as meconiumTimingLabels, h as stoolColorLabels, i as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, j as umbilicalConditionLabels, m as musculoskeletalDeformityLabels, s as skinFindingLabels, t as toneAssessmentLabels, a as suckReflexLabels, g as graspReflexLabels, b as moroReflexLabels } from './reviewOfSystemsLabels-CROeEooM.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-DOxpuKdv.js';
...
const outcomeSections = [
  ...
  {
    title: "Summary",
    subtitle: "Admission Outcomes Summary",
    description: "Review your entries before saving",
    formData: [
      {
        componentType: "Alert",
        name: "admission_outcomes_summary_alert",
        type: "warning",
        backgroundColor: "#FEDF89",
        textColor: "#B54708",
        message: "Review your entries carefully. You can go back to edit if needed."
      ...
      {
        componentType: "summaryField",
        name: "admissionOutcomesSummary",
        title: "Admission Outcomes Summary",
        subtitle: "Auto-generated summary from admission outcomes",
        emptyStateMessage: "No admission outcomes captured yet.",
        builder: (formValues) => {
          const rows = [];
          const outcome = typeof formValues?.admissionOutcome === "string" ? formValues.admissionOutcome : void 0;
          if (outcome) {
            rows.push({ section: "Outcome", label: "Admission outcome", value: outcome });
          }
          const otherOutcome = typeof formValues?.admissionOutcomeOther === "string" ? formValues.admissionOutcomeOther : void 0;
...
const neonatalAdmissionOutcomesSections = outcomeSections;
    ...
    formData: [
      {
        ...
        condition: (formValues) => formValues.color === "yellow"
      },
      {
        componentType: "listSelectionField",
...
const useNeonatalExamStore = defineStore("neonatalExamStore", {
  ...
  actions: {
    ...
    setCongenitalAbnormalityType(type) {
      this.congenitalAbnormalityType = type;
    },
...
const _sfc_main = defineComponent({
  ...
  setup(props) {
    ...
    if (props.flowType === "enrollment") {
      ...
      getNextSectionIndex$3 = getNextSystemicExaminationSectionIndex;
      getPreviousSectionIndex$3 = getPreviousSystemicExaminationSectionIndex;
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b1a2d425"]]);

export { useNeonatalDischargeStore as A, getDischargeSectionIndexByName as B, triageConceptMapping as C, defaultNeonatalTriageForm as D, getSystemicExaminationSectionById as E, useSystemicExaminationStore as F, useSignsSymptomsStore as G, useReviewOfSystemsStore as H, neonatalAdmissionOutcomeSections as I, useNeonatalAdmissionOutcomesStore as J, neonatalInvestigationSections as K, useTreatmentPlanStore as L, defaultNeonatalTreatmentPlanForm as M, NeonatalStepper as N, neonatalGeneralExaminationFormKey as a, neonatalReviewOfSystemsFormKey as b, congenitalAbnormalityLabels as c, neonatalSignsSymptomsFormKey as d, neonatalAdmissionOutcomesFormKey as e, neonatalTriageFormKey as f, neonatalSystemicExaminationFormKey as g, neonatalTreatmentPlanFormKey as h, useNeonatalTriageStore as i, neonatalReviewOfSystemsSections as j, neonatalSignsSymptomsSections as k, neonatalEnrollmentSections as l, neonatalAdmissionOutcomesSections as m, neonatalGeneralExaminationSections as n, neonatalTriageSections as o, neonatalSystemicExaminationSections as p, neonatalTreatmentPlanSections as q, useDiagnosisStore as r, useSuggestedDiagnosisStore as s, neonatalVitalsSections as t, useNeonatalExamStore as u, neonatalVitalsFormKey as v, useNeonatalVitalsStore as w, getDischargeSectionByName as x, neonatalDischargeFormKey as y, neonatalDischargeSections as z };
