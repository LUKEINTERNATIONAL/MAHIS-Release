import { q as defineComponent, r as ref, bn as V, cY as DataTable, d as computed, w as watch, a1 as onMounted, n as nextTick, aj as onBeforeUnmount, x as createElementBlock, y as openBlock, z as createVNode, B as withCtx, A as createBaseVNode, H as Fragment, Q as renderList, C as toDisplayString, E as unref, a3 as normalizeClass } from './vendor-sqYZJ6fK.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["table-responsive", _ctx.containerClass])
      }, [
        createVNode(unref(V), {
          ...
          default: withCtx(() => [
            createBaseVNode("thead", null, [
              createBaseVNode("tr", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.headers, (head) => {
