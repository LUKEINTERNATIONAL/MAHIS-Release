import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fi as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, e$ as provide } from './vendor-D_Iz0VZ7.js';
import { s as storeToRefs } from './pinia-BGxzTr_B.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cn as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, cj as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-DR39kxWD.js';
import { D as DemographicBar } from './DemographicBar-DSJ-1k5H.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-Cs_On_uY.js';
import { S as SummarySection } from './SummarySection-DI82iJ2s.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-BdY3zWSn.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-lMu6MLaf.js';
