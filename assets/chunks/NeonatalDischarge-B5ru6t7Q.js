import { q as defineComponent, r as ref, d as computed, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, a3 as normalizeClass, z as createVNode, E as unref, d1 as person, K as IonIcon, C as toDisplayString, a4 as createTextVNode, h as inject, w as watch, N as createBlock, a2 as onUnmounted, G as createCommentVNode, H as Fragment, Q as renderList, aP as medicalOutline, b5 as calendarOutline, bS as trashOutline, bz as createStaticVNode, aa as checkmarkOutline, aj as onBeforeUnmount, R as withDirectives, S as vShow, cy as E, bD as QRCode, cz as autoTable, M as IonButton, aD as IonContent, bs as IonPage, aI as useRouter, a_ as printOutline, eS as provide, v as resolveComponent, B as withCtx } from './vendor-sqYZJ6fK.js';
import { s as storeToRefs } from './pinia-B_NbVBpS.js';
import { u as useDemographicsStore, H as HisDate, cj as InputField, P as PatientService, _ as _export_sfc, K as ObservationService, C as StandardForm, ck as SearchableDropdown, cl as DateInputField, ab as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-_N7CIn5p.js';
import { N as NeonatalService } from './neonatal_service-DfcsuN5C.js';
import { D as DemographicBar } from './DemographicBar-C1AiU9D7.js';
import { g as neonatalDischargeFormKey, h as neonatalDischargeSections, i as neonatalAdmissionOutcomesFormKey, j as neonatalAdmissionSignOffSections, k as useNeonatalDischargeStore, N as NeonatalStepper } from './NeonatalStepper-CxQhVATI.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-DCBFxbAR.js';
