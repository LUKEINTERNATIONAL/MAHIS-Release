...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bY as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, bZ as resetOPDPatientData, bI as StagesService, v as usePatientList, r as closeVisit } from '../index-Dh01XRoO.js';
import { D as DemographicBar } from './DemographicBar-DCt6mIO8.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-T94Y6Dqw.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-DHIJcvaa.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-fPHGCHvI.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-By0a24Ie.js';
import { I as Investigations } from './Investigations-dRsvkiJV.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-Cp9o86KD.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-DeiuGH8a.js';
import { P as PreviousTreatment } from './treatment-D_AxfBot.js';
import { l as lodashExports } from './lodash-B7NSOofK.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-CG3prvF_.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-BRU-18sM.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-FAVneWOS.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-CMWR--Ag.js';
