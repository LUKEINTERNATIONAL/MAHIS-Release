import { q as defineComponent, aI as useRouter, r as ref, d as computed, w as watch, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, R as withDirectives, z as createVNode, C as toDisplayString, E as unref, fl as caretDown, fm as caretUp, K as IonIcon, S as vShow, bz as createStaticVNode, a3 as normalizeClass, G as createCommentVNode, N as createBlock, aa as checkmarkOutline, a4 as createTextVNode, H as Fragment, Q as renderList, V as alertController } from './vendor-DGIzCW4f.js';
import { s as storeToRefs } from './pinia-Bmkga1nW.js';
import { u as useDemographicsStore, b as EncounterTypeId, _ as _export_sfc } from '../index-D_1ZD1MC.js';
  ...
  setup(__props) {
    ...
    const loadProgress = async () => {
      ...
      try {
        ...
        const completedCount = getSequentiallyCompletedStepCount(savedEncounters.value, admissionSubSteps.value);
        admissionSubSteps.value.forEach((step, index) => {
          step.isCompleted = index < completedCount;
        });
        const normalizedEncounterSet = new Set(
          savedEncounters.value.map((encounter) => normalizeEncounterName(encounter))
        );
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          ...
          withDirectives(createBaseVNode("div", _hoisted_4, [
            ...
            _cache[10] || (_cache[10] = createStaticVNode('<div class="progress-step last" data-v-854733d0><div class="step-indicator" data-v-854733d0><div class="step-circle" data-v-854733d0></div></div><div class="step-content" data-v-854733d0><div class="step-title incomplete" data-v-854733d0>Signoff &amp; Printout</div></div></div>', 1))
          ], 512), [
...
const AdmissionProgressBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-854733d0"]]);
