import { s as defineComponent, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aI as IonContent, bu as pulseOutline, be as checkmark, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode } from './vendor-Cddp3aFV.js';
import { n as icons, b0 as List, H as HisDate, K as ObservationService, b2 as iconList, b1 as iconGraph, u as useDemographicsStore, _ as _export_sfc } from '../index-CKPE6QZm.js';
  ...
  methods: {
    async updateList() {
      ...
      const presentingComplaint = !lodashExports.isEmpty(obs) ? Promise.all(
        obs.map(async (ob) => {
          if (ob.value_coded) {
            let complaintName = await ObservationService.getConceptName(ob["value_coded"]);
            let duration = ob.children[0].value_text;
...
const previousComplaints = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b64230de"]]);
