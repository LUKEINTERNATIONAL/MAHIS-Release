import { w as watch, f as ref, c as computed, s as defineComponent, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, F as unref, A as createVNode, B as withCtx, aB as IonCol, a5 as createTextVNode, af as IonRow, J as Fragment, S as renderList, O as createBlock, D as toDisplayString, N as IonButton, L as IonIcon, dj as eyeOutline, H as createCommentVNode, fB as TransitionGroup, bW as trashOutline, aS as syncOutline, fC as Transition, bI as addOutline, I as IonHeader, aE as IonToolbar, aF as IonTitle, bf as IonButtons, aH as IonContent, bH as IonModal, aM as useRouter, bN as useRoute, fk as onIonViewWillEnter, f1 as provide, bw as IonPage } from './vendor-DvGYa1v4.js';
import { u as useDemographicsStore, S as Service, g as getPouchDBRecords, O as OrderService, M as ConceptService, J as savePatientRecord, aY as AppEncounterService, b as EncounterTypeId, t as toastWarning, z as StandardForm, o as createModal, _ as _export_sfc, T as Toolbar } from '../index-CXpUT7W5.js';
import { l as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-BgQIjmg3.js';
import { d as defineStore, s as storeToRefs } from './pinia-C0lBSi-v.js';
import { _ as _sfc_main$2 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-Bw7auOT4.js';
import { b as neonatalInvestigationFormKey, S as SummarySection } from './SummarySection-CyTIaC9k.js';
