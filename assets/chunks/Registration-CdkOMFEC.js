import { bN as useRoute, c as computed, f as ref, w as watch, s as defineComponent, y as openBlock, O as createBlock, F as unref, aM as useRouter, a3 as onMounted, bw as IonPage, Q as normalizeClass, B as withCtx, z as createElementBlock, A as createVNode, M as IonSpinner, C as createBaseVNode, H as createCommentVNode, I as IonHeader, D as toDisplayString, aH as IonContent, T as withDirectives, U as vShow, bg as IonFooter, G as closeCircleOutline, N as IonButton, a5 as createTextVNode, J as Fragment, S as renderList, dp as checkmarkDoneCircleOutline, K as modalController } from './vendor-BcieWP-_.js';
import { h as createSameAsCurrentHandler, R as RegistrationService, u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$5, b as _sfc_main$6, c as _sfc_main$7, d as _sfc_main$8, e as _sfc_main$9, f as _sfc_main$a, g as _sfc_main$b } from './useSetRegistrationValues-CX8yrow8.js';
import { S as Service, f as useStatusStore, g as getPouchDBRecords, a8 as RelationsService, n as icons, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, F as DynamicButton, t as toastWarning, k as alertConfirmation, H as HisDate, _ as _export_sfc } from '../index-DYy5O9I5.js';
...
import { u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-DsHQ6jUd.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { setFormValues, setPatientLocation } = useSetRegistrationValues();
    const saveAllData = async () => {
      try {
        ...
        const registrationResult = await new RegistrationService().saveRegistrationData(allFormValues.value, context === "neonatal-mother" ? true : props.relativeRegistration);
        if (registrationResult) {
          const context2 = route.query.context;
          const returnTo = route.query.returnTo;
          if (context2 === "neonatal-mother" && returnTo === "/neonatal/enrollment") {
    ...
    const updateData = () => {
      if (props.isBaby) {
        setPatientLocation(formRefs);
        const birthDate = sessionStorage.getItem("DeliveryDate");
        personalInformationRef.value?.setFormValue("birthdate", birthDate ? HisDate.toStandardHisDisplayFormat(birthDate) : "");
      } else {
...
const Registration = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-215956dc"]]);
