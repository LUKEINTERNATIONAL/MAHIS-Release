import { s as defineComponent, fo as IonAlert, K as modalController, x as resolveComponent, y as openBlock, O as createBlock, ap as IonList, aq as IonItem, ai as IonRadio, ah as IonRadioGroup, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, R as renderList, a5 as createTextVNode, D as toDisplayString, af as IonRow, N as IonButton, aA as IonCol, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, I as IonHeader, aG as IonContent, f as ref, C as createBaseVNode, S as withDirectives, T as vShow, H as createCommentVNode, bF as IonModal, a7 as IonLabel, aI as IonAccordionGroup, aH as IonAccordion, ba as IonCardTitle, cD as IonCardSubtitle, bb as IonCardHeader, bd as IonCardContent, bK as IonCard, bu as IonPage, cu as IonMenuButton, bf as IonFooter, L as IonIcon, ab as checkmarkOutline, G as closeCircleOutline, a2 as onMounted, F as unref, fp as folderOpenOutline, c as computed, au as script, dj as Navigation, dk as Pagination, dl as Slide, dm as Carousel, c8 as clipboardOutline, d2 as person, e0 as ellipsisVerticalSharp, bc as checkmark, bX as chevronBackOutline, a4 as normalizeClass } from './vendor-74dOmGLc.js';
import { _ as _export_sfc, m as useAdministerVaccineStore, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, G as toastSuccess, o as createModal, g as getPouchDBRecords, z as StandardForm, F as DynamicButton, K as ObservationService, cp as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cM as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, cN as VitalsService, bJ as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-C7zo43Se.js';
...
import { m as mapState, s as storeToRefs } from './pinia-DUPmLFD0.js';
import { S as Stepper } from './Stepper-DQ4Vcjz7.js';
import { T as Treatment } from './treatment-DN5y6yHM.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-CZS_CLSM.js';
import WeightHeightChart from './WeightHeightChart-Bq0cBLrd.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-BeH8O_Cm.js';
import { c as customDatePicker } from './customDatePicker-j1VpHr9X.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, n as nextAppointMent } from './vaccines_service-kmCRXor7.js';
import { S as StockService } from './stock_service-DA6ve8dU.js';
import { u as useRelationships, _ as _sfc_main$c } from './Registration-kowvAeGY.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-BFCZyuwj.js';
...
import { O as Outcome, _ as _sfc_main$d } from './usePatientProfile-DHV49wpr.js';
...
const administerVaccineModal = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$7], ["__scopeId", "data-v-048a4a1b"]]);
            ...
            createBaseVNode("div", _hoisted_2$4, [
              createVNode(unref(IonAccordionGroup), {
                ...
                default: withCtx(() => [
                  ...
                  __props.protectedStatus != "Yes" ? (openBlock(), createBlock(unref(IonAccordion), {
                    key: 0,
                    value: "third",
                    "toggle-icon-slot": "start",
                    class: "custom_card"
...
const administerOtherVaccineModal = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-5a49669d"]]);
...
const _sfc_main$1 = defineComponent({
  ...
  methods: {
    ...
    openPIM() {
      createModal(_sfc_main$d, { class: "fullScreenModal" });
    },
    openOutCome() {
