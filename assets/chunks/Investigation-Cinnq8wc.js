import { w as watch, f as ref, c as computed, s as defineComponent, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, F as unref, A as createVNode, B as withCtx, aA as IonCol, a5 as createTextVNode, af as IonRow, J as Fragment, S as renderList, O as createBlock, D as toDisplayString, N as IonButton, L as IonIcon, dj as eyeOutline, H as createCommentVNode, fA as TransitionGroup, bV as trashOutline, aR as syncOutline, fB as Transition, bH as addOutline, I as IonHeader, aD as IonToolbar, aE as IonTitle, be as IonButtons, aG as IonContent, bG as IonModal, aL as useRouter, bM as useRoute, fk as onIonViewWillEnter, f1 as provide, bv as IonPage } from './vendor-BRtiyW5a.js';
import { u as useDemographicsStore, S as Service, g as getPouchDBRecords, O as OrderService, ar as ConceptService, J as savePatientRecord, aY as AppEncounterService, b as EncounterTypeId, t as toastWarning, z as StandardForm, o as createModal, _ as _export_sfc, T as Toolbar } from '../index-o64PGrp2.js';
import { l as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-COtgCjF6.js';
import { d as defineStore, s as storeToRefs } from './pinia-BGmPTYET.js';
import { _ as _sfc_main$2 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-Cggsx4hT.js';
import { b as neonatalInvestigationFormKey, S as SummarySection } from './SummarySection-66zMrNGk.js';
