import { c as computed, s as defineComponent, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, bd as IonCardContent, f as ref, z as createElementBlock, C as createBaseVNode, bA as createStaticVNode, cF as mergeProps, H as createCommentVNode, D as toDisplayString } from './vendor-CNJ0IVCn.js';
import { z as StandardForm, y as StandardValidations, c7 as createPopover, _ as _export_sfc, u as useDemographicsStore, H as HisDate } from '../index-CMNG45JS.js';
import { _ as _sfc_main$k, a as _sfc_main$l, b as _sfc_main$m, L as LungFrontMaleSVG } from './DisplaySelectedBodyParts.vue_vue_type_script_setup_true_lang-BzqFkJaj.js';
import './lodash-CFXvmrwU.js';
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleBodyPartClick = async (partName, e) => {
      const popover = await createPopover(_sfc_main$k, e, {
        title: partName
      });
...
const LungFrontFemale = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-743b0961"]]);
...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const handleBodyPartClick = async (partName, e) => {
      ...
      const popover = await createPopover(_sfc_main$l, e, {
        title: partName
      });
      const { data, role } = await popover.onDidDismiss();
...
const LungBackFemale = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-2a5c6ff4"]]);
...
const LungBackMale = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-885ff869"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        createBaseVNode("g", _hoisted_1$c, [
          createBaseVNode("path", {
...
const LungLeftMale = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-98c7650a"]]);
...
const LungLeftFemale = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-8c015b29"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        createBaseVNode("g", _hoisted_1$9, [
          createBaseVNode("path", {
            id: "Left_Lateral_Lower_Zone",
            "data-label": "Left Lateral Lower Zone",
            onClick: _cache[0] || (_cache[0] = ($event) => handleBodyPartClick("Left Lateral Lower Zone", $event)),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        _cache[15] || (_cache[15] = createStaticVNode('<g id="BODY_OUTLINE" data-label="BODY OUTLINE" data-v-e87ae194><path class="cls-lower-3" d="M2079.32,731c-15.42,6.57-33.58,14.8-50.36,7.52-12.49-5.61-20.18-20.58-22.82-33.37-3.23-20,6-39.14,15.27-56.23.72-1.55,1.77-3.59,2.36-5.17,14.71-38-7.07-78.75-28-110.32-4.59-6.78-9.57-13.65-13.93-20.63-8.93-14-17.24-28.34-25.52-42.71s-16.34-28.84-22.44-44.51c16.67,18.83,29.6,39.89,43.78,60.38,6.35,9.39,12.75,18.74,19,28.2,7.74,11.14,15.49,22.32,22.14,34.23,17.17,30.22,30.07,69.1,14.43,102.79-3.1,6.43-7,12.7-9.78,19.26-4.57,10.6-8.3,21.62-6.64,32.92,2,9.95,7.42,22.26,16.21,27.32,13.39,7.38,31.66,1.83,46.38.32Z" data-v-e87ae194></path><path class="cls-lower-3" d="M2151.55,733.43c9,.69,20.37,3.1,29.11.63,5.19-1.44,9.22-4.58,12.89-8.65a78.49,78.49,0,0,0,6.84-9,32,32,0,0,0,4.83-9.21c3.81-13.91-2.92-29.48-9.14-42.35-1.25-2.52-2.75-5.31-4.14-7.78-11.54-19
33.55-103.3-41.36-192s11.28-61.13-18.62-134.49-128.73-296-129.17-662.4C1592.88,522.21,1637,403.08,1637,403.08h942.42s44.06,119.13,40.81,358.94c-.45,366.44-99.27,589-129.17,662.4s-10.82,45.79-18.63,134.49-52.7,76-41.36,192c26.67,119.09,59.89,217.94,54.23,329.23-1.12,64.7-86.6,471.19-101.47,550.93s-18,76.67-1.44,144.59-17,114.38-6.4,128.23c32.08,32.23,55.08,83.81,59.88,102.59s17,20.24,35.72,46.84-8.2,63.12-35.85,57.2c-38.81,33.47-49,11.59-56.89,11.79-43.35,31.24-61.22,2.33-73.08,10.09-38.46,28.39-59.73-12.22-64-12.22-11.73,20.78-62.57,45.86-89.38,10.19s6.83-87.79,10.84-102.34,3-60.37,17.89-97.56,9.71-55.56,2.57-97.85,19.67-73.84,26.4-97.89c12.51-62.13,3.55-163.8-1.42-230.51s-39.68-206-61.13-344.87,35.76-266,49.33-310.74,7.61-74.31-5.72-121.32-16.55-72.06-19.82-142.19-2.74-221.16-8.37-304.07-52.09-527.17-52.09-527.17" data-v-e87ae194></path></g>', 1))
      ], 16);
    };
  }
});

const LowerLimbMaleAnteriorSVG = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-e87ae194"]]);
...
const LowerLimbFemaleAnteriorSVG = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-bbe725e5"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        _cache[10] || (_cache[10] = createBaseVNode("g", {
          id: "BODY_OUTLINE",
          "data-label": "BODY OUTLINE"
        }, [
          createBaseVNode("path", {
...
const AbdomenMaleSVG = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-b3a8c3de"]]);
...
const _hoisted_1$4 = { class: "gcs-score-display" };
const _hoisted_2$1 = { class: "gcs-score-value" };
              ...
              createVNode(StandardForm, {
                ...
                gcsScoreDisplay: withCtx(({ formValues }) => [
                  createBaseVNode("div", _hoisted_1$4, [
                    createBaseVNode("div", _hoisted_2$1, toDisplayString(calculateGCS(formValues)), 1)
                  ])
                ]),
                _: 1
              }, 8, ["formData"])
...
const DisabilityAssessment = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-a3b4621c"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        _cache[28] || (_cache[28] = createBaseVNode("g", { id: "SKIN" }, [
          createBaseVNode("path", {
            className: "cls-fullbody-male-back-1",
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        _cache[52] || (_cache[52] = createBaseVNode("g", { id: "SKIN" }, [
          createBaseVNode("path", {
            className: "cls-fullbody-female-front-1",
...
const FullBodyFemaleFrontSVG = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-363c6148"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", mergeProps({
        ...
        ref_key: "svgRef",
        ref: svgRef
      }, props), [..._cache[0] || (_cache[0] = [
        createBaseVNode("g", { id: "SKIN" }, [
          createBaseVNode("path", {
            className: "cls-fullbody-female-1",
        ...
        createBaseVNode("g", {
          ...
          createBaseVNode("path", {
            id: "Occiput",
            className: "cls-fullbody-female-2",
...
const FullBodyFemaleBackSVG = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-314f2944"]]);
...
const ExposureAssessment = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3978c173"]]);

export { DisabilityAssessment as D, ExposureAssessment as E, _sfc_main$j as _, _sfc_main$b as a, _sfc_main$6 as b };
