import { q as defineComponent, bq as IonPage, L as IonIcon, b7 as IonCardContent, b4 as IonCardTitle, b5 as IonCardHeader, bH as IonCard, aw as IonCol, af as IonRow, av as IonGrid, bV as chevronBackOutline, cl as checkmarkCircle, aF as useRouter, eU as heart, cc as personCircle, aH as people, eV as gitMerge, eW as calendarNumber, eX as checkmarkDone, v as resolveComponent, O as createBlock, y as openBlock, A as withCtx, z as createVNode, B as createBaseVNode, x as createElementBlock, J as Fragment, R as renderList, a4 as normalizeClass, a5 as createTextVNode, G as createCommentVNode, C as toDisplayString, P as normalizeStyle } from './vendor-BK8x96Ok.js';
import { T as Toolbar, F as DynamicButton, K as ObservationService, u as useDemographicsStore, _ as _export_sfc } from '../index-xpeKIrss.js';
import { D as DemographicBar } from './DemographicBar-C8SxvZgL.js';
import { m as mapState } from './pinia-C47my0-I.js';
import { u as useObstreticHistoryStore } from './PastObstreticHistoryStore-C-1BcFc1.js';
