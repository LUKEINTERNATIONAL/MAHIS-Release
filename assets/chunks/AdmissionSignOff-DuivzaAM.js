import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, a2 as onMounted, cj as onBeforeUnmount, S as withDirectives, T as vShow, a4 as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c as computed, cz as E, bE as QRCode, cA as autoTable, B as withCtx, N as IonButton, L as IonIcon, b1 as printOutline, a5 as createTextVNode, aG as IonContent, bu as IonPage, aL as useRouter, eX as provide, x as resolveComponent, O as createBlock } from './vendor-74dOmGLc.js';
import { s as storeToRefs } from './pinia-DUPmLFD0.js';
import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, a6 as useUserStore, K as ObservationService, H as HisDate, T as Toolbar } from '../index-C7zo43Se.js';
import { e as neonatalAdmissionOutcomesFormKey, G as useSignsSymptomsStore, w as useNeonatalVitalsStore, N as NeonatalStepper, J as useNeonatalAdmissionOutcomesStore } from './NeonatalStepper-zSZJsNNP.js';
import { A as AdmissionProgressBar } from './AdmissionProgressBar-C-T_39S6.js';
import { n as neonatalAdmissionSignOffSections, u as useAdmissionSignOff } from './useAdmissionSignOff-C8cd2FWs.js';
import { u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-CfYKrXEc.js';
