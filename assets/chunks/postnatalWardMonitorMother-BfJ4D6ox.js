import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, a2 as onMounted, n as nextTick, ck as onBeforeUnmount, O as createBlock, af as IonRow, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, f as ref, aL as useRouter, aG as IonContent, bY as chevronBackOutline, J as Fragment, R as renderList, S as withDirectives, c2 as resolveDynamicComponent, T as vShow, bu as IonPage } from './vendor-D9gV--WW.js';
import { _ as _sfc_main$4 } from './Wizard.vue_vue_type_script_setup_true_lang-FRCThg_d.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, l as PreviousVitals, t as toastWarning, J as savePatientRecord, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-DGSSrngm.js';
import { D as DemographicBar } from './DemographicBar-ukLZb9xj.js';
import { u as useFormWizard } from './useFormWizard-BMnQTq7K.js';
import { u as useHeightWeightForm } from './useHeightWeightForm-x1UVej_O.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-Cr6t6bGt.js';
