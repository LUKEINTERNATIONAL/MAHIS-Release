import { s as defineComponent, aL as useRouter, ct as useRoute, a2 as onMounted, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aG as IonContent, H as createCommentVNode, C as createBaseVNode, af as IonRow, aA as IonCol, bK as IonCard, bd as IonCardContent, L as IonIcon, e0 as ellipsisVerticalSharp, a4 as normalizeClass, d2 as person, D as toDisplayString, a5 as createTextVNode, G as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, a7 as IonLabel, z as createElementBlock, P as normalizeStyle, aq as IonItem, a$ as personOutline, v as documentTextOutline, cI as idCardOutline, b1 as printOutline, J as Fragment, R as renderList, d3 as add, bu as IonPage, cR as defineAsyncComponent, cH as __vitePreload, f as ref, c as computed } from './vendor-D_Iz0VZ7.js';
import { s as storeToRefs } from './pinia-BGxzTr_B.js';
import { A as ArtCard } from './PatientProfile-Btppexb5.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, q as usePatientList, G as toastSuccess, v as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-DR39kxWD.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BUtisteN.js'),true              ?[]:void 0,import.meta.url));
