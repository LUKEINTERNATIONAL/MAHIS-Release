import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, bb as IonCardHeader, B as withCtx, L as IonIcon, ax as searchOutline, cD as IonCardSubtitle, a5 as createTextVNode, ba as IonCardTitle, bd as IonCardContent, ac as IonNote, bS as IonSearchbar, N as IonButton, bm as chevronForward, J as Fragment, R as renderList, D as toDisplayString, H as createCommentVNode, cO as closeCircle, f as ref, c as computed, a2 as onMounted, O as createBlock, aL as useRouter, ct as useRoute, ew as qrCode, bG as addOutline, ey as callOutline, bX as chevronBackOutline, df as chevronForwardOutline, d2 as person, fo as barcode, b8 as calendarOutline, G as closeCircleOutline, Q as alertCircleOutline, aG as IonContent, bu as IonPage, f0 as provide, x as resolveComponent } from './vendor-DVWIs28M.js';
import { s as storeToRefs } from './pinia-dTrQZUgI.js';
import { u as useDemographicsStore, P as PatientService, _ as _export_sfc, V as LocationService, K as ObservationService, z as StandardForm, o as createModal, r as StandardModal, T as Toolbar, t as toastWarning, a7 as RelationsService, H as HisDate, b as EncounterTypeId, S as Service, ci as saveEncounterData, ap as SetProgramService, G as toastSuccess, x as toastDanger } from '../index-BxVulBLy.js';
import { N as NeonatalService } from './neonatal_service-lQabmrwh.js';
import { D as DemographicBar } from './DemographicBar-DFcPyW6i.js';
import { i as neonatalEnrollmentSections, q as extractOptionValue, r as normalizeTextValue, s as extractMultiSelectValues, N as NeonatalStepper } from './NeonatalStepper-64or2pR4.js';
import { n as neonatalEnrollmentFormKey, u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-CYdnFTbt.js';
import { I as IMAGES } from './images-DYlnzYtj.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-q0nihAfi.js';
import { S as SummarySection } from './SummarySection-CdLjy9b9.js';
...
const TwinSearch = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-ed5f0376"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const enrichedFormData = computed(() => {
      return formData.map((field) => {
        ...
        if (field.name === "birthWeight" && loadingBirthWeight.value) {
          return {
            ...field,
            disabled: true,
...
const BirthDetails = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-8d23ffed"]]);
...
const _hoisted_27 = { class: "selected-name-block" };
const _hoisted_28 = { class: "selected-name" };
const _hoisted_29 = { class: "selected-meta" };
const _hoisted_30 = { class: "meta-pill" };
const _hoisted_31 = {
  key: 0,
  class: "meta-pill"
};
const _hoisted_32 = { class: "selected-card-body" };
const _hoisted_33 = { class: "selected-info-grid" };
const _hoisted_34 = { class: "info-item" };
const _hoisted_35 = { class: "info-value" };
const _hoisted_36 = { class: "info-item" };
const _hoisted_37 = { class: "info-value" };
    ...
    const handleSearchInput = async () => {
      ...
      try {
        ...
        searchResults.value = Array.isArray(response) ? response.filter((p) => {
          ...
          const phoneAttribute = person2.person_attributes?.find(
                  ...
                  createBaseVNode("div", _hoisted_24, [
                    createBaseVNode("div", _hoisted_25, [
                      createBaseVNode("div", _hoisted_26, [
                        createVNode(unref(IonIcon), { icon: unref(person) }, null, 8, ["icon"])
                      ]),
                      createBaseVNode("div", _hoisted_27, [
                        createBaseVNode("h3", _hoisted_28, toDisplayString(formatFullName(selectedMother.value.firstName, selectedMother.value.middleName, selectedMother.value.lastName)), 1),
                        createBaseVNode("div", _hoisted_29, [
                          ...
                          selectedMother.value.birthdate ? (openBlock(), createElementBlock("div", _hoisted_31, [
                            createVNode(unref(IonIcon), {
                  ...
                  createBaseVNode("div", _hoisted_32, [
                    createBaseVNode("div", _hoisted_33, [
                      createBaseVNode("div", _hoisted_34, [
                        ...
                        createBaseVNode("span", _hoisted_35, toDisplayString(selectedMother.value.address ? formatAddress(selectedMother.value.address) : "Not provided"), 1)
                      ]),
                      createBaseVNode("div", _hoisted_36, [
                        _cache[11] || (_cache[11] = createBaseVNode("span", { class: "info-label" }, "Phone", -1)),
                        createBaseVNode("span", _hoisted_37, toDisplayString(selectedMother.value.phone || "Not provided"), 1)
                      ])
                    ])
                  ])
                ])
...
const MotherSearch = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-c78f7955"]]);
...
const Enrollment = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d6cf98c6"]]);
