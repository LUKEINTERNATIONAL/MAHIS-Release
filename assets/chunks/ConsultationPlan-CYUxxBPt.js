...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, M as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b3 as useTreatmentPlanStore, F as DynamicButton, a1 as DrugService, b5 as confirmModal, b4 as useOutcomeStore, aC as ListPicker, bk as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b2 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, a_ as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-DK2HCmpA.js';
import { D as DemographicBar } from './DemographicBar-CMynQj3g.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DHt8PTD2.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-Ce3ccfT2.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-BNZK1bx8.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DPobEOA_.js';
import { I as Investigations } from './Investigations-BuIqyjie.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-FT97E1XN.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-BwapDJRu.js';
import { P as PreviousTreatment } from './treatment-BAWPWjL2.js';
import { l as lodashExports } from './lodash-BEEU-9Fk.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-Dkgi5xuv.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DjaUwEti.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DyFfBSl4.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BlkmZzkL.js';
...
const VisitHistory = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render], ["__scopeId", "data-v-26631d3b"]]);
...
const OPDTreatmentPlan = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cc87bb64"]]);
