import { s as defineComponent, y as openBlock, O as createBlock, f as ref, c as computed, a2 as onMounted, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bK as IonCard, J as Fragment, bF as IonModal, I as IonHeader, aD as IonToolbar, aE as IonTitle, C as createBaseVNode, L as IonIcon, eO as eggOutline, a5 as createTextVNode, D as toDisplayString, be as IonButtons, N as IonButton, G as closeCircleOutline, a7 as IonLabel, aG as IonContent, H as createCommentVNode, bf as IonFooter, bH as saveOutline, R as renderList, a4 as normalizeClass, cn as checkmarkCircle, e3 as createOutline, bG as addOutline, w as watch, aL as useRouter, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage } from './vendor-CNJ0IVCn.js';
import { z as StandardForm, x as toastDanger, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, t as toastWarning, _ as _export_sfc, F as DynamicButton, u as useDemographicsStore, C as useExposeFromStandardForm, S as Service, J as savePatientRecord, y as StandardValidations, T as Toolbar } from '../index-CMNG45JS.js';
import { D as DemographicBar } from './DemographicBar-D29PWndP.js';
import { _ as _sfc_main$i } from './Wizard.vue_vue_type_script_setup_true_lang-C1KyuL1q.js';
import { u as useFormWizard } from './useFormWizard-CmlzzR47.js';
import { V as Vitals } from './Vitals-DequGuIj.js';
import { d as defineStore, s as storeToRefs } from './pinia-DxI5rRJg.js';
import { _ as _sfc_main$h } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CylKgy_4.js';
