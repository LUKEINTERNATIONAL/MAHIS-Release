import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bL as IonCard, B as withCtx, A as createVNode, ba as IonCardTitle, dZ as IonSkeletonText, z as createElementBlock, L as IonIcon, aS as medicalOutline, a5 as createTextVNode, J as Fragment, bb as IonCardHeader, ap as IonList, R as renderList, aq as IonItem, a7 as IonLabel, b8 as calendarOutline, C as createBaseVNode, D as toDisplayString, cJ as idCardOutline, c7 as folderOutline, c4 as checkmarkCircleOutline, bd as IonCardContent, f as ref, p as dayjs, a2 as onMounted, aB as IonGrid, af as IonRow, aA as IonCol, a4 as normalizeClass, d_ as checkboxOutline, H as createCommentVNode, c9 as clipboardOutline, d$ as statsChartOutline, K as modalController, aL as useRouter, cu as useRoute, x as resolveComponent, aG as IonContent, e0 as ellipsisVerticalSharp, d3 as person, aI as IonAccordionGroup, aH as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, a$ as personOutline, v as documentTextOutline, b1 as printOutline, d4 as add, bu as IonPage, cS as defineAsyncComponent, cI as __vitePreload, c as computed } from './vendor-Dw8g_yFL.js';
import { s as storeToRefs } from './pinia-zB_ge_8G.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, ab as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-CIYQg2Yf.js';
...
import { i as isTaskPermitted } from './tasks-M8eVQVEk.js';
import { A as ANCRedirection } from './anc_service-D5M2e2zs.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-LXWK8U96.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BfRO3xY0.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-QSWxSpMx.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-DH90DbBA.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-BxgQxo59.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-C5AYKPQL.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-hyeUE1RA.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-UHzu2IKq.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-CjCN1rOi.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-wQtXzAcR.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-BedVfZ-y.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-CIYQg2Yf.js').then(n => n.cS),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-D3Csn9Dn.js'),true              ?[]:void 0,import.meta.url));
