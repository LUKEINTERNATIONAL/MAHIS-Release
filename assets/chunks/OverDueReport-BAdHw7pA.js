import { s as defineComponent, bM as IonCard, bq as V, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bw as IonPage, cv as IonMenuButton, I as IonHeader, aH as IonContent, c_ as DataTable, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, z as createElementBlock, A as createVNode, C as createBaseVNode, H as createCommentVNode, Q as normalizeClass } from './vendor-CZkQjgFf.js';
import { F as DynamicButton, a4 as ToolbarSearch, T as Toolbar, d as _sfc_main$1, t as toastWarning, H as HisDate, P as PatientService, u as useDemographicsStore, _ as _export_sfc } from '../index-BM8B4uT5.js';
...
const _sfc_main = defineComponent({
  ...
  watch: {
    $route: {
      async handler(data) {
        if (data.name == "immunizationOverdueReport") {
...
const OverDueReport = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0ade6b89"]]);
