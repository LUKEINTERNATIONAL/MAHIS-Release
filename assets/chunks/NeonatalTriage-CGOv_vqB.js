import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, c as computed, x as resolveComponent, O as createBlock, B as withCtx, H as createCommentVNode, cu as useRoute, bT as IonSearchbar, L as IonIcon, fe as qrCode, N as IonButton, bH as addOutline, a5 as createTextVNode, ff as callOutline, bY as chevronBackOutline, dg as chevronForwardOutline, ax as searchOutline, cP as closeCircle, bd as IonCardContent, ck as onBeforeUnmount, aG as IonContent, bu as IonPage, aL as useRouter, fa as onIonViewWillEnter, r as reactive, eT as provide } from './vendor-CZ_rDZM9.js';
import { s as storeToRefs } from './pinia-B4JSZd0E.js';
import { z as StandardForm, _ as _export_sfc, P as PatientService, S as Service, u as useDemographicsStore, o as createModal, T as Toolbar, cl as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ch as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-OU0RFndh.js';
import { D as DemographicBar } from './DemographicBar-D5wQZjc2.js';
import { p as neonatalTriageSections, q as neonatalTriageFormKey, g as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, r as defaultNeonatalTriageForm } from './NeonatalStepper-B35K-Rmb.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-B0gokBGo.js';
...
const FindRegisterPatient = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-982158f6"]]);
