import { q as defineComponent, a1 as onMounted, r as ref, x as createElementBlock, y as openBlock, A as createBaseVNode, z as createVNode, B as withCtx, a4 as createTextVNode, C as toDisplayString, E as unref, a6 as IonLabel, bz as createStaticVNode, fn as I1, M as IonButton, H as Fragment, J as modalController, fo as IonAlert, v as resolveComponent, N as createBlock, am as IonList, an as IonItem, ah as IonRadio, ag as IonRadioGroup, Q as renderList, ae as IonRow, ay as IonCol, a5 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, I as IonHeader, aD as IonContent, R as withDirectives, G as createCommentVNode, S as vShow, bE as IonModal, aF as IonAccordionGroup, aE as IonAccordion, b7 as IonCardTitle, cC as IonCardSubtitle, b8 as IonCardHeader, ba as IonCardContent, bJ as IonCard, bs as IonPage, ct as IonMenuButton, bc as IonFooter, K as IonIcon, aa as checkmarkOutline, F as closeCircleOutline, d as computed, fp as folderOpenOutline, ar as script, di as Navigation, dj as Pagination, dk as Slide, dl as Carousel, c8 as clipboardOutline, d1 as person, d$ as ellipsisVerticalSharp, b9 as checkmark, bW as chevronBackOutline, a3 as normalizeClass } from './vendor-DGIzCW4f.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, ab as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, C as StandardForm, F as DynamicButton, K as ObservationService, cm as PatientRegistrationService, a6 as RelationsService, x as toastDanger, cL as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bU as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-D_1ZD1MC.js';
...
import { m as mapState, s as storeToRefs } from './pinia-Bmkga1nW.js';
import { S as Stepper } from './Stepper-BwAjep6E.js';
import { T as Treatment } from './nonPharmaTherapyStore-5vNNiaAn.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-x9dAegJP.js';
import WeightHeightChart from './WeightHeightChart-BCk_MdS_.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-7vQ-aZKt.js';
import { c as customDatePicker } from './customDatePicker-Q3ZezFaE.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, N as NextAppointment } from './vaccines_service-CkWDon4b.js';
import { S as StockService } from './stock_service-55V9JbSF.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-BDQhW2su.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-B8yauaRs.js';
...
import { _ as _sfc_main$e } from './usePatientProfile-BJaPg_YH.js';
import { O as Outcome } from './Outcome-CHwuwR8U.js';
