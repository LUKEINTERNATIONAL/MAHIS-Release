import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, O as createBlock, G as createCommentVNode, bq as IonPage, H as IonContent, aF as useRouter, eT as provide, v as resolveComponent, A as withCtx } from './vendor-Cy_N32Zh.js';
import { s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { C as StandardForm, _ as _export_sfc, cn as Alert, co as SummaryField, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-CZxb0S4T.js';
import { r as neonatalReviewOfSystemsSections, s as neonatalReviewOfSystemsFormKey, N as NeonatalStepper } from './NeonatalStepper-De2iEpYL.js';
import { N as NeonatalService } from './neonatal_service-BeQX_Mek.js';
import { u as useReviewOfSystemsStore } from './useReviewOfSystemsStore-BGQZrjWQ.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const summaryFieldConfig = computed(() => sectionConfig.formData.find((field) => field.componentType === "summaryField"));
    const rosForm = inject(neonatalReviewOfSystemsFormKey);
    __expose({
      getFormRef: () => null,
      validateForm: () => null,
...
const SummarySection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a186299b"]]);
