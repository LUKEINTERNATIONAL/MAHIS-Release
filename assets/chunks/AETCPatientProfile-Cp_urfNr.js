import { v as defineComponent, aK as useRouter, cv as useRoute, a3 as onMounted, f as ref, w as watch, y as resolveComponent, P as createBlock, A as openBlock, D as withCtx, B as createVNode, G as unref, aF as IonContent, J as createCommentVNode, C as createBaseVNode, ag as IonRow, aA as IonCol, bL as IonCard, bc as IonCardContent, M as IonIcon, e1 as ellipsisVerticalSharp, a5 as normalizeClass, d4 as person, E as toDisplayString, a6 as createTextVNode, z as createElementBlock, c as computed, H as closeCircleOutline, di as IonSegment, dj as IonSegmentButton, a8 as IonLabel, Q as normalizeStyle, cR as defineAsyncComponent, ap as IonItem, a_ as personOutline, x as documentTextOutline, cK as idCardOutline, b0 as printOutline, K as Fragment, S as renderList, d5 as add, bu as IonPage, cJ as __vitePreload } from './vendor-CJ5LqAxe.js';
import { s as storeToRefs } from './pinia-BmV_6_tV.js';
import { A as ArtCard } from './PatientProfile-BbQHCYf7.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-BBSKuWmW.js';
...
import { C as CPR } from './CPR-BpkLtpLu.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-DTb6z7EY.js'),true              ?[]:void 0));
