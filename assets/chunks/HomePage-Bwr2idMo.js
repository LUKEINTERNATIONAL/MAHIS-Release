import { q as defineComponent, c_ as addIcons, aI as useRouter, r as ref, d as computed, w as watch, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, G as createCommentVNode, a3 as normalizeClass, C as toDisplayString, z as createVNode, E as unref, a5 as IonInput, a4 as createTextVNode, K as IonIcon, H as Fragment, Q as renderList, c$ as arrowBackOutline, cc as personAddOutline, P as alertCircleOutline, al as informationCircleOutline, au as searchOutline, c8 as clipboardOutline, bt as personCircleOutline, bn as V, v as resolveComponent, N as createBlock, B as withCtx, ct as useRoute, bK as m, n as nextTick, aG as menuController, d0 as clipboard, d1 as thermometer, aK as people, d2 as person, d3 as add, ch as medkit, d4 as globe, d5 as document$1, d6 as colorPalette, d7 as chevronUpCircle, d8 as chevronForwardCircle, d9 as chevronDownCircle, da as grid, b9 as checkmark, bW as chevronBackOutline, ba as IonCardContent, b7 as IonCardTitle, b8 as IonCardHeader, bJ as IonCard, ay as IonCol, M as IonButton, ae as IonRow, aA as IonToolbar, bs as IonPage, I as IonHeader, aD as IonContent, a as reactive, az as todayOutline, db as timeOutline, aZ as locationOutline, dc as womanOutline, dd as manOutline, cI as idCardOutline, aY as personOutline, cN as openOutline, b5 as calendarOutline, O as normalizeStyle, de as gridOutline, b1 as peopleOutline, aX as medkitOutline, R as withDirectives, aw as vModelText, df as chevronForwardOutline, l as dayjs, dg as IonSegment, dh as IonSegmentButton, a6 as IonLabel, di as eyeOutline, aa as checkmarkOutline, bH as IonBadge, ar as script, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, J as modalController, bp as pulseOutline, dj as Navigation, dk as Pagination, dl as Slide, dm as Carousel, ad as IonCheckbox, bm as IonPopover, cj as onBeforeUnmount, cE as createSlots, F as closeCircleOutline, S as vShow, dn as checkmarkDoneCircleOutline, bk as search, bb as IonButtons, dp as personAdd, af as close, L as IonSpinner, dq as skullOutline, dr as calendar, cb as flask, ds as refresh, dt as lockClosed, a2 as onUnmounted, c1 as resolveDynamicComponent } from './vendor-Cd5ziTxG.js';
import { S as Service, u as useDemographicsStore, _ as _export_sfc, P as PatientService, t as toastWarning, a as useProgramStore, E as EncounterService, H as HisDate, g as getPouchDBRecords, b as EncounterTypeId, A as AppointmentService, c as HorizontalLine, d as _sfc_main$v, e as useGeneralStore, f as useStatusStore, h as useWindowSize, i as useEnrollementStore, R as ReportService, p as parameterizeUrl, j as STANDARD_DATE_FORMAT, k as alertConfirmation, O as OrderService, l as PreviousVitals, B as BasicInputField, m as useAdministerVaccineStore, n as icons, o as createModal, q as StandardModal, r as closeVisit, s as isPatientDeceased, v as usePatientList, w as getTodaysVisits, x as toastDanger, y as StandardValidations, z as useExposeFromStandardForm, C as StandardForm, D as PatientSearchService, F as DynamicButton, G as toastSuccess, I as alertConfirmationIonic, J as savePatientRecord, K as ObservationService, T as Toolbar, L as useWorkerStore, M as ProgramId, N as checkAndsetSessionDate, Q as resetDemographics, U as useGlobalPropertyStore, V as UserService, W as LocationService, X as modal } from '../index-CKTz1PXB.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-UguK66WW.js';
import { A as Appointment } from './ncd_appointment_service-BelcveJg.js';
import { D as DateInputField } from './DateInputField-CbosCXOS.js';
import { u as useActionButtonStore, _ as _sfc_main$D, M as ModulePicker } from './ActionButtons.vue_vue_type_script_setup_true_lang-C3EivFOa.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-DsghXZmN.js';
import { B as BottomNavBar } from './bottomNavBar-DFUDhn6H.js';
import { P as PatientReportService } from './patient_report_service-CtT7v2NY.js';
...
import { u as useAdministerOtherVaccineStore } from './AdministerOtherVaccinesStore-BVS2nNud.js';
import { c as customDatePicker } from './customDatePicker-DbhT7tAF.js';
import { s as saveVaccineAdministeredDrugs } from './vaccines_service-DMIlBXWu.js';
import { g as getVaccinesData } from './dashboard_service-YzytlHGC.js';
import { i as img } from './Img-RarZMYTn.js';
import { R as ReusableDataTable } from './ReusableDataTable-wgYvA8PH.js';
import { R as RegistrationService, u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$w, b as _sfc_main$x, c as _sfc_main$y, d as _sfc_main$z, e as _sfc_main$A, f as _sfc_main$B, g as _sfc_main$C } from './useSetRegistrationValues-B6ATCQqy.js';
import { u as useUserActivities } from './useUserActivities-DkCaAOKB.js';
import { L as LandingPage } from './LandingPage-CJCbndjs.js';
