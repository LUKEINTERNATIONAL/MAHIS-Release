import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, a5 as createTextVNode, H as createCommentVNode, N as IonButton, L as IonIcon, af as IonRow, bb as IonCardHeader, ba as IonCardTitle, bd as IonCardContent, f as ref, c as computed, aq as IonItem, ae as IonCheckbox, a7 as IonLabel, Q as normalizeClass, a6 as IonInput, r as reactive, a3 as onMounted, ap as IonList, T as withDirectives, U as vShow, cR as defineAsyncComponent, cH as __vitePreload, aL as useRouter, bL as useRoute, aG as IonContent, bY as chevronBackOutline, bu as IonPage, ab as checkmarkOutline } from './vendor-ltMrzBmS.js';
import { s as storeToRefs } from './pinia-CSbxcXdD.js';
import { z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, n as icons, y as StandardValidations, _ as _export_sfc, a_ as List, u as useDemographicsStore, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, b2 as useTreatmentPlanStore, be as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, ar as ConceptService, G as toastSuccess, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-D1sAwkPe.js';
import { D as DemographicBar } from './DemographicBar-0_E8h7ow.js';
import { _ as _sfc_main$d, u as useFormWizard } from './useFormWizard-DioG1Hne.js';
...
import { _ as _sfc_main$e, C as CirculationAssessment, D as DisabilityAssessment, E as ExposureAssessment } from './ExposureAssessment-ruYOQJEn.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const PrescribedMedicationList = defineAsyncComponent(() => __vitePreload(() => import('./Medications-CVk2BM1d.js'),true              ?[]:void 0));
    const CONCEPTS = {
