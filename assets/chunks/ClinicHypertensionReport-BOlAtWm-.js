import { cp as toDisplayGenderFmt, cq as _sfc_main$1, aP as loader, aO as toastWarning } from '../index-OU0RFndh.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ClinicHypertensionReport",
  setup(__props) {
    const period = ref("-");
    const rows = ref([]);
    const title = ref("Hypertension Report");
    const columns = [
