import { s as defineComponent, y as openBlock, O as createBlock, a2 as onMounted, B as withCtx, C as createBaseVNode, z as createElementBlock, A as createVNode, F as unref, M as IonSpinner, J as Fragment, R as renderList, bK as IonCard, bd as IonCardContent, a4 as normalizeClass, D as toDisplayString, a5 as createTextVNode, N as IonButton, L as IonIcon, bT as trashOutline, H as createCommentVNode, dD as IonFab, dC as IonFabButton, cc as personAddOutline, bG as addOutline, f as ref, W as alertController, cB as toastController, a7 as IonLabel, aA as IonCol, aq as IonItem, x as resolveComponent, w as watch, eb as time, ak as IonDatetime, ba as IonCardTitle, bb as IonCardHeader, af as IonRow, au as script, ef as pencilOutline, bH as saveOutline, G as closeCircleOutline, K as modalController, b0 as locationOutline, bv as personCircleOutline, ae as IonCheckbox, dz as phonePortraitOutline, aS as medicalOutline, c as computed, ap as IonList, aD as IonToolbar, aE as IonTitle, be as IonButtons, I as IonHeader, aG as IonContent, bf as IonFooter, aL as useRouter, cI as idCardOutline, Q as alertCircleOutline, a6 as IonInput, by as IonText, P as normalizeStyle, dA as domtoimage, X as Capacitor } from './vendor-CCA5uLDN.js';
import { u as useDemographicsStore, r as StandardModal, _ as _export_sfc, k as alertConfirmation, a4 as popoverConfirmation, n as icons, B as BasicInputField, b3 as useOutcomeStore, g as getPouchDBRecords, aI as _sfc_main$e, F as DynamicButton, t as toastWarning, $ as SelectFacility, V as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aB as ListPicker, ai as ProgramService, o as createModal, b4 as confirmModal, S as Service, H as HisDate, G as toastSuccess, c as HorizontalLine, aC as areFieldsValid, x as toastDanger, aD as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, J as savePatientRecord, Z as printLabel, aM as PrintoutService, b5 as printArtVisitLbl } from '../index-4BtwP8vl.js';
import { R as Registration } from './Registration-BC9qARkA.js';
import { s as storeToRefs } from './pinia-D-2CL6iz.js';
import { u as useWardsStore } from './wardsStore-DPknZIP0.js';
  ...
  setup(__props) {
    ...
    const confirmVoid = async (rel) => {
      const alert = await alertController.create({
        ...
        message: `Remove ${rel.given_name} ${rel.family_name} as ${rel.relationship_type?.a_is_to_b || "relationship"}?`,
    ...
    const openAddModal = () => {
      console.log("Add relationship triggered");
    };
        ...
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1$6, [
                ...
                return openBlock(), createBlock(unref(IonCard), {
                  ...
                  default: withCtx(() => [
                    createVNode(unref(IonCardContent), { class: "rel-content" }, {
                      default: withCtx(() => [
                        createBaseVNode("div", {
                          class: normalizeClass(["status-accent", getAccentClass(rel.relationship_type?.a_is_to_b)])
                        }, null, 2),
                        createBaseVNode("div", _hoisted_4$4, [
                          createBaseVNode("div", _hoisted_5$3, [
                            createBaseVNode("div", {
                              class: normalizeClass(["initials-avatar", { "spouse-bg": isSpouse(rel.relationship_type?.a_is_to_b) }])
                            }, toDisplayString(getInitials(rel)), 3)
                          ]),
                          createBaseVNode("div", _hoisted_6$3, [
                            createBaseVNode("div", {
                              class: normalizeClass(["rel-type", { "spouse-text": isSpouse(rel.relationship_type?.a_is_to_b) }])
                            }, toDisplayString(rel.relationship_type?.a_is_to_b || "Unknown"), 3),
            ...
            createVNode(unref(IonFab), {
              ...
              default: withCtx(() => [
                createVNode(unref(IonFabButton), { onClick: openAddModal }, {
                  default: withCtx(() => [
                    createVNode(unref(IonIcon), { icon: unref(personAddOutline) }, null, 8, ["icon"])
                  ]),
                  _: 1
                })
              ]),
...
const RelationshipManagementModal = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-a82bcc2b"]]);
