...
const useNeonatalEnrollmentStore = defineStore("neonatalEnrollmentStore", {
  ...
  actions: {
    ...
    /**
     * Sets whether the mother has MNH data available
     * @param hasMnhData - Boolean indicating if MNH data exists
     */
    setMotherHasMnhData(hasMnhData) {
      this.motherHasMnhData = hasMnhData;
    },
    /**
     * Sets the MNH data for the mother
     * @param data - MNH data object from the service
     */
    setMnhData(data) {
      this.mnhData = data;
      this.motherHasMnhData = Boolean(
        data && Object.values(data).some((value) => value != null && value !== "")
      );
    },
    /**
