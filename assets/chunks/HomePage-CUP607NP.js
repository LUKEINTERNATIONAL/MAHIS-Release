...
import { s as saveVaccineAdministeredDrugs } from './vaccines_service-8fTTW6et.js';
import { g as getVaccinesData } from './dashboard_service-DnUF5RMP.js';
import { i as img } from './Img-RarZMYTn.js';
import { R as ReusableDataTable } from './ReusableDataTable-qNCGEjG3.js';
import { R as RegistrationService, u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$v, b as _sfc_main$w, c as _sfc_main$x, d as _sfc_main$y, e as _sfc_main$z, f as _sfc_main$A, g as _sfc_main$B } from './useSetRegistrationValues-kZNn6E46.js';
import { u as useUserActivities } from './useUserActivities-CdrIpu1f.js';
import NeonatalHome from './NeonatalHome-CYCxXX9Q.js';
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(IonCard), {
        ...
        default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_1$a, toDisplayString(_ctx.count), 1),
          createBaseVNode("div", _hoisted_2$a, toDisplayString(_ctx.label), 1)
        ]),
        _: 1
      }, 8, ["style"]);
    };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_3$6, toDisplayString(_ctx.title), 1)
      ]);
    };
  }
});
