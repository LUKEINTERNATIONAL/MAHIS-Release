import { q as defineComponent, aF as useRouter, cr as useRoute, r as ref, d as computed, a2 as onMounted, w as watch, O as createBlock, y as openBlock, A as withCtx, z as createVNode, x as createElementBlock, G as createCommentVNode, B as createBaseVNode, E as unref, M as IonSpinner, dD as IonLoading, H as IonContent, S as withDirectives, bV as chevronBackOutline, T as vShow, bq as IonPage, eH as lockClosedOutline, ab as checkmarkOutline } from './vendor-Cy_N32Zh.js';
import { s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { u as useFormWizard, _ as _sfc_main$1 } from './useFormWizard-t34pEOVg.js';
import { u as useDemographicsStore, bb as useInvestigationStore, bW as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-B2p2mVqz.js';
import { D as DemographicBar } from './DemographicBar-ChySBBij.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-0p-58ch2.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-DsXm4RNQ.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-BTdFavKN.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-Cd1Z6Vw9.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-d1JfaxFV.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-B8_fnC9G.js';
