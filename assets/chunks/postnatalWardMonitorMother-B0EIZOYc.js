import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, a2 as onMounted, n as nextTick, cj as onBeforeUnmount, O as createBlock, af as IonRow, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, f as ref, aL as useRouter, aG as IonContent, bX as chevronBackOutline, J as Fragment, R as renderList, S as withDirectives, c1 as resolveDynamicComponent, T as vShow, bu as IonPage } from './vendor-CIi-jrCy.js';
import { _ as _sfc_main$4, u as useFormWizard } from './useFormWizard-ZJugK8XM.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, l as PreviousVitals, t as toastWarning, J as savePatientRecord, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-U74EcRLP.js';
import { D as DemographicBar } from './DemographicBar-b5Vl2nY8.js';
import { u as useHeightWeightForm } from './useHeightWeightForm-BMKylYnr.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-DmEdJApG.js';
  ...
  const wardDangerSignsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        condition: (allFormValues) => {
          const hasConsciousness = allFormValues["Danger signs"]?.includes("Consciousness");
          const hasAnyGcsInput = !!allFormValues["Eyes"] || !!allFormValues["Voice"] || !!allFormValues["Motor"];
