import { s as defineComponent, h as inject, y as openBlock, z as createElementBlock, A as createVNode, F as unref, aq as IonItem, B as withCtx, ae as IonCheckbox, a7 as IonLabel, C as createBaseVNode, D as toDisplayString, L as IonIcon, e_ as chevronUpOutline, a9 as chevronDownOutline, S as withDirectives, J as Fragment, R as renderList, O as createBlock, a5 as createTextVNode, T as vShow, c as computed, f as ref, M as IonSpinner, H as createCommentVNode, e$ as provide, x as resolveComponent, a2 as onMounted, aL as useRouter, ct as useRoute, w as watch, aG as IonContent, bX as chevronBackOutline, bu as IonPage, ab as checkmarkOutline } from './vendor-D_Iz0VZ7.js';
import { s as storeToRefs } from './pinia-BGxzTr_B.js';
import { _ as _export_sfc, F as DynamicButton, n as icons, y as StandardValidations, z as StandardForm, bk as useVitalsStore, u as useDemographicsStore, bl as useInvestigationStore, ba as useDiagnosisStore, b2 as useTreatmentPlanStore, bg as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, bm as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, aq as ConceptService, G as toastSuccess, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DR39kxWD.js';
import { D as DemographicBar } from './DemographicBar-DSJ-1k5H.js';
import { u as useRadiologyStore } from './RadiologyStore-C8UHA1nW.js';
import { B as BasicForm } from './BasicForm-Bb2FR1pN.js';
import { _ as _sfc_main$6, u as useFormWizard } from './useFormWizard-Cn6YqiiC.js';
...
import { s as stageAllergies } from './treatment-DPFxZs1B.js';
