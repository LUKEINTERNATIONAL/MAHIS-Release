import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fe as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eX as provide } from './vendor-74dOmGLc.js';
import { s as storeToRefs } from './pinia-DUPmLFD0.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cp as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, cl as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-C7zo43Se.js';
import { D as DemographicBar } from './DemographicBar-nq_5lbQU.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-zSZJsNNP.js';
import { S as SummarySection } from './SummarySection-Bup3kLZV.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-DhECCu1J.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-B4wFxnjC.js';
