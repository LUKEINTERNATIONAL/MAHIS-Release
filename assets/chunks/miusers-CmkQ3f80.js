import { e5 as createAvatar, e6 as initials, q as defineComponent, r as ref, w as watch, a1 as onMounted, N as createBlock, y as openBlock, E as unref, bE as IonModal, B as withCtx, z as createVNode, I as IonHeader, aA as IonToolbar, aB as IonTitle, a4 as createTextVNode, C as toDisplayString, bb as IonButtons, M as IonButton, K as IonIcon, F as closeCircleOutline, aD as IonContent, A as createBaseVNode, x as createElementBlock, G as createCommentVNode, an as IonItem, a3 as normalizeClass, a5 as IonInput, ad as IonCheckbox, a6 as IonLabel, ag as IonRadioGroup, ah as IonRadio, bM as IonSelect, H as Fragment, Q as renderList, bL as IonSelectOption, a7 as withModifiers, bc as IonFooter, L as IonSpinner, l as dayjs, d as computed, bJ as IonCard, b8 as IonCardHeader, e1 as IonAvatar, b7 as IonCardTitle, cC as IonCardSubtitle, d1 as person, dq as calendar, bN as IonChip, cm as checkmarkCircle, cN as closeCircle, ba as IonCardContent, e7 as briefcase, e8 as apps, e9 as business, ea as time, eb as create, ec as pause, ed as play, at as trash, aK as people, cA as toastController, V as alertController, ay as IonCol, bR as IonSearchbar, dm as personAdd, ae as IonRow, df as IonSegment, dg as IonSegmentButton, a2 as onUnmounted, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { N as NavigationMenu } from './NavigationMenu-DJdi8c9H.js';
import { E as EIRreportsStore } from './EIRreportsStore-DQlNZfMT.js';
import { B as BottomNavBar } from './bottomNavBar-BxzmklL3.js';
import { ai as ProgramService, aG as MIUMService, V as UserService, ac as isPasswordValid, aH as ChangePasswordComponent, aI as _sfc_main$4, $ as SelectFacility, H as HisDate, x as toastDanger, _ as _export_sfc, aJ as MIUMUserService } from '../index-_N7CIn5p.js';
              ...
              createVNode(unref(IonToolbar), null, {
                default: withCtx(() => [
                  createVNode(unref(IonTitle), null, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.editingUser ? "Edit User" : "Add New User"), 1)
                    ]),
                    _: 1
                  }),
          ...
          createVNode(unref(IonContent), { class: "ion-padding" }, {
            default: withCtx(() => [
              createBaseVNode("form", {
                ...
                _ctx.editingUser ? (openBlock(), createBlock(unref(IonItem), {
                  key: 4,
                  lines: "none",
                  class: "toggle-item"
                }, {
                ...
                !_ctx.editingUser || isChangingPassword.value ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
                  createVNode(unref(IonItem), {
                    slot: "header",
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", null, [
                        ...
                        createVNode(unref(IonButton), {
                          ...
                          default: withCtx(() => [
                            _ctx.isSaving ? (openBlock(), createBlock(unref(IonSpinner), {
                              key: 0,
                              style: { "height": "36px" },
                              name: "crescent",
                              slot: "start"
                            })) : createCommentVNode("", true),
                            createTextVNode(" " + toDisplayString(_ctx.editingUser ? "Update" : "Create") + " User ", 1)
                          ]),
                          _: 1
                        }, 8, ["disabled"])
                      ])
