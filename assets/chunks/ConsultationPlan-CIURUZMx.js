...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bI as StagesService, v as usePatientList, r as closeVisit } from '../index-CoTAfgAo.js';
import { D as DemographicBar } from './DemographicBar-BaEs4wNK.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DS6XHr9_.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BmXHbcFA.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-0-x3BYME.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-BjDfwla-.js';
import { I as Investigations } from './Investigations-BYJ64cGT.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-d5vurXOQ.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-DLxJwQmk.js';
import { P as PreviousTreatment } from './treatment-CRYWWEPC.js';
import { l as lodashExports } from './lodash-IJNQpAoV.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-CqSpWGWB.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DEkVK-K5.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-iM_hcNZ0.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BkpydIdj.js';
