import { q as defineComponent, a1 as onMounted, f as ref, x as createElementBlock, y as openBlock, A as createBaseVNode, z as createVNode, B as withCtx, a4 as createTextVNode, C as toDisplayString, E as unref, a6 as IonLabel, bz as createStaticVNode, fo as I1, M as IonButton, H as Fragment, J as modalController, fp as IonAlert, v as resolveComponent, N as createBlock, am as IonList, an as IonItem, ah as IonRadio, ag as IonRadioGroup, Q as renderList, ae as IonRow, ay as IonCol, a5 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, I as IonHeader, aD as IonContent, R as withDirectives, G as createCommentVNode, S as vShow, bE as IonModal, aF as IonAccordionGroup, aE as IonAccordion, b7 as IonCardTitle, cD as IonCardSubtitle, b8 as IonCardHeader, ba as IonCardContent, bJ as IonCard, bs as IonPage, cu as IonMenuButton, bc as IonFooter, K as IonIcon, aa as checkmarkOutline, F as closeCircleOutline, fq as folderOpenOutline, c as computed, ar as script, dj as Navigation, dk as Pagination, dl as Slide, dm as Carousel, c8 as clipboardOutline, d2 as person, d$ as ellipsisVerticalSharp, b9 as checkmark, bW as chevronBackOutline, a3 as normalizeClass } from './vendor-xvx_X2hj.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, ab as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, C as StandardForm, F as DynamicButton, K as ObservationService, cm as PatientRegistrationService, a6 as RelationsService, x as toastDanger, cL as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bU as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-D5ZuGc-h.js';
...
import { m as mapState, s as storeToRefs } from './pinia-CiVhHi9d.js';
import { S as Stepper } from './Stepper-B-BDooMS.js';
import { T as Treatment } from './treatment-CtZZOuLB.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-SkgeUjsE.js';
import WeightHeightChart from './WeightHeightChart-95pGVvgg.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-Dq31EQFW.js';
import { c as customDatePicker } from './customDatePicker-DRq8zPlR.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, N as NextAppointment } from './vaccines_service-BvBzPqTs.js';
import { S as StockService } from './stock_service-BVRmcK8i.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-5rv7Yelo.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-BEfW3Yq6.js';
...
import { O as Outcome, c as _sfc_main$e } from './usePatientProfile-DJ1EW7-2.js';
