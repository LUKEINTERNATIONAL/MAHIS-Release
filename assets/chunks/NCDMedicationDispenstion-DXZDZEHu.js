import { s as defineComponent, w as watch, y as openBlock, z as createElementBlock, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, a4 as normalizeClass, A as createVNode, B as withCtx, F as unref, L as IonIcon, c3 as checkmarkCircleOutline, N as IonButton, di as eyeOutline, aS as medicalOutline, H as createCommentVNode, f as ref, c as computed, aA as IonCol, af as IonRow, aE as IonTitle, bu as IonPage, bf as IonFooter, I as IonHeader, aG as IonContent, ag as close, ch as medkit, K as modalController, x as resolveComponent, a5 as createTextVNode, aL as useRouter, ct as useRoute, cj as onBeforeUnmount, a2 as onMounted, O as createBlock, Q as alertCircleOutline, bK as IonCard, bd as IonCardContent, a6 as IonInput, dn as checkmarkDoneCircleOutline, bx as eye, bb as IonCardHeader, ba as IonCardTitle } from './vendor-DrpjccQs.js';
import { s as storeToRefs } from './pinia-CWrBOO3c.js';
import { E as EIRreportsStore } from './EIRreportsStore-BUJuzJ34.js';
import { N as NavigationMenu } from './NavigationMenu-BT7un6TF.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-Dfre6zVN.js';
import { a as useProgramStore, H as HisDate, aq as ConceptService, b as EncounterTypeId, _ as _export_sfc, n as icons, aY as AppEncounterService, P as PatientService, S as Service, u as useDemographicsStore, J as savePatientRecord, G as toastSuccess, bX as toastDanger, bH as DrugOrderService, e as useGeneralStore, q as usePatientList, aM as PrintoutService, v as closeVisit, k as alertConfirmation, x as toastDanger$1, o as createModal, bY as checkLiveAPIStatus, g as getPouchDBRecords } from '../index-UzX4smS4.js';
import { a as DRUG_FREQUENCIES } from './drug_prescription_service-_JfLT9GC.js';

const _hoisted_1$2 = { class: "diagnosis-container" };
const _hoisted_2$2 = { class: "date-header" };
const _hoisted_3$2 = { class: "full-date" };
const _hoisted_4$2 = { class: "iso-date" };
const _hoisted_5$2 = { class: "minimal-table" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(uniqueDates.value, (date) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("div", _hoisted_2$2, [
              createBaseVNode("span", _hoisted_3$2, toDisplayString(formatFullDate(date)), 1),
              createBaseVNode("span", _hoisted_4$2, toDisplayString(date), 1)
            ]),
        ...
        uniqueDates.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_10$1, [
          createVNode(unref(IonIcon), {
...
const DiagnosisSummary = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-76d5a10d"]]);
