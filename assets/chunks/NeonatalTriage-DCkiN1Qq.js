import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, a5 as createTextVNode, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fc as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eT as provide } from './vendor-BO7XRaEo.js';
import { s as storeToRefs } from './pinia-BoqbyD4X.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, co as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ck as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-0HlCc1Mr.js';
import { D as DemographicBar } from './DemographicBar-LY9R4Sx4.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-BNW-CsoQ.js';
import { S as SummarySection } from './SummarySection-BFLTxRZP.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-DZ9JmYmJ.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-eqzhWW-D.js';
...
const VitalSectionTwo = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-daa0e96c"]]);
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-43364494"]]);
