import { q as defineComponent, ad as IonCheckbox, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, v as resolveComponent, N as createBlock, y as openBlock, M as IonButton, K as IonIcon, ay as IonCol, du as IonImg, ae as IonRow, e2 as IonAvatar, a6 as IonLabel, J as modalController, x as createElementBlock, G as createCommentVNode, z as createVNode, A as createBaseVNode, B as withCtx, a4 as createTextVNode, H as Fragment, bE as IonModal, aF as IonAccordionGroup, aE as IonAccordion, b7 as IonCardTitle, cD as IonCardSubtitle, b8 as IonCardHeader, ba as IonCardContent, bJ as IonCard, bs as IonPage, cu as IonMenuButton, et as list, da as grid, eu as arrowForwardCircle, b9 as checkmark, bW as chevronBackOutline, a3 as normalizeClass } from './vendor-Dvd0YFIr.js';
import { aT as modifyCheckboxInputField, bL as getRadioSelectedValue, a1 as modifyFieldValue, i as useEnrollementStore, o as createModal, n as icons, _ as _export_sfc, F as DynamicButton, a3 as ToolbarSearch, T as Toolbar, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, a2 as getFieldValue, t as toastWarning, y as StandardValidations, aa as GlobalPropertyService, Y as IdentifierService, P as PatientService, bo as resetNCDPatientData, S as Service, bM as resetPatientData, e as useGeneralStore, bb as useDiagnosisStore, bm as useInvestigationStore, b1 as useVitalsStore, u as useDemographicsStore, f as useStatusStore } from '../index-BQO1lu0i.js';
...
import { F as FamilyHistoryNCDNumber, S as SubstanceDiagnosis, P as PatientHistory } from './NCDNumber-BlHDAPIs.js';
import { D as DispositionModal } from './OutcomeModal-CKacg3--.js';
import { B as BasicForm } from './BasicForm-DnoKyUJU.js';
import { B as BasicCard, u as useConfigurationStore } from './BasicCard-pqiPrt5I.js';
import { _ as _sfc_main$7 } from './RiskAssessment.vue_vue_type_script_setup_true_lang-Biv-VrSp.js';
import { b as formatCheckBoxData, c as formatRadioButtonData } from './formatServerData-DEjm6_a0.js';
