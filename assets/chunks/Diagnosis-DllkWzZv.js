import { _ as _export_sfc, u as useDemographicsStore, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-D_1ZD1MC.js';
import { q as defineComponent, ar as script, x as createElementBlock, y as openBlock, G as createCommentVNode, A as createBaseVNode, z as createVNode, D as renderSlot, B as withCtx, a4 as createTextVNode, C as toDisplayString, E as unref, r as ref, w as watch, d as computed, N as createBlock, a3 as normalizeClass, cE as mergeProps, fg as draggable, c1 as resolveDynamicComponent, H as Fragment, Q as renderList, bP as withKeys, a7 as withModifiers, aI as useRouter, aD as IonContent, bs as IonPage } from './vendor-DGIzCW4f.js';
import { u as useNeonatalTriageStore, N as NeonatalStepper } from './NeonatalStepper-gJVDjU6C.js';
import { d as defineStore, s as storeToRefs } from './pinia-Bmkga1nW.js';
import { I as IMAGES } from './images-D8oY7oX5.js';
import { u as useNeonatalVitalsStore } from './useNeonatalVitalsStore-C7deUB-7.js';
import { u as useReviewOfSystemsStore } from './useReviewOfSystemsStore-C7kAc-7C.js';
import { u as useNeonatalExamStore } from './useNeonatalExamStore-lQqRalf4.js';
import { u as useSystemicExaminationStore } from './useSystemicExaminationStore-BSzYhObk.js';
import { u as useSignsSymptomsStore } from './useSignsSymptomsStore-BKztIzUi.js';
