import { s as defineComponent, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, K as modalController, br as pulseOutline, bc as checkmark, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, bp as V, al as IonPopover, a6 as IonInput, B as withCtx, a5 as createTextVNode, J as Fragment, ct as useRoute, w as watch, a2 as onMounted, n as nextTick, R as renderList, D as toDisplayString, F as unref, f as ref, cZ as DataTable, aL as useRouter, L as IonIcon, a7 as IonLabel, bO as IonChip, aA as IonCol, af as IonRow, bu as IonPage, cu as IonMenuButton, a_ as medkitOutline, O as createBlock, a4 as normalizeClass, H as createCommentVNode, bK as IonCard, ax as searchOutline, ae as IonCheckbox, bd as IonCardContent, ba as IonCardTitle, N as IonButton, bb as IonCardHeader, b6 as cubeOutline, G as closeCircleOutline, Q as alertCircleOutline, db as timeOutline, er as moon, es as partlySunny, et as sunny, ch as medkit, c as computed, au as script, bf as IonFooter, aI as IonAccordionGroup, aH as IonAccordion, c8 as clipboardOutline, ad as IonTextarea, dh as IonSegmentButton, dg as IonSegment, bX as chevronBackOutline, S as withDirectives, T as vShow, ab as checkmarkOutline } from './vendor-D523m2MA.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-BZkYQmJa.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$g, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-6cYhgLOM.js';
import { D as DemographicBar } from './DemographicBar-CDh7jCPf.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-CTUgzpv0.js';
import { D as DashBox } from './DashBox-Cm6dAMLt.js';
import { B as BasicForm } from './BasicForm-BAECvbVX.js';
import { l as lodashExports } from './lodash-BqX4mskJ.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-Bgdm0jf4.js';
import { v as validateInputFiledData } from './group_validation-Cao_3Z97.js';
import { u as useComplicationsStore } from './ComplicationsStore-WCe57IjM.js';
import { I as Investigations, _ as _sfc_main$j, i as isQualifiedAHD } from './Investigations-CDCX7BHh.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-Bgj5xxFM.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-Dv8OvEik.js';
import { _ as _sfc_main$i } from './RiskAssessment.vue_vue_type_script_setup_true_lang-CG3jEuiz.js';
import { V as Vitals } from './Vitals-DFDhlo-f.js';
import { _ as _sfc_main$h } from './Wizard.vue_vue_type_script_setup_true_lang-Z4N8aj1a.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-LYs_rg2p.js';
import { u as useFormWizard } from './useFormWizard-C_YYiP8i.js';
import { u as usePatientProfile } from './usePatientProfile-BdybpVZh.js';
