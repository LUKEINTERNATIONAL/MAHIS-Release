...
import { u as useDemographicsStore, bb as useInvestigationStore, bW as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-NXBj2cdM.js';
import { D as DemographicBar } from './DemographicBar-DA8a_nW9.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-CQc9TrSk.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-BHfrDdyg.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-DTERmpXQ.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DeJod_cW.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-WeQ92Mjz.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-zjqRrpkw.js';
