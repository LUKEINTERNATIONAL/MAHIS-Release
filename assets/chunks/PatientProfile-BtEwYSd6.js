import { q as defineComponent, r as ref, w as watch, O as createBlock, y as openBlock, E as unref, bH as IonCard, A as withCtx, z as createVNode, b4 as IonCardTitle, x as createElementBlock, dW as IonSkeletonText, a5 as createTextVNode, L as IonIcon, aM as medicalOutline, J as Fragment, b5 as IonCardHeader, am as IonList, R as renderList, an as IonItem, a7 as IonLabel, b2 as calendarOutline, B as createBaseVNode, C as toDisplayString, cG as idCardOutline, c5 as folderOutline, c2 as checkmarkCircleOutline, b7 as IonCardContent, l as dayjs, a2 as onMounted, av as IonGrid, af as IonRow, aw as IonCol, a4 as normalizeClass, dX as checkboxOutline, G as createCommentVNode, c7 as clipboardOutline, dY as statsChartOutline, K as modalController, aF as useRouter, d as computed, dZ as warning, cr as useRoute, v as resolveComponent, H as IonContent, cN as defineAsyncComponent, d_ as ellipsisVerticalSharp, d0 as person, aC as IonAccordionGroup, aB as IonAccordion, P as normalizeStyle, F as closeCircleOutline, de as IonSegment, df as IonSegmentButton, aV as personOutline, s as documentTextOutline, aX as printOutline, d1 as add, bq as IonPage, cF as __vitePreload } from './vendor-Cy_N32Zh.js';
import { d as defineStore, s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, aa as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$4, al as ArtTasks, z as useExposeFromStandardForm, y as StandardValidations, C as StandardForm, F as DynamicButton, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, am as router, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, M as ProgramId, S as Service, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-B2p2mVqz.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { u as useUserActivities } from './useUserActivities-DqMKxAZo.js';
import { u as usePatientProfile } from './usePatientProfile-BHc9iq9u.js';
import { D as DemographicBar } from './DemographicBar-ChySBBij.js';
import { i as isTaskPermitted } from './tasks-m0G7w1Qa.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-CLCi0Ebb.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BNk3PNkO.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-zSvTq2i1.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-eDKrsqkU.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-DQ7Q6r0l.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-Clz8a6Yt.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-b56QA0b_.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-Da66rH1y.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-dL3wuJ_7.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-BCu7S1is.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-B5anKHmw.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-B2p2mVqz.js').then(n => n.cO),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DQ7txzml.js'),true              ?[]:void 0,import.meta.url));
    const LabourEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./LabourEnrollmentModal-LoWX6aRf.js'),true              ?[]:void 0,import.meta.url));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-Bbq2GBlJ.js'),true              ?[]:void 0,import.meta.url));
    const router = useRouter();
