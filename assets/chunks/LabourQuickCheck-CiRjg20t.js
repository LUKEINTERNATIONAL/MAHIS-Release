import { v as defineComponent, bu as IonPage, aF as IonContent, aK as useRouter, bY as chevronBackOutline, f as ref, y as resolveComponent, z as openBlock, P as createBlock, C as withCtx, B as createVNode, D as createBaseVNode } from './vendor-Cbv9TWZo.js';
import { aY as AppEncounterService, F as DynamicButton, T as Toolbar, u as useDemographicsStore, t as toastWarning, K as ObservationService, S as Service, G as toastSuccess, bM as resetPatientData, _ as _export_sfc } from '../index-BWK4lXtd.js';
import { D as DemographicBar } from './DemographicBar-C6ArQXWf.js';
import { B as BasicFooter, _ as _sfc_main$2 } from './SetEncounter.vue_vue_type_script_lang-b0CwU5L7.js';
import { L as LabourQuickCheck$1 } from './LabourQuickCheck-CbkZNtjy.js';
import { _ as _sfc_main$1 } from './SetUserRole.vue_vue_type_script_lang-DJpUoJOR.js';
  ...
  setup() {
    ...
    const saveData = async () => {
      ...
      if (shouldRouteToDelivery) {
        router.push("/labourDeliveryDetails");
        return;
      }
      navigateToHome();
    };
...
const LabourQuickCheck = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d828c9d0"]]);
