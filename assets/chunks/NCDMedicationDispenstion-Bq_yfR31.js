import { f as ref, s as defineComponent, w as watch, y as openBlock, z as createElementBlock, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, F as unref, a4 as normalizeClass, A as createVNode, B as withCtx, L as IonIcon, c3 as checkmarkCircleOutline, N as IonButton, di as eyeOutline, aS as medicalOutline, H as createCommentVNode, c as computed, aL as useRouter, ct as useRoute, cj as onBeforeUnmount, a2 as onMounted, O as createBlock, aG as IonContent, Q as alertCircleOutline, bK as IonCard, ch as medkit, a5 as createTextVNode, a6 as IonInput, af as IonRow, aA as IonCol, bu as IonPage } from './vendor-DrpjccQs.js';
            ...
            default: withCtx(() => [
              activeDynamicButton.value === "diagnosis" ? (openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                Object.keys(medicationsByProgram.value).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_2, [
                  ...
                  _cache[0] || (_cache[0] = createBaseVNode("h2", { class: "text-xl font-semibold text-gray-700 mb-2" }, "No Medications to Dispense", -1)),
                  _cache[1] || (_cache[1] = createBaseVNode("p", { class: "text-gray-600" }, "There are currently no medications waiting to be dispensed for current Client.", -1))
...
const NCDMedicationDispenstion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7f8ad74c"]]);
