import { c3 as HisFooter, H as HisDate, S as Service, _ as _export_sfc } from '../index-DLvxOSk2.js';
import { v as defineComponent, aF as IonContent, bu as IonPage, dH as IonLoading, y as resolveComponent, z as openBlock, A as createElementBlock, B as createVNode, P as createBlock, J as createCommentVNode, C as withCtx, D as createBaseVNode, K as Fragment } from './vendor-B3kX1Pjg.js';
import { a as HisStandardForm, _ as _sfc_main$1 } from './ReportMixin.vue_vue_type_script_lang-BzplsSsS.js';
import { H as HmisTemplate, a as HMISReportService } from './HMISTemplate-CG0E73i0.js';
import { H as HmisHeader } from './MOHReportHeader-neV1xr5E.js';
...
const _sfc_main = defineComponent({
  ...
  data: () => ({
    ...
    totalOPDVisits: 0,
    reportparams: {},
    // Assuming this is an empty object initially
    rangeLabel: "Default Range",
    // Provide a default value or dynamically set it
    range: ""
    // Example range
  }),
  created() {
...
const HMIS15 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);

export { HMIS15 as default };
