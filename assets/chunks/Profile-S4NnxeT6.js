import { f as ref, c as computed, s as defineComponent, w as watch, a3 as onMounted, n as nextTick, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bf as IonCardContent, O as createBlock, bN as IonCard, H as createCommentVNode, C as createBaseVNode, a5 as createTextVNode, L as IonIcon, R as alertCircleOutline, D as toDisplayString, J as Fragment, S as renderList, Q as normalizeClass, eL as shieldCheckmarkOutline, aU as medicalOutline, G as closeCircleOutline, eM as helpCircleOutline, c6 as checkmarkCircleOutline, eN as lockClosedOutline, ba as calendarOutline, e5 as createOutline, aN as useRouter, bO as useRoute, aI as IonContent, b$ as chevronBackOutline, T as withDirectives, U as vShow, bx as IonPage, ab as checkmarkOutline } from './vendor-8vOj_QAN.js';
import { s as storeToRefs } from './pinia-Drf8jDfn.js';
import { n as icons, u as useDemographicsStore, z as StandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, y as StandardValidations, e as useGeneralStore, ac as useConfigStore, f as useStatusStore, T as Toolbar, F as DynamicButton, a4 as getFieldValue, H as HisDate, a$ as getOfflineSavedUnsavedData, J as savePatientRecord } from '../index-Bn2sysQf.js';
import { D as DemographicBar } from './DemographicBar-CJWnjE0e.js';
import { _ as _sfc_main$9, u as useFormWizard } from './useFormWizard-BpEGdcvr.js';
import { u as useLocation } from './useLocation-DnR_Hwqr.js';
import { u as useGynaecologyForm } from './useGynaecologyForm-L2lxGv1p.js';

const usePastObstetricHistoryForm = (options) => {
  const liveBirthsCount = ref(0);
  const isFullTerm = options?.isFullTerm ?? ref(false);
  const resetForm = () => {
    liveBirthsCount.value = 0;
  };
  const modeOfDeliveryOptions = [
    { value: "Caesarean section", label: "Caesarean section" },
    { value: "Vacuum extraction delivery", label: "Vacuum extraction delivery" },
    { value: "Breech delivery", label: "Breech delivery" },
    { value: "SVD", label: "SVD" },
  ...
  const pastPregnancyComplicationsOptions = [
    ...
    { value: "Puerperal Sepsis", label: "Puerperal Sepsis" },
    ...
    { value: "Perineal tear", label: "Perineal tear" },
    { value: "Symphysiolysis", label: "Symphysiolysis" },
    { value: "Antepartum haemorrhage", label: "Antepartum haemorrhage" },
    { value: "Postpartum haemorrhage", label: "Postpartum haemorrhage" },
    { value: "Hypertensive disorders in pregnancy", label: "Hypertensive disorders in pregnancy" },
    ...
    { value: "Prolonged labour", label: "Prolonged labour" },
    { value: "Obstructed labour", label: "Obstructed labour" },
    { value: "Cord prolapse", label: "Cord prolapse" },
    { value: "Cord Presentation", label: "Cord Presentation" },
    { value: "Malpresentation", label: "Malpresentation" },
    { value: "Premature Rapture of Membranes", label: "Premature Rapture of Membranes" },
    { value: "Shoulder dystocia", label: "Shoulder dystocia" },
    { value: "Other", label: "Other" }
  ];
  const perinealTearOptions = [
    { value: "1st degree perineal tear", label: "1st degree perineal tear" },
    { value: "2nd degree perineal tear", label: "2nd degree perineal tear" },
    { value: "3rd degree perineal tear", label: "3rd degree perineal tear" },
    { value: "4th degree perineal tear", label: "4th degree perineal tear" }
  ];
  const neonatalComplicationsOptionsBase = [
    { value: "None", label: "None", exclusive: true },
    ...
    { value: "Baby died within 24hrs of birth", label: "Baby died within 24hrs of birth" },
    { value: "Other", label: "Other" }
  ];
  const neonatalComplicationsOptionsWithoutPrematurity = [
    { value: "None", label: "None", exclusive: true },
    { value: "Asphyxia", label: "Asphyxia" },
    { value: "Macrosomia", label: "Macrosomia" },
    { value: "Jaundice", label: "Jaundice" },
    { value: "Birth injuries", label: "Birth injuries" },
    { value: "Neonatal sepsis", label: "Neonatal sepsis" },
    { value: "Hypothermia", label: "Hypothermia" },
    { value: "Hypoxia-ischemic encephalopathy", label: "Hypoxia-ischemic encephalopathy" },
    { value: "Respiratory distress syndrome", label: "Respiratory distress syndrome syndrome" },
    { value: "Congenital abnormalities", label: "Congenital abnormalities" },
    { value: "Low birth weight", label: "Low birth weight" },
    { value: "Baby died within 24hrs of birth", label: "Baby died within 24hrs of birth" },
    { value: "Other", label: "Other" }
  ];
  const neonatalComplicationsOptions = computed(() => {
    return isFullTerm.value ? neonatalComplicationsOptionsWithoutPrematurity : neonatalComplicationsOptionsBase;
  });
  const generateModeOfDeliveryFields = (numberOfChildren) => {
    ...
    for (let index = 0; index < numberOfChildren; index++) {
      fields.push({
        ...
        header: `Reason for Caesarean section (child ${index + 1})`,
        name: `Reason for Caesarean section ${index}`,
        type: "inline",
        icon: icons.editPen,
        required: true,
        grid: { s: "12", md: "6" },
        validation: (value, allFormValues) => {
          ...
          const selectedOption = modeOfDeliveryOptions.find((opt) => opt.value === modeId);
          const modeName = selectedOption?.value || "";
          if (modeName === "Caesarean section" && (!value || value === "")) {
            return `Please specify reason for Caesarean section for child ${index + 1}`;
          }
          return null;
        },
        condition: (allFormValues) => {
          const modeId = allFormValues?.[`Mode of delivery ${index}`];
          return modeId.includes("Caesarean section");
        }
      });
    }
    fields.push({
      ...
      condition: (allFormValues) => {
        for (let i = 0; i < numberOfChildren; i++) {
          const modeId = allFormValues?.[`Mode of delivery ${i}`];
          if (modeId?.includes("Other") || modeId?.includes("Caesarean section")) return true;
        }
        return false;
      }
    });
    for (let index = 0; index < numberOfChildren; index++) {
      fields.push({
        ...
        validation: (value, allFormValues) => {
          ...
          const selectedOption = modeOfDeliveryOptions.find((opt) => opt.value === modeId);
          const modeName = selectedOption?.value || "";
          if ((modeName === "Other" || modeName === "Caesarean section") && (!value || value === "")) {
            return `Please specify details for child ${index + 1} since mode of delivery is ${modeName}`;
          }
          return null;
        },
        condition: (allFormValues) => {
          const modeId = allFormValues?.[`Mode of delivery ${index}`];
          return modeId.includes("Other");
        }
      });
    }
    return fields;
  ...
  const pastObstetricHistoryFormSection = computed(() => {
    const formElements = [
      ...
      {
        componentType: "inputField",
        header: "Number of children who are alive",
        name: "Number of children who are alive",
        icon: icons.editPen,
        required: true,
        grid: { s: "12", md: "6" },
        validation: (value, allFormValues) => {
          const num = Number(value);
          if (isNaN(num)) return "Number of alive children can only be number";
          if (num < 0 || num > 50) return "Number of alive children must be between 0 and 50";
          if (num > parseInt(allFormValues["Parity"])) return "Number of alive children cannot be greater than parity";
          return null;
        },
        condition: (allFormValues) => parseInt(allFormValues["Gravida"]) > 1
      }
    ];
  ...
  const pastPregnancyComplicationsForm = computed(() => [
    // ========== PAST PREGNANCY COMPLICATIONS ==========
    {
      ...
      validation: (value) => {
        if (!value || Array.isArray(value) && value.length === 0) {
          return "Please select at least one option for past pregnancy complications";
        }
    ...
    },
    {
      ...
      condition: (allFormValues) => {
        ...
        return complications.includes("Perineal tear") && !complications.includes("None");
      }
    },
    {
      componentType: "radioButtonField",
      header: "Degree of Perineal tear",
      name: "Perineal tear",
      type: "inline",
    ...
    },
    {
      ...
      condition: (allFormValues) => {
        const complications = allFormValues?.["past pregnancies complications"];
        return complications.includes("Other") && !complications.includes("None");
      }
    },
  ...
  const pastNeonatalComplicationsOptionForm = computed(() => [
    {
      componentType: "checkboxField",
      name: "past neonatal complications",
      type: "multiple",
      twoColumns: true,
      required: true,
      grid: { s: "12" },
      options: neonatalComplicationsOptions.value,
      validation: (value) => {
        if (!value || Array.isArray(value) && value.length === 0) {
          return "Please select at least one option for past neonatal complications";
        }
        if (Array.isArray(value)) {
          const hasNone = value.some((item) => item.name === "None");
          const hasOtherComplications = value.some((item) => item.name !== "None");
    ...
    },
    {
      ...
      componentType: "Dashes",
      condition: (allFormValues) => {
        const complications = allFormValues?.["past neonatal complications"];
        return complications.includes("Other") && !complications.includes("None");
      }
    },
    {
      componentType: "inputField",
      header: "Specify other neonatal complications",
      name: "Other neonatal complications notes",
      icon: icons.editPen,
      required: true,
      grid: { s: "12" },
      condition: (allFormValues) => {
  ...
  return {
    ...
    pastPregnancyComplicationsForm,
    pastNeonatalComplicationsOptionForm,
    liveBirthsCount
  };
};
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const obstetricFormRef = ref(null);
    const pregnanciesComplicationFormRef = ref(null);
    const neonatalComplicationFormRef = ref(null);
    const formKey = ref(0);
    const formValues = ref(null);
    const isFullTerm = computed(() => formValues.value?.["Gestation age at last live birth"] === "≥37 weeks (Full term)");
    const pastObstetricFormComposable = usePastObstetricHistoryForm({ isFullTerm });
    ...
    const onSubmit = async () => {
      const currentObstetricFormValues = formValues.value ?? obstetricFormRef.value?.getFormValues();
      const fullTerm = currentObstetricFormValues?.["Gestation age at last live birth"] === "≥37 weeks (Full term)";
      if (!obstetricFormRef.value || !pregnanciesComplicationFormRef.value || !fullTerm && !neonatalComplicationFormRef.value) {
        console.error("Form reference is not available");
        return false;
      }
      const validationErrors = obstetricFormRef.value.validateForm();
      if (validationErrors) {
        toastWarning("Please fix validation errors in Past Obstetric History before submitting");
        return false;
      }
      const pregnancyComplicationErrors = pregnanciesComplicationFormRef.value.validateForm();
      if (pregnancyComplicationErrors) {
        toastWarning("Please fix validation errors in Past Pregnancy Complications before submitting");
        return false;
      }
      if (validationErrors) {
      ...
      const formData = {
        ...obstetricFormRef.value.getFormValues(),
        ...pregnanciesComplicationFormRef.value.getFormValues(),
        ...neonatalComplicationFormRef.value.getFormValues()
      };
      try {
    ...
    const pastPregnacyComplicationForm = computed(() => {
      return pastObstetricFormComposable.pastPregnancyComplicationsForm.value;
    });
    const pastNeoneatalComplicationForm = computed(() => {
      return pastObstetricFormComposable.pastNeonatalComplicationsOptionForm.value;
    });
    __expose({
      validateForm: () => obstetricFormRef.value?.validateForm(),
      onSubmit,
      resetForm: () => {
        formKey.value++;
        pastObstetricFormComposable.resetForm();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
            ...
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Past Obstetric History",
                  formData: pastObstetricHistoryForm.value,
                  ref_key: "obstetricFormRef",
                  ref: obstetricFormRef,
                  key: formKey.value,
                  "onUpdate:formValues": _cache[0] || (_cache[0] = (v) => formValues.value = v)
                }, null, 8, ["formData"]))
              ]),
              _: 1
            })
        ...
        (formValues.value?.["Gravida"] ?? 0) > 1 ? (openBlock(), createBlock(unref(IonCard), {
          key: 0,
          class: "section"
        }, {
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Past Pregnancy Complications",
                  formData: pastPregnacyComplicationForm.value,
                  ref_key: "pregnanciesComplicationFormRef",
                  ref: pregnanciesComplicationFormRef,
                  key: formKey.value
                }, null, 8, ["formData"]))
              ]),
              _: 1
        ...
        (formValues.value?.["Gravida"] ?? 0) > 1 ? (openBlock(), createBlock(unref(IonCard), {
          ...
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Past Neonatal Complications",
                  formData: pastNeoneatalComplicationForm.value,
                  ref_key: "neonatalComplicationFormRef",
                  ref: neonatalComplicationFormRef,
                  key: `${formKey.value}-${isFullTerm.value}`
                }, null, 8, ["formData"]))
              ]),
              _: 1
            })
...
const PastObstetricHistory = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-caaf115c"]]);
...
const useMedicalHistoryForm = () => {
  ...
  const chronicConditionsFormSection = computed(() => {
    return [
      ...
      {
        componentType: "radioButtonField",
        header: "When did she start ART?",
        name: "When did she start ART?",
        type: "inline",
        required: true,
        condition: (allFormValues) => {
          const conditions = allFormValues["chronic conditions"];
        ...
        options: [
          ...
          {
            values: "1st or 2nd trimester (0-27 weeks)",
      ...
      {
        componentType: "radioButtonField",
        header: "Check ART adherence",
        name: "Check ART adherence",
        type: "inline",
        required: true,
        condition: (allFormValues) => {
          const conditions = allFormValues["chronic conditions"];
        ...
        options: [
          ...
          {
            label: "Refer to ART Clinic",
            value: "Refer to ART Clinic"
          }
        ]
      },
      {
        componentType: "radioButtonField",
        header: "Check recent viral results",
        name: "Check recent viral results",
        type: "inline",
        required: true,
        condition: (allFormValues) => {
          const conditions = allFormValues["chronic conditions"];
        ...
        options: [
          ...
          {
            label: "Low viral load/Undetected viral load",
            value: "Low viral load/Undetected viral load"
          }
        ]
      },
      {
        ...
        validation: (value, allFormValues) => {
          ...
          if (!/^[a-zA-Z0-9]+$/.test(value)) {
            return "ART number must be alphanumeric";
          }
          if (value.length < 3) {
            return "ART number must be at least 3 characters";
          }
          if (value.length > 20) {
            return "ART number must be less than 20 characters";
          }
          return null;
        },
        condition: (allFormValues) => {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      if (allergiesErrors || chronicErrors) {
        toastWarning("Please fix validation errors before submitting");
        return false;
      }
      ...
      try {
        const observations = await processMedicalHistory(allergiesData, chronicData);
    ...
    const processMedicalHistory = async (allergiesData, chronicData) => {
      const observations = [];
      const allData = { ...allergiesData, ...chronicData };
    ...
    __expose({
      validateForm: () => {
        const allergiesErrors = allergiesFormRef.value?.validateForm();
        const chronicErrors = chronicFormRef.value?.validateForm();
        return allergiesErrors || chronicErrors;
      },
      onSubmit,
      resetForm: () => {
        allergiesFormKey.value++;
...
const MedicalHistory = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-330af6ca"]]);

const _hoisted_1$6 = { class: "tetanus-immunization-wrapper" };
const _hoisted_2$1 = {
  key: 0,
  class: "error-message",
  style: { "margin-bottom": "12px" }
};
const _hoisted_3 = { class: "status-selection" };
const _hoisted_4 = ["onClick"];
const _hoisted_5 = { class: "status-content" };
const _hoisted_6 = { class: "status-label" };
const _hoisted_7 = { class: "status-desc" };
const _hoisted_8 = {
  key: 1,
...
const _hoisted_10 = { class: "section-subtitle-header" };
const _hoisted_11 = { class: "progress-badge" };
const _hoisted_12 = { class: "doses-grid" };
const _hoisted_13 = { class: "input-header-row" };
const _hoisted_14 = { class: "input-label" };
const _hoisted_15 = {
  key: 0,
  class: "completed-badge"
};
const _hoisted_16 = { class: "input-wrapper" };
const _hoisted_17 = ["value", "onChange", "max", "min", "disabled"];
const _hoisted_18 = {
  key: 0,
  class: "error-message"
};
...
const _hoisted_20 = { class: "field-group" };
const _hoisted_21 = {
  key: 0,
  class: "error-message",
  style: { "margin-bottom": "12px" }
};
const _hoisted_22 = { class: "dose-count-options" };
const _hoisted_23 = ["onClick"];
const _hoisted_24 = { class: "count-number" };
const _hoisted_25 = { class: "count-label" };
const _hoisted_26 = {
  key: 0,
  class: "dashed-separator"
};
...
const _hoisted_28 = { class: "input-header-row" };
const _hoisted_29 = { class: "input-label" };
const _hoisted_30 = {
  key: 0,
  class: "completed-badge"
};
const _hoisted_31 = { class: "input-wrapper" };
const _hoisted_32 = ["value", "onChange", "max", "min", "disabled"];
const _hoisted_33 = {
  key: 0,
  class: "error-message"
};
...
const _hoisted_35 = { class: "field-group" };
const _hoisted_36 = {
  key: 0,
  class: "error-message",
  style: { "margin-bottom": "12px" }
};
const _hoisted_37 = { class: "radio-options" };
...
const _hoisted_42 = { class: "input-label" };
const _hoisted_43 = { class: "input-wrapper" };
const _hoisted_44 = { class: "text-input-container" };
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["immunizationStatusChange"],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isStockout = computed(() => noDosesReason.value === "stockout");
    watch(
      immunizationStatus,
      (v) => emit("immunizationStatusChange", v),
      { immediate: true }
    );
    const statusError = ref("");
    const doseCountError = ref("");
    ...
    const validateDoseDateOrder = (dates, setErrorAtIndex, doseLabel) => {
      for (let i = 1; i < dates.length; i++) {
        if (!dates[i] || !dates[i - 1]) continue;
        const currentDate = new Date(dates[i]);
        const previousDate = new Date(dates[i - 1]);
        if (Number.isNaN(currentDate.getTime()) || Number.isNaN(previousDate.getTime())) continue;
        if (currentDate <= previousDate) {
          setErrorAtIndex(i, `Date must be after ${doseLabel} ${i}`);
          return `Date must be after ${doseLabel} ${i}`;
        }
      }
      return null;
    };
    const handleFullyDateChange = (index, value) => {
      ...
      if (index > 0 && fullyDates.value[index - 1]) {
        ...
        if (currentDate <= previousDate) {
          fullyErrors.value[index] = `Date must be after TDV ${index}`;
          return;
        }
      }
    ...
    const handleUnderDateChange = (index, value) => {
      ...
      if (index > 0 && underDates.value[index - 1]) {
        ...
        if (currentDate <= previousDate) {
          underErrors.value[index] = `Date must be after TDV ${index}`;
          return;
        }
      }
    ...
    const validate = () => {
      ...
      if (!immunizationStatus.value) {
        statusError.value = "Tetanus immunization status is required";
        return statusError.value;
      }
      if (immunizationStatus.value === "Fully immunised") {
        const orderError = validateDoseDateOrder(
          fullyDates.value,
          (idx, msg) => {
            fullyErrors.value[idx] = msg;
          },
          "TDV"
        );
        ...
        for (let i = 0; i < 5; i++) {
          if (!fullyDates.value[i]) {
            fullyErrors.value[i] = `TTV Dose ${i + 1} date is required`;
      ...
      if (immunizationStatus.value === "Under immunised") {
        if (!selectedDoseCount.value) {
          doseCountError.value = "Please select number of doses";
          return doseCountError.value;
        }
        const orderError = validateDoseDateOrder(
          underDates.value.slice(0, selectedDoseCount.value),
          (idx, msg) => {
            underErrors.value[idx] = msg;
          },
          "TDV"
        );
        if (orderError) return orderError;
        for (let i = 0; i < selectedDoseCount.value; i++) {
          if (!underDates.value[i]) {
            underErrors.value[i] = `TTV Dose ${i + 1} date is required`;
      ...
      if (immunizationStatus.value === "No doses") {
        ...
        if (noDosesReason.value === "other" && !otherReason.value) {
          otherReasonError.value = "Please specify other reason";
          return otherReasonError.value;
        }
      }
      return null;
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        _cache[11] || (_cache[11] = createBaseVNode("div", { class: "field-header-container" }, [
          createBaseVNode("div", { class: "header-with-icon" }, [
            createBaseVNode("div", null, [
              createBaseVNode("h6", { class: "field-header" }, [
                createTextVNode("Select Tetanus Immunization Status "),
                createBaseVNode("span", { class: "required-asterisk" }, "*")
              ])
            ])
          ])
        ], -1)),
        statusError.value ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
          createVNode(unref(IonIcon), {
            icon: unref(alertCircleOutline),
            class: "error-icon"
          }, null, 8, ["icon"]),
          createTextVNode(" " + toDisplayString(statusError.value), 1)
        ])) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3, [
          (openBlock(), createElementBlock(Fragment, null, renderList(statusOptions, (status) => {
            return createBaseVNode("div", {
              key: status.value,
              class: normalizeClass(["status-option", { selected: immunizationStatus.value === status.value, "has-error": statusError.value }]),
              ...
              createBaseVNode("div", _hoisted_5, [
                createBaseVNode("span", _hoisted_6, toDisplayString(status.label), 1),
                createBaseVNode("span", _hoisted_7, toDisplayString(status.description), 1)
              ])
            ], 10, _hoisted_4);
          }), 64))
        ]),
        immunizationStatus.value ? (openBlock(), createElementBlock("div", _hoisted_8)) : createCommentVNode("", true),
        immunizationStatus.value === "Fully immunised" ? (openBlock(), createElementBlock("div", _hoisted_9, [
          createBaseVNode("div", _hoisted_10, [
            _cache[3] || (_cache[3] = createBaseVNode("div", { class: "subtitle-left" }, [
              createBaseVNode("span", null, "Complete all 5 TDV dose dates")
            ], -1)),
            createBaseVNode("span", _hoisted_11, toDisplayString(completedFullyDoses.value) + "/5", 1)
          ]),
            ...
            (openBlock(), createElementBlock(Fragment, null, renderList(5, (dose) => {
              return createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_13, [
                  ...
                  fullyDates.value[dose - 1] ? (openBlock(), createElementBlock("span", _hoisted_15, [
                ...
                createBaseVNode("div", _hoisted_16, [
                  createBaseVNode("input", {
                    ...
                    onClick: _cache[0] || (_cache[0] = (e) => e.target.showPicker?.()),
                    max: (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
                    min: dose > 1 && fullyDates.value[dose - 2] ? addDaysISO(fullyDates.value[dose - 2], 1) : void 0,
                ...
                fullyErrors.value[dose - 1] ? (openBlock(), createElementBlock("div", _hoisted_18, [
                  createVNode(unref(IonIcon), {
                    icon: unref(alertCircleOutline),
                    class: "error-icon"
                  }, null, 8, ["icon"]),
        ...
        immunizationStatus.value === "Under immunised" ? (openBlock(), createElementBlock("div", _hoisted_19, [
          createBaseVNode("div", _hoisted_20, [
            ...
            doseCountError.value ? (openBlock(), createElementBlock("div", _hoisted_21, [
              createVNode(unref(IonIcon), {
                icon: unref(alertCircleOutline),
                class: "error-icon"
              }, null, 8, ["icon"]),
              createTextVNode(" " + toDisplayString(doseCountError.value), 1)
            ])) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_22, [
              (openBlock(), createElementBlock(Fragment, null, renderList([1, 2, 3, 4], (count) => {
                return createBaseVNode("button", {
                  key: count,
                  type: "button",
                  class: normalizeClass(["dose-count-btn", { active: selectedDoseCount.value === count, "has-error": doseCountError.value }]),
                  onClick: ($event) => selectDoseCount(count)
                }, [
                  createBaseVNode("span", _hoisted_24, toDisplayString(count), 1),
                  createBaseVNode("span", _hoisted_25, "dose" + toDisplayString(count > 1 ? "s" : ""), 1)
                ], 10, _hoisted_23);
              }), 64))
            ])
          ]),
          selectedDoseCount.value ? (openBlock(), createElementBlock("div", _hoisted_26)) : createCommentVNode("", true),
          selectedDoseCount.value ? (openBlock(), createElementBlock("div", _hoisted_27, [
              ...
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_28, [
                  createBaseVNode("label", _hoisted_29, [
                    createTextVNode(" Date for TDV " + toDisplayString(dose) + " ", 1),
                    _cache[6] || (_cache[6] = createBaseVNode("span", { class: "required-asterisk" }, "*", -1))
                  ]),
                  underDates.value[dose - 1] ? (openBlock(), createElementBlock("span", _hoisted_30, [
                    createVNode(unref(IonIcon), { icon: unref(checkmarkCircleOutline) }, null, 8, ["icon"])
                  ])) : createCommentVNode("", true)
                ]),
                createBaseVNode("div", _hoisted_31, [
                  createBaseVNode("input", {
                    ...
                    onClick: _cache[1] || (_cache[1] = (e) => e.target.showPicker?.()),
                    max: (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
                    min: dose > 1 && underDates.value[dose - 2] ? addDaysISO(underDates.value[dose - 2], 1) : void 0,
                ...
                underErrors.value[dose - 1] ? (openBlock(), createElementBlock("div", _hoisted_33, [
                  createVNode(unref(IonIcon), {
                    icon: unref(alertCircleOutline),
                    class: "error-icon"
                  }, null, 8, ["icon"]),
        ...
        immunizationStatus.value === "No doses" ? (openBlock(), createElementBlock("div", _hoisted_34, [
          createBaseVNode("div", _hoisted_35, [
            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "header-with-icon" }, [
              createBaseVNode("div", null, [
                createBaseVNode("h6", { class: "field-header" }, [
            ...
            reasonError.value ? (openBlock(), createElementBlock("div", _hoisted_36, [
              createVNode(unref(IonIcon), {
                icon: unref(alertCircleOutline),
                class: "error-icon"
              }, null, 8, ["icon"]),
              createTextVNode(" " + toDisplayString(reasonError.value), 1)
            ])) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_37, [
              (openBlock(), createElementBlock(Fragment, null, renderList(reasonOptions, (reason) => {
                return createBaseVNode("div", {
                  key: reason.value,
                  class: normalizeClass(["radio-option", { selected: noDosesReason.value === reason.value, "has-error": reasonError.value }]),
                  onClick: ($event) => handleReasonChange(reason.value)
                }, [
                  createBaseVNode("div", {
                    class: normalizeClass(["radio-circle", { checked: noDosesReason.value === reason.value }])
                  }, [
                    noDosesReason.value === reason.value ? (openBlock(), createElementBlock("div", _hoisted_39)) : createCommentVNode("", true)
                  ], 2),
          ...
          noDosesReason.value === "other" ? (openBlock(), createElementBlock("div", _hoisted_40)) : createCommentVNode("", true),
          noDosesReason.value === "other" ? (openBlock(), createElementBlock("div", _hoisted_41, [
            createBaseVNode("label", _hoisted_42, [
              createVNode(unref(IonIcon), {
                icon: unref(createOutline),
                class: "label-icon"
              }, null, 8, ["icon"]),
              _cache[8] || (_cache[8] = createTextVNode(" Specify other reasons ", -1)),
              _cache[9] || (_cache[9] = createBaseVNode("span", { class: "required-asterisk" }, "*", -1))
            ]),
            createBaseVNode("div", _hoisted_43, [
              createBaseVNode("div", _hoisted_44, [
                createBaseVNode("input", {
                  ...
                  onInput: _cache[2] || (_cache[2] = (e) => handleOtherReasonChange(e.target.value)),
                  placeholder: "Please specify the reason...",
                  class: normalizeClass(["text-input", { "has-error": otherReasonError.value }])
                }, null, 42, _hoisted_45),
                createVNode(unref(IonIcon), {
                  icon: unref(createOutline),
                  class: "input-icon"
            ...
            otherReasonError.value ? (openBlock(), createElementBlock("div", _hoisted_46, [
              createVNode(unref(IonIcon), {
                icon: unref(alertCircleOutline),
                class: "error-icon"
              }, null, 8, ["icon"]),
              createTextVNode(" " + toDisplayString(otherReasonError.value), 1)
            ])) : createCommentVNode("", true)
          ])) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        immunizationStatus.value === "Unknown doses" ? (openBlock(), createElementBlock("div", _hoisted_47, [
          createVNode(unref(IonIcon), {
            icon: unref(alertCircleOutline),
            class: "alert-icon"
          }, null, 8, ["icon"]),
          _cache[10] || (_cache[10] = createBaseVNode("div", { class: "alert-content" }, [
        ...
        immunizationStatus.value ? (openBlock(), createElementBlock("div", _hoisted_48)) : createCommentVNode("", true)
      ]);
    };
  }
});

const TetanusImmunizationTable = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-7121f0c7"]]);

const useCurrentPregnancyForm = (isStockout, tetanusImmunizationStatus) => {
  const resetForm = () => {
  };
  const gestationAgeSection = computed(() => {
    const formElements = [
      ...
      },
      {
        ...
        validation: (value, allFormValues) => {
          const gestationMethod = allFormValues?.["Gestation age to be used"];
          if (gestationMethod === "GA by LNMP" && value) {
            const lnmpDate = allFormValues?.["lmnp date"];
            if (lnmpDate) {
              const eddTime = Date.parse(value);
              const lnmpTime = Date.parse(lnmpDate);
              if (!isNaN(eddTime) && !isNaN(lnmpTime) && eddTime < lnmpTime) {
                return "EDD must not be less than LNMP date";
              }
            }
          }
          return null;
      ...
      // ========== ULTRASOUND SECTION ==========
      {
        ...
        validation: (value, allFormValues) => {
          ...
          if (gestationMethod === "GA by ultrasound") {
            ...
            const lnmpDate = allFormValues?.["Estimated date"];
            if (lnmpDate && value) {
              const ultrasoundTime = Date.parse(value);
              const lnmpTime = Date.parse(lnmpDate);
              if (!isNaN(ultrasoundTime) && !isNaN(lnmpTime) && lnmpTime >= ultrasoundTime) {
                return "LNMP date must be less than the date of ultrasound";
              }
            }
          }
          return null;
      ...
      {
        componentType: "dateInputField",
        header: "LNMP date from ultrasound",
        name: "Estimated date",
        icon: icons.calenderPrimary,
        grid: { s: "12", md: "6" },
        validation: (value, allFormValues) => {
          const gestationMethod = allFormValues?.["Gestation age to be used"];
          if (gestationMethod === "GA by ultrasound" && value) {
            const ultrasoundDate = allFormValues?.["Date"];
            if (ultrasoundDate) {
              const lnmpTime = Date.parse(value);
              const ultrasoundTime = Date.parse(ultrasoundDate);
              if (!isNaN(lnmpTime) && !isNaN(ultrasoundTime) && lnmpTime >= ultrasoundTime) {
                return "LNMP date must be less than the date of ultrasound";
              }
            }
          }
  ...
  const tdvSection = computed(() => {
    const status = tetanusImmunizationStatus.value;
    const showTdvIntervals = !isStockout.value && (status === "Fully immunised" || status === "Under immunised");
    return [
      {
        componentType: "Slot",
        name: "tdvSlot",
      ...
      {
        componentType: "radioButtonField",
        header: "TDV Doses given at what intervals?",
        name: "TDV at gestation age",
        type: "inline",
        grid: { s: "12" },
        offset: "0.2",
        options: [
          { label: "0 Week", value: "0 weeks" },
          { label: "4 Weeks", value: "4 weeks" },
          { label: "6 Months", value: "6 months" },
          { label: "1 year", value: "1 year" },
          { label: "> 1 yr", value: "> 1 yr" }
        ],
        condition: () => showTdvIntervals
      }
    ];
  });
  return {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const formKey = ref(0);
    const isStockout = computed(() => unref(tetanusRef.value?.isStockout) ?? false);
    const tetanusImmunizationStatus = ref("");
    const onTetanusImmunizationStatusChange = (value) => {
      tetanusImmunizationStatus.value = value;
    };
    const currentPregnancyComposable = useCurrentPregnancyForm(isStockout, tetanusImmunizationStatus);
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    watch(
      () => patient.value?.patientID,
        ...
        createVNode(unref(IonCard), { class: "section" }, {
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Tetanus Diphtheria Vaccination (TDV)",
                  ...
                  tdvSlot: withCtx(() => [
                    (openBlock(), createBlock(TetanusImmunizationTable, {
                      ref_key: "tetanusRef",
                      ref: tetanusRef,
                      key: formKey.value,
                      onImmunizationStatusChange: onTetanusImmunizationStatusChange
                    }))
                  ]),
                  _: 1
                }, 8, ["formData"]))
...
const CurrentPregnancy = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6e20c1ce"]]);
    ...
    return [
      {
        ...
        options: [
          ...
          { value: "anti-convulsant", label: "Anti-convulsant" },
          { value: "anti-malarial", label: "Anti-malarial" },
...
const Medications = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-13af32c8"]]);

const useWomanBehaviourForm = () => {
  const resetForm = () => {
  };
  const caffeineIntakeOptions = computed(() => [
    {
      componentType: "checkboxField",
      header: "Daily caffeine use",
  ...
  const drugAndSubstanceAbuseOptions = computed(() => [
    {
      componentType: "checkboxField",
      header: "Misuse of drugs",
  ...
  return {
    resetForm,
    caffeineIntakeOptions,
    drugAndSubstanceAbuseOptions
  };
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const caffeineIntakeFormRef = ref(null);
    const drugAndSubstanceAbuseFormRef = ref(null);
    const formKey = ref(0);
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    watch(
    ...
    const onSubmit = async () => {
      if (!caffeineIntakeFormRef.value || !drugAndSubstanceAbuseFormRef.value) {
        return false;
      }
      const validationErrors = [caffeineIntakeFormRef.value.validateForm(), drugAndSubstanceAbuseFormRef.value.validateForm()].filter(
      ...
      const formData = {
        ...caffeineIntakeFormRef.value.getFormValues(),
        ...drugAndSubstanceAbuseFormRef.value.getFormValues()
      };
      try {
    ...
    const caffeineIntakeForm = computed(() => womanBehaviourFormComposable.caffeineIntakeOptions.value);
    const drugAndSubstanceAbuseForm = computed(() => womanBehaviourFormComposable.drugAndSubstanceAbuseOptions.value);
    __expose({
      validateForm: () => {
        if (!caffeineIntakeFormRef.value || !drugAndSubstanceAbuseFormRef.value) return null;
        return [caffeineIntakeFormRef.value.validateForm(), drugAndSubstanceAbuseFormRef.value.validateForm()].find(
          (error) => error !== null && error !== void 0
        );
      },
      onSubmit,
        ...
        createVNode(unref(IonCard), { class: "section" }, {
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Caffeine Intake",
                  formData: caffeineIntakeForm.value,
                  ref_key: "caffeineIntakeFormRef",
                  ref: caffeineIntakeFormRef,
                  key: formKey.value
                }, null, 8, ["formData"]))
              ]),
              _: 1
        ...
        createVNode(unref(IonCard), { class: "section" }, {
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Drug And Substance Abuse",
                  formData: drugAndSubstanceAbuseForm.value,
                  ref_key: "drugAndSubstanceAbuseFormRef",
                  ref: drugAndSubstanceAbuseFormRef,
                  key: formKey.value
                }, null, 8, ["formData"]))
              ]),
              _: 1
...
const WomanBehaviour = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-63707bf6"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      const observations = await ObservationService.buildSaveObs(data, EncounterTypeId.Obstetrics_and_Gynecology);
    ...
    const validateForm = () => {
      ...
      const allergiesErrors = formRef.value?.validateForm();
      return surgeriesErrors || allergiesErrors;
    };
    __expose({
...
const Gynaecology = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3585cb08"]]);

const usePreviousANCContactsForm = () => {
  const resetForm = () => {
  };
  const previousANCContactsFormSection = computed(() => {
    return [
      {
        componentType: "radioButtonField",
        header: "Has the woman had any previous ANC contacts before?",
        name: "Previous anc visit",
      ...
      {
        componentType: "inputField",
        header: "Enter number of previous ANC contacts",
        name: "Number of previous anc contacts",
        obsValueType: "value_numeric",
        icon: icons.editPen,
        type: "number",
        condition: (formValues) => formValues["Previous anc visit"] === "Yes",
        validation: (value) => {
          ...
          if (num > 7) {
            return "Number of previous ANC contacts cannot exceed 7";
          }
          if (num < 1) {
            return "Must have at least 1 contact";
          }
          return null;
        },
        grid: { s: "12", sm: "6" }
  ...
  return {
    resetForm,
    previousANCContactsFormSection
  };
};

const usePreviousANCContactsDetailsForm = () => {
  const numberOfContacts = ref(0);
  const resetForm = () => {
    numberOfContacts.value = 0;
  };
  const { facilityList, getFacilities } = useLocation();
  getFacilities();
  const setNumberOfContacts = (count) => {
    numberOfContacts.value = count;
  };
  const previousANCContactsDetailsFormSection = computed(() => {
    const formElements = [];
    for (let i = 1; i <= numberOfContacts.value; i++) {
      formElements.push(
        {
          componentType: "Heading",
          name: `Previous ANC Contact ${i} Details`
        },
        {
          componentType: "dateInputField",
          header: `Date of ANC visit ${i}`,
          name: `Date of ANC visit ${i}`,
        ...
        {
          componentType: "multiSelectInputField",
          name: `Facility from which the client received ANC care ${i}`,
          header: `Facility from which the client received ANC care ${i}`,
          placeholder: "Search for facility",
  ...
  return {
    resetForm,
    setNumberOfContacts,
    previousANCContactsDetailsFormSection,
    numberOfContacts
  };
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "PreviousANCContacts",
  setup(__props, { expose: __expose }) {
    const previousANCContactsFormComposable = usePreviousANCContactsForm();
    const previousANCContactsDetailsFormComposable = usePreviousANCContactsDetailsForm();
    const parentFormRef = ref(null);
    const contactFormRefs = ref(/* @__PURE__ */ new Map());
    const parentFormKey = ref(0);
    const numberOfContactsToRender = ref(0);
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    const setContactFormRef = (el, contactNumber) => {
      if (el) {
        contactFormRefs.value.set(contactNumber, el);
      }
    };
    watch(
      () => patient.value?.patientID,
      async (newPatientID, oldPatientID) => {
        if (newPatientID && newPatientID !== oldPatientID) {
          previousANCContactsDetailsFormComposable.resetForm();
          numberOfContactsToRender.value = 0;
          contactFormRefs.value.clear();
          parentFormKey.value++;
          await nextTick();
        }
      }
    ...
    watch(
      () => {
        const formValues = parentFormRef.value?.getFormValues();
        return formValues?.["Number of previous anc contacts"];
      },
      async (newValue, oldValue) => {
        if (newValue === oldValue) return;
        const count = parseInt(newValue) || 0;
        previousANCContactsDetailsFormComposable.setNumberOfContacts(count);
        numberOfContactsToRender.value = count;
        if (count < (parseInt(oldValue) || 0)) {
          for (let i = count + 1; i <= (parseInt(oldValue) || 0); i++) {
            contactFormRefs.value.delete(i);
          }
        }
        await nextTick();
      }
    ...
    const parentFormData = computed(() => {
      return previousANCContactsFormComposable.previousANCContactsFormSection.value;
    });
    const getContactFormData = (contactNumber) => {
      const allContactFormElements = previousANCContactsDetailsFormComposable.previousANCContactsDetailsFormSection.value;
      const elementsPerContact = 3;
      const startIndex = (contactNumber - 1) * elementsPerContact;
      const endIndex = startIndex + elementsPerContact;
      const contactElements = allContactFormElements.slice(startIndex, endIndex);
      return contactElements.filter((element) => element.componentType === "dateInputField" || element.componentType === "multiSelectInputField");
    };
    const onSubmit = async () => {
      if (!parentFormRef.value) {
        return false;
      }
      const validationErrors = parentFormRef.value.validateForm();
      if (validationErrors) {
        toastWarning("Please fix validation errors before submitting");
        return false;
      }
      let hasContactErrors = false;
      for (const [contactNumber, formRef] of contactFormRefs.value.entries()) {
        if (formRef && formRef.validateForm) {
          const errors = formRef.validateForm();
          if (errors) {
            toastWarning(`Please fix validation errors in Contact ${contactNumber}`);
      ...
      const parentData = parentFormRef.value.getFormValues();
      const allFormData = { ...parentData };
      for (const [contactNumber, formRef] of contactFormRefs.value.entries()) {
        if (formRef && formRef.getFormValues) {
          const contactData = formRef.getFormValues();
          Object.assign(allFormData, contactData);
        }
      }
      try {
        const observations = await processPreviousANCContacts(allFormData);
        if (observations.length === 0) {
          toastWarning("No previous ANC contacts data to save");
          return false;
        }
        await ObservationService.addObsToEncounterPatient(observations, EncounterTypeId.ANC_ENROLLMENT);
        previousANCContactsFormComposable.resetForm();
        previousANCContactsDetailsFormComposable.resetForm();
        numberOfContactsToRender.value = 0;
        contactFormRefs.value.clear();
        parentFormKey.value++;
        await nextTick();
        toastSuccess("Previous ANC contacts saved successfully");
        return true;
      } catch (error) {
        toastWarning(error?.message || "Failed to save previous ANC contacts data");
        return false;
      }
    };
    const processPreviousANCContacts = async (data) => {
      const observations = [];
      for (const [key, value] of Object.entries(data)) {
        if (!value || value === false || value === "") continue;
        if (Array.isArray(value)) {
          ...
          observations.push(await ObservationService.buildValueText("Previous visit", key));
        }
      }
      return observations;
    };
    ...
    __expose({
      validateForm: () => {
        const parentErrors = parentFormRef.value?.validateForm();
        if (parentErrors) return parentErrors;
        for (const [contactNumber, formRef] of contactFormRefs.value.entries()) {
          if (formRef && formRef.validateForm) {
            const errors = formRef.validateForm();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createVNode(unref(IonCard), { class: "section" }, {
          default: withCtx(() => [
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                (openBlock(), createBlock(StandardForm, {
                  subtitle: "Previous ANC Contacts",
                  formData: parentFormData.value,
                  ref_key: "parentFormRef",
                  ref: parentFormRef,
                  key: parentFormKey.value
                }, null, 8, ["formData"]))
              ]),
              _: 1
            })
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(Math.min(numberOfContactsToRender.value, 7), (contactNumber) => {
          return openBlock(), createBlock(unref(IonCard), {
            ...
            default: withCtx(() => [
              createVNode(unref(IonCardContent), null, {
                default: withCtx(() => [
                  createVNode(StandardForm, {
                    subtitle: `ANC Contact ${contactNumber} Details`,
                    formData: getContactFormData(contactNumber),
                    ref_for: true,
                    ref: (el) => setContactFormRef(el, contactNumber)
...
const PreviousANCContacts = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-69d30d61"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const previousANCContactsRef = ref(null);
    ...
    const getActiveTabs = () => {
      return [
        ...
        { title: "Gynaecological History", icon: "" },
        { title: "Current Pregnancy", icon: "" },
        { title: "Previous ANC Contacts", icon: "" },
    ...
    const getActiveComponent = () => {
      ...
      const componentMap = {
        ...
        "Previous ANC Contacts": "PreviousANCContacts",
        "Gynaecological History": "Gynaecology",
    ...
    const getComponentRef = (title) => {
      const componentRefs = {
        ...
        "Previous ANC Contacts": previousANCContactsRef,
        "Gynaecological History": gynaecologyRef,
    ...
    const saveAllData = async () => {
      ...
      try {
        ...
        await router.replace({ name: "ancQuickCheck" });
      } catch (error) {
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_1, [
                showWizard.value ? (openBlock(), createBlock(_sfc_main$9, {
                  key: 0,
                  ref_key: "wizard",
                  ref: wizard,
                  ...
                  default: withCtx(() => [
                    ...
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(PreviousANCContacts, {
                        ref_key: "previousANCContactsRef",
                        ref: previousANCContactsRef
                      }, null, 512)
                    ], 512), [
                      [vShow, getActiveComponent() == "PreviousANCContacts"]
                    ]),
                    withDirectives(createBaseVNode("div", null, [
...
const Profile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-73617864"]]);
