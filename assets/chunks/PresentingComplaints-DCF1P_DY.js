import { u as useDemographicsStore, n as icons, z as StandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, N as ConceptService, b0 as List, F as DynamicButton, C as useExposeFromStandardForm, a3 as modifyFieldValue, S as Service, y as StandardValidations, _ as _export_sfc } from '../index-Bn2sysQf.js';
import { s as storeToRefs } from './pinia-Drf8jDfn.js';
import { c as computed, s as defineComponent, w as watch, a3 as onMounted, n as nextTick, y as openBlock, O as createBlock, f as ref, z as createElementBlock, x as resolveComponent, A as createVNode, H as createCommentVNode, B as withCtx, C as createBaseVNode, F as unref, aq as IonItem, a5 as createTextVNode, J as Fragment } from './vendor-8vOj_QAN.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const buildPresentingComplaintsList = (data) => {
      ...
      const isOther = presentingComplainData.name === "Other";
      const complaintName = isOther ? data["Other (specify)"] : presentingComplainData.name;
      const childEntries = [
        {
          concept_id: presentingComplainData.concept_id,
          value_text: isOther ? complaintName + " | " + duration : duration,
    ...
    const deletePresentingComplaintsList = (presentingComplaintsItem) => {
      ...
      display_item.value = presentingComplaintsList.value.length > 0;
      show_btn.value = presentingComplaintsList.value.length > 0 && !search_item.value;
      if (presentingComplaintsList.value.length <= 0) {
        search_item.value = true;
      }
    };
    const onSubmit = async (showAlert = true) => {
        ...
        show_btn.value ? (openBlock(), createBlock(_component_ion_row, {
          ...
          default: withCtx(() => [
            createVNode(DynamicButton, {
              ...
              name: "Add new presenting complaint"
            }, null, 8, ["icon"])
          ]),
          _: 1
        })) : createCommentVNode("", true),
...
const PresentingComplaints = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e858778"]]);
