import { cH as __vitePreload, w as watch, r as reactive, f as ref, s as defineComponent, L as IonIcon, M as IonSpinner, af as IonRow, aA as IonCol, bd as IonCardContent, bK as IonCard, N as IonButton, cG as arrowForward, fr as download, h as inject, dw as arrowBack, G as closeCircleOutline, bY as chevronBackOutline, f0 as provide, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, S as renderList, T as withDirectives, Q as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c2 as resolveDynamicComponent, U as vShow } from './vendor-ltMrzBmS.js';
import { n as icons, H as HisDate, S as Service, y as StandardValidations, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-BztXY-eR.js';
import { S as SaveProgressModal } from './SaveProgressModal-CjKqjr-N.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-dCsJ28WL.js';
import { getInfographicByKey } from './infographics-D7H9eIsM.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-BucgHPqs.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-wWB4Epaa.js';
import { d as defineStore } from './pinia-CSbxcXdD.js';
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("JaundiceManagement"))
      },
      {
        componentType: "listSelectionField",
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-D7H9eIsM.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalMoroReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "moroReflex",
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-4037077f"]]);
