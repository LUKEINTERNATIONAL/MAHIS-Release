import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bL as IonCard, B as withCtx, A as createVNode, ba as IonCardTitle, dZ as IonSkeletonText, z as createElementBlock, L as IonIcon, aS as medicalOutline, a5 as createTextVNode, J as Fragment, bb as IonCardHeader, ap as IonList, R as renderList, aq as IonItem, a7 as IonLabel, b8 as calendarOutline, C as createBaseVNode, D as toDisplayString, cI as idCardOutline, c7 as folderOutline, c4 as checkmarkCircleOutline, bd as IonCardContent, f as ref, p as dayjs, a2 as onMounted, aB as IonGrid, af as IonRow, aA as IonCol, a4 as normalizeClass, d_ as checkboxOutline, H as createCommentVNode, c9 as clipboardOutline, d$ as statsChartOutline, K as modalController, aL as useRouter, cu as useRoute, x as resolveComponent, aG as IonContent, e0 as ellipsisVerticalSharp, d2 as person, aI as IonAccordionGroup, aH as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, a$ as personOutline, v as documentTextOutline, b1 as printOutline, d3 as add, bu as IonPage, cR as defineAsyncComponent, bg as __vitePreload, c as computed } from './vendor-CL0dVHZq.js';
import { s as storeToRefs } from './pinia-e5upVPR3.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, ab as GlobalPropertyService, r as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, q as usePatientList, v as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-yRu5EhmF.js';
...
import { i as isTaskPermitted } from './tasks-G9-1jRdr.js';
import { A as ANCRedirection } from './anc_service-CjDC8Mqp.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-BKKyVSCB.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-KEyuIdAJ.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CvaK3P1q.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-D6pLejfW.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-DECQyWVD.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-Da-nZ-Ru.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-jLW1VkEv.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-DrkaRNsz.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-CLaRzMXz.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-MLWpZQhj.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-BX-6OZJY.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-yRu5EhmF.js').then(n => n.cS),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-fN4NoHss.js'),true              ?[]:void 0,import.meta.url));
...
const PatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a13b99c9"]]);
