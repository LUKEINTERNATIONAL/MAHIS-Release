import { w as watch, f as ref, c as computed, s as defineComponent, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, F as unref, A as createVNode, B as withCtx, aB as IonCol, a5 as createTextVNode, af as IonRow, J as Fragment, S as renderList, O as createBlock, D as toDisplayString, N as IonButton, L as IonIcon, dj as eyeOutline, H as createCommentVNode, fB as TransitionGroup, bW as trashOutline, aS as syncOutline, fC as Transition, bI as addOutline, I as IonHeader, aE as IonToolbar, aF as IonTitle, bf as IonButtons, aH as IonContent, bH as IonModal, aM as useRouter, bN as useRoute, fk as onIonViewWillEnter, f1 as provide, bw as IonPage } from './vendor-CvMfV7DM.js';
import { u as useDemographicsStore, S as Service, g as getPouchDBRecords, O as OrderService, ar as ConceptService, J as savePatientRecord, aY as AppEncounterService, b as EncounterTypeId, t as toastWarning, z as StandardForm, o as createModal, _ as _export_sfc, T as Toolbar } from '../index-C5FwKd58.js';
import { l as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-DC7a0AWV.js';
import { d as defineStore, s as storeToRefs } from './pinia-OlYjPPGt.js';
import { _ as _sfc_main$2 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-Crso4kli.js';
import { b as neonatalInvestigationFormKey, S as SummarySection } from './SummarySection-T-jwJjEk.js';
...
const useNeonatalInvestigationStore = defineStore("neonatalInvestigation", () => {
  ...
  const formValues = computed(() => ({
    ...
    queuedTestsSummary: queuedTestsSummary.value
  }));
...
const Investigation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-04c7dfa4"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const investigationStore = useNeonatalInvestigationStore();
    provide(neonatalInvestigationFormKey, investigationStore.formValues);
