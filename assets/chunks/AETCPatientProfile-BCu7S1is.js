import { q as defineComponent, aF as useRouter, cr as useRoute, r as ref, d as computed, a2 as onMounted, w as watch, v as resolveComponent, O as createBlock, y as openBlock, A as withCtx, z as createVNode, E as unref, H as IonContent, G as createCommentVNode, x as createElementBlock, cN as defineAsyncComponent, af as IonRow, aw as IonCol, bH as IonCard, b7 as IonCardContent, B as createBaseVNode, L as IonIcon, d_ as ellipsisVerticalSharp, a4 as normalizeClass, d0 as person, C as toDisplayString, a5 as createTextVNode, F as closeCircleOutline, de as IonSegment, df as IonSegmentButton, a7 as IonLabel, P as normalizeStyle, an as IonItem, aV as personOutline, s as documentTextOutline, cG as idCardOutline, aX as printOutline, J as Fragment, R as renderList, d1 as add, bq as IonPage, cF as __vitePreload } from './vendor-Cy_N32Zh.js';
import { s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { u as useANCEnrollmentStore, A as ArtCard } from './PatientProfile-BtEwYSd6.js';
import { aY as AppEncounterService, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cL as PatientOpdList, o as createModal, t as toastWarning, ai as ProgramService, K as ObservationService, _ as _export_sfc } from '../index-B2p2mVqz.js';
import { u as usePatientProfile } from './usePatientProfile-BHc9iq9u.js';
import { c as formatRadioButtonData } from './formatServerData-vTu6TxbF.js';
import { D as DemographicBar } from './DemographicBar-ChySBBij.js';
import { C as CPR } from './CPR-Cf--WJm8.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-zSvTq2i1.js'),true              ?[]:void 0,import.meta.url));
    ...
    const AncEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./AncEnrollmentModal-DcTMxasD.js'),true              ?[]:void 0,import.meta.url));
