import { v as defineComponent, w as watch, a3 as onMounted, y as resolveComponent, z as createElementBlock, A as openBlock, C as createBaseVNode, B as createVNode, G as unref, R as alertCircleOutline, c as computed, c5 as checkmarkCircleOutline, K as Fragment, S as renderList, J as createCommentVNode, b7 as calendarOutline, E as toDisplayString, a5 as normalizeClass, f as ref, aa as chevronDownOutline, M as IonIcon, eB as bodyOutline, eC as scanOutline, bH as addOutline, br as pulseOutline, eD as moveOutline, eE as fitnessOutline, df as manOutline, eF as happyOutline, eG as earOutline, eH as nutritionOutline, dk as eyeOutline, c4 as warningOutline, aR as medicalOutline, aU as femaleOutline, x as documentTextOutline, n as nextTick, P as createBlock, D as withCtx, a8 as IonLabel, a6 as createTextVNode, au as IonToggle, ap as IonItem, ag as IonRow, aG as IonAccordion, O as IonButton, a9 as withModifiers, aH as IonAccordionGroup, ao as IonList, at as script, a7 as IonInput, bI as saveOutline, H as closeCircleOutline, ca as clipboardOutline, ae as IonTextarea, L as modalController, bL as IonCard, ba as IonCardHeader, a$ as locationOutline, bv as personCircleOutline, af as IonCheckbox, dB as phonePortraitOutline, eg as pencilOutline, bc as IonCardContent, aA as IonCol, aK as useRouter, cv as useRoute, N as IonSpinner, dH as IonLoading, aF as IonContent, T as withDirectives, bY as chevronBackOutline, U as vShow, bu as IonPage, eI as lockClosedOutline, ac as checkmarkOutline } from './vendor-CJ5LqAxe.js';
import { s as storeToRefs, m as mapState } from './pinia-BmV_6_tV.js';
import { u as useFormWizard, _ as _sfc_main$d } from './useFormWizard-DaQAwIrH.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, C as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, o as createModal, b4 as confirmModal, B as BasicInputField, aI as _sfc_main$b, c as HorizontalLine, aC as areFieldsValid, x as toastDanger, aD as getFieldsValuesObj, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, v as usePatientList, r as closeVisit } from '../index-BBSKuWmW.js';
import { D as DemographicBar } from './DemographicBar-ORexdOz6.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$8 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-BTv6AhpS.js';
import { P as PresentingComplaints, _ as _sfc_main$9, a as _sfc_main$a } from './PresentingComplaints-DB3-kAHi.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-3cxzgPdX.js';
import { I as Investigations } from './Investigations-CAi-RicT.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-Dv-Fzh_9.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-DJL_2Zly.js';
import { P as PreviousTreatment } from './treatment-DXUZd2LY.js';
import { l as lodashExports } from './lodash-BxWMU_OR.js';
import { _ as _sfc_main$c, D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-RNiuao65.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-x_rwWzvm.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-Pz1KVMIU.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DvvAe7Di.js';
import { u as useUserActivities } from './useUserActivities-Cl-mKmlC.js';
