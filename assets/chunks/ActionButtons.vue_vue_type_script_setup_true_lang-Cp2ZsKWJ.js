import { ab as useUserStore, a as useProgramStore, at as MultiColumnView, au as mapObjsToOptions, S as Service, t as toastWarning, av as ART_PRIMARY_ACTIVITIES, aw as OPD_PRIMARY_ACTIVITIES, ax as NCD_PRIMARY_ACTIVITIES, _ as _export_sfc, M as ProgramId, X as modal, V as UserService, n as icons, o as createModal } from '../index-BQO1lu0i.js';
import { q as defineComponent, r as ref, d as computed, a1 as onMounted, N as createBlock, y as openBlock, B as withCtx, z as createVNode, E as unref, I as IonHeader, aB as IonTitle, a4 as createTextVNode, C as toDisplayString, K as IonIcon, F as closeCircleOutline, J as modalController, aD as IonContent, x as createElementBlock, H as Fragment, Q as renderList, ae as IonRow, ay as IonCol, ad as IonCheckbox, a6 as IonLabel, bc as IonFooter, M as IonButton, bs as IonPage, w as watch, v as resolveComponent, bk as search, A as createBaseVNode, O as normalizeStyle, aI as useRouter, G as createCommentVNode, dD as IonFab, dC as IonFabButton, da as grid } from './vendor-Dvd0YFIr.js';
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.programs, (program, index) => {
          return openBlock(), createElementBlock("div", {
            key: index,
            class: "program-tile",
            onClick: () => _ctx.onSelect(program)
          }, [
            createBaseVNode("div", {
  ...
  setup(__props) {
    ...
    const filteredPrograms = computed(() => {
      return authorizedPrograms.value.filter(
        (program) => program.name.toLowerCase().includes(searchQuery.value.toLowerCase())
      );
    });
    function setProgram(program) {
      if (program.program_id === ProgramId.MEMIS_PROGRAM) {
        modal.hide();
        router.push({ name: "MEMIS-INVENTORY" });
      } else {
...
const ModulePicker = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-df48cfec"]]);
