import { q as defineComponent, x as createElementBlock, y as openBlock, B as createBaseVNode, z as createVNode, O as createBlock, G as createCommentVNode, E as unref, L as IonIcon, cm as checkmarkCircle, C as toDisplayString, a4 as normalizeClass, r as ref, v as resolveComponent, A as withCtx, a5 as createTextVNode, s as documentTextOutline, K as modalController, d as computed, aH as useRouter, c8 as clipboardOutline, ez as bodyOutline, cb as flask, ch as medkit, eQ as chatbubbles, a2 as onMounted, H as IonContent, bW as chevronBackOutline, dq as calendar, eR as paperPlaneOutline, eS as checkmarkDoneOutline, J as Fragment, R as renderList, br as IonPage } from './vendor-BPW-J91F.js';
import { _ as _export_sfc, S as Service, u as useDemographicsStore, F as DynamicButton, q as StandardModal, K as ObservationService, H as HisDate, b as EncounterTypeId, G as toastSuccess, J as savePatientRecord, y as StandardValidations, n as icons, z as useExposeFromStandardForm, C as StandardForm, t as toastWarning, T as Toolbar, o as createModal } from '../index-Bc-TK-yC.js';
import { D as DemographicBar } from './DemographicBar-Drb9gSYU.js';
import { s as storeToRefs } from './pinia-D-q2_lrU.js';
import { u as useLocation } from './useLocation-BM0Lauif.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BYyC3fxS.js';

const _hoisted_1$4 = { class: "icon-container" };
const _hoisted_2$2 = { class: "card-title" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_2$2, toDisplayString(__props.title), 1)
      ], 2);
    };
  }
});

const ANCCard = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2f6e2295"]]);
              ...
              createBaseVNode("div", _hoisted_1, [
                ...
                createBaseVNode("div", _hoisted_3, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(filteredCardsData.value, (card, index) => {
                    return openBlock(), createBlock(ANCCard, {
                      key: index,
                      icon: card.icon,
                      title: card.title,
...
const Contacts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-96bfe89a"]]);
