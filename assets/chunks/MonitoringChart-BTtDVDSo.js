import { c as computed, s as defineComponent, f as ref, w as watch, y as openBlock, O as createBlock, F as unref, bN as IonCard, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, S as renderList, C as createBaseVNode, H as createCommentVNode, bf as IonCardContent, P as normalizeStyle, D as toDisplayString, aN as useRouter, bO as useRoute, a3 as onMounted, aI as IonContent, b$ as chevronBackOutline, T as withDirectives, U as vShow, bx as IonPage, ab as checkmarkOutline } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { n as icons, z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, _ as _export_sfc, bk as useVitalsStore, u as useDemographicsStore, bl as useInvestigationStore, bm as useDiagnosisStore, b4 as useTreatmentPlanStore, bg as useNCDMedicationsStore, e as useGeneralStore, b5 as useOutcomeStore, i as useEnrollementStore, ac as useConfigStore, f as useStatusStore, T as Toolbar, a4 as getFieldValue, H as HisDate, a$ as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, N as ConceptService, G as toastSuccess, bp as useAllegyStore, a8 as useUserStore, S as Service } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { _ as _sfc_main$4 } from './Medications.vue_vue_type_script_setup_true_lang-sLglGcFt.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-DB5Ppn00.js';
