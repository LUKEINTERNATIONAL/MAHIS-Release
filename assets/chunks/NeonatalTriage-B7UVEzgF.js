import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fc as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eT as provide } from './vendor-CCA5uLDN.js';
import { s as storeToRefs } from './pinia-D-2CL6iz.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, co as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ck as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-CA5gZ8gz.js';
import { D as DemographicBar } from './DemographicBar-BCK9KPjc.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-Cq0otx9I.js';
import { S as SummarySection } from './SummarySection-D3EHCSwB.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-C3UlLO_3.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-CWClWDaD.js';
