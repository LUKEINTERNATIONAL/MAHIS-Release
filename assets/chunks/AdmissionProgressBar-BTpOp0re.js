import { s as defineComponent, aL as useRouter, f as ref, w as watch, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, D as toDisplayString, A as createVNode, F as unref, fk as caretDown, fl as caretUp, L as IonIcon, S as withDirectives, T as vShow, a4 as normalizeClass, O as createBlock, ab as checkmarkOutline, H as createCommentVNode, a5 as createTextVNode, J as Fragment, R as renderList, bA as createStaticVNode, c as computed, W as alertController } from './vendor-CHJxKtY0.js';
import { s as storeToRefs } from './pinia-DvUiFzi9.js';
import { u as useDemographicsStore, b as EncounterTypeId, E as EncounterService, _ as _export_sfc } from '../index-eygbwbqc.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const steps = ref(["Triage", "Admission", "Profiling"]);
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          ...
          withDirectives(createBaseVNode("div", _hoisted_4, [
            ...
            createBaseVNode("div", {
              class: normalizeClass(["progress-step", { completed: isAdmissionCompleted.value, active: !isAdmissionCompleted.value && isTriageCompleted.value }])
            }, [
              ...
              createBaseVNode("div", _hoisted_9, [
                createBaseVNode("div", {
                  ...
                  !showAdmissionDetails.value ? (openBlock(), createElementBlock("span", _hoisted_10, "edit")) : createCommentVNode("", true)
                ], 2),
            ...
            createBaseVNode("div", {
              class: normalizeClass(["progress-step", { completed: isEnrollmentCompleted.value, active: !isEnrollmentCompleted.value && isAdmissionCompleted.value }])
            }, [
              ...
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("div", {
                  class: normalizeClass(["step-title", { clickable: !isEnrollmentCompleted.value && isAdmissionCompleted.value, incomplete: !isEnrollmentCompleted.value }]),
                  onClick: _cache[1] || (_cache[1] = ($event) => !isEnrollmentCompleted.value && isAdmissionCompleted.value && goToEnrollment())
                }, " Profiling ", 2)
              ])
            ], 2),
            createBaseVNode("div", {
            ...
            _cache[11] || (_cache[11] = createStaticVNode('<div class="progress-step last" data-v-301b37ef><div class="step-indicator" data-v-301b37ef><div class="step-circle" data-v-301b37ef></div></div><div class="step-content" data-v-301b37ef><div class="step-title incomplete" data-v-301b37ef>Signoff &amp; Printout</div></div></div>', 1))
          ], 512), [
...
const AdmissionProgressBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-301b37ef"]]);
