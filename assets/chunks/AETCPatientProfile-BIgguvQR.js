import { q as defineComponent, aI as useRouter, cs as useRoute, r as ref, d as computed, a1 as onMounted, w as watch, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, z as createVNode, E as unref, aD as IonContent, G as createCommentVNode, x as createElementBlock, cO as defineAsyncComponent, ae as IonRow, ay as IonCol, bJ as IonCard, ba as IonCardContent, A as createBaseVNode, K as IonIcon, d$ as ellipsisVerticalSharp, a3 as normalizeClass, d1 as person, C as toDisplayString, a4 as createTextVNode, F as closeCircleOutline, df as IonSegment, dg as IonSegmentButton, a6 as IonLabel, O as normalizeStyle, an as IonItem, aY as personOutline, s as documentTextOutline, cH as idCardOutline, a_ as printOutline, H as Fragment, Q as renderList, d2 as add, bs as IonPage, cG as __vitePreload } from './vendor-DGIzCW4f.js';
import { s as storeToRefs } from './pinia-Bmkga1nW.js';
import { u as useANCEnrollmentStore, A as ArtCard } from './PatientProfile-bKPfKJYv.js';
import { aY as AppEncounterService, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cP as PatientOpdList, o as createModal, t as toastWarning, ai as ProgramService, K as ObservationService, _ as _export_sfc } from '../index-D_1ZD1MC.js';
import { u as usePatientProfile } from './usePatientProfile-BJaPg_YH.js';
import { c as formatRadioButtonData } from './formatServerData-DP8BmV3m.js';
import { D as DemographicBar } from './DemographicBar-ZlD63UIC.js';
import { C as CPR } from './CPR-Dv_DNG2z.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-YeVByVHD.js'),true              ?[]:void 0));
    ...
    const AncEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./AncEnrollmentModal-BBDNxZUH.js'),true              ?[]:void 0));
