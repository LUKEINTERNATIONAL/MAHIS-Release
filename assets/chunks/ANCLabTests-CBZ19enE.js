import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, f as ref, aM as useRouter, a3 as onMounted, O as createBlock, F as unref, aH as IonContent, C as createBaseVNode, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-E5FFSfhd.js';
import { _ as _sfc_main$5, u as useFormWizard } from './useFormWizard-DyaLcr6F.js';
import { z as StandardForm, K as ObservationService, b as EncounterTypeId, c6 as toastSuccess, t as toastWarning, _ as _export_sfc, G as toastSuccess$1, u as useDemographicsStore, T as Toolbar, F as DynamicButton, J as savePatientRecord } from '../index-5i0obq1H.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      if (formRef.value?.validateForm() == null) {
        const patient = await ObservationService.buildAddObsToEncounterPatient(data, EncounterTypeId.LABOUR_ASSESSMENT);
        if (patient) {
          toastSuccess("Ultrasound Scan data saved successfully");
          await formRef.value?.resetForm();
        } else {
          toastWarning("Ultrasound Scan data not saved");
        }
      } else {
...
const UltrasoundScan = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-3136d9f6"]]);
    ...
    const onSubmit = async () => {
      ...
      if (formRef.value?.validateForm() == null) {
        ...
        if (patient) {
          ...
          toastWarning("Urine Test  data not saved");
        }
      } else {
        toastWarning("Please fix validation errors before submitting");
      }
...
const UrineTest = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2d5b7e47"]]);
  ...
  const tbScreeningFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        type: "multiple",
        condition: (allFormValues) => {
          return allFormValues["TB screening status"] == "TB Screening Not Conducted";
        },
        grid: { s: "11" },
        offset: "1",
        options: [
    ...
    const onSubmit = async () => {
      ...
      if (formRef.value?.validateForm() == null) {
        ...
        if (patient) {
          ...
          toastWarning("TB Screening data not saved");
        }
      } else {
        toastWarning("Please fix validation errors before submitting");
      }
...
const TBTest = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3a31d4bd"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      const data = formRef.value?.getFormValues();
      if (formRef.value?.validateForm() == null) {
        const patient = await ObservationService.buildAddObsToEncounterPatient(data, EncounterTypeId.LAB);
        if (patient) {
          toastSuccess$1("Lab investigation saved successfully");
          await formRef.value?.resetForm();
        } else {
          toastWarning("Lab investigation not saved");
        }
      } else {
        toastWarning("Please fix validation errors before submitting");
      }
        ...
        createVNode(_component_ion_card, { class: "section" }, {
          default: withCtx(() => [
            createVNode(_component_ion_card_content, null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  subtitle: "Laboratory Tests and Results",
                  ref_key: "formRef",
                  ref: formRef,
...
const LabInvestigation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e9dc6657"]]);
