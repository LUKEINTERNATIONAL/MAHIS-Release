import { s as defineComponent, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, K as modalController, br as pulseOutline, bc as checkmark, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, bp as V, al as IonPopover, a6 as IonInput, B as withCtx, a5 as createTextVNode, J as Fragment, ct as useRoute, w as watch, a2 as onMounted, n as nextTick, R as renderList, D as toDisplayString, F as unref, f as ref, cZ as DataTable, aL as useRouter, L as IonIcon, a7 as IonLabel, bO as IonChip, aA as IonCol, af as IonRow, bu as IonPage, cu as IonMenuButton, a_ as medkitOutline, O as createBlock, a4 as normalizeClass, H as createCommentVNode, bK as IonCard, ax as searchOutline, ae as IonCheckbox, bd as IonCardContent, ba as IonCardTitle, N as IonButton, bb as IonCardHeader, b6 as cubeOutline, G as closeCircleOutline, Q as alertCircleOutline, db as timeOutline, eu as moon, ev as partlySunny, ew as sunny, ch as medkit, c as computed, au as script, bf as IonFooter, aI as IonAccordionGroup, aH as IonAccordion, c8 as clipboardOutline, ad as IonTextarea, dh as IonSegmentButton, dg as IonSegment, bX as chevronBackOutline, S as withDirectives, T as vShow, ab as checkmarkOutline } from './vendor-74dOmGLc.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-DUPmLFD0.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, bc as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bd as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, be as checkIfSamePatient, bf as setCurrentPatientID, bg as getAntiHypertensivesMedication, bh as getDiabetesDrugs, bi as clearMedicationData, bj as useNCDMedicationsStore, bk as useOtherNCDMedicationStore, bl as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$f, bm as addOtherMedicationToNCDMedicationList, T as Toolbar, bn as useVitalsStore, bo as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b7 as getOfflineSavedUnsavedData, bp as MedicationSelectionHasValues, bq as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, br as useAllegyStore, a6 as useUserStore, S as Service } from '../index-CJh5hefu.js';
import { D as DemographicBar } from './DemographicBar-D1ctsQ0E.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-RlmjDxbK.js';
import { D as DashBox } from './DashBox-28ywB_jU.js';
import { B as BasicForm } from './BasicForm-p1RsfPZc.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-YQKJJFbz.js';
import { v as validateInputFiledData } from './group_validation-CnEoef4M.js';
import { u as useComplicationsStore } from './ComplicationsStore-iuvBk0v4.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-CwelYtHt.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-C3v7j5vj.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-COssD_Tx.js';
import { P as PreviousAllergies } from './PreviousAllergies-DKOQXQiD.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-C0A0ebfM.js';
import { V as Vitals } from './Vitals-BZkE477T.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-DwW-7eqF.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CrVmX0EC.js';
import { u as usePatientProfile } from './usePatientProfile-AKrlGXB6.js';
