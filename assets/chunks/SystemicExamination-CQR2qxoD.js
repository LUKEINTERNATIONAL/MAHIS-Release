...
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-8Y6Qmz3g.js';
import { s as neonatalSystemicExaminationFormKey, N as NeonatalStepper, v as useSystemicExaminationStore } from './NeonatalStepper-Cqmkwz1I.js';
import { N as NeonatalService } from './neonatal_service-BMWhdi_k.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DM5pynbQ.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DM5pynbQ.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DM5pynbQ.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DM5pynbQ.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
