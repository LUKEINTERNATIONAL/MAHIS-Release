import { r as ref, ct as useRoute, d as computed, w as watch, q as defineComponent, N as createBlock, y as openBlock, E as unref, aI as useRouter, a1 as onMounted, B as withCtx, A as createBaseVNode, x as createElementBlock, G as createCommentVNode, z as createVNode, R as withDirectives, F as closeCircleOutline, M as IonButton, a4 as createTextVNode, S as vShow, H as Fragment, Q as renderList, a3 as normalizeClass, dn as checkmarkDoneCircleOutline, J as modalController } from './vendor-wM1cIaYi.js';
import { R as RegistrationService, u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$2, b as _sfc_main$3, c as _sfc_main$4, d as _sfc_main$5, e as _sfc_main$6, f as _sfc_main$7, g as _sfc_main$8 } from './useSetRegistrationValues-D4DbRs-w.js';
import { f as useStatusStore, S as Service, g as getPouchDBRecords, a6 as RelationsService, n as icons, y as StandardValidations, z as useExposeFromStandardForm, C as StandardForm, q as StandardModal, F as DynamicButton, t as toastWarning, I as alertConfirmationIonic, a4 as popoverConfirmation, _ as _export_sfc } from '../index-Cd3-tqLQ.js';
import { i as isNCDClerk } from './user_role_management-DL7Xd_1B.js';
import { u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-BtpPOO2h.js';
...
const _hoisted_1 = { class: "masonry-grid" };
...
const _hoisted_7 = { class: "custom-card card-margin-top" };
const _hoisted_8 = {
  key: 0,
  class: "card-container"
};
const _hoisted_9 = { class: "custom-card" };
const _hoisted_10 = { class: "custom-card card-margin-top" };
const _hoisted_11 = { class: "card-container" };
const _hoisted_12 = { class: "custom-card" };
const _hoisted_13 = {
  key: 0,
  class: "custom-card card-margin-top"
};
const _hoisted_14 = { class: "footer-buttons-left" };
const _hoisted_15 = {
  key: 0,
  class: "pagination-dots"
};
const _hoisted_16 = ["onClick", "aria-label"];
const _hoisted_17 = { class: "footer-buttons-right" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(StandardModal, {
        title: __props.editMode ? "Edit Patient Demographic" : "New Patient Registration"
      }, {
        "top-buttons": withCtx(() => [..._cache[4] || (_cache[4] = [])]),
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            ...
            withDirectives(createBaseVNode("div", _hoisted_4, [
              checkAge.value.underNineMonths && !__props.editMode ? (openBlock(), createElementBlock("div", _hoisted_5, [
              ...
              checkAge.value.moreThanThirteenYears ? (openBlock(), createElementBlock("div", _hoisted_6, [
            ...
            !countryFormValues.value?.country?.name || countryFormValues.value?.country?.name === "Malawi" ? withDirectives((openBlock(), createElementBlock("div", _hoisted_8, [
            ...
            withDirectives(createBaseVNode("div", _hoisted_11, [
              ...
              unref(Service).getProgramID() == 1 ? (openBlock(), createElementBlock("div", _hoisted_13, [
        ...
        footer: withCtx(() => [
          ...
          unref(showPaginationButtons) ? (openBlock(), createElementBlock("div", _hoisted_15, [
...
const Registration = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-007f6f00"]]);
