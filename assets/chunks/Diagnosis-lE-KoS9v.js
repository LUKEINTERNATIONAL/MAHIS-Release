import { _ as _export_sfc, u as useDemographicsStore, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-B8cwm10e.js';
import { q as defineComponent, ar as script, x as createElementBlock, y as openBlock, G as createCommentVNode, B as createBaseVNode, z as createVNode, D as renderSlot, A as withCtx, a5 as createTextVNode, C as toDisplayString, E as unref, r as ref, w as watch, d as computed, O as createBlock, a4 as normalizeClass, cE as mergeProps, fg as draggable, c1 as resolveDynamicComponent, J as Fragment, R as renderList, bP as withKeys, a8 as withModifiers, aH as useRouter, H as IonContent, br as IonPage } from './vendor-BizyHS9K.js';
import { u as useNeonatalTriageStore, N as NeonatalStepper } from './NeonatalStepper-BRDzwe5s.js';
import { d as defineStore, s as storeToRefs } from './pinia-xTR-gbcT.js';
import { I as IMAGES } from './images-D8oY7oX5.js';
import { u as useNeonatalVitalsStore } from './useNeonatalVitalsStore-_NQufRfU.js';
import { u as useReviewOfSystemsStore } from './useReviewOfSystemsStore-Dqdt1dX_.js';
import { u as useNeonatalExamStore } from './useNeonatalExamStore-DV5eUD-J.js';
import { u as useSystemicExaminationStore } from './useSystemicExaminationStore-BumFPHSJ.js';
import { u as useSignsSymptomsStore } from './useSignsSymptomsStore-DySmOgJ8.js';
