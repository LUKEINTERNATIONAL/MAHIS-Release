...
import { S as Service, u as useDemographicsStore, J as savePatientRecord, K as ObservationService, b as EncounterTypeId, H as HisDate, al as ProgramService, M as ProgramId, aZ as AppEncounterService, N as ConceptService, a8 as useUserStore } from '../index-DuHjvOtM.js';
...
class NeonatalService extends Service {
  ...
  static async getPatientSummary(patientId, date = HisDate.sessionDate()) {
    if (Service.getPouchDbStatus() || Service.getLanConnectionStatus()) {
      ...
      const { default: NeonatalOfflineService } = await __vitePreload(async () => { const { default: NeonatalOfflineService } = await import('./neonatal_offline_service-aS6KwCIs.js');return { default: NeonatalOfflineService }},true              ?[]:void 0);
