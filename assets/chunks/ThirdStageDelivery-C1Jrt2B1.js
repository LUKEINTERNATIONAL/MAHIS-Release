  ...
  const deliveryNewbornDetailsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        condition: (formValues) => isStillbirth(formValues)
      },
      {
        componentType: "Dashes"
      },
      ...
      },
      {
        ...
        offset: "1",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Place of delivery"] === " Other facility";
        }
      },
      {
        componentType: "Dashes",
      ...
      },
      {
        ...
        offset: "1",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Mode of delivery"] == "Other mode of delivery";
        }
      },
      {
        componentType: "Dashes",
      ...
      },
      {
        ...
        offset: "2",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Obstetric complications"] == "Other";
        }
      },
      {
        componentType: "Dashes",
      ...
      },
      {
        ...
        offset: "2",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Obstetric complications"] != "None" && formValues["Obstetric complications"].length > 0;
        },
        options: [
          { label: "None", value: "None", exclusive: true },
      ...
      //Evacuation
      {
        ...
        type: "inline",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Obstetric care provided"]?.includes("Evacuation");
        },
        options: [
          { label: "Yes", value: "Yes" },
          { label: "No", value: "No" }
      ...
      },
      {
        ...
        offset: "2",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["IV Fluids"] === "Yes";
        }
      },
      {
        componentType: "timeInputField",
      ...
      },
      {
        ...
        offset: "1",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Type of fluids"] === "Other, specify";
        }
      },
      {
        componentType: "radioButtonField",
      ...
      },
      {
        ...
        offset: "2",
        condition: (formValues) => {
          return !isStillbirth(formValues) && formValues["Blood transfusion"] === "Yes";
        }
      },
      {
        componentType: "timeInputField",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const openBabyModal = async (index) => {
      const babyData = await createModal(_sfc_main$2, { class: "large-medium-width-modal" }, true, {
        babyIndex: index,
...
const SecondStageDelivery = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-43cc4a84"]]);
