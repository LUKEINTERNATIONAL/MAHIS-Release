import { s as defineComponent, y as openBlock, O as createBlock, a2 as onMounted, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, bd as IonCardContent, N as IonButton, L as IonIcon, bG as addOutline, a5 as createTextVNode, f as ref, K as modalController, z as createElementBlock, M as IonSpinner, J as Fragment, R as renderList, bK as IonCard, a4 as normalizeClass, D as toDisplayString, bT as trashOutline, H as createCommentVNode, W as alertController, cB as toastController, a7 as IonLabel, aA as IonCol, aq as IonItem, x as resolveComponent, w as watch, eb as time, ak as IonDatetime, ba as IonCardTitle, bb as IonCardHeader, af as IonRow, au as script, ef as pencilOutline, bH as saveOutline, G as closeCircleOutline, b0 as locationOutline, bv as personCircleOutline, ae as IonCheckbox, dz as phonePortraitOutline, aS as medicalOutline, c as computed, ap as IonList, aD as IonToolbar, aE as IonTitle, be as IonButtons, I as IonHeader, aG as IonContent, bf as IonFooter, aL as useRouter, cI as idCardOutline, Q as alertCircleOutline, a6 as IonInput, by as IonText, P as normalizeStyle, dA as domtoimage, X as Capacitor } from './vendor-CIi-jrCy.js';
import { u as useDemographicsStore, y as StandardValidations, n as icons, z as StandardForm, r as StandardModal, C as useExposeFromStandardForm, b4 as RelationshipService, G as toastSuccess, t as toastWarning, o as createModal, _ as _export_sfc, k as alertConfirmation, a4 as popoverConfirmation, B as BasicInputField, b3 as useOutcomeStore, g as getPouchDBRecords, aI as _sfc_main$f, F as DynamicButton, $ as SelectFacility, V as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aB as ListPicker, ai as ProgramService, b5 as confirmModal, S as Service, H as HisDate, c as HorizontalLine, aC as areFieldsValid, x as toastDanger, aD as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, J as savePatientRecord, Z as printLabel, aM as PrintoutService, b6 as printArtVisitLbl } from '../index-COGk33Kr.js';
import { R as Registration, u as useRelationships } from './Registration-CrSS_AcO.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-C2dcsBZQ.js';
import { u as useWardsStore } from './wardsStore-CCnTTCA1.js';
...
const RelationshipManagementModal = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-a1c82e04"]]);
...
export { AdmittedforShortStayOutcomef as A, DynamicDispositionList as D, Outcome as O, ReferredOutCome as R, _sfc_main$e as _, DischargedHome as a, ReferToAnotherClinic as b, deadOutcome as d, usePatientProfile as u };
