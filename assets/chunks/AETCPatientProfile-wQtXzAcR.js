import { s as defineComponent, aL as useRouter, cu as useRoute, a2 as onMounted, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aG as IonContent, H as createCommentVNode, C as createBaseVNode, af as IonRow, aA as IonCol, bL as IonCard, bd as IonCardContent, L as IonIcon, e0 as ellipsisVerticalSharp, a4 as normalizeClass, d3 as person, D as toDisplayString, a5 as createTextVNode, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, a7 as IonLabel, z as createElementBlock, P as normalizeStyle, aq as IonItem, a$ as personOutline, v as documentTextOutline, cJ as idCardOutline, b1 as printOutline, J as Fragment, R as renderList, d4 as add, bu as IonPage, cS as defineAsyncComponent, cI as __vitePreload, f as ref, c as computed } from './vendor-Dw8g_yFL.js';
import { s as storeToRefs } from './pinia-zB_ge_8G.js';
import { A as ArtCard } from './PatientProfile-C-44KvkS.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-CIYQg2Yf.js';
...
import { C as CPR } from './CPR-Cnw-ntYU.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-QSWxSpMx.js'),true              ?[]:void 0,import.meta.url));
