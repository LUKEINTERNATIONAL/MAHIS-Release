import { s as defineComponent, M as IonSpinner, L as IonIcon, a7 as IonLabel, aq as IonItem, ap as IonList, cE as IonCardSubtitle, bb as IonCardTitle, be as IonCardContent, aF as IonTitle, bg as IonFooter, I as IonHeader, bM as IonCard, aH as IonContent, aB as IonCol, af as IonRow, aC as IonGrid, a3 as onMounted, w as watch, R as alertCircleOutline, aw as searchOutline, dj as eyeOutline, b1 as locationOutline, b0 as personOutline, b9 as calendarOutline, f as ref, r as reactive, c as computed, K as modalController, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, a5 as createTextVNode, D as toDisplayString, C as createBaseVNode, O as createBlock, H as createCommentVNode, J as Fragment, S as renderList, bw as IonPage, P as normalizeStyle } from './vendor-CvMfV7DM.js';
import { B as BasicInputField, H as HisDate, _ as _export_sfc, P as PatientService, u as useDemographicsStore, o as createModal, ar as ConceptService } from '../index-C5FwKd58.js';
import { m as mapState } from './pinia-OlYjPPGt.js';
import { f as getunderfiveImmunizationsDrugs, h as getAefiReport } from './vaccines_service-D5cl3UML.js';
...
const _sfc_main = defineComponent({
  ...
  watch: {
    $route: {
      async handler(data) {
        if (data.name == "immunizationEirReport") await this.initReport();
      },
      deep: true
    }
  },
...
const AEFIReportTemplate = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-23f26da4"]]);
