import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, aD as IonContent, bs as IonPage, aI as useRouter, eT as provide, v as resolveComponent, N as createBlock, B as withCtx } from './vendor-Cd5ziTxG.js';
import { s as storeToRefs } from './pinia-UguK66WW.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, H as HisDate, G as toastSuccess } from '../index-CKTz1PXB.js';
import { N as NeonatalService } from './neonatal_service-tcfx2RvJ.js';
import { D as DemographicBar } from './DemographicBar-CG1DJaK8.js';
import { s as neonatalSignsSymptomsSections, v as neonatalSignsSymptomsFormKey, N as NeonatalStepper, w as useSignsSymptomsStore } from './NeonatalStepper-nFV0R9Qa.js';
      ...
      if (currentIndex === stepperData.length - 1) {
        return async () => {
          ...
          try {
            ...
            await NeonatalService.saveSignsSymptomsAssessment(
              patient.value.patientID,
              signsFormData,
              date
            );
...
const NeonatalSignsSymptoms = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a896ff63"]]);
