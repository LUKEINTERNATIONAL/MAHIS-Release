import { s as defineComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, f as ref, K as modalController, ct as useRoute, z as createElementBlock, F as unref, bS as IonSearchbar, L as IonIcon, er as qrCode, N as IonButton, bG as addOutline, a5 as createTextVNode, J as Fragment, R as renderList, D as toDisplayString, H as createCommentVNode, es as callOutline, bX as chevronBackOutline, df as chevronForwardOutline, ax as searchOutline, cO as closeCircle, bd as IonCardContent, c as computed } from './vendor-6OQ3r7Vr.js';
import { n as icons, y as StandardValidations, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, P as PatientService, S as Service, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-B-NulKpO.js';
import { R as Registration } from './Registration-Cla53dKS.js';
import { R as RegistrationService } from './useSetRegistrationValues-CKyNCZXq.js';
...
const _hoisted_11 = { class: "patient-name" };
const _hoisted_12 = { class: "patient-dob" };
const _hoisted_13 = { class: "patient-gender" };
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(paginatedResults.value, (patient, index) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_10, [
                        createBaseVNode("span", _hoisted_11, toDisplayString(patient.firstName) + " " + toDisplayString(patient.middleName ? patient.middleName + " " : "") + toDisplayString(patient.lastName), 1),
                        createBaseVNode("span", _hoisted_12, "DOB: " + toDisplayString(formatDate(patient.birthdate)), 1),
                        createBaseVNode("span", _hoisted_13, toDisplayString(patient.gender === "F" ? "Female" : patient.gender), 1)
                      ]),
                      createBaseVNode("div", _hoisted_14, [
                        patient.address ? (openBlock(), createElementBlock("p", _hoisted_15, [
                        ...
                        patient.phone ? (openBlock(), createElementBlock("p", _hoisted_16, [
...
const FindRegisterPatient = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9ece36d"]]);
