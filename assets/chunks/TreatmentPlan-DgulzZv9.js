import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, T as Toolbar, t as toastWarning, G as toastSuccess } from '../index-b5KMun-7.js';
import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, O as createBlock, aL as useRouter, f0 as provide, B as withCtx, aG as IonContent, bu as IonPage } from './vendor-CjPalcaW.js';
import { m as neonatalTreatmentPlanSections, e as neonatalTreatmentPlanFormKey, L as useTreatmentPlanStore, N as NeonatalStepper } from './NeonatalStepper-Cog00SLF.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const syncForPatient = () => {
      treatmentStore.initializeForRawPatientId(patient.value?.patientID);
    };
    syncForPatient();
    watch(
    ...
    const getSaveFnForStep = (currentIndex) => {
      ...
      return async () => {
        ...
        const saveResult = await treatmentStore.saveAssessment(patientId);
        if (!saveResult.ok) {
