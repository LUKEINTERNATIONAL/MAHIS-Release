import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, bK as IonCard, aL as useRouter, O as createBlock, aG as IonContent, C as createBaseVNode, bX as chevronBackOutline, bu as IonPage, f as ref } from './vendor-C-pvji42.js';
import { n as icons, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-Bs77YW3d.js';
    ...
    return [
      {
        ...
        validation: (value) => requiredField(value, "Maternal Blood Group"),
        options: [
          { label: "A", value: "A" },
          { label: "B", value: "B" },
          { label: "AB", value: "AB" },
      ...
      { componentType: "Dashes", grid: { s: "12" } },
      {
        ...
        name: "Maternal Rhesus Factor",
        type: "inline",
        obsValueType: "value_coded",
        validation: (value) => requiredField(value, "Maternal Rhesus Factor"),
        options: [
