import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, aD as IonContent, bs as IonPage, aI as useRouter, eT as provide, v as resolveComponent, N as createBlock, B as withCtx, A as createBaseVNode } from './vendor-DGIzCW4f.js';
import { s as storeToRefs } from './pinia-Bmkga1nW.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore } from '../index-D_1ZD1MC.js';
import { k as neonatalAdmissionSignOffSections, j as neonatalAdmissionOutcomesFormKey, N as NeonatalStepper } from './NeonatalStepper-gJVDjU6C.js';
import { A as AdmissionProgressBar } from './AdmissionProgressBar-CGvBMbno.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-CcZ--aqv.js';
import { P as PrintSummarySection, u as useNeonatalAdmissionOutcomesStore } from './useNeonatalAdmissionOutcomesStore-CDyD-3En.js';
...
const AdmissionSignOff = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b6e6d1fe"]]);
