import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, c as computed, x as resolveComponent, O as createBlock, B as withCtx, H as createCommentVNode, ck as onBeforeUnmount, a5 as createTextVNode, L as IonIcon, N as IonButton, aF as IonContent, bt as IonPage, aK as useRouter, cu as useRoute, fb as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eU as provide } from './vendor-BIA1Qh8a.js';
import { s as storeToRefs } from './pinia-BgytB2RM.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cl as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ch as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-BKtQ6Cec.js';
import { D as DemographicBar } from './DemographicBar-DBYkBcdj.js';
import { p as neonatalTriageSections, q as neonatalTriageFormKey, f as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, r as defaultNeonatalTriageForm } from './NeonatalStepper-LV_lO9WA.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-B-qZlvMB.js';
