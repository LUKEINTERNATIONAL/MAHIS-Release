import { v as defineComponent, w as watch, z as openBlock, P as createBlock, G as unref, bL as IonCard, C as withCtx, B as createVNode, b9 as IonCardTitle, d_ as IonSkeletonText, A as createElementBlock, M as IonIcon, aR as medicalOutline, a6 as createTextVNode, K as Fragment, ba as IonCardHeader, ao as IonList, S as renderList, ap as IonItem, a8 as IonLabel, b7 as calendarOutline, D as createBaseVNode, E as toDisplayString, cK as idCardOutline, c8 as folderOutline, c5 as checkmarkCircleOutline, bc as IonCardContent, f as ref, q as dayjs, a3 as onMounted, aA as IonGrid, ag as IonRow, az as IonCol, a5 as normalizeClass, d$ as checkboxOutline, J as createCommentVNode, ca as clipboardOutline, e0 as statsChartOutline, L as modalController, aK as useRouter, cv as useRoute, y as resolveComponent, aF as IonContent, e1 as ellipsisVerticalSharp, d4 as person, aH as IonAccordionGroup, aG as IonAccordion, Q as normalizeStyle, H as closeCircleOutline, di as IonSegment, dj as IonSegmentButton, a_ as personOutline, x as documentTextOutline, b0 as printOutline, d5 as add, bu as IonPage, cT as defineAsyncComponent, cJ as __vitePreload, c as computed } from './vendor-Cbv9TWZo.js';
import { s as storeToRefs } from './pinia-C6LE2xz6.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, ab as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-BHF9kXfk.js';
...
import { i as isTaskPermitted } from './tasks-D_Ygk6Og.js';
import { A as ANCRedirection } from './anc_service-BLB_J5Ru.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-gShbAHdJ.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-CFgoas7z.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-Bx9gQdDr.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-DHEAlMjS.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-Dc6beS0u.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-CUPytt-y.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-ujC8T9e8.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-D-Nv4s9I.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-0XUzfCMC.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-DMs5EyUg.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-Bg9qHt8o.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-BHF9kXfk.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-B3Y8Vgxb.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-C8-UGLKi.js'),true              ?[]:void 0));
...
const PatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d1f85bef"]]);
