import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bM as IonCard, B as withCtx, A as createVNode, bb as IonCardTitle, d_ as IonSkeletonText, z as createElementBlock, L as IonIcon, aT as medicalOutline, a5 as createTextVNode, J as Fragment, bc as IonCardHeader, ap as IonList, S as renderList, aq as IonItem, a7 as IonLabel, b9 as calendarOutline, C as createBaseVNode, D as toDisplayString, cJ as idCardOutline, c8 as folderOutline, c5 as checkmarkCircleOutline, be as IonCardContent, f as ref, p as dayjs, a3 as onMounted, aC as IonGrid, af as IonRow, aB as IonCol, Q as normalizeClass, d$ as checkboxOutline, H as createCommentVNode, ca as clipboardOutline, e0 as statsChartOutline, K as modalController, aM as useRouter, v as documentTextOutline, c as computed, bN as useRoute, aH as IonContent, e1 as ellipsisVerticalSharp, d3 as person, aJ as IonAccordionGroup, aI as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, al as IonPopover, b0 as personOutline, b2 as printOutline, d4 as add, bw as IonPage, cS as defineAsyncComponent, cI as __vitePreload } from './vendor-XNfOCpdb.js';
import { s as storeToRefs } from './pinia-CtfxbWof.js';
import { ak as ProgramService, _ as _export_sfc, P as PatientService, al as PatientProgramService, ac as GlobalPropertyService, r as StandardModal, o as createModal, am as _sfc_main$5, an as ArtTasks, u as useDemographicsStore, F as DynamicButton, K as ObservationService, b as EncounterTypeId, G as toastSuccess, H as HisDate, ao as router, a as useProgramStore, h as useWindowSize, T as Toolbar, L as ProgramId, S as Service, ap as iconBMI, k as alertConfirmation, aq as openVisit, q as usePatientList, v as closeVisit, t as toastWarning, ar as SetProgramService, M as ConceptService, as as getActiveVisit } from '../index-DjgSdAC3.js';
import { u as useUserActivities } from './useUserActivities-BT68ZrNz.js';
import { u as usePatientProfile } from './usePatientProfile-BHnO0lpm.js';
import { D as DemographicBar } from './DemographicBar-C6xRBdRR.js';
import { i as isTaskPermitted } from './tasks-DjKEKzuL.js';
import { E as EnrollmentService, A as ANCRedirection } from './anc_service-CGZVLsIM.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-CNGz3ifU.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BoLUJvDc.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BWSB0-yS.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-DOLPJFH5.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CFFwD_Jz.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-Bv_YIZS7.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-CbV_kkld.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-vUmegRGD.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-DJt0lHXz.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-Djk_LfqS.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-jCTFKO3b.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-DjgSdAC3.js').then(n => n.cU),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DjCWs-T0.js'),true              ?[]:void 0));
    const router = useRouter();
