import { S as Service, H as HisDate, ai as ProgramService, W as ProgramId, aY as AppEncounterService, b as EncounterTypeId, K as ObservationService } from '../index-Di9oihr7.js';
import { f as feedingModeLabels, a as feedingFrequencyLabels, b as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, c as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, d as umbilicalConditionLabels } from './reviewOfSystemsLabels-DyMLDdTa.js';
...
const TYPE_OF_FEED_CONCEPT_MAP = {
  formula: "FORMULA FEEDS",
  breast_milk: "BREASTFEEDING",
  mixed_feeds: "MIXED FEEDING"
};
const resolveTypeOfFeedConceptName = (rawValue) => {
  ...
  const mapped = TYPE_OF_FEED_CONCEPT_MAP[normalized];
  if (!mapped) {
...
class NeonatalService extends Service {
  ...
  static async buildSystemicExaminationObservations(data, date) {
    ...
    await pushCoded("Moro reflex", resolveMappedLabel(data.MoreReflex, MoreReflexLabels));
  ...
  static async buildReviewOfSystemsObservations(data, date) {
    ...
    await pushCoded("Type of feed", resolveTypeOfFeedConceptName(data.type_of_feed));
  ...
  static async buildAdmissionOutcomesObservations(data, date) {
    ...
    await pushText("Admission outcome other", data.admissionOutcomeOther);
...
export { MoreReflexLabels as M, NeonatalService as N, suckReflexLabels as a, graspReflexLabels as g, musculoskeletalDeformityLabels as m, skinFindingLabels as s, toneAssessmentLabels as t };
