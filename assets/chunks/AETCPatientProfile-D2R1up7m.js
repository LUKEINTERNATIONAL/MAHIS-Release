import { s as defineComponent, aM as useRouter, bN as useRoute, a3 as onMounted, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aH as IonContent, H as createCommentVNode, C as createBaseVNode, af as IonRow, aB as IonCol, bM as IonCard, be as IonCardContent, L as IonIcon, e1 as ellipsisVerticalSharp, Q as normalizeClass, d3 as person, D as toDisplayString, a5 as createTextVNode, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, a7 as IonLabel, z as createElementBlock, P as normalizeStyle, aq as IonItem, b0 as personOutline, v as documentTextOutline, cJ as idCardOutline, b2 as printOutline, J as Fragment, S as renderList, d4 as add, bw as IonPage, cS as defineAsyncComponent, cI as __vitePreload, f as ref, c as computed } from './vendor-CZkQjgFf.js';
import { s as storeToRefs } from './pinia-CBCkT7wa.js';
import { A as ArtCard } from './PatientProfile-CifXVi_g.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ar as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, ap as iconBMI, k as alertConfirmation, aq as openVisit, q as usePatientList, G as toastSuccess, v as closeVisit, cQ as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-HUvHuTRi.js';
...
import { C as CPR } from './CPR-C5O04mvh.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-uIwpiyaX.js'),true              ?[]:void 0));
