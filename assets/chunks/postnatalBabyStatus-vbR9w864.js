import { c as computed, s as defineComponent, aN as useRouter, a3 as onMounted, w as watch, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aI as IonContent, C as createBaseVNode, b$ as chevronBackOutline, N as IonButton, L as IonIcon, f6 as linkOutline, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, H as createCommentVNode, bh as IonFooter, bx as IonPage, f as ref, n as nextTick } from './vendor-QOXikrLM.js';
import { n as icons, u as useDemographicsStore, T as Toolbar, F as DynamicButton, z as StandardForm, b7 as RelationshipService, o as createModal, t as toastWarning, G as toastSuccess, K as ObservationService, b as EncounterTypeId, _ as _export_sfc } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-CJCz3Bta.js';
import { B as BabyCard } from './BabyCard-DRIB8cRj.js';
import { L as LinkBabyModal } from './LinkBabyModal-CfCBjmky.js';
