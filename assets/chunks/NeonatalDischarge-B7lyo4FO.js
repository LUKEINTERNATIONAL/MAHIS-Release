import { s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, a4 as normalizeClass, A as createVNode, F as unref, d3 as person, L as IonIcon, D as toDisplayString, a5 as createTextVNode, f as ref, c as computed, h as inject, w as watch, O as createBlock, M as IonSpinner, Q as alertCircleOutline, N as IonButton, B as withCtx, a_ as medkitOutline, J as Fragment, R as renderList, H as createCommentVNode, eT as chevronUpOutline, a9 as chevronDownOutline, a3 as onUnmounted, aS as medicalOutline, b8 as calendarOutline, bU as trashOutline, bB as createStaticVNode, ab as checkmarkOutline, ck as onBeforeUnmount, S as withDirectives, T as vShow, cA as E, bF as QRCode, cB as autoTable, aG as IonContent, bu as IonPage, aL as useRouter, b1 as printOutline, eU as provide, x as resolveComponent } from './vendor-DlXvc2CI.js';
import { s as storeToRefs } from './pinia-DxIh5T-z.js';
import { u as useDemographicsStore, ci as InputField, H as HisDate, P as PatientService, _ as _export_sfc, K as ObservationService, z as StandardForm, bH as DrugOrderService, cj as SearchableDropdown, ck as DateInputField, a6 as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-Di9oihr7.js';
import { N as NeonatalService } from './neonatal_service-DoReqTZ5.js';
import { D as DemographicBar } from './DemographicBar-CSfXd-qY.js';
import { h as getDischargeSectionByName, i as neonatalDischargeFormKey, j as neonatalDischargeSections, k as neonatalAdmissionOutcomesFormKey, l as useNeonatalDischargeStore, N as NeonatalStepper, m as getDischargeSectionIndexByName } from './NeonatalStepper-BgQrfyga.js';
import { u as useAdmissionSignOff, n as neonatalAdmissionSignOffSections } from './useAdmissionSignOff-C-VKVhx0.js';
...
const _hoisted_2$6 = { class: "detail-row" };
const _hoisted_3$5 = { class: "detail-value status-value" };
const _hoisted_4$5 = { class: "detail-row" };
const _hoisted_5$4 = { class: "weight-box" };
const _hoisted_6$3 = { class: "weight-value" };
const _hoisted_7$3 = { class: "weight-date" };
const _hoisted_8$3 = { class: "section-subtitle" };
        ...
        createBaseVNode("div", _hoisted_1$9, [
          ...
          createBaseVNode("div", _hoisted_4$5, [
            ...
            createBaseVNode("div", _hoisted_5$4, [
              createBaseVNode("span", _hoisted_6$3, toDisplayString(birthWeight.value ? birthWeight.value + " kg" : "..."), 1),
              _cache[1] || (_cache[1] = createBaseVNode("span", { class: "weight-separator" }, "|", -1)),
              createBaseVNode("span", _hoisted_7$3, "Date: " + toDisplayString(birthDate.value || "..."), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_8$3, toDisplayString(unref(sectionConfig).subtitle), 1)
        ]),
...
const DischargeVitals = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-29459625"]]);
