import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, bd as IonCardHeader, B as withCtx, L as IonIcon, aw as searchOutline, cF as IonCardSubtitle, a5 as createTextVNode, bc as IonCardTitle, bf as IonCardContent, bW as IonSearchbar, N as IonButton, bo as chevronForward, J as Fragment, S as renderList, D as toDisplayString, H as createCommentVNode, cQ as closeCircle, f as ref, c as computed, a3 as onMounted, n as nextTick, O as createBlock, aN as useRouter, bO as useRoute, ac as IonNote, ey as qrCode, bJ as addOutline, eB as callOutline, b$ as chevronBackOutline, dh as chevronForwardOutline, fy as barcode, ba as calendarOutline, G as closeCircleOutline, f6 as linkOutline, Q as normalizeClass, cp as refreshOutline, dg as gridOutline, b9 as listOutline, R as alertCircleOutline, bD as createStaticVNode, aI as IonContent, bx as IonPage, f3 as provide, x as resolveComponent } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { u as useDemographicsStore, D as PatientSearchService, cl as Banner, S as Service, P as PatientService, _ as _export_sfc, Y as LocationService, z as StandardForm, N as ConceptService, K as ObservationService, b as EncounterTypeId, t as toastWarning, H as HisDate, o as createModal, r as StandardModal, cn as infoAlert, T as Toolbar, a9 as RelationsService, as as SetProgramService, G as toastSuccess, x as toastDanger } from '../index-SKNIAGXC.js';
import { N as NeonatalService } from './neonatal_service-Ba63sn1T.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { i as neonatalEnrollmentSections, r as neonatalEnrollmentSectionIndex, v as validateNeonatalEnrollmentBirthWeight, s as hasDataFromMnh, t as extractOptionValue, w as normalizeTextValue, x as extractMultiSelectValues, y as motherEnrollmentRules, N as NeonatalStepper } from './NeonatalStepper-DJUdVdam.js';
...
import { r as resolveNeonatalBirthWeightInGrams } from './neonatalBirthWeightPrefill-BxG_la5K.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-DaubbYIE.js';
import { S as SummarySection } from './SummarySection-CPWH6ohz.js';
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function prefillBirthWeightFromTriage() {
      ...
      try {
        const weightInGrams = await resolveNeonatalBirthWeightInGrams(patientId, patient.value);
        if (weightInGrams == null) return;
        const weightString = Math.round(weightInGrams).toString();
        if (enrollmentForm) {
    ...
    const enrichedFormData = computed(() => {
      return formData.value.map((field) => {
        ...
        if (field.name === "birthWeight" && field.componentType === "Banner") {
          return {
            ...field,
            condition: (formValues) => {
              ...
              return {
                title: "Birth weight (grams)",
                message: bw ? `${bw} g — captured from neonatal triage` : "Birth weight will appear here after it is captured in neonatal triage (vital signs).",
                backgroundColor: field.backgroundColor,
                textColor: field.textColor
              };
            }
    ...
    __expose({
      ...
      validateForm: () => {
        ...
        const birthWeightErr = validateNeonatalEnrollmentBirthWeight(enrollmentForm?.birthWeight);
        const birthWeightErrors = birthWeightErr ? { birthWeight: birthWeightErr } : null;
        const errors = [twinQuestionErrors, formErrors, twinErrors, birthWeightErrors].filter(Boolean);
...
const BirthDetails = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-aed1cff7"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const syncFormValues = (values) => {
      ...
      enrollmentForm.motherOnArt = values.motherOnArt || "";
      ...
      enrollmentForm.babyGiven2p = values.babyGiven2p || "";
...
const MotherEnrollmentDetails = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4f4c9a66"]]);
