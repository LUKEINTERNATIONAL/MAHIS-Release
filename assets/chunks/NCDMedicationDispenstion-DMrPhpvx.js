...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getMedicationDuration = (medication) => {
      if (!medication.start_date || !medication.expire_date) return "N/A";
      const start = new Date(medication.start_date);
      const end = new Date(medication.expire_date);
...
const NCDMedicationDispenstion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-209b4cd9"]]);
