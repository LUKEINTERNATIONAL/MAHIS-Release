import { q as defineComponent, r as ref, w as watch, N as createBlock, y as openBlock, E as unref, bJ as IonCard, B as withCtx, z as createVNode, b7 as IonCardTitle, x as createElementBlock, dY as IonSkeletonText, a4 as createTextVNode, K as IonIcon, aP as medicalOutline, H as Fragment, b8 as IonCardHeader, am as IonList, Q as renderList, an as IonItem, a6 as IonLabel, b5 as calendarOutline, A as createBaseVNode, C as toDisplayString, cI as idCardOutline, c6 as folderOutline, c3 as checkmarkCircleOutline, ba as IonCardContent, l as dayjs, a1 as onMounted, ax as IonGrid, ae as IonRow, ay as IonCol, a3 as normalizeClass, dZ as checkboxOutline, G as createCommentVNode, c8 as clipboardOutline, d_ as statsChartOutline, J as modalController, aI as useRouter, ct as useRoute, d as computed, v as resolveComponent, aD as IonContent, cP as defineAsyncComponent, d$ as ellipsisVerticalSharp, d2 as person, aF as IonAccordionGroup, aE as IonAccordion, O as normalizeStyle, F as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, aY as personOutline, s as documentTextOutline, a_ as printOutline, d3 as add, bs as IonPage, cH as __vitePreload } from './vendor-wM1cIaYi.js';
import { s as storeToRefs } from './pinia-Czqxf__w.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, aa as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, M as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-I4g3KlCH.js';
import { u as useUserActivities } from './useUserActivities-C95l7aWo.js';
...
import { i as isTaskPermitted } from './tasks-DdiJerLv.js';
import { A as ANCRedirection } from './anc_service-D_4aiutB.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-Dxd1Zhbd.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-74nZwFE9.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CmSWKdKK.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-D6UumJRi.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-aaLX2wno.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-DcM7-_PN.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-5mgt47qu.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-CXB2WI2I.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-D0i_nK0N.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-86jC9TOl.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-7LCp6nSi.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-I4g3KlCH.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-CG5TbNQg.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-CVtTsX8G.js'),true              ?[]:void 0));
