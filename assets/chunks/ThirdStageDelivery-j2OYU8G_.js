  ...
  const deliveryNewbornDetailsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        offset: "1",
        condition: (formValues) => {
          return !isStillbirth(formValues) && !isNeonatalDeath(formValues) && formValues["Mode of delivery"] == "Other mode of delivery";
        }
      },
      {
        componentType: "Dashes",
