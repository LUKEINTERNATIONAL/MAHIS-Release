import { s as defineComponent, L as IonIcon, N as IonButton, aA as IonCol, af as IonRow, aB as IonGrid, bd as IonCardContent, ba as IonCardTitle, bb as IonCardHeader, bK as IonCard, aD as IonToolbar, aE as IonTitle, bu as IonPage, I as IonHeader, aG as IonContent, cN as openOutline, dW as ribbonOutline, dX as schoolOutline, dY as briefcaseOutline, aW as heartOutline, b8 as calendarOutline, v as documentTextOutline, ao as informationCircleOutline, b0 as locationOutline, a$ as personOutline, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, J as Fragment, R as renderList, a5 as createTextVNode, D as toDisplayString, P as normalizeStyle, O as createBlock, H as createCommentVNode, a4 as normalizeClass, ct as useRoute, a2 as onMounted, w as watch, S as withDirectives, F as unref, ax as searchOutline, T as vShow, bf as IonFooter, f as ref, r as reactive } from './vendor-CIi-jrCy.js';
import { N as NavigationMenu } from './NavigationMenu-COIpWRye.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { E as EIRreportsStore } from './EIRreportsStore-WDPEonHq.js';
import { P as PatientService, u as useDemographicsStore, _ as _export_sfc, a6 as useUserStore, B as BasicInputField } from '../index-CPakPmy3.js';
