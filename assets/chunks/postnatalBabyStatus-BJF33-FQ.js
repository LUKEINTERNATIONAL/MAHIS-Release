import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, b0 as personOutline, f as ref, K as modalController, aM as useRouter, a3 as onMounted, w as watch, aH as IonContent, b_ as chevronBackOutline, N as IonButton, L as IonIcon, f4 as linkOutline, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, H as createCommentVNode, bg as IonFooter, bw as IonPage, n as nextTick } from './vendor-XNfOCpdb.js';
import { n as icons, u as useDemographicsStore, z as StandardForm, F as DynamicButton, r as StandardModal, t as toastWarning, b6 as RelationshipService, J as savePatientRecord, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, o as createModal } from '../index-DjgSdAC3.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function onSubmit() {
      ...
      const savedPnc = await ObservationService.buildSaveRelativeObs(patient, pncData, EncounterTypeId.PNC_VISIT);
...
const postnatalBabyStatus = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ce6a6969"]]);
