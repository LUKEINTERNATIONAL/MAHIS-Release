import { O as OrderService, bs as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bt as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, bc as SelectionPopover, S as Service, g as getPouchDBRecords, aq as ConceptService, bo as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bu as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bv as ADULT_WHO_STAGE_CRITERIA, bw as CHILD_WHO_STAGE_CRITERIA, bx as ADULT_ART_ELIGIBILITY, by as CHILD_ART_ELIGIBILITY, bz as RECOMMENDED_ADULT_STAGING_CONDITIONS, bA as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bB as BasicYesNoSelect, bC as BasicDateInput, bD as BasicSelect, bE as BasicInput, bF as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, r as StandardModal, a2 as getFieldValue, b7 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-BcjCT4MQ.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-DUPmLFD0.js';
import LabOrdersList from './LabOrdersList-BzxmPGUo.js';
import { v as validateInputFiledData } from './group_validation-DC1dprJL.js';
import { u as useRadiologyStore } from './RadiologyStore-DA36CEtM.js';
import { B as BasicForm } from './BasicForm-C4xbIyk4.js';
import { s as defineComponent, a2 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, R as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, br as pulseOutline, bc as checkmark, a5 as createTextVNode, c as computed, bK as IonCard, aB as IonGrid, af as IonRow, aA as IonCol, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, D as toDisplayString, bO as IonChip, ae as IonCheckbox, by as IonText, bd as IonCardContent, r as reactive, p as dayjs, aL as useRouter, ct as useRoute, S as withDirectives, T as vShow, K as modalController } from './vendor-74dOmGLc.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-C8ep-Z16.js';
import { D as DashBox } from './DashBox-T1Yh3rqX.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-n8058H5j.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-DPxbEFWE.js';
import { P as PatientComplaintsService } from './patient_complaints_service-D-t35ixS.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-DwW-7eqF.js';
import { i as isClinician } from './Registration-Be5adnnq.js';
