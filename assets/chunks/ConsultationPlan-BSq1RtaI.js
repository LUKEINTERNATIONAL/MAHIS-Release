...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, br as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bo as useInvestigationStore, b$ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bI as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, c0 as resetOPDPatientData, bL as StagesService, q as usePatientList, v as closeVisit } from '../index-CJh5hefu.js';
import { D as DemographicBar } from './DemographicBar-D1ctsQ0E.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-D9ADyPGB.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-DcnuBSRI.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-C9T1Lgr0.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-COssD_Tx.js';
import { I as Investigations } from './Investigations-CwelYtHt.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-v0s3y4zX.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-B3r9CJPC.js';
import { P as PreviousTreatment } from './treatment-C3v7j5vj.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-AKrlGXB6.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DIreb1mi.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CrVmX0EC.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-PWEzJ2c0.js';
