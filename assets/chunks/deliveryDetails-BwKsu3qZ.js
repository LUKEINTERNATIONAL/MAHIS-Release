import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, C as createBaseVNode, bM as IonCard, f as ref, aM as useRouter, a3 as onMounted, O as createBlock, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-NYNX75Tj.js';
import { _ as _sfc_main$2, u as useFormWizard } from './useFormWizard-CPfmUxeA.js';
import { n as icons, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton, t as toastWarning } from '../index-DRy1cgfg.js';
import { D as DemographicBar } from './DemographicBar-auLXyZQi.js';
import { S as SecondStageDelivery, T as ThirdStageDelivery } from './ThirdStageDelivery-DuVTm4XL.js';
...
const useMaternalObstetricEmergencyComplications = () => {
  ...
  const maternalObstetricEmergencyComplicationsFormSection = computed(() => {
    return [
      {
        componentType: "Slot",
        slotName: "complications_subtitle",
        grid: { xs: "12" }
      },
      {
      ...
      },
      {
        ...
        unit: "mls",
        validation: (value) => {
          if (isNaN(value)) return "IV fluids volume must be a number";
          if (value < 0) return "IV fluids volume must be greater than 0";
          if (value > 5e3) return "IV fluids volume must be less than 5000";
          return null;
        },
        grid: { xs: "12" },
        condition: (formValues) => formValues["Requires IV fluids"] === "Yes"
      },
      {
        componentType: "Dashes",
        grid: { s: "12" }
      ...
      {
        componentType: "Slot",
        slotName: "preeclampsia_eclampsia",
        grid: { xs: "12" }
      },
      {
        componentType: "radioButtonField",
      ...
      {
        componentType: "Slot",
        slotName: "retained_products_of_conception",
        grid: { xs: "12" }
      },
      {
        componentType: "radioButtonField",
      ...
      {
        componentType: "inputField",
        name: "_other retained products of conception",
        icon: icons.editPen,
        validation: (value) => {
          if (value === "" || value === null || value === void 0) return null;
          if (!isNaN(Number(value))) return "Value must be a text";
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      if (await ObservationService.buildSaveObs(data, EncounterTypeId.Labour_and_delivery_visit))
        toastSuccess("Obstetric Complications data saved successfully");
            ...
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ...
                  complications_subtitle: withCtx(() => [..._cache[0] || (_cache[0] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Maternal Obstetric Emergency Complications (Postpartum Hemorrhage)", -1)
                  ])]),
                  oxytocic_drugs: withCtx(() => [..._cache[1] || (_cache[1] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Oxytocic Drugs", -1)
                  ])]),
                  management_subtitle: withCtx(() => [..._cache[2] || (_cache[2] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Management", -1)
                  ])]),
                  preeclampsia_eclampsia: withCtx(() => [..._cache[3] || (_cache[3] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Preeclampsia/Eclampsia", -1)
                  ])]),
                  ruptureduterus: withCtx(() => [..._cache[4] || (_cache[4] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Ruptured Uterus", -1)
                  ])]),
                  retained_products_of_conception: withCtx(() => [..._cache[5] || (_cache[5] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Retained Products of Conception", -1)
                  ])]),
                  examination_subtitle: withCtx(() => [..._cache[6] || (_cache[6] = [
                    createBaseVNode("div", { class: "section-subtitle" }, "Examination and Escalation", -1)
                  ])]),
                  _: 1
                }, 8, ["form-data"])
              ]),
...
const ObstetricComplications = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d056d7aa"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const saveData = async () => {
      isSaving.value = true;
      try {
        const componentRefs = [secondStageDeliveryRef.value, thirdStageDeliveryRef.value, obstetricComplications.value];
        for (let i = 0; i < componentRefs.length; i++) {
          const compRef = componentRefs[i];
          if (!compRef || typeof compRef.validateForm !== "function") continue;
