...
import { q as defineComponent, aI as useRouter, r as ref, a1 as onMounted, w as watch, x as createElementBlock, y as openBlock, A as createBaseVNode, z as createVNode, E as unref, ax as IonGrid, B as withCtx, ae as IonRow, ay as IonCol, bJ as IonCard, N as createBlock, G as createCommentVNode, bH as IonBadge, a4 as createTextVNode, C as toDisplayString, ba as IonCardContent, du as IonImg, bw as IonText, d as computed, v as resolveComponent, a3 as normalizeClass, d2 as person, e0 as ellipsisVerticalSharp, aF as IonAccordionGroup, aE as IonAccordion, an as IonItem, a6 as IonLabel, am as IonList, as as IonToggle, bm as IonPopover } from './vendor-DUNDjU_C.js';
...
import { u as useDemographicsStore, b as EncounterTypeId, E as EncounterService, t as toastWarning, _ as _export_sfc, l as PreviousVitals, o as createModal, q as StandardModal, bq as LabOrderService, S as Service, K as ObservationService, H as HisDate, P as PatientService } from '../index-77Br-hAb.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(
      ...
      (path) => {
        if (path.includes("/neonatal/patient-profile") || path === "/patientProfile") {
          loadNextEncounterBadge();
        }
      }
    );
...
const NeonatalCare = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-74c591a4"]]);
...
const NeonatalPatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9a5ec97e"]]);
