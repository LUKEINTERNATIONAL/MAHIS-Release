import { s as defineComponent, aC as IonToolbar, aD as IonTitle, aE as IonMenu, ao as IonList, ap as IonItem, I as IonHeader, aF as IonContent, K as modalController, bq as pulseOutline, bb as checkmark, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, bo as V, ak as IonPopover, a6 as IonInput, B as withCtx, a5 as createTextVNode, J as Fragment, cu as useRoute, w as watch, a2 as onMounted, n as nextTick, R as renderList, D as toDisplayString, F as unref, f as ref, c_ as DataTable, aK as useRouter, L as IonIcon, a7 as IonLabel, bO as IonChip, az as IonCol, af as IonRow, bt as IonPage, cv as IonMenuButton, aZ as medkitOutline, O as createBlock, a4 as normalizeClass, H as createCommentVNode, bK as IonCard, aw as searchOutline, ae as IonCheckbox, bc as IonCardContent, b9 as IonCardTitle, N as IonButton, ba as IonCardHeader, b5 as cubeOutline, G as closeCircleOutline, Q as alertCircleOutline, dc as timeOutline, er as moon, es as partlySunny, et as sunny, ci as medkit, c as computed, at as script, be as IonFooter, aH as IonAccordionGroup, aG as IonAccordion, c9 as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, bX as chevronBackOutline, S as withDirectives, T as vShow, ab as checkmarkOutline } from './vendor-Wwszy5sF.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-BYnbfcrK.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$g, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DTh6TpA9.js';
import { D as DemographicBar } from './DemographicBar-BtFCG8jJ.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BG-Zur0d.js';
import { D as DashBox } from './DashBox-DqWxxpZS.js';
import { B as BasicForm } from './BasicForm-CY01_oNC.js';
import { l as lodashExports } from './lodash-aZqQi0CK.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-B6_MBT_Q.js';
import { v as validateInputFiledData } from './group_validation-DgXR9NzQ.js';
import { u as useComplicationsStore } from './ComplicationsStore-DVhYZh63.js';
import { I as Investigations, _ as _sfc_main$j, i as isQualifiedAHD } from './Investigations-BqYQ5z-w.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-Bsm2kBLY.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DqWrydyd.js';
import { _ as _sfc_main$i } from './RiskAssessment.vue_vue_type_script_setup_true_lang-CFDiuUqm.js';
import { V as Vitals } from './Vitals-BjzZmIix.js';
import { _ as _sfc_main$h } from './Wizard.vue_vue_type_script_setup_true_lang-BZFuESOB.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-Kt1Sp1Dd.js';
import { u as useFormWizard } from './useFormWizard-BvRDETn8.js';
import { u as usePatientProfile } from './usePatientProfile-DKTvf1Se.js';
