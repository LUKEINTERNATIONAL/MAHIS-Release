import { q as defineComponent, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, a3 as normalizeClass, c as computed, z as createVNode, E as unref, d2 as person, K as IonIcon, C as toDisplayString, a4 as createTextVNode, f as ref, h as inject, w as watch, N as createBlock, a2 as onUnmounted, G as createCommentVNode, H as Fragment, Q as renderList, aP as medicalOutline, b5 as calendarOutline, bS as trashOutline, bz as createStaticVNode, aa as checkmarkOutline, cj as onBeforeUnmount, R as withDirectives, S as vShow, cz as E, bD as QRCode, cA as autoTable, M as IonButton, aD as IonContent, bs as IonPage, aI as useRouter, a_ as printOutline, eT as provide, v as resolveComponent, B as withCtx } from './vendor-xvx_X2hj.js';
import { s as storeToRefs } from './pinia-CiVhHi9d.js';
import { u as useDemographicsStore, cj as InputField, H as HisDate, P as PatientService, _ as _export_sfc, K as ObservationService, C as StandardForm, ck as SearchableDropdown, cl as DateInputField, ab as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-D5ZuGc-h.js';
import { N as NeonatalService } from './neonatal_service-CIYqdGKj.js';
import { D as DemographicBar } from './DemographicBar-B8N8L6LG.js';
import { g as neonatalDischargeFormKey, h as neonatalDischargeSections, i as neonatalAdmissionOutcomesFormKey, j as neonatalAdmissionSignOffSections, k as useNeonatalDischargeStore, N as NeonatalStepper } from './NeonatalStepper-j7YfAMMr.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-D1ZMDyQg.js';
