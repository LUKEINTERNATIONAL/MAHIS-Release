...
import { u as useDemographicsStore, bb as useInvestigationStore, bW as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-BaBlba8w.js';
import { D as DemographicBar } from './DemographicBar-_xoIVYXa.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-D_g2mWd8.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-CJfDXfxt.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CYMqMJlK.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-D9i2H-7w.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CydLFJuR.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Cnzp4EcC.js';
