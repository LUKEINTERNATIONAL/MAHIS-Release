import { y as StandardValidations, n as icons, z as StandardForm, K as ObservationService, H as HisDate, ar as ConceptService, _ as _export_sfc } from '../index-DPst19NB.js';
import { c as computed, s as defineComponent, a3 as onMounted, n as nextTick, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, f as ref } from './vendor-BRtiyW5a.js';
...
function useLabourQuickCheckForm() {
  ...
  const reasonForComingOptions = [
    { label: "In labour", value: "In labour", exclusive: true },
    { label: "Delivered on the way to the facility", value: "Delivered", exclusive: true },
    { label: "Elective CS", value: "Elective CS" },
    { label: "Pre-eclampsia/eclampsia", value: "Pre-eclampsia/eclampsia" },
    { label: "Preterm labour", value: "Preterm labour", exclusive: true },
    ...
    { label: "Home Delivery ", value: "Home Delivery", exclusive: true },
  ...
  const quickCheckForm = computed(() => {
    return [
      ...
      },
      {
        ...
        name: "Specify other medical condition",
        obsValueType: "value_text",
        icon: icons.editPen,
        validation: StandardValidations.required,
        grid: { s: "8" },
        condition: (formValues) => Array.isArray(formValues?.["What is the reason for coming to the facility"]) && formValues["What is the reason for coming to the facility"].includes("Other medical/obstetric conditions")
      },
      ...
      },
      {
        ...
        name: "Has she had food in 4 hours",
        obsValueType: "value_coded",
        type: "inline",
        condition: (formValues) => hasSelected(formValues?.reason, "In labour"),
        options: [
...
const LabourQuickCheck = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de7ee028"]]);
