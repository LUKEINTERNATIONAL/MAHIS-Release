import { v as defineComponent, h as inject, w as watch, f as ref, z as createElementBlock, A as openBlock, B as createVNode, G as unref, K as Fragment, S as renderList, C as createBaseVNode, E as toDisplayString, c as computed, y as resolveComponent, P as createBlock, D as withCtx, J as createCommentVNode, ah as close, M as IonIcon, R as alertCircleOutline, a6 as createTextVNode, O as IonButton, cl as onBeforeUnmount, aF as IonContent, bu as IonPage, aK as useRouter, cv as useRoute, fg as onIonViewWillEnter, bY as chevronBackOutline, r as reactive, eV as provide } from './vendor-B4fW45I4.js';
import { s as storeToRefs } from './pinia-ClrgJtgl.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-C9DqaTYI.js';
import { D as DemographicBar } from './DemographicBar-CyYoXIEa.js';
import { l as neonatalTriageSections, m as neonatalTriageFormKey, o as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, p as defaultNeonatalTriageForm } from './NeonatalStepper-CKzmBNKc.js';
