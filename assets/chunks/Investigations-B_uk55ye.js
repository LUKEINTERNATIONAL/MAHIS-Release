import { O as OrderService, bq as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, br as getCheckboxSelectedValue, aW as modifyRadioValue, a3 as modifyFieldValue, aY as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, b0 as List, B as BasicInputField, bs as SelectionPopover, S as Service, g as getPouchDBRecords, N as ConceptService, bl as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aZ as AppEncounterService, Y as LocationService, bt as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bu as ADULT_WHO_STAGE_CRITERIA, bv as CHILD_WHO_STAGE_CRITERIA, bw as ADULT_ART_ELIGIBILITY, bx as CHILD_ART_ELIGIBILITY, by as RECOMMENDED_ADULT_STAGING_CONDITIONS, bz as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bA as BasicYesNoSelect, bB as BasicDateInput, bC as BasicSelect, bD as BasicInput, bE as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, ac as useConfigStore, r as StandardModal, a4 as getFieldValue, a$ as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-Bn2sysQf.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-Drf8jDfn.js';
import LabOrdersList from './LabOrdersList-nWlc0PR0.js';
import { v as validateInputFiledData } from './group_validation-CeC_kYzU.js';
import { u as useRadiologyStore } from './RadiologyStore-C33bGRoR.js';
import { B as BasicForm } from './BasicForm-DVQSxZ-F.js';
import { s as defineComponent, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aI as IonContent, bu as pulseOutline, be as checkmark, a5 as createTextVNode, c as computed, bN as IonCard, aC as IonGrid, af as IonRow, aB as IonCol, aK as IonAccordionGroup, aJ as IonAccordion, a7 as IonLabel, D as toDisplayString, bS as IonChip, ae as IonCheckbox, bB as IonText, bf as IonCardContent, r as reactive, p as dayjs, aN as useRouter, bO as useRoute, T as withDirectives, U as vShow, K as modalController } from './vendor-8vOj_QAN.js';
import { l as lodashExports } from './lodash-DZHX9O7j.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-C9U6QMid.js';
import { D as DashBox } from './DashBox-9PCaa5tP.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-BztHT2S8.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-BdYVzE0Y.js';
import { P as PatientComplaintsService } from './patient_complaints_service-BmMFYbhf.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-BpEGdcvr.js';
import { i as isClinician } from './Registration-Bufzi17g.js';
