import { s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, a5 as createTextVNode, D as toDisplayString, F as unref, a7 as IonLabel, fl as I1, bA as createStaticVNode, N as IonButton, J as Fragment, f as ref, K as modalController, fm as IonAlert, x as resolveComponent, O as createBlock, ao as IonList, ap as IonItem, ai as IonRadio, ah as IonRadioGroup, R as renderList, af as IonRow, az as IonCol, a6 as IonInput, aC as IonToolbar, aD as IonTitle, aE as IonMenu, I as IonHeader, aF as IonContent, S as withDirectives, T as vShow, H as createCommentVNode, bF as IonModal, aH as IonAccordionGroup, aG as IonAccordion, b9 as IonCardTitle, cE as IonCardSubtitle, ba as IonCardHeader, bc as IonCardContent, bK as IonCard, bt as IonPage, cv as IonMenuButton, be as IonFooter, L as IonIcon, ab as checkmarkOutline, G as closeCircleOutline, fn as folderOpenOutline, c as computed, at as script, dk as Navigation, dl as Pagination, dm as Slide, dn as Carousel, c9 as clipboardOutline, d3 as person, e0 as ellipsisVerticalSharp, bb as checkmark, bX as chevronBackOutline, a4 as normalizeClass } from './vendor-BIA1Qh8a.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, z as StandardForm, F as DynamicButton, K as ObservationService, cl as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cK as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, cL as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-BKtQ6Cec.js';
...
import { m as mapState, s as storeToRefs } from './pinia-BgytB2RM.js';
import { S as Stepper } from './Stepper-C5njC5X1.js';
import { T as Treatment } from './treatment-PEPvTN2B.js';
import { l as lodashExports } from './lodash-IJNQpAoV.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-BBHcYi58.js';
import WeightHeightChart from './WeightHeightChart-BV9dfoXF.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-BcGNJFcn.js';
import { c as customDatePicker } from './customDatePicker-BOuNdmGK.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, n as nextAppointMent } from './vaccines_service-QFn_a9nF.js';
import { S as StockService } from './stock_service-CEOYPUXW.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-CwDRtupq.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-eiB7KJXw.js';
...
import { O as Outcome, _ as _sfc_main$e } from './usePatientProfile-Ddx16xug.js';
