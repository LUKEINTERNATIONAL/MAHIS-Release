import { K as modalController, s as defineComponent, y as openBlock, O as createBlock, a3 as onMounted, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, bd as IonCardContent, N as IonButton, L as IonIcon, bH as addOutline, a5 as createTextVNode, f as ref, z as createElementBlock, M as IonSpinner, J as Fragment, S as renderList, bL as IonCard, Q as normalizeClass, D as toDisplayString, bV as trashOutline, H as createCommentVNode, X as alertController, cC as toastController, a7 as IonLabel, aA as IonCol, aq as IonItem, x as resolveComponent, w as watch, ec as time, ak as IonDatetime, ba as IonCardTitle, bb as IonCardHeader, af as IonRow, au as script, eg as pencilOutline, bI as saveOutline, G as closeCircleOutline, b0 as locationOutline, bw as personCircleOutline, ae as IonCheckbox, dA as phonePortraitOutline, aS as medicalOutline, c as computed, ap as IonList, aD as IonToolbar, aE as IonTitle, be as IonButtons, I as IonHeader, aG as IonContent, bf as IonFooter, aL as useRouter, cJ as idCardOutline, R as alertCircleOutline, a6 as IonInput, bz as IonText, P as normalizeStyle, dB as domtoimage, Y as Capacitor } from './vendor-CL83uZHJ.js';
import { b4 as confirmModal, u as useDemographicsStore, y as StandardValidations, n as icons, z as StandardForm, r as StandardModal, C as useExposeFromStandardForm, b5 as RelationshipService, G as toastSuccess, t as toastWarning, o as createModal, _ as _export_sfc, k as alertConfirmation, a4 as popoverConfirmation, B as BasicInputField, b3 as useOutcomeStore, g as getPouchDBRecords, aI as _sfc_main$f, F as DynamicButton, $ as SelectFacility, V as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aC as ListPicker, aj as ProgramService, S as Service, H as HisDate, c as HorizontalLine, aD as areFieldsValid, x as toastDanger, aE as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, J as savePatientRecord, Z as printLabel, aM as PrintoutService, b6 as printArtVisitLbl } from '../index-sOpwMpcu.js';
import { R as Registration, u as useRelationships } from './Registration-BHTxgfm0.js';
import { s as storeToRefs } from './pinia-CtPjMI11.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-BehW8qCe.js';
import { u as useWardsStore } from './wardsStore-RgPyaqpi.js';
