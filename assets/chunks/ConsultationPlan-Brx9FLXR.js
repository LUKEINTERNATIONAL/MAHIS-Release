...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bq as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b5 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bn as useInvestigationStore, b_ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bH as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-DjGK15Gi.js';
import { D as DemographicBar } from './DemographicBar-B6R1hp7T.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-BhyiAhhM.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-D3wdFLec.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-C7Zx8b6_.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-jjmE8WxT.js';
import { I as Investigations } from './Investigations-Ctqvvx_d.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-YbksLJhF.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-cvuCaByp.js';
import { P as PreviousTreatment } from './treatment-6myahvxl.js';
import { l as lodashExports } from './lodash-CuxQuz9v.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-BP1IOwdL.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-Bz0f4tYR.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-2EJR0D29.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Dc7Dwgnl.js';
