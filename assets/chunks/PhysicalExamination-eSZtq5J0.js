import { s as defineComponent, y as openBlock, O as createBlock, f as ref, c as computed, a2 as onMounted, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bK as IonCard, J as Fragment, bF as IonModal, I as IonHeader, aD as IonToolbar, aE as IonTitle, C as createBaseVNode, L as IonIcon, eO as eggOutline, a5 as createTextVNode, D as toDisplayString, be as IonButtons, N as IonButton, G as closeCircleOutline, a7 as IonLabel, aG as IonContent, H as createCommentVNode, bf as IonFooter, bH as saveOutline, aq as IonItem, bN as IonSelect, R as renderList, bM as IonSelectOption, a4 as normalizeClass, aL as useRouter, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage } from './vendor-D523m2MA.js';
import { z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, t as toastWarning, n as icons, _ as _export_sfc, x as toastDanger, F as DynamicButton, C as useExposeFromStandardForm, S as Service, J as savePatientRecord, y as StandardValidations, u as useDemographicsStore, T as Toolbar } from '../index-CZ_DHssM.js';
...
import { _ as _sfc_main$h } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-J0nOHG1o.js';
...
const useFetalAssessmentStore = defineStore("fetalAssessmentStore", {
  ...
  actions: {
     ...
     * This keeps the modal fields populated when switching between fetuses.
     */
     ...
     * Using fetusNum as a key ensures we overwrite old data for the same fetus.
     */
    setValidatedFetalData(fetusNum, obsArray) {
      this.validatedFetalObsData[fetusNum] = obsArray;
    },
    /**
     * Returns all validated observations flattened into a single array for the final save.
     */
    getBundledObs() {
...
const addFetus = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-aa1c7f6b"]]);
            ...
            createVNode(unref(IonItem), {
              ...
              default: withCtx(() => [
                ...
                createVNode(unref(IonSelect), {
                  ...
                  placeholder: "Select",
                  class: "custom-select",
                  onIonChange: _cache[1] || (_cache[1] = ($event) => numFetuses.value !== null && unref(fetalStore).setTotalFetuses(numFetuses.value))
                }, {
                  default: withCtx(() => [
...
const FetusSelector = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-114e5b7f"]]);
    ...
    const onSubmit = async () => {
      ...
      if (formValues["Number of fetuses known"] || formValues["Symphysis-fundal height"]) {
        ...
        Object.entries(allFetuses || {}).forEach(([key, fetus]) => {
          const knownFetusCountObsversation2 = {
            "concept_name": "Register Number",
            "value_text": key,
            // Uses the actual key from the Proxy object
            "obs_datetime": Service.getSessionDate(),
            "location_id": Service.getUserLocationId(),
            child: fetus
          };
          assessmentObs?.push(knownFetusCountObsversation2);
        });
        ...
        toastWarning("No Fetal Assessmen data to save");
      }
    };
    __expose({
      onSubmit
...
const PhysicalExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fcab4d20"]]);
