import { q as defineComponent, h as inject, r as ref, d as computed, w as watch, x as createElementBlock, G as createCommentVNode, y as openBlock, A as createBaseVNode, z as createVNode, E as unref, b8 as IonCardHeader, B as withCtx, K as IonIcon, au as searchOutline, cD as IonCardSubtitle, a4 as createTextVNode, b7 as IonCardTitle, ba as IonCardContent, ab as IonNote, bR as IonSearchbar, M as IonButton, bj as chevronForward, H as Fragment, Q as renderList, C as toDisplayString, cO as closeCircle, a1 as onMounted, N as createBlock, aI as useRouter, ct as useRoute, fi as qrCode, bF as addOutline, fj as callOutline, bW as chevronBackOutline, df as chevronForwardOutline, aD as IonContent, bs as IonPage, eT as provide, v as resolveComponent } from './vendor-Cd5ziTxG.js';
import { s as storeToRefs } from './pinia-UguK66WW.js';
import { u as useDemographicsStore, P as PatientService, _ as _export_sfc, W as LocationService, C as StandardForm, T as Toolbar, t as toastWarning, a6 as RelationsService, H as HisDate, b as EncounterTypeId, S as Service, ci as saveEncounterData, ap as SetProgramService, G as toastSuccess, x as toastDanger } from '../index-CKTz1PXB.js';
import { N as NeonatalService } from './neonatal_service-tcfx2RvJ.js';
import { D as DemographicBar } from './DemographicBar-CG1DJaK8.js';
import { c as neonatalEnrollmentSections, N as NeonatalStepper } from './NeonatalStepper-nFV0R9Qa.js';
import { n as neonatalEnrollmentFormKey, u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-0NIPkBPE.js';
      ...
      if (currentIndex === stepperData.length - 1) {
        return async () => {
          ...
          try {
            ...
            console.log("[Enrollment] encounter type names:", encounters.map((e) => typeof e === "string" ? e : e?.name || e));
...
const Enrollment = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-591c026e"]]);
