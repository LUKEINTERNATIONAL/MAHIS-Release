...
import { A as ArtCard } from './PatientProfile-CjJ784Lq.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cQ as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-kwyS_uSy.js';
...
import { C as CPR } from './CPR-BNcMDaco.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-aJzmPN9G.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-C0Olejkm.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BU7fjXqk.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CJ7yvLC5.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-C_48DZJl.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-DrxhGzwB.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-kwyS_uSy.js').then(n => n.cT),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-tu-l7uKL.js'),true              ?[]:void 0,import.meta.url));
