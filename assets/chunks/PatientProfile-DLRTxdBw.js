import { v as defineComponent, a3 as onMounted, f as ref, z as createElementBlock, A as openBlock, C as createBaseVNode, B as createVNode, D as withCtx, a6 as createTextVNode, E as toDisplayString, G as unref, a8 as IonLabel, bB as createStaticVNode, fq as I1, O as IonButton, K as Fragment, L as modalController, fr as IonAlert, y as resolveComponent, P as createBlock, ao as IonList, ap as IonItem, aj as IonRadio, ai as IonRadioGroup, S as renderList, ag as IonRow, aA as IonCol, a7 as IonInput, aC as IonToolbar, aD as IonTitle, aE as IonMenu, I as IonHeader, aF as IonContent, T as withDirectives, J as createCommentVNode, U as vShow, bG as IonModal, aH as IonAccordionGroup, aG as IonAccordion, b9 as IonCardTitle, cF as IonCardSubtitle, ba as IonCardHeader, bc as IonCardContent, bL as IonCard, bu as IonPage, cw as IonMenuButton, be as IonFooter, M as IonIcon, ac as checkmarkOutline, H as closeCircleOutline, fs as folderOpenOutline, c as computed, at as script, dl as Navigation, dm as Pagination, dn as Slide, dp as Carousel, ca as clipboardOutline, d4 as person, e1 as ellipsisVerticalSharp, bb as checkmark, bY as chevronBackOutline, a5 as normalizeClass } from './vendor-CJ5LqAxe.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, C as StandardForm, F as DynamicButton, K as ObservationService, cm as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cL as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bU as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-DihysMBN.js';
...
import { m as mapState, s as storeToRefs } from './pinia-BmV_6_tV.js';
import { S as Stepper } from './Stepper-DfjRDAax.js';
import { T as Treatment } from './treatment-BJ1k0L-S.js';
import { l as lodashExports } from './lodash-BxWMU_OR.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-mIwYx1Kf.js';
import WeightHeightChart from './WeightHeightChart-C8W3H7rJ.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-CrIocNra.js';
import { c as customDatePicker } from './customDatePicker-CSEtxUs8.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, N as NextAppointment } from './vaccines_service-Cr3ILaXl.js';
import { S as StockService } from './stock_service-Cq_NYrga.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-SOC1Mx6U.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-CuT3SLAq.js';
import { u as useAdministerOtherVaccineStore } from './AdministerOtherVaccinesStore-AtlqY4xi.js';
import { B as BasicForm } from './BasicForm-D_UTFx4e.js';
import { O as Outcome, c as _sfc_main$e } from './usePatientProfile-lJDOEQwS.js';
