import { c as computed, s as defineComponent, y as openBlock, O as createBlock, F as unref, bL as IonCard, B as withCtx, A as createVNode, bd as IonCardContent, f as ref, aL as useRouter, cu as useRoute, w as watch, a2 as onMounted, aG as IonContent, C as createBaseVNode, bY as chevronBackOutline, S as withDirectives, T as vShow, H as createCommentVNode, bu as IonPage, ab as checkmarkOutline } from './vendor-CL0dVHZq.js';
import { s as storeToRefs } from './pinia-e5upVPR3.js';
import { y as StandardValidations, z as StandardForm, bi as useVitalsStore, u as useDemographicsStore, bj as useInvestigationStore, bk as useDiagnosisStore, b2 as useTreatmentPlanStore, be as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, F as DynamicButton, a2 as getFieldValue, H as HisDate, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, aq as ConceptService, G as toastSuccess, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-WCwjUkov.js';
import { D as DemographicBar } from './DemographicBar-DVT0lAbF.js';
import { V as Vitals } from './Vitals-QeVto0vD.js';
import { _ as _sfc_main$6 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-qiv2vzm7.js';
import { P as PresentingComplaints } from './PresentingComplaints-BuLykCf3.js';
