import { s as defineComponent, dG as IonToggle, bx as IonPage, bh as IonFooter, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aI as IonContent, p as dayjs, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, z as createElementBlock, A as createVNode, C as createBaseVNode, H as createCommentVNode, a5 as createTextVNode, D as toDisplayString, Q as normalizeClass } from './vendor-DdMq-dB8.js';
import { D as DispositionModal } from './OutcomeModal-CezvUFoS.js';
import { F as DynamicButton, T as Toolbar, H as HisDate, a4 as getFieldValue, S as Service, G as toastSuccess, t as toastWarning, a3 as modifyFieldValue, aa as validateField, o as createModal, ab as PatientDemographicsExchangeService, W as useGlobalPropertyStore, ac as useConfigStore, n as icons, _ as _export_sfc } from '../index-CQh6ahck.js';
import { m as mapState } from './pinia-C0spauhr.js';
import { B as BasicForm } from './BasicForm-CYKj7hVf.js';
import { F as FacilityInformationBar } from './FacilityInformationBar-3LSO5viw.js';
