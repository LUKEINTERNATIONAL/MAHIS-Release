import { s as defineComponent, h as inject, ck as onBeforeUnmount, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, D as toDisplayString, A as createVNode, F as unref, f as ref, c as computed, aG as IonContent, bu as IonPage, aL as useRouter, eT as provide, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-D9gV--WW.js';
import { s as storeToRefs } from './pinia-CI1UBDxV.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, b as EncounterTypeId, t as toastWarning, K as ObservationService, ch as saveEncounterData, G as toastSuccess } from '../index-DGSSrngm.js';
import { e as neonatalVitalsSections, f as neonatalVitalsFormKey, g as useNeonatalTriageStore, N as NeonatalStepper, h as useNeonatalVitalsStore } from './NeonatalStepper-DpC-SUCx.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-BrORl6BQ.js';
...
const BloodSugarSection = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-0f5479f5"]]);
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const stepperData = [
      ...
      { title: "Blood Sugar", value: "3", component: BloodSugarSection, configIndex: getIndex("Blood Sugar"), hasDialog: true },
      {
...
const NeonatalVitals = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-17170efc"]]);
