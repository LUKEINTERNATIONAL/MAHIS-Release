import { q as defineComponent, r as ref, d as computed, a2 as onMounted, x as createElementBlock, y as openBlock, B as createBaseVNode, a4 as normalizeClass, z as createVNode, E as unref, d1 as person, L as IonIcon, C as toDisplayString, a5 as createTextVNode, h as inject, w as watch, O as createBlock, a3 as onUnmounted, G as createCommentVNode, J as Fragment, R as renderList, aO as medicalOutline, b4 as calendarOutline, bS as trashOutline, by as createStaticVNode, ab as checkmarkOutline, aj as onBeforeUnmount, S as withDirectives, T as vShow, cy as E, bC as QRCode, cz as autoTable, N as IonButton, H as IonContent, br as IonPage, aH as useRouter, aZ as printOutline, eT as provide, v as resolveComponent, A as withCtx } from './vendor-BizyHS9K.js';
import { s as storeToRefs, d as defineStore } from './pinia-xTR-gbcT.js';
import { u as useDemographicsStore, H as HisDate, cj as InputField, P as PatientService, _ as _export_sfc, K as ObservationService, C as StandardForm, ck as SearchableDropdown, cl as DateInputField, ab as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-B8cwm10e.js';
import { N as NeonatalService } from './neonatal_service-CuRSR6yr.js';
import { D as DemographicBar } from './DemographicBar-CkcbvACx.js';
import { g as neonatalDischargeFormKey, h as neonatalDischargeSections, i as defaultNeonatalDischargeForm, j as neonatalAdmissionOutcomesFormKey, k as neonatalAdmissionSignOffSections, N as NeonatalStepper } from './NeonatalStepper-BRDzwe5s.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-Q3v8Hg7r.js';
