import { v as defineComponent, h as inject, w as watch, z as openBlock, A as createElementBlock, B as createVNode, G as unref, f as ref, K as Fragment, S as renderList, D as createBaseVNode, E as toDisplayString, c as computed, y as resolveComponent, P as createBlock, C as withCtx, J as createCommentVNode, ah as close, M as IonIcon, R as alertCircleOutline, a6 as createTextVNode, O as IonButton, cl as onBeforeUnmount, aF as IonContent, bu as IonPage, aK as useRouter, cv as useRoute, fe as onIonViewWillEnter, bY as chevronBackOutline, r as reactive, eV as provide } from './vendor-D3hawxEQ.js';
import { s as storeToRefs } from './pinia-CMzUCnxi.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-DeiarqPy.js';
import { D as DemographicBar } from './DemographicBar-BBYXMYgA.js';
import { l as neonatalTriageSections, m as neonatalTriageFormKey, o as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, p as defaultNeonatalTriageForm } from './NeonatalStepper-BJgzrcuh.js';
