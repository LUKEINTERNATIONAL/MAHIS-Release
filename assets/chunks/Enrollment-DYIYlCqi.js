import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, bb as IonCardHeader, B as withCtx, L as IonIcon, ax as searchOutline, cD as IonCardSubtitle, a5 as createTextVNode, ba as IonCardTitle, bd as IonCardContent, bS as IonSearchbar, N as IonButton, bm as chevronForward, J as Fragment, R as renderList, D as toDisplayString, H as createCommentVNode, cO as closeCircle, f as ref, c as computed, a2 as onMounted, O as createBlock, aL as useRouter, ct as useRoute, ac as IonNote, ew as qrCode, bG as addOutline, ey as callOutline, bX as chevronBackOutline, df as chevronForwardOutline, fr as barcode, b8 as calendarOutline, G as closeCircleOutline, Q as alertCircleOutline, aG as IonContent, bu as IonPage, f0 as provide, x as resolveComponent } from './vendor-BFWX6OWQ.js';
import { s as storeToRefs } from './pinia-CjkeFwdd.js';
import { u as useDemographicsStore, cj as Banner, P as PatientService, _ as _export_sfc, V as LocationService, K as ObservationService, z as StandardForm, t as toastWarning, H as HisDate, o as createModal, r as StandardModal, T as Toolbar, a7 as RelationsService, b as EncounterTypeId, S as Service, ci as saveEncounterData, aq as SetProgramService, G as toastSuccess, x as toastDanger } from '../index-DJqGAImg.js';
import { N as NeonatalService } from './neonatal_service-Ch66PJ1I.js';
import { D as DemographicBar } from './DemographicBar-BAZsXSKk.js';
import { h as neonatalEnrollmentSections, p as extractOptionValue, q as normalizeTextValue, r as extractMultiSelectValues, N as NeonatalStepper } from './NeonatalStepper-B4vXKZ8L.js';
import { n as neonatalEnrollmentFormKey, u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-CEPyheiF.js';
