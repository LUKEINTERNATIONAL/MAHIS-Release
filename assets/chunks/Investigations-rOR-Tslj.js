import { O as OrderService, bp as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bq as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, br as SelectionPopover, S as Service, g as getPouchDBRecords, aq as ConceptService, bj as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, r as StandardModal, a2 as getFieldValue, bl as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-WCwjUkov.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-e5upVPR3.js';
import LabOrdersList from './LabOrdersList-CxmTsMPG.js';
import { v as validateInputFiledData } from './group_validation-qGTW-iL4.js';
import { u as useRadiologyStore } from './RadiologyStore-DI9yiHur.js';
import { B as BasicForm } from './BasicForm-BkxPSo-s.js';
import { s as defineComponent, a2 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, R as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, br as pulseOutline, bc as checkmark, a5 as createTextVNode, c as computed, bL as IonCard, aB as IonGrid, af as IonRow, aA as IonCol, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, D as toDisplayString, bP as IonChip, ae as IonCheckbox, by as IonText, bd as IonCardContent, r as reactive, p as dayjs, aL as useRouter, cu as useRoute, S as withDirectives, T as vShow, K as modalController } from './vendor-CL0dVHZq.js';
import { l as lodashExports } from './lodash-Ba28qa7J.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-CmEmw2sO.js';
import { D as DashBox } from './DashBox-D9K0VI-R.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-Ha_N_OTV.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-DHpBhw87.js';
import { P as PatientComplaintsService } from './patient_complaints_service-5fxZsshQ.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-GNH9uDZA.js';
import { i as isClinician } from './Registration-Deh1Zoit.js';
