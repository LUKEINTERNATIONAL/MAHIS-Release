...
import { u as useDemographicsStore, H as HisDate, P as PatientService, M as ConceptService, K as ObservationService, _ as _export_sfc, z as StandardForm, bH as DrugOrderService, cj as Banner, cm as SearchableDropdown, cn as DateInputField, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-C1knEXPM.js';
import { N as NeonatalService } from './neonatal_service-vDBD1DyT.js';
import { D as DemographicBar } from './DemographicBar-DyOMdyWi.js';
import { z as getDischargeSectionByName, A as neonatalDischargeFormKey, B as neonatalDischargeSections, b as neonatalClinicalReviewOutcomesFormKey, N as NeonatalStepper, C as useNeonatalDischargeStore, D as getDischargeSectionIndexByName } from './NeonatalStepper-Bp9hTOAq.js';
import { I as IMAGES } from './images-_va7dFSn.js';
import { u as useClinicalReviewSignOff, n as neonatalClinicalReviewSignOffSections, R as ReportFooter, a as ReportHeader, b as ReportRow, c as ReportSection } from './ReportFooter-CPin4KJo.js';
import { N as NeonatalReportService } from './reportService-CKIhf1n1.js';
  ...
  setup(__props) {
    ...
    const fetchMotherName = async () => {
      ...
      try {
        ...
        if (!motherName.value) {
          try {
            const conceptId = await ConceptService.getConceptID("Mother name", false);
            const obs = await ObservationService.getObs({
              person_id: patientId,
              concept_id: conceptId,
              page_size: 1
            });
            const valueText = Array.isArray(obs) && obs.length ? obs[0]?.value_text : "";
            motherName.value = valueText || "N/A";
          } catch {
            motherName.value = "N/A";
          }
        }
...
const ProfileInformation = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-27317a6f"]]);
...
const DischargeVitals = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-b5ea5374"]]);
...
const NeonatalDischarge = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c0f3c577"]]);
