import { cl as Banner, cm as SummaryField, H as HisDate, _ as _export_sfc } from '../index-CKPE6QZm.js';
import { n as neonatalReviewOfSystemsFormKey, a as neonatalSignsSymptomsFormKey, b as neonatalClinicalReviewOutcomesFormKey, c as neonatalTriageFormKey, d as neonatalSystemicExaminationFormKey, e as neonatalDiagnosisFormKey, f as neonatalTreatmentPlanFormKey, g as neonatalReviewOfSystemsSections, h as neonatalSignsSymptomsSections, i as neonatalEnrollmentSections, j as neonatalClinicalReviewOutcomesSections, k as neonatalSystemicExaminationSections, l as neonatalDiagnosisSections, m as neonatalTreatmentPlanSections, o as neonatalInvestigationSections } from './NeonatalStepper-D8WSbnc9.js';
import { n as neonatalEnrollmentFormKey, u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-D9gbTpDk.js';
import { u as useNeonatalTriageStore, n as neonatalTriageSections } from './triage-pRsUVtUP.js';
import { a as neonatalGeneralExaminationFormKey, n as neonatalGeneralExaminationSections } from './neonatal_service-CWEUHp3w.js';
import { s as defineComponent, h as inject, i as isRef, y as openBlock, z as createElementBlock, A as createVNode, O as createBlock, H as createCommentVNode, c as computed } from './vendor-Cddp3aFV.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const allFormValues = computed(() => {
      ...
      if (triageForm) {
        ...
        values = snapshot;
      } else if (investigationForm) {
        const resolved = isRef(investigationForm) ? investigationForm.value : investigationForm;
        values = resolved || {};
      } else {
        values = { ...rosForm || signsSymptomsForm || enrollmentForm || clinicalReviewOutcomesForm || {} };
      }
      return values;
    });
    ...
    const mnhSummaryRows = computed(() => {
      if (!enrollmentForm) return [];
      const data = enrollmentStore.mnhData;
      if (!data) return [];
      const fields = [
        { key: "dateOfDelivery", label: "Date of Delivery", format: formatMnhDate },
        { key: "timeOfDelivery", label: "Time of Delivery" },
        { key: "placeOfDelivery", label: "Place of Delivery" },
        { key: "modeOfDelivery", label: "Mode of Delivery" },
        { key: "numberOfBabies", label: "Number of Babies" },
        { key: "gestationAgeWeeks", label: "Gestation Age (weeks)" },
        { key: "gestationMethod", label: "Gestation Method" },
        { key: "gravida", label: "Gravida" },
        { key: "parity", label: "Parity" },
        { key: "numberOfANCVisits", label: "ANC Visits" },
        { key: "membranesRuptured", label: "Membranes" },
        { key: "stateOfLiquor", label: "Liquor State" },
        { key: "hivStatus", label: "HIV Status" },
        { key: "hivTestDate", label: "HIV Test Date", format: formatMnhDate },
        { key: "syphilisTest", label: "Syphilis Test" },
        { key: "hepatitisBTest", label: "Hepatitis B Test" },
        { key: "maternalOutcome", label: "Maternal Outcome" },
        { key: "pncStatusOfMother", label: "PNC Status of Mother" },
        { key: "ironSupplementation", label: "Iron Supplementation" },
        { key: "folicAcidPrescription", label: "Folic Acid" },
        { key: "spDoses", label: "SP Doses" }
      ];
    ...
    const summaryFieldConfig = computed(() => {
      ...
      const mergedRows = [...autoRows, ...mnhSummaryRows.value, ...diagnosisSystemsSuggestionRows.value];
      if (treatmentPlanForm) {
    ...
    __expose({
      ...
      getFormValues: () => {
        ...
        if (investigationForm) {
          return isRef(investigationForm) ? investigationForm.value : investigationForm;
        }
        return { ...rosForm || signsSymptomsForm || enrollmentForm || clinicalReviewOutcomesForm || {} };
      }
    });
    return (_ctx, _cache) => {
...
const SummarySection = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b1c5689e"]]);

export { SummarySection as S, neonatalInvestigationFormKey as n };
