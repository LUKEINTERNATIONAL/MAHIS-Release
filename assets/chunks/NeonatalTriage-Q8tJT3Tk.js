import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, c as computed, x as resolveComponent, O as createBlock, B as withCtx, H as createCommentVNode, cu as useRoute, bT as IonSearchbar, L as IonIcon, ff as qrCode, N as IonButton, bH as addOutline, a5 as createTextVNode, fg as callOutline, bY as chevronBackOutline, dg as chevronForwardOutline, ax as searchOutline, cP as closeCircle, bd as IonCardContent, ck as onBeforeUnmount, aG as IonContent, bu as IonPage, aL as useRouter, fb as onIonViewWillEnter, r as reactive, eU as provide } from './vendor-DlXvc2CI.js';
import { s as storeToRefs } from './pinia-DxIh5T-z.js';
import { z as StandardForm, _ as _export_sfc, P as PatientService, S as Service, u as useDemographicsStore, o as createModal, T as Toolbar, cl as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ch as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-DVTnCrb2.js';
import { D as DemographicBar } from './DemographicBar-XlNoETRz.js';
import { o as neonatalTriageSections, p as neonatalTriageFormKey, f as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, q as defaultNeonatalTriageForm } from './NeonatalStepper-Cj8bIWd1.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-lDdg91mj.js';
