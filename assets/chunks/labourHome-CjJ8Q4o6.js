import { t as toRaw, c as computed, s as defineComponent, w as watch, a3 as onMounted, n as nextTick, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, v as documentTextOutline, K as modalController, x as resolveComponent, a5 as createTextVNode, D as toDisplayString, z as createElementBlock, J as Fragment, S as renderList, Q as normalizeClass, b0 as personOutline, ab as checkmarkOutline, H as createCommentVNode, dg as chevronForwardOutline, d0 as arrowBackOutline, T as withDirectives, U as vShow, f as ref, aM as useRouter, aH as IonContent, b_ as chevronBackOutline, eZ as paperPlaneOutline, e_ as checkmarkDoneOutline, ca as clipboardOutline, f2 as notificationsOutline, cd as flask, f3 as documentText, cp as checkmarkCircle, bw as IonPage } from './vendor-NYNX75Tj.js';
import { a7 as useUserStore, y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, b6 as RelationshipService, P as PatientService, J as savePatientRecord, _ as _export_sfc, u as useDemographicsStore, T as Toolbar, o as createModal } from '../index-DRy1cgfg.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const cardsData = [
      ...
      { title: "Immediate Postnatal Checks (4th Stage of Labour)", path: "/labour/postnatal-checks", icon: checkmarkCircle, isSaved: false }
    ];
...
const labourHome = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f2f9691f"]]);
