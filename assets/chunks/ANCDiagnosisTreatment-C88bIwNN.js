import { s as defineComponent, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, F as unref, be as IonCardContent, c as computed, f as ref, bM as IonCard, aM as useRouter, O as createBlock, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-CZkQjgFf.js';
import { _ as _sfc_main$5, u as useFormWizard } from './useFormWizard-hl6mfJEw.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, y as StandardValidations, u as useDemographicsStore, J as savePatientRecord, t as toastWarning, a1 as DrugService, T as Toolbar, F as DynamicButton } from '../index-HUvHuTRi.js';
    ...
    const diagnosesForm = computed(
      () => [
        ...
        },
        {
          ...
          obsValueType: "value_coded",
          condition: (data) => {
            return data?.["Diagnosis"]?.includes("Other");
          },
          grid: { xs: "12" }
        }
      ]
...
const optionalNumericValidation = (value) => {
  ...
  const medicationDispensedForm = computed(() => {
    return [
      ...
      },
      {
        ...
        grid: { s: "6" },
        validation: optionalNumericValidation,
        condition: (data) => {
  ...
  const hepatitisForm = computed(() => {
    return [
      ...
      { grid: { s: "0.5" } },
      {
        componentType: "inputField",
        header: "Other Specify",
        name: "_Reason Hepatitis B vaccination not conducted",
        obsValueType: "value_text",
        icon: icons.editPen,
        grid: { s: "11.5" },
        condition: (data) => {
          return data["Hepatitis B vaccine given?"] === "No" && data["Reason Hepatitis B vaccination not conducted"] === "Other";
        }
      }
    ];
  });
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createVNode(unref(IonCardContent), null, {
            default: withCtx(() => [
              createVNode(StandardForm, {
                subtitle: "Hepatitis Vaccination",
