...
const DASHBOARD_STATS_PATH$1 = "mnh/stats";
...
async function getAncDashboard() {
  ...
  try {
    const raw = await Service.getJson(DASHBOARD_STATS_PATH$1, {
      program_id: programId,
      date
    });
    if (!raw || typeof raw !== "object") return emptyDashboardData$1();
    return mapResponseToDashboardData$1(raw);
  } catch (_) {
    return emptyDashboardData$1();
  }
}
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createBaseVNode("div", _hoisted_2$7, [
          ...
          createVNode(DashboardStatCard, {
            ...
            label: "Pregnant women who attended 4+ ANC contacts",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
...
const Dashboard$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-f7bebc41"]]);
