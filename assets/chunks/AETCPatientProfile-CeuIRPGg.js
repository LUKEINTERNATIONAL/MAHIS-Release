import { v as defineComponent, aK as useRouter, cv as useRoute, a3 as onMounted, w as watch, y as resolveComponent, z as openBlock, P as createBlock, C as withCtx, B as createVNode, G as unref, aF as IonContent, J as createCommentVNode, D as createBaseVNode, ag as IonRow, az as IonCol, bL as IonCard, bc as IonCardContent, M as IonIcon, e1 as ellipsisVerticalSharp, a5 as normalizeClass, d4 as person, E as toDisplayString, a6 as createTextVNode, H as closeCircleOutline, di as IonSegment, dj as IonSegmentButton, a8 as IonLabel, A as createElementBlock, Q as normalizeStyle, ap as IonItem, a_ as personOutline, x as documentTextOutline, cK as idCardOutline, b0 as printOutline, K as Fragment, S as renderList, d5 as add, bu as IonPage, cT as defineAsyncComponent, cJ as __vitePreload, f as ref, c as computed } from './vendor-D3hawxEQ.js';
import { s as storeToRefs } from './pinia-CMzUCnxi.js';
import { A as ArtCard } from './PatientProfile-DDdsv1NN.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-DeiarqPy.js';
...
import { C as CPR } from './CPR-Bne4Q8DR.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CDBoHJuU.js'),true              ?[]:void 0));
