import { c as computed, v as defineComponent, z as openBlock, P as createBlock, C as withCtx, D as createBaseVNode, B as createVNode, G as unref, x as documentTextOutline, L as modalController, aK as useRouter, a3 as onMounted, aF as IonContent, bY as chevronBackOutline, eR as paperPlaneOutline, eS as checkmarkDoneOutline, A as createElementBlock, K as Fragment, S as renderList, ca as clipboardOutline, eW as notificationsOutline, eX as documentText, cp as checkmarkCircle, bu as IonPage, f as ref } from './vendor-Cbv9TWZo.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, q as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-C5Wp79uq.js';
import { D as DemographicBar } from './DemographicBar-Bnp1xjw4.js';
import { D as DashboardCards } from './DashboardCards-_UceLxlE.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const cardsData = [
      ...
      { title: "Quick Check", path: "/labourQuickCheck", icon: clipboardOutline, isSaved: false },
...
const labourHome = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-13cb728e"]]);
