import { _ as _export_sfc, u as useDemographicsStore, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-_N7CIn5p.js';
import { q as defineComponent, ar as script, x as createElementBlock, y as openBlock, G as createCommentVNode, A as createBaseVNode, z as createVNode, D as renderSlot, B as withCtx, a4 as createTextVNode, C as toDisplayString, E as unref, r as ref, w as watch, d as computed, N as createBlock, a3 as normalizeClass, cE as mergeProps, fh as draggable, c1 as resolveDynamicComponent, H as Fragment, Q as renderList, bP as withKeys, a7 as withModifiers, aI as useRouter, aD as IonContent, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { a as useDiagnosisStore, b as useSuggestedDiagnosisStore, N as NeonatalStepper } from './NeonatalStepper-CxQhVATI.js';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        !_ctx.items || _ctx.items.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_2$3, [
          ...
          item: withCtx(({ element: item, index }) => [
            createBaseVNode("div", {
              ...
              _ctx.isDifferential ? (openBlock(), createElementBlock("span", _hoisted_4$3, "#" + toDisplayString(index + 1), 1)) : createCommentVNode("", true),
