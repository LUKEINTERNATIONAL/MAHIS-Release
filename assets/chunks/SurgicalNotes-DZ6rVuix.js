import { q as defineComponent, aI as useRouter, ct as useRoute, r as ref, d as computed, w as watch, a1 as onMounted, N as createBlock, y as openBlock, B as withCtx, z as createVNode, E as unref, aD as IonContent, A as createBaseVNode, G as createCommentVNode, R as withDirectives, bW as chevronBackOutline, S as vShow, bs as IonPage, aa as checkmarkOutline } from './vendor-Cd5ziTxG.js';
import { s as storeToRefs } from './pinia-UguK66WW.js';
import { bl as useVitalsStore, u as useDemographicsStore, bm as useInvestigationStore, bb as useDiagnosisStore, b2 as useTreatmentPlanStore, bh as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, a9 as useConfigStore, f as useStatusStore, T as Toolbar, F as DynamicButton, a2 as getFieldValue, H as HisDate, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, aq as ConceptService, G as toastSuccess, bp as useAllegyStore, ab as useUserStore, S as Service } from '../index-CKTz1PXB.js';
import { D as DemographicBar } from './DemographicBar-CG1DJaK8.js';
import { u as useFormWizard, _ as _sfc_main$1 } from './useFormWizard-CTfcl1gg.js';
...
import { _ as _sfc_main$2, B as BreathingAssessment, a as _sfc_main$3, b as _sfc_main$4, c as _sfc_main$5 } from './ExposureAssessment.vue_vue_type_script_setup_true_lang-7zQU4QAm.js';
              ...
              createBaseVNode("div", _hoisted_1, [
                showWizard.value ? (openBlock(), createBlock(_sfc_main$1, {
                  ...
                  default: withCtx(() => [
                    ...
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(BreathingAssessment, { ref: "breathingAssessmentRef" }, null, 512)
                    ], 512), [
                      [vShow, getActiveComponent() == "BreathingAssessment"]
                    ]),
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(_sfc_main$3, { ref: "circulationAssessmentRef" }, null, 512)
                    ], 512), [
                      [vShow, getActiveComponent() == "CirculationAssessment"]
                    ]),
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(_sfc_main$4, { ref: "disabilityAssessmentRef" }, null, 512)
                    ], 512), [
                      [vShow, getActiveComponent() == "DisabilityAssessment"]
                    ]),
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(_sfc_main$5, { ref: "exposureAssessmentRef" }, null, 512)
                    ], 512), [
