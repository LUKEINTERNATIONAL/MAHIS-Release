import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bM as IonCard, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, a5 as createTextVNode, H as createCommentVNode, N as IonButton, L as IonIcon, af as IonRow, bc as IonCardHeader, bb as IonCardTitle, be as IonCardContent, f as ref, c as computed, aq as IonItem, ae as IonCheckbox, a7 as IonLabel, Q as normalizeClass, a6 as IonInput, r as reactive, a3 as onMounted, ap as IonList, T as withDirectives, U as vShow, cS as defineAsyncComponent, cI as __vitePreload, aM as useRouter, bN as useRoute, aH as IonContent, b_ as chevronBackOutline, bw as IonPage, ab as checkmarkOutline } from './vendor-NYNX75Tj.js';
import { s as storeToRefs } from './pinia-Byno_K7k.js';
import { z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, n as icons, y as StandardValidations, _ as _export_sfc, a$ as List, u as useDemographicsStore, bj as useVitalsStore, bk as useInvestigationStore, bl as useDiagnosisStore, b3 as useTreatmentPlanStore, bf as useNCDMedicationsStore, e as useGeneralStore, b4 as useOutcomeStore, i as useEnrollementStore, ab as useConfigStore, f as useStatusStore, T as Toolbar, a3 as getFieldValue, H as HisDate, a_ as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, M as ConceptService, G as toastSuccess, bo as useAllegyStore, a7 as useUserStore, S as Service } from '../index-DRy1cgfg.js';
import { D as DemographicBar } from './DemographicBar-45M9jSpH.js';
import { _ as _sfc_main$d, u as useFormWizard } from './useFormWizard-CPfmUxeA.js';
...
import { _ as _sfc_main$e, C as CirculationAssessment, D as DisabilityAssessment, E as ExposureAssessment } from './ExposureAssessment-CfPGppoJ.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const PrescribedMedicationList = defineAsyncComponent(() => __vitePreload(() => import('./Medications-GJFTT-iQ.js'),true              ?[]:void 0));
    const CONCEPTS = {
