import { f as ref, c as computed, cI as __vitePreload } from './vendor-NYNX75Tj.js';
import { d as defineStore } from './pinia-Byno_K7k.js';
import { n as icons } from '../index-DRy1cgfg.js';
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("Shock"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("Floppy"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ConvulsionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("StartMeasuringVitals"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GiveBVMsupport"))
      }
    ],
    skipCondition: (triageData) => {
      const hr = Number(triageData.heart_rate);
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
      const rr = Number(triageData.respiratory_rate);
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      if (triageData.oxygen_facility_available !== "Yes") return true;
