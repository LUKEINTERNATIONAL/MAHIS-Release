import { q as defineComponent, aI as useRouter, r as ref, d as computed, w as watch, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, z as createVNode, G as createCommentVNode, B as withCtx, E as unref, ay as IonCol, a4 as createTextVNode, ae as IonRow, H as Fragment, Q as renderList, N as createBlock, C as toDisplayString, M as IonButton, K as IonIcon, dh as eyeOutline, I as IonHeader, aA as IonToolbar, aB as IonTitle, bb as IonButtons, aD as IonContent, bE as IonModal, a3 as normalizeClass, da as timeOutline, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { u as useDemographicsStore, n as icons, y as StandardValidations, S as Service, g as getPouchDBRecords, O as OrderService, C as StandardForm, aq as ConceptService, o as createModal, J as savePatientRecord, t as toastWarning, _ as _export_sfc, T as Toolbar } from '../index-_N7CIn5p.js';
import { D as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-CxQhVATI.js';
                        ...
                        return openBlock(), createElementBlock("div", {
                          ...
                          test.result && test.result.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
                            test.result.length > 1 ? (openBlock(), createBlock(unref(IonButton), {
                              ...
                              _: 2
                            }, 1032, ["onClick"])) : (openBlock(), createElementBlock("div", _hoisted_5$1, toDisplayString(test.result[0].value), 1))
