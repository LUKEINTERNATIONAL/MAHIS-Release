import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, bf as IonCardContent, bN as IonCard, f as ref, a3 as onMounted, n as nextTick, cm as onBeforeUnmount, O as createBlock, af as IonRow, aK as IonAccordionGroup, aJ as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, aN as useRouter, aI as IonContent, b$ as chevronBackOutline, J as Fragment, S as renderList, T as withDirectives, c5 as resolveDynamicComponent, U as vShow, bx as IonPage } from './vendor-QOXikrLM.js';
import { _ as _sfc_main$4, u as useFormWizard } from './useFormWizard-DB5Ppn00.js';
import { n as icons, z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, l as PreviousVitals, t as toastWarning, J as savePatientRecord, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-Biv93APm.js';
...
import { u as useHeightWeightForm } from './useHeightWeightForm-DSzp6jVZ.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-cni_hqB6.js';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      if (await ObservationService.buildSaveObs(data, EncounterTypeId.PNC_WARD_MONITORING_MOTHER))
        toastSuccess("Other Examination data saved successfully");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      const data = formRef.value?.getFormValues();
      if (Object.keys(data || {}).length === 0) return;
      if (await ObservationService.buildSaveObs(data, EncounterTypeId.PNC_WARD_MONITORING_MOTHER)) toastSuccess("Danger Signs data saved successfully");
      formRef.value?.resetForm();
