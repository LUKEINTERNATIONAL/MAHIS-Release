import { q as defineComponent, a2 as onMounted, r as ref, x as createElementBlock, y as openBlock, B as createBaseVNode, z as createVNode, A as withCtx, a5 as createTextVNode, C as toDisplayString, E as unref, a7 as IonLabel, bx as createStaticVNode, fn as I1, N as IonButton, J as Fragment, K as modalController, fo as IonAlert, v as resolveComponent, O as createBlock, am as IonList, an as IonItem, ai as IonRadio, ah as IonRadioGroup, R as renderList, af as IonRow, aw as IonCol, a6 as IonInput, ay as IonToolbar, az as IonTitle, aA as IonMenu, I as IonHeader, H as IonContent, S as withDirectives, G as createCommentVNode, T as vShow, bC as IonModal, aC as IonAccordionGroup, aB as IonAccordion, b4 as IonCardTitle, cB as IonCardSubtitle, b5 as IonCardHeader, b7 as IonCardContent, bH as IonCard, bq as IonPage, cs as IonMenuButton, b9 as IonFooter, L as IonIcon, ab as checkmarkOutline, F as closeCircleOutline, d as computed, fp as folderOpenOutline, ar as script, dh as Navigation, di as Pagination, dj as Slide, dk as Carousel, c7 as clipboardOutline, d0 as person, d_ as ellipsisVerticalSharp, b6 as checkmark, bV as chevronBackOutline, a4 as normalizeClass } from './vendor-BK8x96Ok.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, ab as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, C as StandardForm, F as DynamicButton, K as ObservationService, cl as PatientRegistrationService, a6 as RelationsService, x as toastDanger, cK as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bT as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-xpeKIrss.js';
...
import { m as mapState, s as storeToRefs } from './pinia-C47my0-I.js';
import { S as Stepper } from './Stepper-CMWOSTdb.js';
import { T as Treatment } from './nonPharmaTherapyStore-D6SXX4LB.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-C7wl2nM1.js';
import WeightHeightChart from './WeightHeightChart-COXydzDi.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-CauMO5s-.js';
import { c as customDatePicker } from './customDatePicker-0qNg9T0R.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, N as NextAppointment } from './vaccines_service-tSacCv4m.js';
import { S as StockService } from './stock_service-iUOqp3G3.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-DrybY4TH.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-CxFcdRbK.js';
...
import { _ as _sfc_main$e } from './usePatientProfile-CHb2i4nW.js';
import { O as Outcome } from './Outcome-BW7_SIvM.js';
