import { v as defineComponent, a3 as onMounted, z as openBlock, A as createElementBlock, D as createBaseVNode, a5 as normalizeClass, B as createVNode, G as unref, d4 as person, M as IonIcon, E as toDisplayString, a6 as createTextVNode, f as ref, c as computed, h as inject, w as watch, P as createBlock, a4 as onUnmounted, K as Fragment, S as renderList, aR as medicalOutline, b7 as calendarOutline, bU as trashOutline, J as createCommentVNode, bB as createStaticVNode, ac as checkmarkOutline, cl as onBeforeUnmount, T as withDirectives, U as vShow, cB as E, bF as QRCode, cC as autoTable, O as IonButton, aF as IonContent, bu as IonPage, aK as useRouter, b0 as printOutline, eV as provide, y as resolveComponent, C as withCtx } from './vendor-Cbv9TWZo.js';
import { s as storeToRefs } from './pinia-C6LE2xz6.js';
import { u as useDemographicsStore, cj as InputField, H as HisDate, P as PatientService, _ as _export_sfc, K as ObservationService, z as StandardForm, ck as SearchableDropdown, cl as DateInputField, a6 as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-DiiZviOj.js';
import { N as NeonatalService } from './neonatal_service-BFR1ipip.js';
import { D as DemographicBar } from './DemographicBar-CRHj9Ufc.js';
import { g as neonatalDischargeFormKey, h as neonatalDischargeSections, i as neonatalAdmissionOutcomesFormKey, j as neonatalAdmissionSignOffSections, k as useNeonatalDischargeStore, N as NeonatalStepper } from './NeonatalStepper-Sy3XSyn2.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-BRY0UiMs.js';
