...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, v as usePatientList, r as closeVisit } from '../index-BjUu2ofm.js';
import { D as DemographicBar } from './DemographicBar-BUp4v5GZ.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-XTm8GLRb.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-D8Ydwz-p.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-u5nGXgHm.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-9ZwQXUJY.js';
import { I as Investigations } from './Investigations-DQYDVtDb.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-C06VK0FT.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-D9dwr2PO.js';
import { P as PreviousTreatment } from './treatment-DZ6mLUpz.js';
import { l as lodashExports } from './lodash-CxXqq_k7.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DR7pMgkS.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DpHjAsI2.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CZ0bBz6z.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DlaJe1rv.js';
