import { s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, a5 as createTextVNode, D as toDisplayString, F as unref, a7 as IonLabel, fl as I1, bA as createStaticVNode, N as IonButton, J as Fragment, f as ref, K as modalController, fm as IonAlert, x as resolveComponent, O as createBlock, ap as IonList, aq as IonItem, ai as IonRadio, ah as IonRadioGroup, R as renderList, af as IonRow, aA as IonCol, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, I as IonHeader, aG as IonContent, S as withDirectives, T as vShow, H as createCommentVNode, bF as IonModal, aI as IonAccordionGroup, aH as IonAccordion, ba as IonCardTitle, cD as IonCardSubtitle, bb as IonCardHeader, bd as IonCardContent, bK as IonCard, bu as IonPage, cu as IonMenuButton, bf as IonFooter, L as IonIcon, ab as checkmarkOutline, G as closeCircleOutline, fn as folderOpenOutline, c as computed, au as script, dj as Navigation, dk as Pagination, dl as Slide, dm as Carousel, c8 as clipboardOutline, d2 as person, e0 as ellipsisVerticalSharp, bc as checkmark, bX as chevronBackOutline, a4 as normalizeClass } from './vendor-D523m2MA.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, z as StandardForm, F as DynamicButton, K as ObservationService, cl as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cK as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, cL as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-CZ_DHssM.js';
...
import { m as mapState, s as storeToRefs } from './pinia-BZkYQmJa.js';
import { S as Stepper } from './Stepper-CZrcpz6m.js';
import { T as Treatment } from './treatment-D2UzyZqJ.js';
import { l as lodashExports } from './lodash-BqX4mskJ.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-TMVc75Wq.js';
import WeightHeightChart from './WeightHeightChart-BfP_TOtr.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-Bx1-a_lf.js';
import { c as customDatePicker } from './customDatePicker-DMoxFG7C.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, n as nextAppointMent } from './vaccines_service-BuWLB7mD.js';
import { S as StockService } from './stock_service-Dm1c90bA.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-D2XiM72M.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-DaLZmAty.js';
...
import { O as Outcome, _ as _sfc_main$e } from './usePatientProfile-BbxhW5PN.js';
