import { O as OrderService, bq as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, br as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, S as Service, F as DynamicButton, a_ as List, B as BasicInputField, ba as SelectionPopover, g as getPouchDBRecords, aq as ConceptService, bm as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as useExposeFromStandardForm, C as StandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, a9 as useConfigStore, q as StandardModal, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-D5ZuGc-h.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-CiVhHi9d.js';
import LabOrdersList from './LabOrdersList-CG3XWZte.js';
import { v as validateInputFiledData } from './group_validation-Cb2OTU_n.js';
import { u as useRadiologyStore } from './RadiologyStore-9hEmMbCN.js';
import { B as BasicForm } from './BasicForm-B11DWXz6.js';
import { q as defineComponent, a1 as onMounted, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, z as createVNode, A as createBaseVNode, f as ref, x as createElementBlock, H as Fragment, Q as renderList, G as createCommentVNode, E as unref, w as watch, bm as IonPopover, a5 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, bp as pulseOutline, b9 as checkmark, a4 as createTextVNode, c as computed, bJ as IonCard, r as reactive, ax as IonGrid, ae as IonRow, ay as IonCol, aF as IonAccordionGroup, aE as IonAccordion, a6 as IonLabel, C as toDisplayString, bN as IonChip, ad as IonCheckbox, bw as IonText, ba as IonCardContent, l as dayjs, aI as useRouter, ct as useRoute, R as withDirectives, S as vShow, J as modalController } from './vendor-xvx_X2hj.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-RTMKrAR6.js';
import { D as DashBox } from './DashBox-BYH2HWEk.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-Dsb7trv_.js';
import { P as PatientComplaintsService } from './patient_complaints_service-B8Do4OeQ.js';
import { u as useFormWizard, _ as _sfc_main$8 } from './useFormWizard-BGxF4GvH.js';
import { a as isClinician } from './user_role_management-Df0Q6OjO.js';
