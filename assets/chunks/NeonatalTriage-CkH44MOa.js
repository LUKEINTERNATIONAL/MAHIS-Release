import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fd as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eW as provide } from './vendor-CHJxKtY0.js';
import { s as storeToRefs } from './pinia-DvUiFzi9.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, co as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ck as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-eygbwbqc.js';
import { D as DemographicBar } from './DemographicBar-DLk2Dd1d.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-BxRGQY5s.js';
import { S as SummarySection } from './SummarySection-Dr3xNvXD.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-DReKBw0r.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-BlSvEWKR.js';
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b0112847"]]);
