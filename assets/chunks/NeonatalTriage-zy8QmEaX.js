import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, c as computed, x as resolveComponent, O as createBlock, B as withCtx, H as createCommentVNode, ck as onBeforeUnmount, a5 as createTextVNode, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, cu as useRoute, fc as onIonViewWillEnter, bY as chevronBackOutline, r as reactive, eT as provide } from './vendor-D9gV--WW.js';
import { s as storeToRefs } from './pinia-CI1UBDxV.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cl as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ch as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-xr0muyVH.js';
import { D as DemographicBar } from './DemographicBar-CoL-hIND.js';
import { p as neonatalTriageSections, q as neonatalTriageFormKey, g as useNeonatalTriageStore, N as NeonatalStepper, t as triageConceptMapping, r as defaultNeonatalTriageForm } from './NeonatalStepper-CQ29G9Ie.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-DwdoYp27.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-CNuZjA9C.js';
