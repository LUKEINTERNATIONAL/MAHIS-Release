...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bq as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b5 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bn as useInvestigationStore, b_ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bH as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bK as StagesService, q as usePatientList, v as closeVisit } from '../index-jHLvXTOz.js';
import { D as DemographicBar } from './DemographicBar-CePQx5C9.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CSNZkstn.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-1HFkIlT3.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-DvRo4zsk.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-VRKq3668.js';
import { I as Investigations } from './Investigations-CwPCJ2MU.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-IUbR8CfJ.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-y_Ut2tAe.js';
import { P as PreviousTreatment } from './treatment-DsT8Dd8O.js';
import { l as lodashExports } from './lodash-CuxQuz9v.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-BVLzwkcb.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-BhHvDAgR.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DYVuEyHk.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-XfBiZb5l.js';
