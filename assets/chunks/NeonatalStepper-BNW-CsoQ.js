...
const neonatalTriageSections = [
  ...
  // },
  {
    ...
    skipCondition: (triageData) => {
      ...
      if (respiratoryRateValue && (respiratoryRateValue < 60 || respiratoryRateValue > 80)) return false;
