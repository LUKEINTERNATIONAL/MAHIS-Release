import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, a2 as onMounted, cj as onBeforeUnmount, S as withDirectives, T as vShow, a4 as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c as computed, cz as E, bE as QRCode, cA as autoTable, B as withCtx, N as IonButton, L as IonIcon, b1 as printOutline, a5 as createTextVNode, aG as IonContent, bu as IonPage, aL as useRouter, eV as provide, x as resolveComponent, O as createBlock } from './vendor-CIi-jrCy.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, a6 as useUserStore, K as ObservationService, H as HisDate, T as Toolbar } from '../index-CPakPmy3.js';
import { e as neonatalAdmissionOutcomesFormKey, G as useSignsSymptomsStore, w as useNeonatalVitalsStore, N as NeonatalStepper, J as useNeonatalAdmissionOutcomesStore } from './NeonatalStepper-v2ARJQcG.js';
import { A as AdmissionProgressBar } from './AdmissionProgressBar-D6eSLwm8.js';
import { n as neonatalAdmissionSignOffSections, u as useAdmissionSignOff } from './useAdmissionSignOff-CHSu7T2q.js';
import { u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-BckvomC8.js';

const _hoisted_1$3 = { class: "admission-signoff-wrapper" };
...
const AdmissionSignOffSection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-93d24d9e"]]);

const _hoisted_1$2 = { class: "page-header" };
...
const _hoisted_49 = { class: "print-column" };
const _hoisted_50 = { class: "print-section" };
...
const _hoisted_57 = { class: "field-row" };
const _hoisted_58 = { class: "print-section" };
...
const _hoisted_62 = { class: "field-row single-line" };
const _hoisted_63 = {
  key: 0,
  class: "print-section"
};
...
const _hoisted_70 = { class: "field-row" };
const _hoisted_71 = { class: "print-section" };
const _hoisted_72 = { class: "field-row" };
const _hoisted_73 = { class: "field-row" };
const _hoisted_74 = { class: "field-row" };
const _hoisted_75 = { class: "field-row" };
const _hoisted_76 = { class: "print-footer" };
  ...
  setup(__props, { expose: __expose }) {
    ...
    const fetchObservationValues = async (conceptName) => {
      ...
      try {
        ...
        const resolved = await Promise.all(observations.map((obs) => ObservationService.resolvePrimaryValue(obs)));
    ...
    const loadVitalsFromObservations = async () => {
      if (!patient.value?.patientID) return;
      try {
        const [temperature, heartRate, respiratoryRate, oxygenSaturation, bloodSugar, currentWeight, headCircumference] = await Promise.all([
    ...
    const loadAdmissionOutcomesFromObservations = async () => {
      if (!patient.value?.patientID) return;
      try {
        const [outcome, outcomeOther, safeguardConcerns, healthcareWorkerId, userRole, signature, signOffDate] = await Promise.all([
          fetchSingleObservationValue("Admission outcome"),
          fetchSingleObservationValue("Admission outcome other"),
        ...
        observationAdmissionOutcomesData.value = {
          ...
          admissionOutcomeOther: outcomeOther,
          safeguardConcerns,
          healthcareWorkerId,
          userRole,
    ...
    const ensureSignsSymptomsFromObservations = async () => {
      ...
      try {
        const [complaints, notes, onset, severity] = await Promise.all([
    ...
    const exportPdf = async () => {
      ...
      renderSection(
        ...
        [
          ...
          finalAdmissionOutcomesData.value.admissionOutcome === "Other" ? ["Other outcome", finalAdmissionOutcomesData.value.admissionOutcomeOther] : null,
        ...
        createBaseVNode("div", _hoisted_12, [
          createBaseVNode("div", _hoisted_13, [
            ...
            createBaseVNode("section", _hoisted_44, [
              _cache[34] || (_cache[34] = createBaseVNode("h3", { class: "section-title" }, "Admission Outcome", -1)),
              ...
              finalAdmissionOutcomesData.value.admissionOutcome === "Other" ? (openBlock(), createElementBlock("div", _hoisted_47, [
                _cache[32] || (_cache[32] = createBaseVNode("span", null, "Other outcome", -1)),
                createBaseVNode("span", null, toDisplayString(formatValue(finalAdmissionOutcomesData.value.admissionOutcomeOther)), 1)
              ])) : createCommentVNode("", true),
              createBaseVNode("div", _hoisted_48, [
                _cache[33] || (_cache[33] = createBaseVNode("span", null, "Safeguard concerns", -1)),
          ...
          createBaseVNode("div", _hoisted_49, [
            createBaseVNode("section", _hoisted_50, [
              _cache[42] || (_cache[42] = createBaseVNode("h3", { class: "section-title" }, "Patient Information", -1)),
              createBaseVNode("div", _hoisted_51, [
                _cache[35] || (_cache[35] = createBaseVNode("span", null, "Name", -1)),
                createBaseVNode("span", null, toDisplayString(patientFullName.value), 1)
              ]),
              createBaseVNode("div", _hoisted_52, [
                _cache[36] || (_cache[36] = createBaseVNode("span", null, "NPID", -1)),
                createBaseVNode("span", null, toDisplayString(patientNPID.value), 1)
              ]),
              createBaseVNode("div", _hoisted_53, [
                _cache[37] || (_cache[37] = createBaseVNode("span", null, "Gender", -1)),
                createBaseVNode("span", null, toDisplayString(patientGender.value), 1)
              ]),
              createBaseVNode("div", _hoisted_54, [
                _cache[38] || (_cache[38] = createBaseVNode("span", null, "Date of birth", -1)),
                createBaseVNode("span", null, toDisplayString(patientDOB.value), 1)
              ]),
              createBaseVNode("div", _hoisted_55, [
                _cache[39] || (_cache[39] = createBaseVNode("span", null, "Admitted from", -1)),
                createBaseVNode("span", null, toDisplayString(formatValue(enrollmentData.value.admittedFrom)), 1)
              ]),
              createBaseVNode("div", _hoisted_56, [
                _cache[40] || (_cache[40] = createBaseVNode("span", null, "Referred from", -1)),
                createBaseVNode("span", null, toDisplayString(formatValue(enrollmentData.value.referredFrom)), 1)
              ]),
              createBaseVNode("div", _hoisted_57, [
                _cache[41] || (_cache[41] = createBaseVNode("span", null, "Transport mode", -1)),
...
const PrintableAdmissionForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-769b9060"]]);

const _hoisted_1$1 = { class: "print-summary-wrapper" };
...
const PrintSummarySection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7c1e8082"]]);
...
const AdmissionSignOff = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-4f4ac550"]]);
