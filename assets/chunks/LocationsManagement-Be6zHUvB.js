import { q as defineComponent, a2 as onMounted, r as ref, v as resolveComponent, x as createElementBlock, y as openBlock, B as createBaseVNode, z as createVNode, A as withCtx, a5 as createTextVNode, E as unref, N as IonButton, K as modalController, cs as useRoute, w as watch, bm as V, cY as DataTable, n as nextTick, O as createBlock, G as createCommentVNode, H as IonContent, a4 as normalizeClass, br as IonPage } from './vendor-BPW-J91F.js';
import { a2 as getFieldValue, W as LocationService, G as toastSuccess, t as toastWarning, _ as _export_sfc, a1 as modifyFieldValue, S as Service, L as useWorkerStore, n as icons, F as DynamicButton, o as createModal, a4 as popoverConfirmation, g as getPouchDBRecords, H as HisDate, T as Toolbar } from '../index-VhmzLedw.js';
import { u as useStockStore } from './StockStore-CS2zZjWM.js';
import { u as useStartEndDate } from './StartEndDate-DQNHgY9f.js';
import { B as BasicForm } from './BasicForm-B_LQ90yY.js';
import { v as validateInputFiledData } from './group_validation-D7dTq5yv.js';
