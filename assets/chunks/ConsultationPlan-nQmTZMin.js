import { s as defineComponent, w as watch, a3 as onMounted, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, R as alertCircleOutline, J as Fragment, S as renderList, Q as normalizeClass, b8 as calendarOutline, D as toDisplayString, a9 as chevronDownOutline, H as createCommentVNode, f as ref, c as computed, L as IonIcon, ev as bodyOutline, eN as scanOutline, bH as addOutline, bs as pulseOutline, eO as moveOutline, eP as fitnessOutline, de as manOutline, eQ as happyOutline, eR as earOutline, eS as nutritionOutline, dj as eyeOutline, c4 as warningOutline, aS as medicalOutline, aV as femaleOutline, v as documentTextOutline, n as nextTick, O as createBlock, B as withCtx, a7 as IonLabel, a5 as createTextVNode, dF as IonToggle, aq as IonItem, af as IonRow, aH as IonAccordion, N as IonButton, a8 as withModifiers, aI as IonAccordionGroup, ap as IonList, au as script, a6 as IonInput, bI as saveOutline, G as closeCircleOutline, ca as clipboardOutline, ad as IonTextarea, aA as IonCol, aL as useRouter, bM as useRoute, M as IonSpinner, dH as IonLoading, aG as IonContent, bZ as chevronBackOutline, T as withDirectives, U as vShow, bv as IonPage, eL as lockClosedOutline, ab as checkmarkOutline } from './vendor-DOib3KBh.js';
import { s as storeToRefs, m as mapState } from './pinia-X75jUKgt.js';
import { _ as _sfc_main$a, u as useFormWizard } from './useFormWizard-0fJ5qylF.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, ar as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aC as ListPicker, bj as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bl as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-CIoHV0W6.js';
import { D as DemographicBar } from './DemographicBar-DZGC3EMW.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CKqDOFg7.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BQEtvPOD.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-DM1FH_0H.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-Cl_TvSHG.js';
import { I as Investigations } from './Investigations-D1wemuZo.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-BBhMEfI7.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-BSiD2ce8.js';
import { P as PreviousTreatment } from './treatment-UBYoDNbB.js';
import { l as lodashExports } from './lodash-DGAubbbX.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-B7MiPZ-2.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CeQC1KIh.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-M7gjeAx9.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DapQJfXp.js';
...
const ConsultationPlan = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-009e978c"]]);
