...
import { n as icons, H as HisDate, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-OU0RFndh.js';
import { S as SaveProgressModal } from './SaveProgressModal-Dv9x4D5L.js';
import { d as defineStore } from './pinia-B4JSZd0E.js';
import { getInfographicByKey } from './infographics-DcheaXK6.js';
import { e as feedingTypeLabels, f as feedingModeLabels, a as feedingFrequencyLabels, b as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, c as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, d as umbilicalConditionLabels } from './reviewOfSystemsLabels-C_PVLOpw.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-CpU456tc.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("StartMeasuringOxygenSaturation"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DcheaXK6.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0ce41dd8"]]);

export { neonatalReviewOfSystemsFormKey as A, useReviewOfSystemsStore as B, neonatalAdmissionOutcomeSections as C, useNeonatalAdmissionOutcomesStore as D, neonatalAdmissionOutcomesSections as E, neonatalInvestigationSections as F, neonatalTreatmentPlanSections as G, neonatalTreatmentPlanFormKey as H, useTreatmentPlanStore as I, defaultNeonatalTreatmentPlanForm as J, NeonatalStepper as N, useDiagnosisStore as a, useSuggestedDiagnosisStore as b, congenitalAbnormalityLabels as c, neonatalEnrollmentSections as d, neonatalVitalsSections as e, neonatalVitalsFormKey as f, useNeonatalTriageStore as g, useNeonatalVitalsStore as h, getDischargeSectionByName as i, neonatalDischargeFormKey as j, neonatalDischargeSections as k, neonatalAdmissionOutcomesFormKey as l, useNeonatalDischargeStore as m, neonatalGeneralExaminationSections as n, getDischargeSectionIndexByName as o, neonatalTriageSections as p, neonatalTriageFormKey as q, defaultNeonatalTriageForm as r, neonatalSystemicExaminationFormKey as s, triageConceptMapping as t, useNeonatalExamStore as u, useSystemicExaminationStore as v, neonatalSignsSymptomsSections as w, neonatalSignsSymptomsFormKey as x, useSignsSymptomsStore as y, neonatalReviewOfSystemsSections as z };
