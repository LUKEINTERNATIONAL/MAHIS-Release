...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bl as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bm as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-BgFAo788.js';
import { D as DemographicBar } from './DemographicBar-BhlQCTV7.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-BQkzkFPd.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-CqNK4Zgi.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-B4cNLeMs.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DFTboHMI.js';
import { I as Investigations } from './Investigations-Ce9Qkpo3.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-EcW3cWGU.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-WavdoLfy.js';
import { P as PreviousTreatment } from './treatment-LB_OdYeV.js';
import { l as lodashExports } from './lodash-C2jZK40L.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-BcCp6LQu.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-Bl9q8t-1.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-D2HIfGNQ.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Cs6cEZuW.js';
