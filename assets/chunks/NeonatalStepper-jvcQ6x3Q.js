    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("StartMeasuringOxygenSaturation"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
    ...
    formData: [
      {
        componentType: "Alert",
        header: "",
        message: "Mother’s enrollment details. Test History.",
...
const neonatalSignsSymptomsSections = [
  ...
  },
  {
    ...
    formData: [
      {
        componentType: "Alert",
        name: "signs_symptoms_summary_alert",
        type: "warning",
        backgroundColor: "#FEDF89",
        textColor: "#00190E",
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("JaundiceManagement"))
      },
      {
        componentType: "listSelectionField",
    ...
    formData: [
      ...
      },
      {
        ...
        builder: (formValues) => {
          ...
          pushRow("Genitalia", "Genitalia findings", formatLabel(formValues.genitaliaFindings, genitaliaFindingsLabels));
          pushRow("Anus", "Anus findings", formatLabel(formValues.anusFindings, anusFindingsLabels));
          ...
          pushRow(
            "Abdomen Findings",
            "Mass description",
            formValues.otherMassesDescription,
            void 0,
            formValues.otherMasses !== "yes"
          );
          return rows;
        }
      }
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-1mg3dkWu.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalMoroReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "moroReflex",
    ...
    formData: [
      {
        ...
        builder: (formValues) => {
          ...
          pushRow("Birth asphyxia", "Birth asphyxia suspected?", data.birthAsphyxiaSuspected === "yes" ? "Yes" : data.birthAsphyxiaSuspected === "no" ? "No" : void 0);
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c0040f0c"]]);
