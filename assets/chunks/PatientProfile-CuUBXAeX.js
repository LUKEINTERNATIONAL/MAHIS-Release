...
import { i as isTaskPermitted } from './tasks-DMckeiG9.js';
import { A as ANCRedirection } from './anc_service-DVyy6Haw.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-Cf7RWfiS.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Bnu4Eoj_.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-DGkhvzlp.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-DxDX-evc.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CtmRwJP8.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-D9b2BdKs.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DWpHoqSu.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-Bc5midCH.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-ClncNYUb.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-ZXJ404qS.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-DAaurZ2Z.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-CA5gZ8gz.js').then(n => n.cT),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-C_fIjrrj.js'),true              ?[]:void 0,import.meta.url));
