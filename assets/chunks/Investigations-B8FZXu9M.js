import { O as OrderService, br as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bs as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, bb as SelectionPopover, S as Service, g as getPouchDBRecords, aq as ConceptService, bn as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bt as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bu as ADULT_WHO_STAGE_CRITERIA, bv as CHILD_WHO_STAGE_CRITERIA, bw as ADULT_ART_ELIGIBILITY, bx as CHILD_ART_ELIGIBILITY, by as RECOMMENDED_ADULT_STAGING_CONDITIONS, bz as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bA as BasicYesNoSelect, bB as BasicDateInput, bC as BasicSelect, bD as BasicInput, bE as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, r as StandardModal, a2 as getFieldValue, b7 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-eygbwbqc.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-DvUiFzi9.js';
import LabOrdersList from './LabOrdersList-PjtwBSyF.js';
import { v as validateInputFiledData } from './group_validation-BKwxT92P.js';
import { u as useRadiologyStore } from './RadiologyStore-OmG4d0bE.js';
import { B as BasicForm } from './BasicForm-DrQ3JvEq.js';
import { s as defineComponent, a2 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, R as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, br as pulseOutline, bc as checkmark, a5 as createTextVNode, c as computed, bK as IonCard, aB as IonGrid, af as IonRow, aA as IonCol, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, D as toDisplayString, bO as IonChip, ae as IonCheckbox, by as IonText, bd as IonCardContent, r as reactive, p as dayjs, aL as useRouter, ct as useRoute, S as withDirectives, T as vShow, K as modalController } from './vendor-CHJxKtY0.js';
import { l as lodashExports } from './lodash-DVS_Ha8A.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-3Y5yC4bp.js';
import { D as DashBox } from './DashBox-DolP_IeW.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-B-NsSF9r.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-Vd3jy_0-.js';
import { P as PatientComplaintsService } from './patient_complaints_service-Daal4uaQ.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-Dw7SfebS.js';
import { i as isClinician } from './Registration-lEgjSBk_.js';
