import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, aF as IonContent, bt as IonPage, aK as useRouter, eU as provide, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-BIA1Qh8a.js';
import { s as storeToRefs } from './pinia-BgytB2RM.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, H as HisDate, G as toastSuccess, x as toastDanger } from '../index-BAzlf83c.js';
import { i as neonatalAdmissionOutcomesFormKey, C as neonatalAdmissionOutcomeSections, N as NeonatalStepper, D as useNeonatalAdmissionOutcomesStore, j as neonatalAdmissionSignOffSections, E as neonatalAdmissionOutcomesSections } from './NeonatalStepper-D3dgA2Ma.js';
import { P as PrintSummarySection } from './PrintSummarySection-Cse35P0X.js';
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const wizardSections = [...neonatalAdmissionOutcomeSections, neonatalAdmissionSignOffSections[1]];
...
const AdmissionOutcomes = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-523e6c6d"]]);
