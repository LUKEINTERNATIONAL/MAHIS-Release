import { s as defineComponent, d0 as addIcons, aN as useRouter, w as watch, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, Q as normalizeClass, D as toDisplayString, H as createCommentVNode, A as createVNode, F as unref, a6 as IonInput, L as IonIcon, a5 as createTextVNode, J as Fragment, S as renderList, f as ref, c as computed, d1 as arrowBackOutline, cf as personAddOutline, R as alertCircleOutline, ao as informationCircleOutline, aw as searchOutline, cb as clipboardOutline, by as personCircleOutline, br as V, x as resolveComponent, O as createBlock, B as withCtx, bO as useRoute, bP as x, n as nextTick, aL as p, d2 as clipboard, d3 as thermometer, aP as people, d4 as person, d5 as add, ck as medkit, d6 as globe, d7 as document$1, d8 as colorPalette, d9 as chevronUpCircle, da as chevronForwardCircle, db as chevronDownCircle, dc as grid, be as checkmark, b$ as chevronBackOutline, bf as IonCardContent, bc as IonCardTitle, bd as IonCardHeader, bN as IonCard, aB as IonCol, N as IonButton, af as IonRow, aE as IonToolbar, bx as IonPage, I as IonHeader, aI as IonContent, aD as todayOutline, dd as timeOutline, b2 as locationOutline, de as womanOutline, df as manOutline, cK as idCardOutline, b1 as personOutline, cP as openOutline, ba as calendarOutline, r as reactive, P as normalizeStyle, dg as gridOutline, b6 as peopleOutline, b0 as medkitOutline, T as withDirectives, aA as vModelText, dh as chevronForwardOutline, p as dayjs, di as IonSegment, dj as IonSegmentButton, a7 as IonLabel, dk as eyeOutline, ab as checkmarkOutline, bL as IonBadge, au as script, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, K as modalController, bu as pulseOutline, dl as Navigation, dm as Pagination, dn as Slide, dp as Carousel, ae as IonCheckbox, al as IonPopover, cm as onBeforeUnmount, cG as createSlots, G as closeCircleOutline, U as vShow, dq as checkmarkDoneCircleOutline, bp as search, bg as IonButtons, dr as personAdd, ag as close, ds as skullOutline, dt as calendar, ce as flask, du as refresh, dv as lockClosed, a4 as onUnmounted, c5 as resolveDynamicComponent } from './vendor-QOXikrLM.js';
import { S as Service, u as useDemographicsStore, _ as _export_sfc, P as PatientService, t as toastWarning, a as useProgramStore, E as EncounterService, H as HisDate, g as getPouchDBRecords, b as EncounterTypeId, A as AppointmentService, c as HorizontalLine, d as _sfc_main$y, e as useGeneralStore, f as useStatusStore, h as useWindowSize, i as useEnrollementStore, R as ReportService, p as parameterizeUrl, j as STANDARD_DATE_FORMAT, k as alertConfirmation, O as OrderService, l as PreviousVitals, B as BasicInputField, m as useAdministerVaccineStore, n as icons, o as createModal, q as usePatientList, r as StandardModal, s as isPatientDeceased, v as closeVisit, w as getTodaysVisits, x as toastDanger, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, D as PatientSearchService, F as DynamicButton, G as toastSuccess, I as alertConfirmationIonic, J as savePatientRecord, K as ObservationService, L as onPatientRecordSaved, M as ProgramId, N as ConceptService, T as Toolbar, Q as useWorkerStore, U as checkAndsetSessionDate, V as resetDemographics, W as useGlobalPropertyStore, X as UserService, Y as LocationService, Z as modal } from '../index-SKNIAGXC.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-BRP2SQHv.js';
import { A as Appointment } from './ncd_appointment_service-DGa0_ST4.js';
import { D as DateInputField } from './DateInputField-ymcYGu-D.js';
import { u as useActionButtonStore, _ as _sfc_main$G, M as ModulePicker } from './ActionButtons.vue_vue_type_script_setup_true_lang-7oKNOCRl.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-B2Y6Q-oT.js';
import { B as BottomNavBar } from './bottomNavBar-Baa4OoSX.js';
import { P as PatientReportService } from './patient_report_service-Dmc-xguV.js';
import { l as lodashExports } from './lodash-CVfF-l1v.js';
import { B as BasicForm } from './BasicForm-ClINxl6R.js';
import { B as BasicCard } from './BasicCard-xB9a9eI9.js';
import { u as useAdministerOtherVaccineStore } from './AdministerOtherVaccinesStore-Dxz-LUlK.js';
import { c as customDatePicker } from './customDatePicker-ncuXVQCV.js';
import { s as saveVaccineAdministeredDrugs } from './vaccines_service-CqDa-14e.js';
import { g as getVaccinesData } from './dashboard_service-BmZ80sn9.js';
import { i as img } from './Img-RarZMYTn.js';
import { R as ReusableDataTable } from './ReusableDataTable-Da_yTrfK.js';
import { u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$z, b as _sfc_main$A, c as _sfc_main$B, d as _sfc_main$C, e as _sfc_main$D, f as _sfc_main$E, g as _sfc_main$F, R as RegistrationService } from './useSetRegistrationValues-DqT4b5dz.js';
import { u as useUserActivities } from './useUserActivities-DUzYXQlE.js';
import { L as LandingPage } from './LandingPage-d5pDrY5G.js';
...
const _hoisted_1$q = { class: "fhir-viewer" };
const _hoisted_2$p = { class: "container" };
const _hoisted_3$n = {
  key: 0,
  class: "main-header"
};
const _hoisted_4$j = { class: "header-line" };
const _hoisted_5$i = {
  key: 0,
...
const _hoisted_7$b = { class: "action-area-initial" };
const _hoisted_8$9 = {
  key: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$q, [
        createBaseVNode("div", _hoisted_2$p, [
          fhirPatientData.value?.length ? (openBlock(), createElementBlock("header", _hoisted_3$n, [
            createBaseVNode("div", _hoisted_4$j, [
              ...
              createBaseVNode("div", null, [
                ...
                lastUpdatedDate.value ? (openBlock(), createElementBlock("span", _hoisted_5$i, "Last Updated: " + toDisplayString(lastUpdatedDate.value), 1)) : createCommentVNode("", true)
              ])
            ])
          ])) : createCommentVNode("", true),
          !fhirPatientData.value?.length ? (openBlock(), createElementBlock("section", _hoisted_6$c, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(fhirPatientData.value, (bundle) => {
            return openBlock(), createElementBlock("div", {
              ...
              bundle.resourceType === "Bundle" && bundle.entry && bundle.entry[0] && bundle.entry[0].resource.resourceType === "Patient" ? (openBlock(), createElementBlock("section", _hoisted_8$9, [
...
const ExternalReferrals = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-0dc329ef"]]);
...
const _hoisted_1$p = { class: "dueCardContent" };
...
const InternalReferrals = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$c], ["__scopeId", "data-v-5e71d001"]]);
...
const _hoisted_2$o = { style: { "display": "flex", "margin-top": "10px" } };
const _hoisted_3$m = {
  key: 0,
...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    _ctx.segmentContent == "Internal referrals" ? (openBlock(), createElementBlock("div", _hoisted_1$o, [
      createBaseVNode("div", _hoisted_2$o, [
        _ctx.checkUnderFive ? (openBlock(), createElementBlock("div", _hoisted_3$m)) : createCommentVNode("", true),
        _cache[4] || (_cache[4] = createBaseVNode("div", { style: { "width": "50vw", "background-color": "#fff", "border-radius": "5px", "margin-right": "5px" } }, null, -1)),
        !_ctx.checkUnderFive ? (openBlock(), createElementBlock("div", _hoisted_4$i)) : createCommentVNode("", true)
      ])
    ])) : createCommentVNode("", true),
    _ctx.segmentContent == "External referrals" ? (openBlock(), createElementBlock("div", _hoisted_5$h, [
      createVNode(_component_ExternalReferrals)
    ])) : createCommentVNode("", true),
    _ctx.segmentContent == "Internal referrals" ? (openBlock(), createElementBlock("div", _hoisted_6$b, [
      createVNode(_component_InternalReferrals)
    ])) : createCommentVNode("", true)
  ], 64);
}
const Referral = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$b], ["__scopeId", "data-v-8f0f935e"]]);
...
const _hoisted_1$n = { class: "cards-container" };
const _hoisted_2$n = { class: "top-card-text" };
const _hoisted_3$l = { class: "text-2xl font-bold" };
const _hoisted_4$h = { class: "top-card-text" };
const _hoisted_5$g = { class: "text-2xl font-bold" };
const _hoisted_6$a = { class: "top-card-text" };
const _hoisted_7$a = { class: "text-2xl font-bold" };
const _hoisted_8$8 = { class: "top-card-text" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$n, [
              ...
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_2$n, [
                    createBaseVNode("div", _hoisted_3$l, toDisplayString(appointments.value?.length || 0), 1),
              ...
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_4$h, [
                    createBaseVNode("div", _hoisted_5$g, toDisplayString(dashboardData.value.total_pending_dispensations), 1),
              ...
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_6$a, [
                    createBaseVNode("div", _hoisted_7$a, toDisplayString(dashboardData.value.total_defaulters), 1),
          ...
          createVNode(_component_ion_card, {
            class: "top-card action-card",
            onClick: _cache[1] || (_cache[1] = ($event) => navigationMenu("/ncd/active-patients"))
          }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
              ...
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  ...
                  createBaseVNode("div", _hoisted_13$4, [
                    isChartReady.value ? (openBlock(), createBlock(unref(x), {
                      key: 0,
...
const Dashboard$3 = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-799ee56f"]]);
...
const _sfc_main$s = defineComponent({
  name: "Home",
  mixins: [_sfc_main$y, _sfc_main$t],
  components: {
    IonContent,
    IonHeader,
    IonPage,
  ...
  methods: {
    ...
    redirectUser() {
      ...
      if (roles.some((role) => roles.some((role2) => role2.role === "Pharmacist"))) {
        this.$router.push("/ncd/dispensations");
      } else {
        this.$router.push("/patient-profile");
      }
    },
...
const _hoisted_1$m = { class: "appointments-container" };
const _hoisted_2$m = { class: "date-filter" };
const _hoisted_3$k = {
  key: 0,
  style: { "margin": "20px" }
};
const _hoisted_4$g = { key: 1 };
const _hoisted_5$f = { class: "appointments-table" };
const _hoisted_6$9 = { key: 2 };
const _hoisted_7$9 = { class: "date-group-header" };
const _hoisted_8$7 = { class: "date-header-title" };
...
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$m, [
    ...
    createVNode(_component_ion_content, { class: "scrollable-content" }, {
      default: withCtx(() => [
        _ctx.people.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_3$k, [
          createVNode(_component_ion_icon, {
        ...
        ])) : _ctx.currentToggleView === "list" && _ctx.people.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_4$g, [
          createVNode(_component_ion_card, null, {
            default: withCtx(() => [
              createBaseVNode("table", _hoisted_5$f, [
        ...
        ])) : _ctx.currentToggleView === "card" && _ctx.people.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_6$9, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.groupedPaginatedPeople, (appointmentsGroup, date) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_7$9, [
                ...
                createBaseVNode("h2", _hoisted_8$7, toDisplayString(date), 1),
...
const NCDAppointments = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$a], ["__scopeId", "data-v-0a4b0933"]]);

const _hoisted_1$l = {
  key: 0,
  class: "left_col"
};
const _hoisted_2$l = { class: "nav-menu" };
const _hoisted_3$j = ["onClick"];
const _hoisted_4$f = { class: "ellipsis" };
const _hoisted_5$e = {
  key: 1,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(screenWidth) > 940 ? (openBlock(), createElementBlock("div", _hoisted_1$l, [
            ...
            createBaseVNode("ul", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(menuItems.value, (item) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  createBaseVNode("span", _hoisted_4$f, toDisplayString(item.label), 1)
                ], 10, _hoisted_3$j);
              }), 128))
            ])
          ])
        ])) : createCommentVNode("", true),
        unref(screenWidth) <= 940 ? (openBlock(), createElementBlock("div", _hoisted_5$e, [
          createVNode(_component_ion_segment, {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", null, [
            ...
            activeItem.value === "dashboard" ? (openBlock(), createBlock(Dashboard$3, { key: 1 })) : createCommentVNode("", true),
...
const NCDDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-a1132315"]]);
...
const _hoisted_1$k = { class: "content-wrapper dashboard" };
const _hoisted_2$k = { class: "header" };
const _hoisted_3$i = { class: "overlay" };
const _hoisted_4$e = { class: "big-number" };
const _hoisted_5$d = { class: "" };
const _hoisted_6$8 = { class: "cards" };
const _hoisted_7$8 = { class: "card" };
const _hoisted_8$6 = { class: "card-info" };
          ...
          createBaseVNode("div", _hoisted_1$k, [
            createBaseVNode("div", _hoisted_2$k, [
              createBaseVNode("div", _hoisted_3$i, [
                createBaseVNode("h1", _hoisted_4$e, toDisplayString(stats.value?.clients_with_conclusive_results), 1),
...
const HTSDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-d89b76e6"]]);
...
const _hoisted_1$j = { class: "dashboard-container" };
const _hoisted_2$j = { class: "main-section" };
const _hoisted_3$h = { class: "chart-section" };
const _hoisted_4$d = { class: "encounters-section" };
const _hoisted_5$c = { class: "his-sm-text" };
const _hoisted_6$7 = { key: 0 };
const _hoisted_7$7 = { class: "encounter-td" };
const _hoisted_8$5 = { class: "other-td" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$j, [
        createBaseVNode("div", _hoisted_2$j, [
          ...
          createBaseVNode("div", _hoisted_4$d, [
            ...
            createBaseVNode("table", _hoisted_5$c, [
              ...
              rows.value.length ? (openBlock(), createElementBlock("tbody", _hoisted_6$7, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (data, index) => {
                  return openBlock(), createElementBlock("tr", { key: index }, [
                    createBaseVNode("td", _hoisted_7$7, toDisplayString(data.encounter), 1),
                    createBaseVNode("td", _hoisted_8$5, toDisplayString(data.female), 1),
...
const ARTDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-9bb19378"]]);
...
const _hoisted_1$i = { class: "vl-alerts-container" };
const _hoisted_2$i = { class: "table-container" };
const _hoisted_3$g = { class: "vl-table" };
const _hoisted_4$c = { key: 0 };
const _hoisted_5$b = { key: 0 };
const _hoisted_6$6 = ["colspan"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$i, [
        ...
        createBaseVNode("div", _hoisted_2$i, [
          createBaseVNode("table", _hoisted_3$g, [
            createBaseVNode("thead", null, [
              createBaseVNode("tr", null, [
                ...
                selectedCategory.value === "rejected" ? (openBlock(), createElementBlock("th", _hoisted_4$c, "Rejection Reason")) : createCommentVNode("", true),
                _cache[4] || (_cache[4] = createBaseVNode("th", null, "View", -1)),
                _cache[5] || (_cache[5] = createBaseVNode("th", null, "Clear", -1))
              ])
            ]),
            createBaseVNode("tbody", null, [
              filteredResults.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_5$b, [
                createBaseVNode("td", {
                  colspan: selectedCategory.value === "rejected" ? 6 : 5,
                  class: "empty-message"
                }, toDisplayString(getEmptyMessage()), 9, _hoisted_6$6)
              ])) : createCommentVNode("", true),
              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredResults.value, (item) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  selectedCategory.value === "rejected" ? (openBlock(), createElementBlock("td", _hoisted_7$6, toDisplayString(item.rejection_reason || "-"), 1)) : createCommentVNode("", true),
                  createBaseVNode("td", null, [
...
const ARTVlAlert = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-7b9c4735"]]);

const _hoisted_1$h = { class: "dashboard-container" };
const _hoisted_2$h = { class: "segment-content" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$h, [
        ...
        selectedSegment.value === "dashboard" ? (openBlock(), createElementBlock("div", _hoisted_3$f, [
          createVNode(ARTDashboard)
        ])) : createCommentVNode("", true),
        selectedSegment.value === "viralLoadAlerts" ? (openBlock(), createElementBlock("div", _hoisted_4$b, [
          createVNode(ARTVlAlert)
        ])) : createCommentVNode("", true),
        selectedSegment.value === "internalReferrals" ? (openBlock(), createElementBlock("div", _hoisted_5$a, [
...
const ARTHome = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-d237cab2"]]);
...
class WebSocketService {
  ...
  shouldFetchOnOpen;
  identifier;
  isImmunizationChannel;
  externalMessageHandler = null;
  subscribeRetryIntervalId = null;
  subscribeAttempts = 0;
  maxSubscribeAttempts = 15;
  subscribeRetryMs = 1e3;
  constructor(options = {}) {
    this.channel = options.channel || "ImmunizationReportChannel";
    this.location_id = `${options.locationId ?? localStorage.getItem("locationID") ?? ""}`;
    this.shouldFetchOnOpen = options.fetchOnOpen ?? this.channel === "ImmunizationReportChannel";
    this.isImmunizationChannel = this.channel === "ImmunizationReportChannel";
    this.identifier = JSON.stringify({ channel: this.channel, location_id: this.location_id });
  ...
  async init() {
    ...
    try {
      ...
      this.socket = new WebSocket(url, ["actioncable-v1-json", "actioncable-unsupported"]);
  ...
  onMessage = async (event) => {
    try {
      ...
      if (payload?.type === "confirm_subscription" && payload?.identifier === this.identifier) {
        this.isSubscribed = true;
        this.stopSubscriptionRetry();
        this.subscribeAttempts = 0;
        if (this.shouldFetchOnOpen && this.isImmunizationChannel) {
          await this.getPatientSummary();
        }
      }
      if (payload?.type === "reject_subscription" && payload?.identifier === this.identifier) {
        console.error("WebSocket subscription rejected:", this.identifier);
        this.stopSubscriptionRetry();
        this.subscribeAttempts = 0;
      }
    } catch (_error) {
      ...
      if (this.externalMessageHandler) {
        this.externalMessageHandler(event);
      }
    }
  };
  ensureSubscribed() {
    if (this.isSubscribed || !this.isConnected) return;
    if (this.subscribeRetryIntervalId) return;
    this.subscribe();
    this.subscribeRetryIntervalId = window.setInterval(() => {
      if (this.isSubscribed) {
        this.stopSubscriptionRetry();
        return;
      }
      if (this.subscribeAttempts >= this.maxSubscribeAttempts) {
        console.error("WebSocket subscription was not confirmed:", this.identifier);
        this.stopSubscriptionRetry();
        return;
      }
      this.subscribe();
    }, this.subscribeRetryMs);
  }
  stopSubscriptionRetry() {
    if (!this.subscribeRetryIntervalId) return;
    window.clearInterval(this.subscribeRetryIntervalId);
    this.subscribeRetryIntervalId = null;
  }
  subscribe() {
...
const _hoisted_2$g = { class: "header position_content" };
const _hoisted_3$e = { style: { "font-size": "1.2em", "font-weight": "700" } };
const _hoisted_4$a = { class: "dueCardContent" };
const _hoisted_5$9 = ["onClick"];
const _hoisted_6$5 = { style: { "margin-right": "15px" } };
const _hoisted_7$5 = { style: { "align-items": "center", "display": "flex" } };
const _hoisted_8$4 = { style: { "line-height": "1" } };
...
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_ion_content = resolveComponent("ion-content");
  return openBlock(), createElementBlock(Fragment, null, [
    _ctx.isLoading ? (openBlock(), createElementBlock("div", _hoisted_1$g, [
    ...
    createVNode(_component_ion_header, null, {
      default: withCtx(() => [
        createBaseVNode("div", _hoisted_2$g, [
          ...
          createBaseVNode("div", _hoisted_3$e, toDisplayString(_ctx.title), 1),
          createBaseVNode("div", {
            style: { "display": "flex", "align-items": "center" },
...
const DueModal = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$9], ["__scopeId", "data-v-3b0b9d73"]]);
...
const _hoisted_1$f = { class: "topStats" };
const _hoisted_2$f = { class: "hero-section" };
const _hoisted_3$d = { class: "totalStats" };
const _hoisted_4$9 = { class: "statsValue" };
const _hoisted_5$8 = { class: "statsText" };
const _hoisted_6$4 = { class: "dueCardContent" };
const _hoisted_7$4 = { class: "statsValue" };
const _hoisted_8$3 = { class: "statsValue" };
                  ...
                  return openBlock(), createBlock(_component_Slide, { key: slide }, {
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_3$d, [
                        ...
                        createBaseVNode("div", _hoisted_4$9, toDisplayString(slide.value), 1),
                        createBaseVNode("div", _hoisted_5$8, toDisplayString(slide.name), 1)
                      ])
                    ]),
                    _: 2
                  }, 1024);
              ...
              default: withCtx(() => [
                createBaseVNode("div", _hoisted_6$4, [
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", _hoisted_7$4, toDisplayString(_ctx.reportData?.due_today_count || 0), 1),
                  ...
                  createBaseVNode("div", {
                    ...
                    createBaseVNode("div", _hoisted_8$3, toDisplayString(_ctx.reportData?.due_this_week_count || 0), 1),
                  ...
                  createBaseVNode("div", {
                    ...
                    _cache[11] || (_cache[11] = createBaseVNode("div", { class: "card-badge info" }, "Month", -1)),
...
const ImmunizationDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$8], ["__scopeId", "data-v-a679882a"]]);

const _sfc_main$k = /* @__PURE__ */ defineComponent({
  __name: "OPDWaitingListModal",
  props: {
    title: { default: "" },
    list: { default: "" },
    buttonTitle: { default: "" },
  ...
  setup(__props) {
    ...
    const patients = ref([]);
    const setButtonLoading = (patientId, buttonType, isLoading) => {
      const button = document.querySelector(`.btn-${patientId}-${buttonType}`);
      if (!button) return;
      ...
      if (isLoading) {
        ...
        if (loadingSpan) {
          ...
          const interval = setInterval(() => {
            ...
            loadingSpan.textContent = "●".repeat(dotCount || 1);
          }, 300);
        ...
        if (button.loadingInterval) {
          clearInterval(button.loadingInterval);
          button.loadingInterval = null;
        }
      }
    };
    const navigateTo = async (stage, route) => {
      const buttonType = route === props.buttonLink ? "primary" : "profile";
      setButtonLoading(stage.identifier, buttonType, true);
      try {
        let patientRecords = [];
        ...
        setButtonLoading(stage.identifier, buttonType, false);
      }
    };
    const handleAbscond = async (identifier) => {
      setButtonLoading(identifier, "abscond", true);
      try {
        await closeVisit({ ID: identifier });
      } catch (error) {
        console.error("Error closing visit:", error);
      } finally {
        setButtonLoading(identifier, "abscond", false);
      }
    };
    const tableColumns = computed(() => [
      ...
      },
      {
        ...
        createdCell: (td, cellData, rowData) => {
          td.innerHTML = "";
          td.style.cssText = "display: flex; gap: 10px; align-items: center; padding: 8px;";
          const createButton = (text, colorType, onClick, buttonType) => {
            const wrapper = document.createElement("div");
            wrapper.style.cssText = "display: inline-flex; align-items: center; margin-right: 10px;";
            const btn = document.createElement("button");
            btn.className = `btn-action btn-${rowData.identifier}-${buttonType}`;
            btn.setAttribute("data-patient-id", rowData.identifier);
            btn.setAttribute("data-button-type", buttonType);
            const colorMap = {
              primary: { bg: "#006401", text: "#ffffff", hoverBg: "#005001" },
              warning: { bg: "#fedf89", text: "#b54708", hoverBg: "#fcd34d" },
              danger: { bg: "#fecdca", text: "#b42318", hoverBg: "#fca5a0" }
            };
            ...
            loadingSpan.style.cssText = "display: none; font-weight: bold;";
            loadingSpan.textContent = "●●●";
            btn.appendChild(textSpan);
            btn.appendChild(loadingSpan);
            btn.addEventListener("mouseenter", () => {
              if (!btn.hasAttribute("disabled")) {
                btn.style.backgroundColor = colors.hoverBg;
          ...
          td.appendChild(createButton(props.buttonTitle, "primary", () => navigateTo(rowData, props.buttonLink), "primary"));
          td.appendChild(createButton("Profile", "warning", () => navigateTo(rowData, "/patient-profile"), "profile"));
          td.appendChild(createButton("Abscond", "danger", () => handleAbscond(rowData.identifier), "abscond"));
        },
        orderable: false,
        width: "25%"
      }
    ...
    const setList = () => {
      const map = {
        VITALS: patientsWaitingForVitals,
        CONSULTATION: patientsWaitingForConsultation,
        LAB: patientsWaitingForLab,
        DISPENSATION: patientsWaitingForDispensation
      };
      const key = props.list;
      patients.value = map[key] || [];
    };
    watch(
      () => patientsWaitingForConsultation,
      (newVal) => {
        if (props.list === "CONSULTATION") patients.value = newVal;
      },
      { deep: true }
    );
    watch(
      ...
      (newVal) => {
        if (props.list === "VITALS") patients.value = newVal;
      },
      { deep: true }
    );
    watch(
      ...
      (newVal) => {
        if (props.list === "LAB") patients.value = newVal;
      },
      { deep: true }
    );
    watch(
      ...
      (newVal) => {
        if (props.list === "DISPENSATION") patients.value = newVal;
      },
      { deep: true }
    );
    onMounted(() => {
      ...
      tableColumns: [
        ...
        },
        {
          ...
          render: (data, type, row) => {
            ...
            container.appendChild(makeButton("Profile", "warning", () => this.navigateTo(data, "/patient-profile"), "profile"));
            return container;
          },
          orderable: false,
          width: "25%"
    ...
    async navigateTo(data, route) {
      ...
      try {
        ...
        if (patient) {
          ...
          await nextTick();
          if (isPatientDeceased()) {
            this.$router.push("/death-patient-profile");
          } else {
...
const OPDAllPatientsModal = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$7], ["__scopeId", "data-v-a5271233"]]);
...
const _hoisted_2$e = { class: "dueCardContent" };
const _hoisted_3$c = {
  key: 1,
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_StandardModal, {
    ...
    content: withCtx(() => [
      ...
      _ctx.viewMode === "range" ? (openBlock(), createElementBlock("div", _hoisted_1$e, [
        createVNode(_component_ion_row, null, {
          default: withCtx(() => [
            createVNode(_component_ion_col, null, {
              default: withCtx(() => [
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_2$e, [
                _ctx.appointments.length > 0 ? (openBlock(), createBlock(_component_DataTable, {
                  ...
                  class: "display nowrap modern-table",
                  width: "100%"
                }, null, 8, ["data", "columns", "options"])) : (openBlock(), createElementBlock("div", _hoisted_3$c, " No appointments found for the selected " + toDisplayString(_ctx.viewMode === "today" ? "day" : "date range"), 1))
              ])
            ]),
            _: 1
          })
...
const OPDAppointmentsModal = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$6], ["__scopeId", "data-v-a53f5cd9"]]);

const _hoisted_1$d = { class: "card-count" };
const _hoisted_2$d = { class: "card-label" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(IonCard), {
        ...
        default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_1$d, toDisplayString(__props.count), 1),
          createBaseVNode("div", _hoisted_2$d, toDisplayString(__props.label), 1)
        ]),
        _: 1
      }, 8, ["style"]);
    };
...
const DashboardCard$1 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-84ad3c1b"]]);
...
const _hoisted_3$b = { style: { "display": "flex", "width": "100%", "justify-content": "center", "padding": "20px" } };
const _hoisted_4$8 = { class: "search-results-container" };
const _hoisted_5$7 = {
  key: 1,
  class: "patient-info-banner"
};
const _hoisted_6$3 = { class: "patient-details" };
const _hoisted_7$3 = {
  key: 2,
  class: "masonry-grid"
};
const _hoisted_8$2 = { class: "card-container" };
      ...
      try {
        ...
        if (selectedPatientInfo.value) {
          ...
          if (data && Object.keys(data).length > 0) {
            ...
            navigateTo("/death-patient-profile");
          } else {
      ...
      return openBlock(), createBlock(StandardModal, {
        ...
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1$c, [
            !__props.editMode ? (openBlock(), createElementBlock("div", _hoisted_2$c, [
            ...
            selectedPatientInfo.value && !showRegistrationForm.value ? (openBlock(), createElementBlock("div", _hoisted_5$7, [
            ...
            showRegistrationForm.value ? (openBlock(), createElementBlock("div", _hoisted_7$3, [
...
const BroughtInDeadRegistration = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-e14d1c14"]]);

const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "BroughtInDeadTable",
  setup(__props) {
    const router = useRouter();
    const statusStore = useStatusStore();
    const loadingBroughtInDead = ref(false);
    const broughtInDeadData = ref([]);
    const tableKey = ref(0);
    const stageUpdatesSocket = ref(null);
    const removePatientRecordSavedListener = ref(null);
    const bidHeaders = ["First Name", "Surname", "Gender", "Age", "Date Of Death", "Cause Of Death", "Brought By", "Confirmed By", "Action"];
    const bidTableOptions = {
      ...
      initComplete: function() {
        ...
        if (buttonsContainer) {
          ...
          button.className = "btn-register-bid";
    ...
    const broughtInDeadTableData = computed(() => {
      return broughtInDeadData.value.map((row) => [
        row.firstName,
        row.surname,
        row.gender,
        row.age,
    ...
    const bidActionHandlers = computed(() => ({
      "view-profile-btn": handleViewProfile
    }));
    const openBroughtDeadModal = () => {
      createModal(BroughtInDeadRegistration, { class: "fullScreenModal" }, true);
    };
    const handleRegistrationComplete = async () => {
      await fetchBroughtInDeadData();
    };
    const fetchBroughtInDeadData = async () => {
      loadingBroughtInDead.value = true;
      try {
        const locationId = Service.getUserLocationId();
        if (!locationId) {
          broughtInDeadData.value = [];
          return;
        }
        ...
        try {
          ...
          onlineData = processEncounters(encounters || [], locationId);
        } catch (error) {
        ...
        try {
          ...
          offlineData = processPatientRecords(patientArray, locationId, today);
        } catch (error) {
          console.error("Offline fetch failed:", error);
        }
        broughtInDeadData.value = combineAndDeduplicate(onlineData, offlineData);
        forceTableUpdate();
      } catch (error) {
        ...
        loadingBroughtInDead.value = false;
      }
    };
    const processPatientRecords = (patients, locationId, targetDate) => {
      const results = [];
    ...
    const processEncounters = (encounters, locationId) => {
    ...
    const combineAndDeduplicate = (onlineData, offlineData) => {
    ...
    const handleViewProfile = async (data) => {
      if (!data || !data.patientId) return;
      setButtonLoading(data.patientId, "profile", true);
      try {
        let patientRecord = null;
        try {
          const patientRecords = await getPouchDBRecords("patients_records", {
        ...
        if (!patientRecord && statusStore.apiStatus) {
          try {
        ...
        if (patientRecord) {
          ...
          setButtonLoading(data.patientId, "profile", false);
        }
      } catch (error) {
    ...
    const parseCableIdentifier = (identifier) => {
      try {
    ...
    const handleRealtimeMessage = (event) => {
      ...
      if (payload?.type || !payload?.identifier || payload?.message === void 0) return;
      const identifier = parseCableIdentifier(payload.identifier);
      if (!identifier || identifier.channel !== "ClientDetailsChannel") return;
      const eventName = `${payload?.message?.event || ""}`.toLowerCase();
      if (eventName === "patient_record_saved") {
        scheduleRealtimeRefresh();
      }
    };
    const connectToRealtimeChannel = async () => {
      if (stageUpdatesSocket.value || Service.getLanConnectionStatus()) return;
      const locationId = Service.getUserLocationId();
      if (!locationId) return;
      stageUpdatesSocket.value = new WebSocketService({
        channel: "ClientDetailsChannel",
        locationId,
        fetchOnOpen: false
      });
      await stageUpdatesSocket.value.setMessageHandler((event) => {
        handleRealtimeMessage(event);
      });
    };
    const disconnectFromRealtimeChannel = async () => {
      if (!stageUpdatesSocket.value) return;
      await stageUpdatesSocket.value.disconnect();
      stageUpdatesSocket.value = null;
    };
    watch(
      () => statusStore.apiStatus,
      () => {
        fetchBroughtInDeadData();
      }
    );
    onMounted(async () => {
      await fetchBroughtInDeadData();
      await connectToRealtimeChannel();
      removePatientRecordSavedListener.value = onPatientRecordSaved(() => {
        scheduleRealtimeRefresh();
      });
      window.addEventListener("register-bid-click", openBroughtDeadModal);
      window.addEventListener("bid-registration-complete", handleRegistrationComplete);
    });
    onBeforeUnmount(() => {
      void disconnectFromRealtimeChannel();
      if (removePatientRecordSavedListener.value) {
        removePatientRecordSavedListener.value();
        removePatientRecordSavedListener.value = null;
      }
      window.removeEventListener("register-bid-click", openBroughtDeadModal);
      window.removeEventListener("bid-registration-complete", handleRegistrationComplete);
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(IonCard), { class: "dashboard-card bid-card" }, {
        default: withCtx(() => [
          createVNode(unref(IonCardHeader), { class: "dashboard-card-header" }, {
            default: withCtx(() => [
              createVNode(unref(IonCardTitle), { class: "dashboard-title" }, {
                default: withCtx(() => [
                  createVNode(unref(IonIcon), {
          ...
          createVNode(unref(IonCardContent), { class: "bid-card-content" }, {
            default: withCtx(() => [
              (openBlock(), createBlock(ReusableDataTable, {
                headers: bidHeaders,
                data: broughtInDeadTableData.value,
                options: bidTableOptions,
                actionHandlers: bidActionHandlers.value,
                containerClass: "",
                key: tableKey.value
              }, null, 8, ["data", "actionHandlers"]))
            ]),
            _: 1
          })
        ]),
...
const BroughtInDeadTable = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-66cfba94"]]);
...
const _sfc_main$d = defineComponent({
  ...
  data() {
    return {
      ...
      isRefreshing: false,
      refreshQueued: false,
      stageUpdatesSocket: null,
      realtimeRefreshTimeoutId: null,
      realtimeDebounceMs: 300,
      isRealtimeListenersAttached: false,
      onlineListener: null,
  ...
  async mounted() {
    ...
    await this.setupStageRealtimeUpdates();
  },
  beforeUnmount() {
    this.teardownStageRealtimeUpdates();
  },
  methods: {
    skullOutline() {
      return skullOutline;
    ...
    async refreshDashboard(includeUserData = false) {
      ...
      try {
        const locationId = Service.getUserLocationId();
        if (!locationId) return;
        const refreshTasks = [usePatientList().refresh(locationId)];
        if (includeUserData) {
          refreshTasks.push(this.refreshUserData());
        }
    ...
    isRealtimeEnabled() {
      return navigator.onLine && !Service.getLanConnectionStatus();
    },
    async setupStageRealtimeUpdates() {
      if (!this.isRealtimeListenersAttached) {
        this.onlineListener = () => {
          void this.handleRealtimeOnline();
        };
        this.offlineListener = () => {
          void this.handleRealtimeOffline();
        };
        window.addEventListener("online", this.onlineListener);
        window.addEventListener("offline", this.offlineListener);
        this.isRealtimeListenersAttached = true;
      }
      if (!this.isRealtimeEnabled()) return;
      await this.connectToStageUpdatesChannel();
    },
    teardownStageRealtimeUpdates() {
      ...
      this.isRealtimeListenersAttached = false;
      if (this.realtimeRefreshTimeoutId) {
        window.clearTimeout(this.realtimeRefreshTimeoutId);
        this.realtimeRefreshTimeoutId = null;
      }
      void this.disconnectFromStageUpdatesChannel();
    },
    async connectToStageUpdatesChannel() {
      if (this.stageUpdatesSocket || !this.isRealtimeEnabled()) return;
      const locationId = Service.getUserLocationId();
      if (!locationId) return;
      this.stageUpdatesSocket = new WebSocketService({
        channel: "ClientDetailsChannel",
        locationId,
        fetchOnOpen: false
      });
      await this.stageUpdatesSocket.setMessageHandler((event) => {
        void this.handleStageRealtimeMessage(event);
      });
    },
    async disconnectFromStageUpdatesChannel() {
      if (!this.stageUpdatesSocket) return;
      await this.stageUpdatesSocket.disconnect();
      this.stageUpdatesSocket = null;
    },
    async handleRealtimeOnline() {
      await this.refreshDashboard();
      await this.connectToStageUpdatesChannel();
    },
    async handleRealtimeOffline() {
      await this.disconnectFromStageUpdatesChannel();
    },
    parseCableIdentifier(identifier) {
      try {
        return JSON.parse(identifier);
      } catch (_error) {
        return null;
    ...
    async handleStageRealtimeMessage(event) {
      let payload = null;
      try {
        payload = JSON.parse(event.data);
      } catch (_error) {
      ...
      if (payload?.type || !payload?.identifier || !payload?.message) return;
      const identifier = this.parseCableIdentifier(payload.identifier);
      if (!identifier || !["StageUpdatesChannel", "ClientDetailsChannel"].includes(identifier.channel)) return;
      const eventName = `${payload?.message?.event || ""}`.toLowerCase();
      if (!eventName) {
        this.scheduleRealtimeDashboardRefresh();
        return;
      }
      if (eventName.startsWith("stage_")) {
        this.applyRealtimeStageUpdate(payload?.message?.data, eventName);
        return;
      }
      if (["patient_record_saved", "visit_created", "visit_closed", "dashboard_refresh"].includes(eventName)) {
        this.scheduleRealtimeDashboardRefresh();
      }
    },
    ...
    buildRealtimeStageRecord(stageData) {
      const givenName = `${stageData?.given_name || ""}`.trim();
      const familyName = `${stageData?.family_name || ""}`.trim();
      return {
        ...stageData,
        stage: `${stageData?.stage || stageData?.category || ""}`.toUpperCase(),
        location_id: `${stageData?.location_id ?? ""}`,
        full_name: `${stageData?.full_name || `${givenName} ${familyName}`}`.trim()
      };
    },
    upsertRealtimeStageList(list, stageData) {
      const currentIdentifier = this.normalizeIdentifier(stageData?.identifier);
      if (!currentIdentifier) return list;
      const withoutPatient = list.filter((item) => this.normalizeIdentifier(item?.identifier) !== currentIdentifier);
      return [stageData, ...withoutPatient];
    },
    removeFromAllRealtimeStageLists(identifier) {
      const patientListStore = usePatientList();
      const removeByIdentifier = (list) => list.filter((item) => this.normalizeIdentifier(item?.identifier) !== identifier);
      patientListStore.patientsWaitingForVitals = removeByIdentifier(patientListStore.patientsWaitingForVitals);
      patientListStore.patientsWaitingForConsultation = removeByIdentifier(patientListStore.patientsWaitingForConsultation);
      patientListStore.patientsWaitingForLab = removeByIdentifier(patientListStore.patientsWaitingForLab);
      patientListStore.patientsWaitingForDispensation = removeByIdentifier(patientListStore.patientsWaitingForDispensation);
    },
    applyRealtimeStageUpdate(rawStageData, eventName = "") {
      if (!rawStageData) {
        this.scheduleRealtimeDashboardRefresh();
        return;
      }
      const patientListStore = usePatientList();
      const stageData = this.buildRealtimeStageRecord(rawStageData);
      const identifier = this.normalizeIdentifier(stageData.identifier);
      const currentLocationId = this.normalizeIdentifier(Service.getUserLocationId());
      const stageLocationId = this.normalizeIdentifier(stageData.location_id);
      const isActiveStage = stageData.status === true || stageData.status === 1 || stageData.status === "1";
      if (!identifier) {
        this.scheduleRealtimeDashboardRefresh();
        return;
      }
      this.removeFromAllRealtimeStageLists(identifier);
      if (!isActiveStage || !stageData.stage || stageLocationId && stageLocationId !== currentLocationId) {
        return;
      }
      switch (stageData.stage) {
        case "VITALS":
          patientListStore.patientsWaitingForVitals = this.upsertRealtimeStageList(patientListStore.patientsWaitingForVitals, stageData);
          break;
        case "CONSULTATION":
          patientListStore.patientsWaitingForConsultation = this.upsertRealtimeStageList(
            patientListStore.patientsWaitingForConsultation,
            stageData
          );
          break;
        case "LAB":
          patientListStore.patientsWaitingForLab = this.upsertRealtimeStageList(patientListStore.patientsWaitingForLab, stageData);
          break;
        case "DISPENSATION":
          patientListStore.patientsWaitingForDispensation = this.upsertRealtimeStageList(
            patientListStore.patientsWaitingForDispensation,
            stageData
          );
          break;
        default:
      ...
      if (eventName === "stage_created") {
        const hasVisit = patientListStore.patientsVisits.some(
          (visit) => this.normalizeIdentifier(visit?.identifier) === identifier
        );
        if (!hasVisit) {
          patientListStore.patientsVisits = [stageData, ...patientListStore.patientsVisits];
        }
      }
    },
    ...
    openPatientsListModal(title, list, buttonText, link) {
      createModal(_sfc_main$k, { class: "large-medium-width-modal" }, true, {
        title,
        list,
        buttonTitle: buttonText,
        buttonLink: link
...
const _hoisted_1$b = { class: "dashboard-wrapper" };
const _hoisted_2$b = { class: "dashboard-card" };
const _hoisted_3$a = {
  key: 0,
    ...
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_1$b, [
        createBaseVNode("div", _hoisted_2$b, [
            ...
            default: withCtx(() => [
              createVNode(_component_ion_card_title, { class: "dashboard-title" }, {
                default: withCtx(() => [
                  ...
                  _cache[7] || (_cache[7] = createTextVNode(" Today's Patients Overview ", -1))
                ]),
                _: 1
              })
            ]),
          ...
          createVNode(_component_ion_card_content, null, {
            default: withCtx(() => [
              !_ctx.ready ? (openBlock(), createElementBlock("div", _hoisted_3$a, [
                createVNode(_component_ion_spinner, { name: "crescent" }),
                _cache[8] || (_cache[8] = createBaseVNode("p", { class: "loading-text" }, "Loading dashboard...", -1))
              ])) : _ctx.OPDWaitingLists.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_4$7, [
                createVNode(_component_ion_icon, {
                  icon: _ctx.lockClosed(),
                  class: "no-access-icon"
                }, null, 8, ["icon"]),
                _cache[10] || (_cache[10] = createBaseVNode("h2", { class: "no-access-title" }, "No Waiting Lists Assigned", -1)),
                _cache[11] || (_cache[11] = createBaseVNode("p", { class: "no-access-message" }, " You currently don't have access to any waiting lists. Please contact your system administrator or supervisor to request access. ", -1)),
                createVNode(_component_ion_button, {
                  color: "primary",
                  fill: "outline",
                  onClick: _cache[0] || (_cache[0] = ($event) => _ctx.refreshDashboard(true)),
                  ...
                  default: withCtx(() => [
                    ...
                    _cache[9] || (_cache[9] = createTextVNode(" Refresh ", -1))
                  ]),
                  _: 1
                })
                  ...
                  createVNode(_component_ion_row, { class: "centered-row" }, {
                    default: withCtx(() => [
                      _ctx.hasWaitingList("Total Patients Today") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[1] || (_cache[1] = ($event) => _ctx.openAllModal("All patients today", "View profile", "/patient-profile"))
                      ...
                      _ctx.hasWaitingList("Appointments Today") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        label: "Appointments",
                        onCardClick: _cache[2] || (_cache[2] = ($event) => _ctx.openAppointmentsModal("OPD Appointments", "14"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Vitals") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[3] || (_cache[3] = ($event) => _ctx.openPatientsListModal("Patients waiting for vitals", "VITALS", "Vitals", "/opd/vitals"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Consultation") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[4] || (_cache[4] = ($event) => _ctx.openPatientsListModal(
                          "Patients waiting for consultation",
                          "CONSULTATION",
                          "Consultation",
                          "/opd/consultation-plan"
                        ))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Laboratory") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[5] || (_cache[5] = ($event) => _ctx.openPatientsListModal("Patients waiting for lab", "LAB", "Lab", "/opd/consultation-plan"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true),
                      _ctx.hasWaitingList("Waiting for Dispensation") ? (openBlock(), createBlock(_component_DashboardCard, {
                        ...
                        onCardClick: _cache[6] || (_cache[6] = ($event) => _ctx.openPatientsListModal("Patients waiting for dispensation", "DISPENSATION", "Dispensation", "/ncd/dispensations"))
                      }, null, 8, ["icon", "count"])) : createCommentVNode("", true)
                    ]),
                    _: 1
                  })
        ...
        _ctx.ready && _ctx.OPDWaitingLists.length > 0 && _ctx.hasWaitingList("Waiting for Consultation") ? (openBlock(), createBlock(_component_BroughtInDeadTable, { key: 0 })) : createCommentVNode("", true)
      ])
    ]),
    _: 1
  });
}
const OPDDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$5], ["__scopeId", "data-v-489db810"]]);

const _hoisted_1$a = { class: "icon-container" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_3$9, toDisplayString(__props.title), 1)
      ]);
    };
  }
});

const DashboardCard = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-334cd0db"]]);

const _hoisted_1$9 = { class: "dashboard-container" };
const _hoisted_2$9 = { class: "dashboard-grid" };
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "AETCDashboard",
  setup(__props) {
    const router = useRouter();
    const dashboardItems = ref([
      { id: "aetcPatientArrival", icon: "plus_dashboard", title: "Patient Arrival" },
      { id: "aetcScreeningList", icon: "checklist", title: "Awaiting Screening List" },
      { id: "aetcRegistrationList", icon: "checklist", title: "Awaiting Registration List" },
      { id: "aetcTriageList", icon: "checklist", title: "Awaiting Triage List" },
      { id: "aetcAssessmentList", icon: "checklist", title: "Awaiting Assessment List" },
      { id: "aetcTestResultsList", icon: "checklist", title: "Awaiting Test Results List" },
      { id: "aetcSpecialtyList", icon: "checklist", title: "Awaiting Specialty List" },
      { id: "aetcDispositionList", icon: "checklist", title: "Disposition List" },
      { id: "aetcBroughtDead", icon: "document", title: "Brought In Dead" },
      { id: "aetcReports", icon: "chart", title: "Reports" }
    ]);
...
const AETCDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-7fec0c9c"]]);

const _hoisted_1$8 = { class: "stat-card-content" };
const _hoisted_2$8 = { class: "stat-value" };
const _hoisted_3$8 = { class: "stat-label" };
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_ion_card_content = resolveComponent("ion-card-content");
      const _component_ion_card = resolveComponent("ion-card");
      return openBlock(), createBlock(_component_ion_card, { class: "dashboard-stat-card" }, {
        default: withCtx(() => [
          createVNode(_component_ion_card_content, null, {
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1$8, [
                createBaseVNode("div", _hoisted_2$8, toDisplayString(displayValue.value), 1),
                createBaseVNode("h3", _hoisted_3$8, toDisplayString(__props.label), 1)
              ])
            ]),
            _: 1
          })
...
const DashboardStatCard = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-0eadd68f"]]);

const DASHBOARD_STATS_PATH$1 = "mnh/stat/anc";
const PROGRAM$2 = ProgramId.ANC_PROGRAM;
const pct$2 = (num, den) => den > 0 ? Math.round(num / den * 1e4) / 100 : 0;
function getDashboardDate$1() {
  return HisDate.toStandardHisFormat(HisDate.sessionDate());
}
function mapResponseToDashboardData$1(raw) {
  const proportionToPercent = (p) => Number.isFinite(p) ? Math.round(p * 1e4) / 100 : 0;
  const percentOrZero = (n) => Number.isFinite(n) ? Math.round(n * 100) / 100 : 0;
  return {
    totalActivePregnancies: raw.new_and_continuing_anc_clients ?? 0,
    ultrasoundProportion: raw.percentage_women_ultrasound_scanning != null ? percentOrZero(raw.percentage_women_ultrasound_scanning) : proportionToPercent(raw.proportion_women_ultrasound_scanning ?? 0),
    fourPlusAncContactsProportion: percentOrZero(raw.percentage_women_4_plus_anc_contacts ?? 0),
    previousUterineScarProportion: percentOrZero(raw.percentage_clients_previous_uterine_scars ?? 0),
    hivPositiveOnArtProportion: percentOrZero(raw.percentage_anc_hiv_positive_on_art ?? 0),
    syphilisTestedProportion: percentOrZero(raw.percentage_women_tested_syphilis_during_anc ?? 0),
    hepatitisBTestedProportion: percentOrZero(raw.percentage_women_tested_hepatitis_b_during_anc ?? 0),
    percentageReceivedItnDuringAnc: percentOrZero(raw.percentage_women_received_itn_during_anc ?? 0),
    date: raw.date
  };
}
function emptyDashboardData$1() {
  return {
    totalActivePregnancies: 0,
    ultrasoundProportion: 0,
    fourPlusAncContactsProportion: 0,
    previousUterineScarProportion: 0,
    hivPositiveOnArtProportion: 0,
    syphilisTestedProportion: 0,
    hepatitisBTestedProportion: 0,
    percentageReceivedItnDuringAnc: 0
  };
}
async function obsPatientIds$2(conceptName, cacheKey, options = {}) {
  const conceptId = await ConceptService.getConceptID(conceptName, true);
  const params = {
  ...
  if (options.valueText != null) {
    params.value_text = options.valueText;
  } else if (Array.isArray(options.valueCoded)) {
    const valueIds = await Promise.all(options.valueCoded.map((name) => ConceptService.getConceptID(name, true)));
    params.value_coded = valueIds.join(",");
  } else if (options.valueCoded != null) {
    params.value_coded = await ConceptService.getConceptID(options.valueCoded, true);
  }
  const observations = await Service.getAPIOfflineJson("/observations", params, cacheKey);
  const patientIds = /* @__PURE__ */ new Set();
  if (Array.isArray(observations)) {
    for (const obs of observations) {
      const patientId = obs?.patient_id ?? obs?.person_id;
      if (patientId != null) {
...
function unionPatientSets(sets) {
...
function intersectPatientSets(a, b) {
  const out = /* @__PURE__ */ new Set();
  for (const id of a) {
    if (b.has(id)) {
      out.add(id);
...
async function patientIdsFromNumericObsAtLeast(conceptName, cacheKey, minInclusive) {
  const conceptId = await ConceptService.getConceptID(conceptName, true);
  const observations = await Service.getAPIOfflineJson(
    "/observations",
    {
      concept_id: conceptId,
      program_id: PROGRAM$2,
  ...
  const patientIds = /* @__PURE__ */ new Set();
  if (!Array.isArray(observations)) return patientIds;
  for (const obs of observations) {
    const raw = obs?.value_numeric ?? obs?.value_text;
    const num = typeof raw === "number" ? raw : parseFloat(String(raw));
    if (!Number.isFinite(num) || num < minInclusive) continue;
    const patientId = obs?.patient_id ?? obs?.person_id;
    if (patientId != null) patientIds.add(Number(patientId));
  }
  return patientIds;
}
async function getTotalAncEnrollmentPatients() {
  const rows = await Service.getAPIOfflineJson("/encounters", { paginate: false, program_id: PROGRAM$2 }, "anc_enrollment_encounters_all");
  if (!Array.isArray(rows)) return 0;
  const set = /* @__PURE__ */ new Set();
  for (const r of rows) {
    const id = r?.patient_id ?? r?.person_id;
    if (id != null) set.add(Number(id));
  }
  return set.size;
}
async function getAncDashboard() {
  const date = getDashboardDate$1();
  let base = emptyDashboardData$1();
  try {
    if (!Service.getLanConnectionStatus()) {
      const res = await Service.getJson(DASHBOARD_STATS_PATH$1, {
        program_id: Service.getProgramID(),
        date
      });
      const data = res?.data && typeof res.data === "object" ? res.data : res;
      if (data && typeof data === "object") {
        base = mapResponseToDashboardData$1(data);
      }
    }
  } catch {
  }
  const [
    ...
    syphilisPositiveIds,
    syphilisNegativeIds,
    hepatitisPositiveIds,
    hepatitisNegativeIds,
    itnGivenIds
  ] = await Promise.all([
    getTotalAncEnrollmentPatients(),
    obsPatientIds$2("Ultrasound scan status", "anc_dash_ultrasound", { valueCoded: "Ultrasound scan conducted" }),
    patientIdsFromNumericObsAtLeast("Number of previous anc contacts", "anc_dash_prev_contacts", 4),
    obsPatientIds$2("Due to previous C/S?", "anc_dash_uterine_scar", { valueCoded: "Yes" }),
    obsPatientIds$2("chronic conditions", "anc_dash_chronic_hiv", { valueCoded: "hiv positive" }),
    obsPatientIds$2("HIV Test", "anc_dash_lab_hiv_pos", { valueCoded: "Positive" }),
    obsPatientIds$2("Is client on ART?", "anc_dash_on_art", { valueCoded: "Yes" }),
    obsPatientIds$2("Syphilis Test Result", "anc_dash_syph_pos", { valueCoded: "Positive" }),
    obsPatientIds$2("Syphilis Test Result", "anc_dash_syph_neg", { valueCoded: "Negative" }),
    obsPatientIds$2("Hepatitis B", "anc_dash_hep_b_pos", { valueCoded: "Positive" }),
    obsPatientIds$2("Hepatitis B", "anc_dash_hep_b_neg", { valueCoded: "Negative" }),
    obsPatientIds$2("Insecticide treated net given", "anc_dash_itn", { valueText: "Yes" })
  ]);
  const hivPositiveIds = unionPatientSets([chronicHivIds, labHivPositiveIds]);
  const hivOnArtIds = intersectPatientSets(hivPositiveIds, onArtIds);
  const syphilisTestedIds = unionPatientSets([syphilisPositiveIds, syphilisNegativeIds]);
  const hepatitisTestedIds = unionPatientSets([hepatitisPositiveIds, hepatitisNegativeIds]);
  const den = totalEnrolled;
  return {
    ...base,
    totalActivePregnancies: den,
    ultrasoundProportion: pct$2(ultrasoundIds.size, den),
    fourPlusAncContactsProportion: pct$2(fourPlusContactIds.size, den),
    previousUterineScarProportion: pct$2(uterineScarIds.size, den),
    hivPositiveOnArtProportion: pct$2(hivOnArtIds.size, den),
    syphilisTestedProportion: pct$2(syphilisTestedIds.size, den),
    hepatitisBTestedProportion: pct$2(hepatitisTestedIds.size, den),
    percentageReceivedItnDuringAnc: pct$2(itnGivenIds.size, den),
    date: base.date ?? date
  };
}

const _hoisted_1$7 = { class: "anc-dashboard" };
const _hoisted_2$7 = { class: "stats-cards" };
const _hoisted_3$7 = { class: "chart-section" };
const _hoisted_4$6 = {
  class: "chart-scroll-wrap",
  ref: "chartRefLab"
};
const _hoisted_5$6 = { class: "chart-wrapper" };
const _hoisted_6$2 = { class: "chart-scroll-wrap" };
const _hoisted_7$2 = { class: "chart-wrapper" };
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...{ name: "ANCDashboard" },
  __name: "Dashboard",
  setup(__props) {
    const route = useRoute();
    const totalActivePregnancies = ref(0);
    const ultrasoundProportion = ref(0);
    const fourPlusAncContactsProportion = ref(0);
    const previousUterineScarProportion = ref(0);
    const hivPositiveOnArtProportion = ref(0);
    const syphilisTestedProportion = ref(0);
    const hepatitisBTestedProportion = ref(0);
    const dashboardDate = ref("");
    const isChartReady = ref(false);
    const labChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: ["ANC HIV+ clients on ART", "Tested for Syphilis", "Tested for Hepatitis B"],
        labels: { style: { fontSize: "11px" }, maxHeight: 80, rotate: -15 }
      },
      yaxis: { max: 100, title: { text: "Percentage (%)" } },
      colors: ["#2563eb"],
      grid: {
        borderColor: "#f3f4f6",
        padding: { bottom: 50, top: 15, left: 15, right: 15 },
    ...
    const labChartSeries = ref([{ name: "Percentage", data: [0, 0, 0] }]);
    const itnChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: ["Received ITN during ANC (%)"],
        labels: { style: { fontSize: "11px" }, maxHeight: 80, rotate: -15 }
      },
      yaxis: { max: 100, title: { text: "Percentage (%)" } },
      colors: ["#2563eb"],
    ...
    const itnChartSeries = ref([{ name: "Percentage", data: [0] }]);
    async function initializeChartData() {
      try {
        const ancDashboardData = await getAncDashboard();
        totalActivePregnancies.value = ancDashboardData.totalActivePregnancies;
        ultrasoundProportion.value = ancDashboardData.ultrasoundProportion;
        fourPlusAncContactsProportion.value = ancDashboardData.fourPlusAncContactsProportion;
        previousUterineScarProportion.value = ancDashboardData.previousUterineScarProportion;
        hivPositiveOnArtProportion.value = ancDashboardData.hivPositiveOnArtProportion;
        syphilisTestedProportion.value = ancDashboardData.syphilisTestedProportion;
        hepatitisBTestedProportion.value = ancDashboardData.hepatitisBTestedProportion;
        dashboardDate.value = ancDashboardData.date ?? "";
        labChartSeries.value[0].data = [
          ancDashboardData.hivPositiveOnArtProportion,
          ancDashboardData.syphilisTestedProportion,
          ancDashboardData.hepatitisBTestedProportion
        ];
        itnChartSeries.value[0].data = [ancDashboardData.percentageReceivedItnDuringAnc ?? 0];
      } catch (_) {
        totalActivePregnancies.value = 0;
        ultrasoundProportion.value = 0;
        fourPlusAncContactsProportion.value = 0;
        previousUterineScarProportion.value = 0;
        hivPositiveOnArtProportion.value = 0;
        syphilisTestedProportion.value = 0;
        hepatitisBTestedProportion.value = 0;
        labChartSeries.value[0].data = [0, 0, 0];
        itnChartSeries.value[0].data = [0];
      }
      await nextTick();
      setTimeout(() => {
        isChartReady.value = true;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createBaseVNode("div", _hoisted_2$7, [
          createVNode(DashboardStatCard, {
            value: totalActivePregnancies.value,
            label: "Total active pregnancies"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: ultrasoundProportion.value,
            label: "Women who did ultrasound scanning",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: fourPlusAncContactsProportion.value,
            label: "Percentage of women completing at least 4+ ANC",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: previousUterineScarProportion.value,
            label: "Clients with previous uterine scars",
            suffix: "%"
          }, null, 8, ["value"])
        ]),
        createBaseVNode("div", _hoisted_3$7, [
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[0] || (_cache[0] = createBaseVNode("div", { class: "chart-title" }, "Laboratory tests and results (%)", -1)),
                  createBaseVNode("div", _hoisted_4$6, [
                    createBaseVNode("div", _hoisted_5$6, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        ...
                        class: "lab-chart",
                        type: "bar",
                        options: labChartOptions.value,
                        series: labChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ], 512)
                ]),
          ...
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "chart-title" }, "Percentage of pregnant women who received ITN during ANC", -1)),
                  createBaseVNode("div", _hoisted_6$2, [
                    createBaseVNode("div", _hoisted_7$2, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        ...
                        class: "lab-chart",
                        type: "bar",
                        options: itnChartOptions.value,
                        series: itnChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ])
                ]),
...
const Dashboard$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-b606e6aa"]]);
...
const _hoisted_1$6 = { class: "appointments-container" };
const _hoisted_2$6 = {
  key: 0,
  class: "date-filter"
};
const _hoisted_3$6 = { class: "appointments-table" };
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    ...
    _ctx.segmentContent === "Date range" ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
      createVNode(_component_ion_row, null, {
        default: withCtx(() => [
          createVNode(_component_ion_col, null, {
            default: withCtx(() => [
...
const ANCAppointments = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$4], ["__scopeId", "data-v-fa57989b"]]);
...
const _hoisted_2$5 = { style: { "display": "flex", "margin-top": "10px" } };
const _hoisted_3$5 = {
  key: 0,
  style: { "width": "50vw", "background-color": "#fff", "border-radius": "5px", "margin-right": "5px" }
};
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    _ctx.segmentContent == "Internal referrals" ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
      createBaseVNode("div", _hoisted_2$5, [
        _ctx.checkUnderFive ? (openBlock(), createElementBlock("div", _hoisted_3$5)) : createCommentVNode("", true),
        _cache[4] || (_cache[4] = createBaseVNode("div", { style: { "width": "50vw", "background-color": "#fff", "border-radius": "5px", "margin-right": "5px" } }, null, -1)),
        !_ctx.checkUnderFive ? (openBlock(), createElementBlock("div", _hoisted_4$5)) : createCommentVNode("", true)
      ])
    ])) : createCommentVNode("", true),
    _ctx.segmentContent == "External referrals" ? (openBlock(), createElementBlock("div", _hoisted_5$5, [
      createVNode(_component_VisitsHistory)
    ])) : createCommentVNode("", true)
  ], 64);
}
const Referrals = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$3], ["__scopeId", "data-v-faad8f8b"]]);
...
const _hoisted_1$4 = { style: { "display": "flex" } };
const _hoisted_2$4 = { class: "left_col" };
const _hoisted_3$4 = { class: "nav-menu" };
const _hoisted_4$4 = ["onClick"];
const _hoisted_5$4 = { class: "right_col" };
...
const ANCDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$2], ["__scopeId", "data-v-f27e271f"]]);

const STATS_PATH = "mnh/stat";
const PROGRAM$1 = ProgramId.LABOUR_AND_DELIVERY_PROGRAM;
const OBSTETRIC_COMPLICATION_VALUES = [
  "None",
...
const OBSTETRIC_COMPLICATION_CONCEPT = "Obstetric complications";
const REFERRAL_REASON_OPTIONS = [
  { label: "ICU advanced monitoring", valueText: "ICU_ADVANCED_MONITORING" },
  { label: "Surgical intervention", valueText: "SURGICAL_INTERVENTION" },
  { label: "Blood transfusion", valueText: "BLOOD_TRANSFUSION" },
  { label: "Specialist consultation", valueText: "SPECIALIST_CONSULTATION" },
  { label: "Other", valueText: "OTHER" }
];
const REFERRAL_REASONS_CONCEPT = "referral reasons";
const n = (x) => x != null && Number.isFinite(x) ? Number(x) : 0;
const pct$1 = (num, den) => den > 0 ? Math.round(num / den * 1e4) / 100 : 0;
async function obsPatientIds$1(conceptName, cacheKey, options = {}) {
  const conceptId = await ConceptService.getConceptID(conceptName, true);
  const params = {
    concept_id: conceptId,
...
function mapApiToDashboard(raw) {
  const no = (x) => x != null && Number.isFinite(x) ? Math.round(Number(x) * 100) / 100 : 0;
  const none = no(raw.obstetric_complication_none_percentage);
  const complications = [
    { label: "Postpartum haemorrhage", percentage: no(raw.obstetric_complication_postpartum_haemorrhage_percentage) },
    { label: "Pre-eclampsia", percentage: no(raw.obstetric_complication_pre_eclampsia_percentage) },
    { label: "Eclampsia", percentage: no(raw.obstetric_complication_eclampsia_percentage) },
    { label: "Sepsis", percentage: no(raw.obstetric_complication_sepsis_percentage) },
    { label: "Retained placenta", percentage: no(raw.obstetric_complication_retained_placenta_percentage) },
    { label: "Perineal tear", percentage: no(raw.obstetric_complication_perineal_tear_2nd_3rd_or_4th_degree_percentage) }
  ];
  return {
    totalClientsEnrolledInProgram: n(raw.total_clients_enrolled_in_program),
    totalDeliveriesWithStaffRecorded: n(raw.total_deliveries_with_staff_recorded),
    mothersDeliveredBySkilledAttendant: n(raw.mothers_delivered_by_skilled_attendant),
    percentageDeliveredBySkilledAttendants: no(raw.percentage_delivered_by_skilled_attendants),
    clientsDeliveredAtHomeOrInTransit: n(raw.clients_delivered_at_home_or_in_transit),
    clientsDeliveredAtThisFacility: n(raw.clients_delivered_at_this_facility),
    totalDeliveriesWithPlaceRecorded: n(raw.total_deliveries_with_place_recorded),
    percentageDeliveredAtThisFacility: no(raw.percentage_delivered_at_this_facility),
    caesareanSectionCount: n(raw.caesarean_section_count),
    totalDeliveriesWithModeRecorded: n(raw.total_deliveries_with_mode_recorded),
    percentageCaesareanSection: no(raw.percentage_caesarean_section),
    percentageWithObstetricComplication: Math.round((100 - none) * 100) / 100,
    complicationBreakdown: complications,
    referralByCondition: (raw.referral_by_condition ?? []).map((r) => ({ label: r.label ?? r.condition ?? "", percentage: no(r.percentage) })).filter((r) => r.label && !/^other$/i.test(r.label)),
    date: raw.date
  };
}
const empty = () => ({
  totalClientsEnrolledInProgram: 0,
  totalDeliveriesWithStaffRecorded: 0,
  mothersDeliveredBySkilledAttendant: 0,
  percentageDeliveredBySkilledAttendants: 0,
  clientsDeliveredAtHomeOrInTransit: 0,
  clientsDeliveredAtThisFacility: 0,
  totalDeliveriesWithPlaceRecorded: 0,
  percentageDeliveredAtThisFacility: 0,
  caesareanSectionCount: 0,
  totalDeliveriesWithModeRecorded: 0,
  percentageCaesareanSection: 0,
  percentageWithObstetricComplication: 0,
  complicationBreakdown: [],
  referralByCondition: []
});
async function getTotalLabourEnrollmentEncountersAllPatients() {
  const rows = await Service.getAPIOfflineJson("/encounters", { paginate: false, program_id: PROGRAM$1 }, "labour_enrollment_encounters");
  if (!Array.isArray(rows)) return 0;
  const set = /* @__PURE__ */ new Set();
  for (const r of rows) {
    const id = r?.patient_id ?? r?.person_id;
...
async function getLabourEncountersDeliveredAtThisFacilityIds() {
  return obsPatientIds$1("Place of delivery", "labour_place_this_facility", { valueCoded: "This facility" });
}
async function getLabourEncountersDeliveredAtHomeOrTransit() {
  return (await obsPatientIds$1("Place of delivery", "labour_place_home_transit", { valueCoded: ["Home", "In transit"] })).size;
}
async function getLabourEncountersWithModeCaesareanIds() {
  return obsPatientIds$1("Mode of delivery", "labour_mode_caesarean", { valueCoded: "Caesarean section" });
}
async function getLabourEncountersDeliveredBySkilledAttendant() {
  const text = "Skilled health worker (Nurse midwife/community midwife assistant/medical assistant/clinical technician/medical doctor";
  return (await obsPatientIds$1("Staff conducting delivery", "labour_staff_skilled", { valueText: text })).size;
}
async function getObstetricComplicationsRecordedPatientIds() {
  return obsPatientIds$1(OBSTETRIC_COMPLICATION_CONCEPT, "labour_obstetric_complications_all", {});
}
async function getObstetricComplicationBreakdownFromObs() {
  const [allRecordedIds, ...conditionSets] = await Promise.all([
    getObstetricComplicationsRecordedPatientIds(),
    ...OBSTETRIC_COMPLICATION_VALUES.map(
      (value) => obsPatientIds$1(OBSTETRIC_COMPLICATION_CONCEPT, `labour_obstetric_complication_${value.replace(/\s+/g, "_")}`, { valueCoded: value })
    )
  ]);
  const totalWithRecorded = allRecordedIds.size;
  const noneCount = conditionSets[0].size;
  const complicationBreakdown = [];
  for (let i = 0; i < OBSTETRIC_COMPLICATION_VALUES.length; i++) {
    const label = OBSTETRIC_COMPLICATION_VALUES[i];
    if (label === "None" || label === "Other") continue;
    complicationBreakdown.push({ label, count: conditionSets[i].size });
  }
  return { totalWithRecorded, noneCount, complicationBreakdown };
}
async function getReferralByConditionFromObs() {
  const conditionSets = await Promise.all(
    REFERRAL_REASON_OPTIONS.filter((o) => o.label !== "Other").map(
      ({ label, valueText }) => obsPatientIds$1(REFERRAL_REASONS_CONCEPT, `labour_referral_reason_${valueText}`, { valueText }).then((set) => ({ label, count: set.size }))
    )
  );
  return conditionSets;
}
async function getLabourDashboard() {
  let base = empty();
  try {
    if (!Service.getLanConnectionStatus()) {
      const res = await Service.getJson(STATS_PATH, {
        program_id: Service.getProgramID(),
        date: HisDate.toStandardHisFormat(HisDate.sessionDate())
      });
      const data = res?.data && typeof res.data === "object" ? res.data : res;
      if (data && typeof data === "object") base = mapApiToDashboard(data);
    }
  } catch {
  }
  const [totalEnrolled, facilityIds, homeOrTransit, skilledCount, caesareanIds, complicationBreakdownData, referralByConditionCounts] = await Promise.all([
    getTotalLabourEnrollmentEncountersAllPatients(),
    getLabourEncountersDeliveredAtThisFacilityIds(),
    getLabourEncountersDeliveredAtHomeOrTransit(),
    getLabourEncountersDeliveredBySkilledAttendant(),
    getLabourEncountersWithModeCaesareanIds(),
    getObstetricComplicationBreakdownFromObs(),
    getReferralByConditionFromObs()
  ]);
  const atFacility = facilityIds.size;
  const caesareanAtFacility = [...caesareanIds].filter((id) => facilityIds.has(id)).length;
  const complicationBreakdown = complicationBreakdownData.complicationBreakdown.filter(({ label }) => label !== "Other").map(({ label, count }) => ({
    label,
    percentage: pct$1(count, totalEnrolled)
  }));
  const percentageWithObstetricComplication = pct$1(complicationBreakdownData.totalWithRecorded - complicationBreakdownData.noneCount, totalEnrolled);
  const referralByCondition = referralByConditionCounts.filter(({ label }) => label !== "Other").map(({ label, count }) => ({
    label,
    percentage: pct$1(count, totalEnrolled)
  }));
  return {
    ...base,
    totalClientsEnrolledInProgram: totalEnrolled,
    clientsDeliveredAtThisFacility: atFacility,
    clientsDeliveredAtHomeOrInTransit: homeOrTransit,
    percentageDeliveredAtThisFacility: pct$1(atFacility, totalEnrolled),
    totalDeliveriesWithStaffRecorded: base.totalDeliveriesWithStaffRecorded ?? 0,
    mothersDeliveredBySkilledAttendant: skilledCount,
    percentageDeliveredBySkilledAttendants: pct$1(skilledCount, totalEnrolled),
    caesareanSectionCount: caesareanAtFacility,
    percentageCaesareanSection: pct$1(caesareanAtFacility, totalEnrolled),
    percentageWithObstetricComplication,
    complicationBreakdown,
    referralByCondition
  };
}

const _hoisted_1$3 = { class: "labour-dashboard" };
const _hoisted_2$3 = {
  key: 0,
  class: "dashboard-date"
};
const _hoisted_3$3 = { class: "stats-cards" };
const _hoisted_4$3 = { class: "chart-section" };
const _hoisted_5$3 = {
  class: "chart-scroll-wrap",
  ref: "chartRefLab"
};
const _hoisted_6$1 = { class: "chart-wrapper" };
const _hoisted_7$1 = { class: "chart-scroll-wrap" };
const _hoisted_8$1 = { class: "chart-wrapper" };
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...{ name: "LabourDashboardContent" },
  __name: "Dashboard",
  setup(__props) {
    const route = useRoute();
    const totalEnrolledInProgram = ref(0);
    const totalDeliveries = ref(0);
    const skilledAttendanceProportion = ref(0);
    const deliveredAtHomeOrInTransit = ref(0);
    const deliveredAtFacilityProportion = ref(0);
    const caesareanSectionProportion = ref(0);
    const withComplicationProportion = ref(0);
    const dashboardDate = ref("");
    const isChartReady = ref(false);
    const complicationChartSeries = ref([{ name: "Percentage", data: [] }]);
    const complicationChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: [],
    ...
    const referralChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: [],
    ...
    const referralChartSeries = ref([{ name: "Percentage", data: [] }]);
    function formatDashboardDate(dateStr) {
      if (!dateStr) return "";
      return HisDate.toStandardHisDisplayFormat(dateStr) || dateStr;
    }
    async function initializeChartData() {
      try {
        const data = await getLabourDashboard();
        totalEnrolledInProgram.value = data.totalClientsEnrolledInProgram ?? 0;
        totalDeliveries.value = data.totalDeliveriesWithStaffRecorded ?? 0;
        skilledAttendanceProportion.value = data.percentageDeliveredBySkilledAttendants ?? 0;
        deliveredAtHomeOrInTransit.value = data.clientsDeliveredAtHomeOrInTransit ?? 0;
        deliveredAtFacilityProportion.value = data.percentageDeliveredAtThisFacility ?? 0;
        caesareanSectionProportion.value = data.percentageCaesareanSection ?? 0;
        withComplicationProportion.value = data.percentageWithObstetricComplication ?? 0;
        dashboardDate.value = data.date ?? "";
        const breakdown = data.complicationBreakdown ?? [];
        const labels = breakdown.map((b) => b.label);
        const values = breakdown.map((b) => b.percentage);
        complicationChartSeries.value[0].data = values;
        complicationChartOptions.value = {
          ...complicationChartOptions.value,
          xaxis: { ...complicationChartOptions.value.xaxis, categories: labels }
        };
        const referral = data.referralByCondition ?? [];
        referralChartSeries.value[0].data = referral.map((r) => r.percentage);
        referralChartOptions.value = {
          ...referralChartOptions.value,
          xaxis: { ...referralChartOptions.value.xaxis, categories: referral.map((r) => r.label) }
        };
      } catch (_) {
        totalDeliveries.value = 0;
        skilledAttendanceProportion.value = 0;
        deliveredAtHomeOrInTransit.value = 0;
        deliveredAtFacilityProportion.value = 0;
        caesareanSectionProportion.value = 0;
        withComplicationProportion.value = 0;
        complicationChartSeries.value[0].data = [];
        complicationChartOptions.value = {
          ...complicationChartOptions.value,
          xaxis: { ...complicationChartOptions.value.xaxis, categories: [] }
        };
        referralChartSeries.value[0].data = [];
        referralChartOptions.value = {
          ...referralChartOptions.value,
          xaxis: { ...referralChartOptions.value.xaxis, categories: [] }
        };
      }
      await nextTick();
      setTimeout(() => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        dashboardDate.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, "Stats as of " + toDisplayString(formatDashboardDate(dashboardDate.value)), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3$3, [
          createVNode(DashboardStatCard, {
            value: totalEnrolledInProgram.value,
            label: "Clients enrolled in Labour program"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: deliveredAtFacilityProportion.value,
            label: "Delivered at this facility",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: skilledAttendanceProportion.value,
            label: "Delivered by skilled attendant",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: deliveredAtHomeOrInTransit.value,
            label: "Delivered at home or in transit"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: caesareanSectionProportion.value,
        ...
        createBaseVNode("div", _hoisted_4$3, [
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[0] || (_cache[0] = createBaseVNode("div", { class: "chart-title" }, "Obstetric complications (%)", -1)),
                  createBaseVNode("div", _hoisted_5$3, [
                    createBaseVNode("div", _hoisted_6$1, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        ...
                        class: "lab-chart",
                        type: "bar",
                        options: complicationChartOptions.value,
                        series: complicationChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ], 512)
                ]),
          ...
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "chart-title" }, "Percentage of referral disaggregated by condition", -1)),
                  createBaseVNode("div", _hoisted_7$1, [
                    createBaseVNode("div", _hoisted_8$1, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        ...
                        class: "lab-chart",
                        type: "bar",
                        options: referralChartOptions.value,
                        series: referralChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ])
                ]),
...
const Dashboard$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-b8617891"]]);
  ...
  data() {
    return {
      menuItems: [
        ...
        { id: "appointments", label: "Appointments", icon: calendarOutline },
        { id: "referrals", label: "Referrals", icon: peopleOutline }
      ],
      activeItem: "dashboard"
    };
  },
...
const _hoisted_1$2 = { class: "labour-dashboard-layout" };
const _hoisted_2$2 = { class: "left_col" };
const _hoisted_3$2 = { class: "nav-menu" };
const _hoisted_4$2 = ["onClick"];
const _hoisted_5$2 = { class: "right_col" };
...
const LabourDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1], ["__scopeId", "data-v-496535eb"]]);

const DASHBOARD_STATS_PATH = "mnh/stats";
const PROGRAM = ProgramId.PNC_PROGRAM;
const POSTNATAL_CHECK_WITHIN_SEVEN_DAYS = ["Up to 48 hrs or before discharge", "3-7 days"];
const EXCLUSIVE_BREASTFEEDING_VALUES = ["Exclusive", "Breastfed exclusively"];
const MOTHER_HIV_POSITIVE_VALUES = ["positive", "Positive"];
const IMMUNISATION_BCG_VALUES = ["BCG", "bcg"];
const IMMUNISATION_POLIO_VALUES = ["Polio 0", "polio", "Polio"];
const LOW_BIRTH_WEIGHT_VALUES = ["Low birthweight", "Low birth weight"];
const CONCEPT_POSTNATAL_CHECK_PERIOD = "Postnatal check period";
const CONCEPT_BREAST_FEEDING = "Breast feeding";
const CONCEPT_MOTHER_HIV_STATUS = "Mother HIV Status";
const CONCEPT_MOTHER_HIV_POSITIVE = "Mother HIV positive";
const CONCEPT_NEWBORN_COMPLICATIONS = "Newborn baby complications";
const CONCEPT_LOW_BIRTH_WEIGHT = "Low birth weight";
const CONCEPT_MANAGEMENT_GIVEN_NEWBORN = "Management given to newborn";
const CONCEPT_PREMATURITY_KANGAROO = "Prematurity/Kangaroo";
const IMMUNISATION_VISIT_CONCEPT = "Type of immunization the baby received";
const IMMUNISATION_WARD_CONCEPT = "Immunisation given";
function getDashboardDate() {
  return HisDate.toStandardHisFormat(HisDate.sessionDate());
}
const pct = (num, den) => den > 0 ? Math.round(num / den * 1e4) / 100 : 0;
function percentOrZero(n) {
  return n != null && Number.isFinite(n) ? Math.round(Number(n) * 100) / 100 : 0;
}
function numOrZero(n) {
  return n != null && Number.isFinite(n) ? Number(n) : 0;
}
async function obsPatientIds(conceptName, cacheKey, options = {}) {
  const conceptId = await ConceptService.getConceptID(conceptName, true);
  const params = {
    concept_id: conceptId,
    program_id: PROGRAM,
...
function mapResponseToDashboardData(raw) {
  return {
    totalPostnatalMothers: numOrZero(raw.total_postnatal_mothers),
    mothersHivPositive: numOrZero(raw.mothers_hiv_positive),
    percentagePostnatalMothersHivPositive: percentOrZero(raw.percentage_postnatal_mothers_hiv_positive),
    mothersCheckedWithinSevenDays: numOrZero(raw.mothers_checked_within_seven_days),
    percentagePostnatalMothersCheckedWithinSevenDays: percentOrZero(raw.percentage_postnatal_mothers_checked_within_seven_days),
    womenCounselledExclusiveBreastfeeding: numOrZero(raw.women_counselled_exclusive_breastfeeding),
    percentageWomenCounselledExclusiveBreastfeeding: percentOrZero(raw.percentage_women_counselled_exclusive_breastfeeding),
    babiesReceivingBcg: numOrZero(raw.babies_receiving_bcg),
    totalBabiesWithImmunisationRecorded: numOrZero(raw.total_babies_with_immunisation_recorded),
    percentageBabiesReceivingBcg: percentOrZero(raw.percentage_babies_receiving_bcg),
    babiesReceivingPolio0: numOrZero(raw.babies_receiving_polio_0),
    percentageBabiesReceivingPolio0: percentOrZero(raw.percentage_babies_receiving_polio_0),
    percentageLowBirthWeightKangarooCare: percentOrZero(raw.percentage_low_birth_weight_kangaroo_care),
    date: raw.date
  };
}
function emptyDashboardData() {
  return {
    totalPostnatalMothers: 0,
    percentagePostnatalMothersHivPositive: 0,
    mothersCheckedWithinSevenDays: 0,
    percentagePostnatalMothersCheckedWithinSevenDays: 0,
    womenCounselledExclusiveBreastfeeding: 0,
    percentageWomenCounselledExclusiveBreastfeeding: 0,
    babiesReceivingBcg: 0,
    totalBabiesWithImmunisationRecorded: 0,
    percentageBabiesReceivingBcg: 0,
    babiesReceivingPolio0: 0,
    percentageBabiesReceivingPolio0: 0,
    mothersHivPositive: 0,
    percentageLowBirthWeightKangarooCare: 0
  };
}
async function getTotalPncEnrollmentEncountersAllPatients() {
  const rows = await Service.getAPIOfflineJson("/encounters", { paginate: false, program_id: PROGRAM }, "pnc_enrollment_encounters");
  if (!Array.isArray(rows)) return 0;
  const set = /* @__PURE__ */ new Set();
  for (const r of rows) {
    const id = r?.patient_id ?? r?.person_id;
...
async function getPostnatalCheckWithinSevenDaysIds() {
  return obsPatientIds(CONCEPT_POSTNATAL_CHECK_PERIOD, "pnc_postnatal_check_within_7_days", {
    valueCoded: [...POSTNATAL_CHECK_WITHIN_SEVEN_DAYS]
  });
}
async function getExclusiveBreastfeedingIds() {
  return obsPatientIds(CONCEPT_BREAST_FEEDING, "pnc_breastfeeding_exclusive", {
    valueCoded: [...EXCLUSIVE_BREASTFEEDING_VALUES]
  });
}
async function getMotherHivPositiveIds() {
  const [statusPositive, positiveAnswer] = await Promise.all([
    obsPatientIds(CONCEPT_MOTHER_HIV_STATUS, "pnc_mother_hiv_status_positive", { valueCoded: [...MOTHER_HIV_POSITIVE_VALUES] }),
    obsPatientIds(CONCEPT_MOTHER_HIV_POSITIVE, "pnc_mother_hiv_positive_yes", { valueCoded: "Yes" })
  ]);
  return unionSets(statusPositive, positiveAnswer);
}
async function getImmunisationIds(visitValue, wardValues, cacheKey) {
  const [visitIds, wardIds] = await Promise.all([
    obsPatientIds(IMMUNISATION_VISIT_CONCEPT, `pnc_immunisation_${cacheKey}_visit`, { valueCoded: visitValue }),
    obsPatientIds(IMMUNISATION_WARD_CONCEPT, `pnc_immunisation_${cacheKey}_ward`, { valueCoded: [...wardValues] })
  ]);
  return unionSets(visitIds, wardIds);
}
async function getBabiesReceivingBcgIds() {
  return getImmunisationIds("BCG", IMMUNISATION_BCG_VALUES, "bcg");
}
async function getBabiesReceivingPolio0Ids() {
  return getImmunisationIds("Polio 0", IMMUNISATION_POLIO_VALUES, "polio0");
}
async function getLowBirthWeightIds() {
  const [complications, lowBirthWeight] = await Promise.all([
    obsPatientIds(CONCEPT_NEWBORN_COMPLICATIONS, "pnc_low_birth_weight_complications", {
      valueCoded: [...LOW_BIRTH_WEIGHT_VALUES]
    }),
    obsPatientIds(CONCEPT_LOW_BIRTH_WEIGHT, "pnc_low_birth_weight", { valueCoded: "Yes" })
  ]);
  return unionSets(complications, lowBirthWeight);
}
async function getKangarooMotherCareIds() {
  const [management, prematurity] = await Promise.all([
    obsPatientIds(CONCEPT_MANAGEMENT_GIVEN_NEWBORN, "pnc_kmc_management", { valueCoded: "Kangaroo mother care" }),
    obsPatientIds(CONCEPT_PREMATURITY_KANGAROO, "pnc_kmc_prematurity", { valueCoded: "Yes" })
  ]);
  return unionSets(management, prematurity);
}
async function getPncDashboard() {
  const date = getDashboardDate();
  const programId = Service.getProgramID();
  let base = emptyDashboardData();
  try {
    if (!Service.getLanConnectionStatus()) {
      const raw = await Service.getJson(DASHBOARD_STATS_PATH, { program_id: programId, date });
      const payload = raw?.data && typeof raw.data === "object" ? raw.data : raw;
      if (payload && typeof payload === "object") base = mapResponseToDashboardData(payload);
    }
  } catch {
  }
  const [
    totalPostnatalMothers,
    postnatalCheckWithinSevenDaysIds,
    exclusiveBreastfeedingIds,
    mothersHivPositiveIds,
    babiesReceivingBcgIds,
    babiesReceivingPolio0Ids,
    lowBirthWeightIds,
    kangarooMotherCareIds
  ] = await Promise.all([
    getTotalPncEnrollmentEncountersAllPatients(),
    getPostnatalCheckWithinSevenDaysIds(),
    getExclusiveBreastfeedingIds(),
    getMotherHivPositiveIds(),
    getBabiesReceivingBcgIds(),
    getBabiesReceivingPolio0Ids(),
    getLowBirthWeightIds(),
    getKangarooMotherCareIds()
  ]);
  const mothersCheckedWithinSevenDays = postnatalCheckWithinSevenDaysIds.size;
  const womenCounselledExclusiveBreastfeeding = exclusiveBreastfeedingIds.size;
  const mothersHivPositive = mothersHivPositiveIds.size;
  const babiesReceivingBcg = babiesReceivingBcgIds.size;
  const babiesReceivingPolio0 = babiesReceivingPolio0Ids.size;
  const babiesWithImmunisation = unionSets(babiesReceivingBcgIds, babiesReceivingPolio0Ids);
  const totalBabiesWithImmunisationRecorded = babiesWithImmunisation.size;
  const lowBirthWeightCount = lowBirthWeightIds.size;
  const lowBirthWeightKmc = intersectionCount(lowBirthWeightIds, kangarooMotherCareIds);
  return {
    ...base,
    totalPostnatalMothers,
    mothersCheckedWithinSevenDays,
    percentagePostnatalMothersCheckedWithinSevenDays: pct(mothersCheckedWithinSevenDays, totalPostnatalMothers),
    womenCounselledExclusiveBreastfeeding,
    percentageWomenCounselledExclusiveBreastfeeding: pct(womenCounselledExclusiveBreastfeeding, totalPostnatalMothers),
    mothersHivPositive,
    percentagePostnatalMothersHivPositive: pct(mothersHivPositive, totalPostnatalMothers),
    babiesReceivingBcg,
    babiesReceivingPolio0,
    totalBabiesWithImmunisationRecorded,
    percentageBabiesReceivingBcg: pct(babiesReceivingBcg, totalBabiesWithImmunisationRecorded),
    percentageBabiesReceivingPolio0: pct(babiesReceivingPolio0, totalBabiesWithImmunisationRecorded),
    percentageLowBirthWeightKangarooCare: pct(lowBirthWeightKmc, lowBirthWeightCount)
  };
}

const _hoisted_1$1 = { class: "pnc-dashboard" };
const _hoisted_2$1 = {
  key: 0,
  class: "dashboard-date"
};
const _hoisted_3$1 = { class: "stats-cards" };
const _hoisted_4$1 = { class: "chart-section" };
const _hoisted_5$1 = { class: "chart-scroll-wrap" };
const _hoisted_6 = { class: "chart-wrapper" };
const _hoisted_7 = { class: "chart-scroll-wrap" };
const _hoisted_8 = { class: "chart-wrapper" };
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...{ name: "PncDashboardContent" },
  __name: "Dashboard",
  setup(__props) {
    const route = useRoute();
    const totalPostnatalMothers = ref(0);
    const mothersCheckedWithinSevenDaysProportion = ref(0);
    const womenCounselledBreastfeedingProportion = ref(0);
    const mothersHivPositiveProportion = ref(0);
    const babiesBcgProportion = ref(0);
    const babiesPolio0Proportion = ref(0);
    const dashboardDate = ref("");
    const isChartReady = ref(false);
    const immunisationChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: ["Babies receiving BCG", "Babies receiving Polio 0"],
        labels: { style: { fontSize: "11px" }, maxHeight: 80, rotate: -15 }
      },
      yaxis: { max: 100, title: { text: "Percentage (%)" } },
      colors: ["#2563eb"],
    ...
    const immunisationChartSeries = ref([{ name: "Percentage", data: [0, 0] }]);
    const kangarooChartOptions = ref({
      chart: { height: 380, type: "bar", toolbar: { show: false } },
      plotOptions: { bar: { borderRadius: 4, columnWidth: "60%", dataLabels: { hideOverflowingLabels: false } } },
      xaxis: {
        categories: ["Kangaroo mother care (%)"],
        labels: { style: { fontSize: "11px" }, maxHeight: 80, rotate: -15 }
      },
      yaxis: { max: 100, title: { text: "Percentage (%)" } },
      colors: ["#2563eb"],
    ...
    const kangarooChartSeries = ref([{ name: "Percentage", data: [0] }]);
    function formatDashboardDate(dateStr) {
      if (!dateStr) return "";
      return HisDate.toStandardHisDisplayFormat(dateStr) || dateStr;
    }
    async function initializeChartData() {
      try {
        const data = await getPncDashboard();
        totalPostnatalMothers.value = data.totalPostnatalMothers ?? 0;
        mothersCheckedWithinSevenDaysProportion.value = data.percentagePostnatalMothersCheckedWithinSevenDays ?? 0;
        womenCounselledBreastfeedingProportion.value = data.percentageWomenCounselledExclusiveBreastfeeding ?? 0;
        mothersHivPositiveProportion.value = data.percentagePostnatalMothersHivPositive ?? 0;
        babiesBcgProportion.value = data.percentageBabiesReceivingBcg ?? 0;
        babiesPolio0Proportion.value = data.percentageBabiesReceivingPolio0 ?? 0;
        dashboardDate.value = data.date ?? "";
        immunisationChartSeries.value[0].data = [
          data.percentageBabiesReceivingBcg ?? 0,
          data.percentageBabiesReceivingPolio0 ?? 0
        ];
        kangarooChartSeries.value[0].data = [data.percentageLowBirthWeightKangarooCare ?? 0];
      } catch (_) {
        totalPostnatalMothers.value = 0;
        mothersCheckedWithinSevenDaysProportion.value = 0;
        womenCounselledBreastfeedingProportion.value = 0;
        mothersHivPositiveProportion.value = 0;
        babiesBcgProportion.value = 0;
        babiesPolio0Proportion.value = 0;
        immunisationChartSeries.value[0].data = [0, 0];
        kangarooChartSeries.value[0].data = [0];
      }
      await nextTick();
      setTimeout(() => {
        isChartReady.value = true;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        dashboardDate.value ? (openBlock(), createElementBlock("div", _hoisted_2$1, "Stats as of " + toDisplayString(formatDashboardDate(dashboardDate.value)), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3$1, [
          createVNode(DashboardStatCard, {
            value: totalPostnatalMothers.value,
            label: "Total postnatal mothers"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: mothersCheckedWithinSevenDaysProportion.value,
            label: "Mothers checked within 7 days",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: womenCounselledBreastfeedingProportion.value,
            label: "Women counselled exclusive breastfeeding",
            suffix: "%"
          }, null, 8, ["value"]),
          createVNode(DashboardStatCard, {
            value: mothersHivPositiveProportion.value,
            label: "Postnatal mothers HIV positive",
            suffix: "%"
          }, null, 8, ["value"])
        ]),
        createBaseVNode("div", _hoisted_4$1, [
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[0] || (_cache[0] = createBaseVNode("div", { class: "chart-title" }, "Immunisation (%)", -1)),
                  createBaseVNode("div", _hoisted_5$1, [
                    createBaseVNode("div", _hoisted_6, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        key: 0,
                        class: "immunisation-chart",
                        type: "bar",
                        options: immunisationChartOptions.value,
                        series: immunisationChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ])
                ]),
          ...
          createVNode(_component_ion_card, { class: "chart-card" }, {
            default: withCtx(() => [
              createVNode(_component_ion_card_content, null, {
                default: withCtx(() => [
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "chart-title" }, "Percentage of babies with low birth weight admitted for kangaroo mother care", -1)),
                  createBaseVNode("div", _hoisted_7, [
                    createBaseVNode("div", _hoisted_8, [
                      isChartReady.value ? (openBlock(), createBlock(unref(x), {
                        ...
                        class: "immunisation-chart",
                        type: "bar",
                        options: kangarooChartOptions.value,
                        series: kangarooChartSeries.value
                      }, null, 8, ["options", "series"])) : createCommentVNode("", true)
                    ])
                  ])
                ]),
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2399e588"]]);
...
const _hoisted_1 = { class: "pnc-dashboard-layout" };
const _hoisted_2 = { class: "left_col" };
...
const PNCDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-4d2e5416"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(IonPage), null, {
        default: withCtx(() => [
          createVNode(Toolbar),
          createVNode(_sfc_main$G),
          activeDashboard.value ? (openBlock(), createBlock(resolveDynamicComponent(activeDashboard.value), { key: 0 })) : (openBlock(), createBlock(unref(IonContent), { key: 1 }, {
