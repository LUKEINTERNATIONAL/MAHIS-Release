    ...
    return [
      ...
      },
      {
        ...
        validation: (value) => {
          ...
          if (num > 8) {
            return ["Number of previous ANC contacts cannot exceed 8"];
          }
          if (num < 1) {
    ...
    for (let i = 1; i <= numberOfContacts.value; i++) {
      formElements.push(
        ...
        },
        {
          ...
          validation: StandardValidations.required,
          minHeight: "80px",
          //show today button for the last contact
          showTodayButton: i === numberOfContacts.value ? true : false,
          openDirection: "auto",
          icon: icons.calenderPrimary
        },
        {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(Math.min(numberOfContactsToRender.value || 0, 7), (contactNumber) => {
...
const PreviousANCContacts = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-23ff4efd"]]);
