...
import { n as icons, H as HisDate, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-CbBGWx39.js';
import { S as SaveProgressModal } from './SaveProgressModal-BN_eZppr.js';
import { d as defineStore } from './pinia-DzwNa_n5.js';
import { getInfographicByKey } from './infographics-BCWrpnS_.js';
import { j as feedingTypeLabels, f as feedingModeLabels, b as feedingFrequencyLabels, c as feedingEffortLabels, d as meconiumTimingLabels, e as stoolColorLabels, h as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, i as umbilicalConditionLabels, m as musculoskeletalDeformityLabels, s as skinFindingLabels, t as toneAssessmentLabels, a as suckReflexLabels, g as graspReflexLabels, M as MoreReflexLabels } from './reviewOfSystemsLabels-D5rRugrN.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-CqFo57H_.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("StartMeasuringOxygenSaturation"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.emergency_observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        builder: (formValues) => {
          ...
          if (formValues.hasCongenitalAbnormalities === "yes" && formValues.congenitalAbnormalitiesType) {
            const abnormalityLabel = congenitalAbnormalityLabels[formValues.congenitalAbnormalitiesType] || formValues.congenitalAbnormalitiesType;
            pushRow("Abnormalities", "Type", abnormalityLabel);
          }
          if (formValues.congenitalAbnormalitiesDescription) {
          ...
          sections: [
            {
              ...
              bullets: ["Tone Assessment", "Suck Reflex", "Grasp Reflex", "More Reflex"]
            },
            {
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("JaundiceManagement")),
    ...
    formData: [
      {
        ...
        builder: (formValues) => {
          ...
          pushRow("Chest Auscultation", "Is a stethoscope available?", formatYesNo(formValues.stethoscopeAvailable));
          pushRow("Chest Auscultation", "Lung sounds", toLabelList(formValues.lungSounds, lungSoundLabels).join(", "));
          ...
          if (formValues.jaundiceSeverity) {
            ...
            pushRow("Perfusion", "Jaundice severity", severityLabel);
          }
          return rows;
        }
      }
    ...
    formData: [
      ...
      },
      {
        ...
        builder: (formValues) => {
          ...
          pushRow("Abdomen", "Is the abdomen distended?", formatYesNo(formValues.abdomenDistendedConfirm));
          pushRow("Abdomen", "Distended veins?", formatYesNo(formValues.abdomenDistendedVeins));
          pushRow("Abdomen", "Tender?", formatYesNo(formValues.abdomenTender));
          pushRow("Abdomen", "Is the abdomen shiny?", formatYesNo(formValues.abdomenShiny));
          pushRow("Abdomen", "Has the abdomen changed color?", formatYesNo(formValues.abdomenColorChange));
          pushRow("Abdomen", "Hepatomegaly?", formatYesNo(formValues.hepatomegaly));
          pushRow("Abdomen", "Splenomegaly?", formatYesNo(formValues.splenomegaly));
          pushRow("Abdomen", "Palpable Kidneys?", formatYesNo(formValues.palpableKidneys));
          pushRow("Abdomen", "Any other masses?", formatYesNo(formValues.otherMasses));
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-BCWrpnS_.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
...
function getNextSystemicExaminationSectionIndex(currentIndex, allExaminationData) {
  ...
  if (nextSection.skipCondition && nextSection.skipCondition(allExaminationData)) {
...
function getPreviousSystemicExaminationSectionIndex(currentIndex, allExaminationData) {
  ...
  if (prevSection.skipCondition && prevSection.skipCondition(allExaminationData)) {
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a5a48e38"]]);

export { neonatalReviewOfSystemsSections as A, neonatalReviewOfSystemsFormKey as B, useReviewOfSystemsStore as C, neonatalAdmissionOutcomeSections as D, useNeonatalAdmissionOutcomesStore as E, neonatalAdmissionOutcomesSections as F, neonatalInvestigationSections as G, neonatalTreatmentPlanSections as H, neonatalTreatmentPlanFormKey as I, useTreatmentPlanStore as J, defaultNeonatalTreatmentPlanForm as K, NeonatalStepper as N, useDiagnosisStore as a, useSuggestedDiagnosisStore as b, congenitalAbnormalityLabels as c, neonatalEnrollmentSections as d, neonatalVitalsSections as e, neonatalVitalsFormKey as f, useNeonatalTriageStore as g, useNeonatalVitalsStore as h, getDischargeSectionByName as i, neonatalDischargeFormKey as j, neonatalDischargeSections as k, neonatalAdmissionOutcomesFormKey as l, useNeonatalDischargeStore as m, neonatalGeneralExaminationSections as n, getDischargeSectionIndexByName as o, neonatalTriageSections as p, neonatalTriageFormKey as q, defaultNeonatalTriageForm as r, neonatalSystemicExaminationSections as s, triageConceptMapping as t, useNeonatalExamStore as u, neonatalSystemicExaminationFormKey as v, useSystemicExaminationStore as w, neonatalSignsSymptomsSections as x, neonatalSignsSymptomsFormKey as y, useSignsSymptomsStore as z };
