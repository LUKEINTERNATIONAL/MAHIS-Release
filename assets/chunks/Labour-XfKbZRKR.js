import { f as ref, c as computed, s as defineComponent, a3 as onMounted, n as nextTick, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bc as IonCardHeader, bb as IonCardTitle, a5 as createTextVNode, be as IonCardContent, bM as IonCard } from './vendor-CXFd4I0A.js';
import { n as icons, y as StandardValidations, z as StandardForm, P as PatientService, K as ObservationService, b as EncounterTypeId, t as toastWarning, G as toastSuccess, H as HisDate, N as ConceptService, _ as _export_sfc } from '../index-D3ME6BhP.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const prefillFromAncObs = async () => {
      ...
      let abortionsValue = abortionsObs ? await resolveObsValue(abortionsObs) : null;
      let stillbirthsValue = stillbirthsObs ? await resolveObsValue(stillbirthsObs) : null;
      ...
      if ((abortionsValue === null || abortionsValue === void 0) && patientId) {
        const apiAbortionsText = await ObservationService.getFirstObsValue(
          patientId,
          "Abortions/Miscarriages",
          "value_text"
        );
        const apiAbortionsNumber = await ObservationService.getFirstObsValue(
          patientId,
          "Abortions/Miscarriages",
          "value_numeric"
        );
        abortionsValue = apiAbortionsText ?? apiAbortionsNumber ?? null;
      }
      if ((stillbirthsValue === null || stillbirthsValue === void 0) && patientId) {
        const apiStillbirthsText = await ObservationService.getFirstObsValue(patientId, "Stillbirths", "value_text");
        const apiStillbirthsNumber = await ObservationService.getFirstObsValue(patientId, "Stillbirths", "value_numeric");
        stillbirthsValue = apiStillbirthsText ?? apiStillbirthsNumber ?? null;
      }
      if (lnmpValue) {
...
const Obstetric = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6ca144ce"]]);
