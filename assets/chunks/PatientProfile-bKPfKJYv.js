import { q as defineComponent, r as ref, w as watch, N as createBlock, y as openBlock, E as unref, bJ as IonCard, B as withCtx, z as createVNode, b7 as IonCardTitle, x as createElementBlock, dX as IonSkeletonText, a4 as createTextVNode, K as IonIcon, aP as medicalOutline, H as Fragment, b8 as IonCardHeader, am as IonList, Q as renderList, an as IonItem, a6 as IonLabel, b5 as calendarOutline, A as createBaseVNode, C as toDisplayString, cH as idCardOutline, c6 as folderOutline, c3 as checkmarkCircleOutline, ba as IonCardContent, l as dayjs, a1 as onMounted, ax as IonGrid, ae as IonRow, ay as IonCol, a3 as normalizeClass, dY as checkboxOutline, G as createCommentVNode, c8 as clipboardOutline, dZ as statsChartOutline, J as modalController, aI as useRouter, d as computed, d_ as warning, cs as useRoute, v as resolveComponent, aD as IonContent, cO as defineAsyncComponent, d$ as ellipsisVerticalSharp, d1 as person, aF as IonAccordionGroup, aE as IonAccordion, O as normalizeStyle, F as closeCircleOutline, df as IonSegment, dg as IonSegmentButton, aY as personOutline, s as documentTextOutline, a_ as printOutline, d2 as add, bs as IonPage, cG as __vitePreload } from './vendor-DGIzCW4f.js';
import { d as defineStore, s as storeToRefs } from './pinia-Bmkga1nW.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, aa as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$4, al as ArtTasks, z as useExposeFromStandardForm, y as StandardValidations, C as StandardForm, F as DynamicButton, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, am as router, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, M as ProgramId, S as Service, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-D_1ZD1MC.js';
...
import { i as isTaskPermitted } from './tasks-3Z7OkJNl.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-cGNhQXpu.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-CS0rfH7F.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-YeVByVHD.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-C7LGOwnL.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-BbTuGEPn.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-D6cXXorg.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DfJXYT2i.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-3vBbZk1K.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-BCFQJHtf.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-BIgguvQR.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-BCk_MdS_.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-D_1ZD1MC.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DsN_iCat.js'),true              ?[]:void 0));
    const LabourEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./LabourEnrollmentModal-BM_3ZOsN.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-D9CXJJJv.js'),true              ?[]:void 0));
    const router = useRouter();
