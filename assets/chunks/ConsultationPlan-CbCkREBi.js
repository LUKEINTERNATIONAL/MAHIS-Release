...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bj as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bl as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-B9nzT5-y.js';
import { D as DemographicBar } from './DemographicBar-D-Q3hhOf.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DAlLKV-K.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-17GVl0y1.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-BnjOlaH6.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CWWk8W3N.js';
import { I as Investigations } from './Investigations-4x9n1wgj.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CXZqrhh5.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-gxqtCis_.js';
import { P as PreviousTreatment } from './treatment-D0qD_opC.js';
import { l as lodashExports } from './lodash-C2jZK40L.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-B0A5SCrU.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-e6kNVsPX.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-aahaBnCD.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-QjfruO8c.js';
...
const OPDTreatmentPlan = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-dc7f0868"]]);
