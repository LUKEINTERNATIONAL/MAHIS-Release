import { u as useDemographicsStore, H as HisDate, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, t as toastWarning } from '../index-5i0obq1H.js';
import { s as storeToRefs } from './pinia-CoQIYQwb.js';
import { c as computed, s as defineComponent, f as ref, y as openBlock, z as createElementBlock, O as createBlock, F as unref, C as createBaseVNode, D as toDisplayString } from './vendor-E5FFSfhd.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const gcs = computed(() => {
      ...
      const isMinor = patientAge.value < 5;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        patientAge.value < 5 ? (openBlock(), createBlock(StandardForm, {
          key: 0,
          subtitle: "BCS (Blantyre Comma Scale)",
