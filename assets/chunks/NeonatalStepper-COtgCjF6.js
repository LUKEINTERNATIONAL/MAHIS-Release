import { cI as __vitePreload, w as watch, r as reactive, f as ref, s as defineComponent, L as IonIcon, M as IonSpinner, af as IonRow, aA as IonCol, bd as IonCardContent, bL as IonCard, N as IonButton, cH as arrowForward, ft as download, h as inject, dx as arrowBack, G as closeCircleOutline, bZ as chevronBackOutline, f1 as provide, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, S as renderList, T as withDirectives, Q as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c3 as resolveDynamicComponent, U as vShow } from './vendor-BRtiyW5a.js';
import { n as icons, H as HisDate, S as Service, y as StandardValidations, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-o64PGrp2.js';
import { S as SaveProgressModal } from './SaveProgressModal-C2Kwqicq.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-B9Z-GfAg.js';
import { getInfographicByKey } from './infographics-DNaiQNcP.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-DcJFcB6y.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-Dzplm1w_.js';
import { d as defineStore } from './pinia-BGmPTYET.js';
...
const useSuggestedDiagnosisStore = defineStore("suggestedDiagnosisStore", {
  ...
  actions: {
    setPatientData() {
      ...
      const examForm = neonatalExamStore.formData;
      ...
      if (examForm.isBabyYellow === "yes") {
        this.patientData.YColour = "Y";
        if (!this.patientData.Jaundice) {
          this.patientData.Jaundice = "MJ";
        }
      }
      if (examForm.hasBabyCyanosis === "yes") {
        this.patientData.DangerSigns = "Cyan";
      }
      if (examForm.isBabyPallorPink === "no") ;
      if (examForm.hasBabyOedema === "yes") ;
      ...
      if (examForm.capillaryRefillTime) {
        if (examForm.capillaryRefillTime === "3 or more seconds") ;
      }
      ...
      if (examForm.cleftLipPalateAssessment === "cleft_lip_and_palate") {
        this.patientData.Palate = "LipPalate";
      } else if (examForm.cleftLipPalateAssessment === "cleft_lip") {
        this.patientData.Palate = "Lip";
      } else if (examForm.cleftLipPalateAssessment === "cleft_palate") {
      ...
      if (examForm.anusPatent) {
        const anus = examForm.anusPatent.toLowerCase();
        if (anus.includes("imperforate") || anus.includes("absent") || anus.includes("atresia")) ;
      }
      if (examForm.hasCongenitalAbnormalities === "yes") {
        if (examForm.congenitalAbnormalitiesDescription) {
          const notes = examForm.congenitalAbnormalitiesDescription.toLowerCase();
          ...
          if (notes.includes("skin") || notes.includes("nevus") || notes.includes("birthmark")) {
            this.patientData.Skin = examForm.congenitalAbnormalitiesDescription;
          }
          if (notes.includes("limb") || notes.includes("digit") || notes.includes("polydactyly") || notes.includes("syndactyly")) {
            this.patientData.MSKproblems = examForm.congenitalAbnormalitiesDescription;
          }
        }
      }
      ...
      if (systemicEexamForm.moroReflex === "Absent" || systemicEexamForm.moroReflex === "Asymmetric") ;
