...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, br as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bo as useInvestigationStore, b$ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bI as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, c0 as resetOPDPatientData, bL as StagesService, q as usePatientList, v as closeVisit } from '../index-BcjCT4MQ.js';
import { D as DemographicBar } from './DemographicBar-Ha76Eub2.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DNHcMa5k.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-_0i8irPX.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-UmxyI_1E.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DvJx_3Ov.js';
import { I as Investigations } from './Investigations-C3qkuHEz.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-ClST9B78.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-BYvv87VJ.js';
import { P as PreviousTreatment } from './treatment-D6dSuLmm.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-L2ccUgaH.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-C9Pwd93I.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CaSH49iU.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DPxbEFWE.js';
