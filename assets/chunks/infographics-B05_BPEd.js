...
const neonatalInfographics = [
  {
    ...
    sections: [
      ...
      // {
      //     title: "Open airway and ventilate",
      //     description: "Position the head, clear airway if needed, and begin ventilations within 60 seconds.",
    ...
    footerNote: "When stable, continue routine care",
  ...
  },
  {
    ...
    footerNote: "When seizures have stopped and baby stable. click the blue arrow to continue",
    ...
    sections: [
      {
        ...
        bullets: [
          "Neutral position.",
          "Maintain on oxygen.",
          "Prepare for referral as per previous instructions.",
          "Monitor Sats.",
          "This baby will need referral to a higher level facility (e.g. KDH or KCH).",
          "If mum is able to express encourage feeding by cup ONLY if baby can tolerate.",
          "Continue Neotree examination ready for referral."
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Press on the chest and count the seconds until the colour returns.",
        description: "Normal refill time is &lt; 3 seconds."
      },
      {
        title: "Feel the femoral pulse",
        content: "Locate and assess the femoral pulse strength.",
        description: "A weak pulse indicates poor circulation.",
