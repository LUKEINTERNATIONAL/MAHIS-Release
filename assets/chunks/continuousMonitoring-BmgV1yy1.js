import { c as computed, s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bc as IonCardContent, bK as IonCard, f as ref, aK as useRouter, O as createBlock, aF as IonContent, C as createBaseVNode, bX as chevronBackOutline, S as withDirectives, T as vShow, bt as IonPage } from './vendor-BIA1Qh8a.js';
import { _ as _sfc_main$2 } from './Wizard.vue_vue_type_script_setup_true_lang-DD9LQwFF.js';
import { y as StandardValidations, z as StandardForm, K as ObservationService, b as EncounterTypeId, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-DJyJhMgX.js';
...
import { u as useContinuousMonitoringStore, O as OtherExams } from './OtherExams-DNUFTKrA.js';
...
const useContinuousMonitoringProgressOfLabourForm = () => {
  ...
  const progressUrineForm = computed(() => [
    { componentType: "Heading", name: "Check urine (hourly)", grid: { s: "12" } },
    {
      componentType: "inputField",
      name: "Urine Volume",
      header: "Urine Volume",
...
const continuousMonitoring = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7b522b1a"]]);
