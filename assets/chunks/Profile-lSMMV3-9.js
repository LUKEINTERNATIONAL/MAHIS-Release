import { f as ref, c as computed, s as defineComponent, w as watch, a3 as onMounted, n as nextTick, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, O as createBlock, bK as IonCard, H as createCommentVNode, C as createBaseVNode, a5 as createTextVNode, L as IonIcon, R as alertCircleOutline, D as toDisplayString, J as Fragment, S as renderList, Q as normalizeClass, eI as shieldCheckmarkOutline, aS as medicalOutline, G as closeCircleOutline, eJ as helpCircleOutline, c4 as checkmarkCircleOutline, eK as lockClosedOutline, b8 as calendarOutline, e3 as createOutline, aL as useRouter, bL as useRoute, aG as IonContent, bY as chevronBackOutline, T as withDirectives, U as vShow, bu as IonPage, ab as checkmarkOutline } from './vendor-ltMrzBmS.js';
import { s as storeToRefs } from './pinia-CSbxcXdD.js';
import { n as icons, u as useDemographicsStore, z as StandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, y as StandardValidations, e as useGeneralStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, F as DynamicButton, a2 as getFieldValue, H as HisDate, bl as getOfflineSavedUnsavedData, J as savePatientRecord } from '../index-BztXY-eR.js';
import { D as DemographicBar } from './DemographicBar-D4ZTsQqJ.js';
import { _ as _sfc_main$9, u as useFormWizard } from './useFormWizard-DioG1Hne.js';
import { u as useGynaecologyForm } from './useGynaecologyForm-mN5gidsK.js';
import { u as useLocation } from './useLocation-BcStJ05p.js';
...
const TetanusImmunizationTable = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-17b33a32"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(Math.min(numberOfContactsToRender.value || 0, 8), (contactNumber) => {
...
const PreviousANCContacts = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-09d2bc3c"]]);
