import { s as defineComponent, w as watch, a2 as onMounted, a3 as onUnmounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, P as normalizeStyle, a5 as createTextVNode, D as toDisplayString, F as unref, z as createElementBlock, H as createCommentVNode, A as createVNode, eq as scaleOutline, L as IonIcon, er as resizeOutline, es as thermometerOutline, aW as heartOutline, et as waterOutline, br as pulseOutline, eu as bodyOutline, S as withDirectives, T as vShow, e0 as ellipsisVerticalSharp, f as ref, c as computed, n as nextTick } from './vendor-BaHWVsW1.js';
import { s as storeToRefs } from './pinia-frgmf8Mo.js';
import { u as useDemographicsStore, a as useProgramStore, H as HisDate, aq as ConceptService, K as ObservationService, P as PatientService, b7 as BMIService, _ as _export_sfc } from '../index-BA1DESJK.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getAge = () => {
      ...
      if (!birthdate) return "";
      return HisDate.calculateAge(birthdate, HisDate.sessionDate()) + " yrs";
    };
...
const DemographicBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f3f3ba4e"]]);
