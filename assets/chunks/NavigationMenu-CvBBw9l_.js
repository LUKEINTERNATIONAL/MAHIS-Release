import { s as defineComponent, L as IonIcon, N as IonButton, aF as IonTitle, eq as IonBackButton, bf as IonButtons, aE as IonToolbar, I as IonHeader, cH as arrowForward, dx as arrowBack, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, H as createCommentVNode, C as createBaseVNode, D as toDisplayString, E as renderSlot } from './vendor-BcieWP-_.js';
        ...
        default: withCtx(() => [
          ...
          createVNode(_component_ion_buttons, { slot: "end" }, {
            default: withCtx(() => [
              ...
              renderSlot(_ctx.$slots, "action-items")
            ]),
            _: 3
          })
        ]),
