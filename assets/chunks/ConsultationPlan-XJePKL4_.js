import { q as defineComponent, aI as useRouter, cs as useRoute, r as ref, d as computed, a1 as onMounted, w as watch, N as createBlock, y as openBlock, B as withCtx, z as createVNode, x as createElementBlock, G as createCommentVNode, A as createBaseVNode, E as unref, L as IonSpinner, dE as IonLoading, aD as IonContent, R as withDirectives, bW as chevronBackOutline, S as vShow, bs as IonPage, eH as lockClosedOutline, aa as checkmarkOutline } from './vendor-DGIzCW4f.js';
import { s as storeToRefs } from './pinia-Bmkga1nW.js';
import { u as useFormWizard, _ as _sfc_main$1 } from './useFormWizard-qlkTPSbU.js';
import { u as useDemographicsStore, bb as useInvestigationStore, bX as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-D_1ZD1MC.js';
import { D as DemographicBar } from './DemographicBar-ZlD63UIC.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-DUfSs06k.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-DTUJ7Gll.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-BKSqwljS.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-ClIirBtW.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-5vNNiaAn.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DRHpZAqa.js';
