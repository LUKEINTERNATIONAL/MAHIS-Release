import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, a2 as onMounted, n as nextTick, cj as onBeforeUnmount, O as createBlock, af as IonRow, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, f as ref, aL as useRouter, aG as IonContent, bX as chevronBackOutline, J as Fragment, R as renderList, S as withDirectives, c1 as resolveDynamicComponent, T as vShow, bu as IonPage } from './vendor-6OQ3r7Vr.js';
import { _ as _sfc_main$4 } from './Wizard.vue_vue_type_script_setup_true_lang-CTguhryK.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, l as PreviousVitals, t as toastWarning, J as savePatientRecord, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-B-NulKpO.js';
import { D as DemographicBar } from './DemographicBar-CYqRCUth.js';
import { u as useFormWizard } from './useFormWizard-XiOxEs-V.js';
import { u as useHeightWeightForm } from './useHeightWeightForm-Glm01Hsp.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-CWCvWc5W.js';
