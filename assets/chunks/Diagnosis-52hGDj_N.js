import { C as StandardForm, _ as _export_sfc, u as useDemographicsStore, E as EncounterService, S as Service, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-BQO1lu0i.js';
import { q as defineComponent, r as ref, w as watch, x as createElementBlock, y as openBlock, z as createVNode, d as computed, N as createBlock, A as createBaseVNode, C as toDisplayString, B as withCtx, a3 as normalizeClass, G as createCommentVNode, E as unref, cF as mergeProps, fh as draggable, a1 as onMounted, a4 as createTextVNode, H as Fragment, Q as renderList, bP as withKeys, a7 as withModifiers, aI as useRouter, aD as IonContent, bs as IonPage } from './vendor-Dvd0YFIr.js';
import { a as useDiagnosisStore, b as useSuggestedDiagnosisStore, N as NeonatalStepper } from './NeonatalStepper-BCxg80QL.js';
...
const DiagnosisSelection = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-83cc7fdc"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        !_ctx.items || _ctx.items.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
          createBaseVNode("p", null, "No " + toDisplayString(_ctx.isDifferential ? "differential" : "working") + " diagnosis selected", 1)
          ...
          item: withCtx(({ element: item, index }) => [
            createBaseVNode("div", {
              class: normalizeClass(["selected-item", {
                "differential": _ctx.isDifferential,
                "is-dragging": activeDragItem.value === item.value,
                "draggable-enabled": _ctx.allowDragging && _ctx.isDifferential
              }])
            }, [
              _ctx.allowDragging && _ctx.isDifferential ? (openBlock(), createElementBlock("div", {
                key: 0,
              ...
              _ctx.isDifferential ? (openBlock(), createElementBlock("span", _hoisted_4$1, "#" + toDisplayString(index + 1), 1)) : createCommentVNode("", true),
...
const SelectedDiagnosisDisplay = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6f381d34"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    computed(() => suggestedDiagnosisStore.patientData);
...
const SystemsSuggestions = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f9f59c59"]]);
