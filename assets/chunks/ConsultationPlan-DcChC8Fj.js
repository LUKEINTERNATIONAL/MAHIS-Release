...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bI as StagesService, q as usePatientList, v as closeVisit } from '../index-4BtwP8vl.js';
import { D as DemographicBar } from './DemographicBar-Bj9rhZxB.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DTZQ6rZV.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-PgJr6pdS.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-C52q_LJh.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-C2C4FySW.js';
import { I as Investigations } from './Investigations-DjO_7doZ.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CPflaZVj.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-COAFLxd-.js';
import { P as PreviousTreatment } from './treatment-BE8SXFWg.js';
import { l as lodashExports } from './lodash-Dm7Pej-A.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DjZhF7Wz.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CGVg2i77.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-Bk0_bwqP.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DYHsNHLX.js';
