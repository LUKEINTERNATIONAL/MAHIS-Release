import { q as defineComponent, aI as useRouter, r as ref, d as computed, a1 as onMounted, w as watch, N as createBlock, y as openBlock, B as withCtx, z as createVNode, E as unref, aD as IonContent, A as createBaseVNode, M as IonButton, a4 as createTextVNode, K as IonIcon, f8 as arrowForwardOutline, C as toDisplayString, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { s as storeToRefs } from './pinia-B_NbVBpS.js';
import { u as useDemographicsStore, b as EncounterTypeId, T as Toolbar, t as toastWarning, _ as _export_sfc } from '../index-_N7CIn5p.js';
  ...
  setup(__props) {
    ...
    const loadProgress = async () => {
      ...
      try {
        ...
        isEnrollmentCompleted.value = savedEncounters.value.some((encounterName) => {
          const normalized = normalizeEncounterName(encounterName);
          return normalized === "NEONATAL ENROLLMENT" || normalized === "NEONATAL ENROLMENT";
        });
        isTriageCompleted.value = savedEncounters.value.some((encounterName) => {
          const name = normalizeEncounterName(encounterName);
          return name === "NEONATAL TRIAGE" || name === "NEONATAL EMERGENCY TRIAGE" || name === "TRIAGE";
        });
...
const NeonatalCheckpoint = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-351b9d09"]]);
