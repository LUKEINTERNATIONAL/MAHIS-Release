import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, a2 as onMounted, ck as onBeforeUnmount, S as withDirectives, T as vShow, a4 as normalizeClass, C as createBaseVNode, D as toDisplayString, H as createCommentVNode, c as computed, cA as E, bF as QRCode, cB as autoTable, B as withCtx, N as IonButton, L as IonIcon, b1 as printOutline, a5 as createTextVNode, aG as IonContent, bu as IonPage, aL as useRouter, eT as provide, x as resolveComponent, O as createBlock } from './vendor-Dw8g_yFL.js';
import { s as storeToRefs } from './pinia-zB_ge_8G.js';
import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, a6 as useUserStore, K as ObservationService, H as HisDate, T as Toolbar } from '../index-CIYQg2Yf.js';
import { l as neonatalAdmissionOutcomesFormKey, z as useSignsSymptomsStore, h as useNeonatalVitalsStore, N as NeonatalStepper, E as useNeonatalAdmissionOutcomesStore } from './NeonatalStepper-C2IL8hJ8.js';
import { A as AdmissionProgressBar } from './AdmissionProgressBar-C2SvAz7q.js';
import { n as neonatalAdmissionSignOffSections, u as useAdmissionSignOff } from './useAdmissionSignOff-BeNLj2aK.js';
import { u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-BvcWQ6eQ.js';
