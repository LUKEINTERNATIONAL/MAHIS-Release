import { q as defineComponent, x as createElementBlock, y as openBlock, A as createBaseVNode, cs as useRoute, aI as useRouter, r as ref, d as computed, a1 as onMounted, w as watch, N as createBlock, B as withCtx, z as createVNode, E as unref, aJ as analyticsOutline, aD as IonContent, G as createCommentVNode, bs as IonPage } from './vendor-sqYZJ6fK.js';
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        !_ctx.url ? (openBlock(), createElementBlock("div", _hoisted_2, _cache[0] || (_cache[0] = [
          createBaseVNode("p", null, "No report URL provided", -1)
        ]))) : (openBlock(), createElementBlock("iframe", {
          key: 1,
          src: _ctx.url,
          title: _ctx.title || "Report Dashboard",
          class: "report-iframe",
          frameborder: "0",
          allowfullscreen: ""
        }, null, 8, _hoisted_3))
