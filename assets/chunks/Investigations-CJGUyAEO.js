import { O as OrderService, bp as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bq as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, br as SelectionPopover, S as Service, g as getPouchDBRecords, ar as ConceptService, bj as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, r as StandardModal, a2 as getFieldValue, bl as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-Cso499He.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-X75jUKgt.js';
import LabOrdersList from './LabOrdersList-BxwD4qbb.js';
import { v as validateInputFiledData } from './group_validation-BvI-I1wK.js';
import { u as useRadiologyStore } from './RadiologyStore-CJtoafZz.js';
import { B as BasicForm } from './BasicForm-o__CO43x.js';
import { s as defineComponent, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aG as IonContent, bs as pulseOutline, bc as checkmark, a5 as createTextVNode, c as computed, bL as IonCard, aB as IonGrid, af as IonRow, aA as IonCol, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, D as toDisplayString, bQ as IonChip, ae as IonCheckbox, bz as IonText, bd as IonCardContent, r as reactive, p as dayjs, aL as useRouter, bM as useRoute, T as withDirectives, U as vShow, K as modalController } from './vendor-DOib3KBh.js';
import { l as lodashExports } from './lodash-DGAubbbX.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-BxMv3Dnx.js';
import { D as DashBox } from './DashBox-D70lRyo6.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-Bwd1Lr_p.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-Bgx8kWAE.js';
import { P as PatientComplaintsService } from './patient_complaints_service-i8TLImwV.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-0fJ5qylF.js';
import { i as isClinician } from './Registration-BR9-_6el.js';
