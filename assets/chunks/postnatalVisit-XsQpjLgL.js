import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, f as ref, aL as useRouter, O as createBlock, aG as IonContent, C as createBaseVNode, bY as chevronBackOutline, J as Fragment, S as renderList, T as withDirectives, c2 as resolveDynamicComponent, U as vShow, bu as IonPage } from './vendor-ltMrzBmS.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-DioG1Hne.js';
import { n as icons, y as StandardValidations, H as HisDate, z as StandardForm, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, F as DynamicButton } from '../index-D1sAwkPe.js';
  ...
  const visitForMotherFormSection = computed(() => {
    ...
    return [
      ...
      },
      {
        ...
        textColor: "#8A4B00",
        value: "Within 48 hours before discharge, only BTL or IUCD can be selected.",
        condition: (allFormValues) => {
      ...
      },
      {
        ...
        textColor: "#0B4F7A",
        value: "After 6 weeks, choose from: Oral contraceptive, Injectable, Implant, IUD, Emergency Pills, Condom, Cycle beads, None, or Other (Specify).",
        condition: (allFormValues) => {
...
const useVisitForBabyForm = () => {
  ...
  const visitForBabyFormSection = computed(() => {
    ...
    const ncdVitalsFields = [
      ...
      return {
        ...baseField,
        onChange: field?.name === "Temperature" && field?.componentType === "inputField" ? (value, allFormValues) => {
          ...
          const mergedValues = { ...allFormValues, ...safeFieldUpdates};
          return {
            ...safeFieldUpdates,
