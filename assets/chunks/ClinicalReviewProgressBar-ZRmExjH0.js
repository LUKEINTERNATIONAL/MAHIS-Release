import { s as defineComponent, aN as useRouter, f as ref, w as watch, a3 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, D as toDisplayString, A as createVNode, F as unref, fC as caretDown, fD as caretUp, L as IonIcon, T as withDirectives, U as vShow, Q as normalizeClass, O as createBlock, ab as checkmarkOutline, H as createCommentVNode, a5 as createTextVNode, J as Fragment, S as renderList, bD as createStaticVNode, c as computed, X as alertController } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { u as useDemographicsStore, b as EncounterTypeId, E as EncounterService, _ as _export_sfc } from '../index-Biv93APm.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isSubStepClickable = (subStep) => {
      ...
      if (subStep.isCompleted) return true;
    ...
    const loadProgress = async () => {
      ...
      try {
        ...
        console.error("[ClinicalReviewProgressBar] Error loading progress:", error);
      }
    };
          ...
          withDirectives(createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("div", {
                  class: normalizeClass(["step-title", { clickable: true, incomplete: !isTriageCompleted.value }]),
                  onClick: _cache[0] || (_cache[0] = ($event) => goToTriage())
                }, "Triage", 2)
              ])
            ], 2),
            createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_15, [
                createBaseVNode("div", {
                  class: normalizeClass(["step-title", { clickable: isClinicalReviewCompleted.value, incomplete: !isEnrollmentCompleted.value }]),
                  onClick: _cache[1] || (_cache[1] = ($event) => isClinicalReviewCompleted.value && goToEnrollment())
                }, " Profiling ", 2)
              ])
            ], 2),
            createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_17, [
                createBaseVNode("div", {
                  class: normalizeClass(["step-title", { clickable: isClinicalReviewCompleted.value, incomplete: !isDiagnosisCompleted.value }]),
                  onClick: _cache[2] || (_cache[2] = ($event) => isClinicalReviewCompleted.value && goToDiagnosis())
                }, " Diagnosis ", 2)
              ])
            ], 2),
            createBaseVNode("div", {
            ...
            _cache[11] || (_cache[11] = createStaticVNode('<div class="progress-step last" data-v-10818628><div class="step-indicator" data-v-10818628><div class="step-circle" data-v-10818628></div></div><div class="step-content" data-v-10818628><div class="step-title incomplete" data-v-10818628>Signoff &amp; Printout</div></div></div>', 1))
          ], 512), [
...
const ClinicalReviewProgressBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10818628"]]);
