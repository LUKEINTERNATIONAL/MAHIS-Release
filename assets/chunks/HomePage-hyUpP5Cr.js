import { s as defineComponent, c$ as addIcons, aL as useRouter, w as watch, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, a4 as normalizeClass, D as toDisplayString, H as createCommentVNode, A as createVNode, F as unref, a6 as IonInput, L as IonIcon, a5 as createTextVNode, J as Fragment, R as renderList, f as ref, c as computed, d0 as arrowBackOutline, cd as personAddOutline, Q as alertCircleOutline, ao as informationCircleOutline, ax as searchOutline, c9 as clipboardOutline, bv as personCircleOutline, bp as V, x as resolveComponent, O as createBlock, B as withCtx, cu as useRoute, bM as m, n as nextTick, aJ as menuController, d1 as clipboard, d2 as thermometer, aN as people, d3 as person, d4 as add, ci as medkit, d5 as globe, d6 as document$1, d7 as colorPalette, d8 as chevronUpCircle, d9 as chevronForwardCircle, da as chevronDownCircle, db as grid, bc as checkmark, bY as chevronBackOutline, bd as IonCardContent, ba as IonCardTitle, bb as IonCardHeader, bL as IonCard, aA as IonCol, N as IonButton, af as IonRow, aD as IonToolbar, bu as IonPage, I as IonHeader, aG as IonContent, aC as todayOutline, dc as timeOutline, b0 as locationOutline, dd as womanOutline, de as manOutline, cJ as idCardOutline, a$ as personOutline, cO as openOutline, b8 as calendarOutline, r as reactive, P as normalizeStyle, df as gridOutline, b4 as peopleOutline, a_ as medkitOutline, S as withDirectives, az as vModelText, dg as chevronForwardOutline, p as dayjs, dh as IonSegment, di as IonSegmentButton, a7 as IonLabel, dj as eyeOutline, ab as checkmarkOutline, bJ as IonBadge, au as script, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, K as modalController, br as pulseOutline, dk as Navigation, dl as Pagination, dm as Slide, dn as Carousel, ae as IonCheckbox, al as IonPopover, ck as onBeforeUnmount, cF as createSlots, G as closeCircleOutline, T as vShow, dp as checkmarkDoneCircleOutline, bn as search, be as IonButtons, dq as personAdd, ag as close, M as IonSpinner, dr as skullOutline, ds as calendar, cc as flask, dt as refresh, du as lockClosed, a3 as onUnmounted, c2 as resolveDynamicComponent } from './vendor-Dw8g_yFL.js';
import { S as Service, u as useDemographicsStore, _ as _export_sfc, P as PatientService, t as toastWarning, a as useProgramStore, E as EncounterService, H as HisDate, g as getPouchDBRecords, b as EncounterTypeId, A as AppointmentService, c as HorizontalLine, d as _sfc_main$v, e as useGeneralStore, f as useStatusStore, h as useWindowSize, i as useEnrollementStore, R as ReportService, p as parameterizeUrl, j as STANDARD_DATE_FORMAT, k as alertConfirmation, O as OrderService, l as PreviousVitals, B as BasicInputField, m as useAdministerVaccineStore, n as icons, o as createModal, q as StandardModal, r as closeVisit, s as isPatientDeceased, v as usePatientList, w as getTodaysVisits, x as toastDanger, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, D as PatientSearchService, F as DynamicButton, G as toastSuccess, I as alertConfirmationIonic, J as savePatientRecord, K as ObservationService, T as Toolbar, L as useWorkerStore, M as checkAndsetSessionDate, N as resetDemographics, Q as useGlobalPropertyStore, U as UserService, V as LocationService, W as ProgramId, X as modal } from '../index-CIYQg2Yf.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-zB_ge_8G.js';
import { A as Appointment } from './ncd_appointment_service-B-KBSMZT.js';
import { D as DateInputField } from './DateInputField-Cc1wYoGI.js';
import { u as useActionButtonStore, _ as _sfc_main$D, M as ModulePicker } from './ActionButtons.vue_vue_type_script_setup_true_lang-D8SbSSVR.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-CN8YYebn.js';
import { B as BottomNavBar } from './bottomNavBar-Dg_1IGDS.js';
import { P as PatientReportService } from './patient_report_service-D1ui-Lv9.js';
import { l as lodashExports } from './lodash-C_bsc44c.js';
import { B as BasicForm } from './BasicForm-CFhJJo0l.js';
import { B as BasicCard } from './BasicCard-DsjFMTW_.js';
import { u as useAdministerOtherVaccineStore } from './AdministerOtherVaccinesStore-DOacCA1W.js';
import { c as customDatePicker } from './customDatePicker-BfMWqI22.js';
import { s as saveVaccineAdministeredDrugs } from './vaccines_service-CTFuJlsP.js';
import { g as getVaccinesData } from './dashboard_service-CYUQPJrI.js';
import { i as img } from './Img-B85mlUNz.js';
import { R as ReusableDataTable } from './ReusableDataTable-aU4QcW0c.js';
import { u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$w, b as _sfc_main$x, c as _sfc_main$y, d as _sfc_main$z, e as _sfc_main$A, f as _sfc_main$B, g as _sfc_main$C, R as RegistrationService } from './useSetRegistrationValues-B52JyhqO.js';
import { u as useUserActivities } from './useUserActivities-CICVtBp6.js';
import { L as LandingPage } from './LandingPage-CBQj7IAH.js';
...
const OPDDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$6], ["__scopeId", "data-v-2962cadb"]]);
