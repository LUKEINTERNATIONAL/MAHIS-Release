import { v as defineComponent, aC as IonToolbar, aD as IonTitle, aE as IonMenu, ao as IonList, ap as IonItem, I as IonHeader, aF as IonContent, L as modalController, br as pulseOutline, bb as checkmark, y as resolveComponent, z as createElementBlock, A as openBlock, C as createBaseVNode, B as createVNode, bp as V, bo as IonPopover, a7 as IonInput, D as withCtx, a6 as createTextVNode, K as Fragment, cv as useRoute, w as watch, a3 as onMounted, n as nextTick, f as ref, S as renderList, E as toDisplayString, G as unref, c$ as DataTable, aK as useRouter, M as IonIcon, a8 as IonLabel, bP as IonChip, aA as IonCol, ag as IonRow, bu as IonPage, cw as IonMenuButton, aZ as medkitOutline, J as createCommentVNode, P as createBlock, a5 as normalizeClass, bL as IonCard, aw as searchOutline, af as IonCheckbox, bc as IonCardContent, b9 as IonCardTitle, O as IonButton, ba as IonCardHeader, b5 as cubeOutline, H as closeCircleOutline, R as alertCircleOutline, dd as timeOutline, es as moon, et as partlySunny, eu as sunny, cj as medkit, c as computed, at as script, be as IonFooter, aH as IonAccordionGroup, aG as IonAccordion, ca as clipboardOutline, ae as IonTextarea, dj as IonSegmentButton, di as IonSegment, T as withDirectives, bY as chevronBackOutline, U as vShow, ac as checkmarkOutline } from './vendor-CJ5LqAxe.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-BmV_6_tV.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$g, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DihysMBN.js';
import { D as DemographicBar } from './DemographicBar-45092v_o.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-DuPE_Bg_.js';
import { D as DashBox } from './DashBox-D8O8wwEO.js';
import { B as BasicForm } from './BasicForm-D_UTFx4e.js';
import { l as lodashExports } from './lodash-BxWMU_OR.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-peDQBuey.js';
import { v as validateInputFiledData } from './group_validation-jSF1qa02.js';
import { u as useComplicationsStore } from './ComplicationsStore-DXTzoP8c.js';
import { I as Investigations, _ as _sfc_main$j, i as isQualifiedAHD } from './Investigations-BFmvUs2t.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-BJ1k0L-S.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-AMYyPpwQ.js';
import { _ as _sfc_main$i } from './RiskAssessment.vue_vue_type_script_setup_true_lang-Hdy68CKJ.js';
import { V as Vitals } from './Vitals-Dst-p9rg.js';
import { u as useFormWizard, _ as _sfc_main$h } from './useFormWizard-DaQAwIrH.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DpiFOp3E.js';
import { u as usePatientProfile } from './usePatientProfile-lJDOEQwS.js';
