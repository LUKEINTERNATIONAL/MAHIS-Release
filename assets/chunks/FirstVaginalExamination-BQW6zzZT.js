import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, C as createBaseVNode, bL as IonCard } from './vendor-BRtiyW5a.js';
import { n as icons, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, y as StandardValidations } from '../index-Cyrcyymo.js';
...
const useLabourPhysicalExamForm = () => {
  const createExclusiveCheckboxOnChange = (fieldName, normalValue, otherValue, otherFieldName) => {
    return (value, allFormValues) => {
      ...
      const previousValues = Array.isArray(allFormValues[fieldName]) ? allFormValues[fieldName] : [];
  ...
  const physicalExaminationForm = computed(() => {
    return [
      ...
      },
      {
        ...
        validation: (value, formValues) => formValues["General condition"] === "Sick" && !value ? "Please specify sick details" : null
      },
      {
