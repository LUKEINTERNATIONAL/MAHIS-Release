...
import { n as icons, H as HisDate, S as Service, u as useDemographicsStore, y as StandardValidations, M as ConceptService, E as EncounterService, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, cj as saveEncounterData, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-DjgSdAC3.js';
import { S as SaveProgressModal } from './SaveProgressModal-BrXqWQEa.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-Rf8aWYID.js';
import { getInfographicByKey, getAllInfographicKeys } from './infographics-CkN5l58X.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-BvbwyxIB.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-CZsriE-x.js';
import { d as defineStore } from './pinia-CtfxbWof.js';
...
const neonatalEnrollmentSections = [
  {
    ...
    formData: [
      ...
      },
      {
        ...
        condition: (formValues) => {
          const placeOfBirth = formValues.placeOfBirth?.value || formValues.placeOfBirth;
          return placeOfBirth === "Hospital" || placeOfBirth === "Health Center";
        }
      },
      {
        componentType: "multiSelectInputField",
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("Hypothermia"))
      }
    ],
    skipCondition: (vitalsData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (vitalsData) => {
      ...
      formData: [
        {
          ...
          infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey(key))
        }
      ],
      skipCondition: (formValues) => {
        const allDiagnoses = [];
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("JaundiceManagement"))
      },
      {
        componentType: "listSelectionField",
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-CkN5l58X.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalMoroReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "moroReflex",
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-979159b6"]]);

export { neonatalDischargeFormKey as A, neonatalDischargeSections as B, useNeonatalDischargeStore as C, getDischargeSectionIndexByName as D, defaultNeonatalTriageForm as E, getSystemicExaminationSectionById as F, useSystemicExaminationStore as G, useSignsSymptomsStore as H, useReviewOfSystemsStore as I, neonatalClinicalReviewOutcomeSections as J, useNeonatalClinicalReviewOutcomesStore as K, useTreatmentPlanStore as L, NeonatalStepper as N, neonatalSignsSymptomsFormKey as a, neonatalClinicalReviewOutcomesFormKey as b, neonatalTriageFormKey as c, neonatalSystemicExaminationFormKey as d, neonatalDiagnosisFormKey as e, neonatalTreatmentPlanFormKey as f, neonatalReviewOfSystemsSections as g, neonatalSignsSymptomsSections as h, neonatalEnrollmentSections as i, neonatalClinicalReviewOutcomesSections as j, neonatalSystemicExaminationSections as k, neonatalDiagnosisSections as l, neonatalTreatmentPlanSections as m, neonatalReviewOfSystemsFormKey as n, neonatalInvestigationSections as o, useDiagnosisStore as p, useSuggestedDiagnosisStore as q, extractOptionValue as r, normalizeTextValue as s, extractMultiSelectValues as t, useNeonatalExamStore as u, motherEnrollmentRules as v, neonatalVitalsSections as w, neonatalVitalsFormKey as x, useNeonatalVitalsStore as y, getDischargeSectionByName as z };
