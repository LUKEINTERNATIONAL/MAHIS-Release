import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, R as renderList, D as toDisplayString, a5 as createTextVNode, H as createCommentVNode, N as IonButton, L as IonIcon, af as IonRow, bb as IonCardHeader, ba as IonCardTitle, bd as IonCardContent, f as ref, c as computed, aq as IonItem, ae as IonCheckbox, a7 as IonLabel, a4 as normalizeClass, a6 as IonInput, r as reactive, a2 as onMounted, ap as IonList, S as withDirectives, T as vShow, cR as defineAsyncComponent, cH as __vitePreload, aL as useRouter, ct as useRoute, aG as IonContent, bX as chevronBackOutline, bu as IonPage, ab as checkmarkOutline } from './vendor-BaHWVsW1.js';
import { s as storeToRefs } from './pinia-frgmf8Mo.js';
import { z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, n as icons, y as StandardValidations, _ as _export_sfc, a_ as List, u as useDemographicsStore, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, b2 as useTreatmentPlanStore, be as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, aq as ConceptService, G as toastSuccess, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-BA1DESJK.js';
import { D as DemographicBar } from './DemographicBar-BpCVKcWm.js';
import { _ as _sfc_main$d, u as useFormWizard } from './useFormWizard-BYZbAnBs.js';
...
import { _ as _sfc_main$e, C as CirculationAssessment, D as DisabilityAssessment, E as ExposureAssessment } from './ExposureAssessment-BslGJiDi.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const PrescribedMedicationList = defineAsyncComponent(() => __vitePreload(() => import('./Medications-DMmAESIo.js'),true              ?[]:void 0,import.meta.url));
    const CONCEPTS = {
