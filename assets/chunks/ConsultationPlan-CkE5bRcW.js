import { s as defineComponent, a2 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bp as V, cZ as DataTable, cu as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, R as renderList, D as toDisplayString, F as unref, aL as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, a5 as createTextVNode, L as IonIcon, a7 as IonLabel, bP as IonChip, aA as IonCol, af as IonRow, aD as IonToolbar, aE as IonTitle, bu as IonPage, cv as IonMenuButton, I as IonHeader, aG as IonContent, a_ as medkitOutline, a4 as normalizeClass, H as createCommentVNode, bL as IonCard, a6 as IonInput, ax as searchOutline, ae as IonCheckbox, bd as IonCardContent, ba as IonCardTitle, N as IonButton, bb as IonCardHeader, b6 as cubeOutline, G as closeCircleOutline, Q as alertCircleOutline, db as timeOutline, ez as moon, eA as partlySunny, eB as sunny, ci as medkit, au as script, al as IonPopover, aF as IonMenu, bf as IonFooter, bc as checkmark, aI as IonAccordionGroup, aH as IonAccordion, c9 as clipboardOutline, ad as IonTextarea, dh as IonSegmentButton, dg as IonSegment, bY as chevronBackOutline, S as withDirectives, T as vShow, ab as checkmarkOutline } from './vendor-CL0dVHZq.js';
import { s as storeToRefs, m as mapState } from './pinia-e5upVPR3.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, aq as ConceptService, b9 as checkIfSamePatient, ba as setCurrentPatientID, bb as getAntiHypertensivesMedication, bc as getDiabetesDrugs, bd as clearMedicationData, B as BasicInputField, be as useNCDMedicationsStore, bf as useOtherNCDMedicationStore, bg as formMedicationObject, x as toastDanger, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$e, bh as addOtherMedicationToNCDMedicationList, T as Toolbar, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-WCwjUkov.js';
import { D as DemographicBar } from './DemographicBar-DVT0lAbF.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-Cf8CzIXJ.js';
import { u as useComplicationsStore } from './ComplicationsStore-BbMdRDKZ.js';
import { B as BasicForm } from './BasicForm-BkxPSo-s.js';
import { I as Investigations, _ as _sfc_main$h, i as isQualifiedAHD } from './Investigations-rOR-Tslj.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-IE6rMKj6.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-D7M370fq.js';
import { P as PreviousAllergies } from './PreviousAllergies-CJv60TBc.js';
import { _ as _sfc_main$g } from './RiskAssessment.vue_vue_type_script_setup_true_lang-BvkoNHlb.js';
import { V as Vitals } from './Vitals-QeVto0vD.js';
import { _ as _sfc_main$f, u as useFormWizard } from './useFormWizard-GNH9uDZA.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-aEWqIUgR.js';
import { l as lodashExports } from './lodash-Ba28qa7J.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-CmEmw2sO.js';
import { u as usePatientProfile } from './usePatientProfile-C3j7X3XD.js';
...
const AddDiagnosisModal = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-d91652f3"]]);
...
const DiagnosisComponent = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-9bcae50c"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onChangeCurrentTab = async (index, _oldIndex) => {
      ...
      if (newTabTitle == "Investigations") {
        ...
        if (response == true) {
          await createModal(_sfc_main$h, { class: "fullScreenModal" }, true, { closeModalOnFinish: true });
        }
      }
