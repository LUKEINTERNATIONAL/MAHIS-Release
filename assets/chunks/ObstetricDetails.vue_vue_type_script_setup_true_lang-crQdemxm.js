import { c as computed, eF as create$3, eG as create$5, eH as create$6, i as isRef, s as defineComponent, a3 as onMounted, n as nextTick, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, H as createCommentVNode, F as unref, a$ as personOutline, f as ref, K as modalController, w as watch, z as createElementBlock, bd as IonCardContent, a7 as IonLabel, a5 as createTextVNode, D as toDisplayString, J as Fragment, S as renderList, bK as IonCard, Q as normalizeClass, bb as IonCardHeader, ba as IonCardTitle, L as IonIcon, R as alertCircleOutline, by as IonText, N as IonButton, e3 as createOutline, bG as addOutline, x as resolveComponent } from './vendor-ltMrzBmS.js';
import { bW as getAgeInDays, n as icons, P as PatientService, K as ObservationService, b as EncounterTypeId, z as StandardForm, F as DynamicButton, r as StandardModal, t as toastWarning, H as HisDate, G as toastSuccess, ar as ConceptService, u as useDemographicsStore, C as useExposeFromStandardForm, b5 as RelationshipService, J as savePatientRecord, _ as _export_sfc, a2 as getFieldValue } from '../index-BztXY-eR.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-BBMehAJx.js';
import { l as lodashExports } from './lodash-B_R-xRJh.js';
import { u as useBabyDetails } from './useBabyDetails-BB4CGTUG.js';
import { s as storeToRefs, d as defineStore } from './pinia-CSbxcXdD.js';
