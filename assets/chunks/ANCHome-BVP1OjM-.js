import { q as defineComponent, r as ref, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, A as createBaseVNode, z as createVNode, a4 as createTextVNode, C as toDisplayString, E as unref, s as documentTextOutline, J as modalController, d as computed, aI as useRouter, c8 as clipboardOutline, ez as bodyOutline, cb as flask, ch as medkit, eP as chatbubbles, a1 as onMounted, aD as IonContent, bW as chevronBackOutline, dr as calendar, eQ as paperPlaneOutline, eR as checkmarkDoneOutline, x as createElementBlock, H as Fragment, Q as renderList, bs as IonPage } from './vendor-DUNDjU_C.js';
import { S as Service, u as useDemographicsStore, F as DynamicButton, q as StandardModal, K as ObservationService, H as HisDate, b as EncounterTypeId, G as toastSuccess, J as savePatientRecord, _ as _export_sfc, y as StandardValidations, n as icons, z as useExposeFromStandardForm, C as StandardForm, t as toastWarning, T as Toolbar, o as createModal } from '../index-DGbW3xS3.js';
import { D as DemographicBar } from './DemographicBar-BtJ0tfeT.js';
import { D as DashboardCards } from './DashboardCards-CVwRn5UO.js';
import { s as storeToRefs } from './pinia-CzgPmrQI.js';
import { u as useLocation } from './useLocation-C3kNZFur.js';
