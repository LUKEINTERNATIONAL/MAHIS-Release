...
import { i as isTaskPermitted } from './tasks-BtSkM6zp.js';
import { A as ANCRedirection } from './anc_service-DpqOsYzP.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-CX0OOzhl.js'),true              ?[]:void 0,import.meta.url));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-CfnU6cY_.js'),true              ?[]:void 0,import.meta.url));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-lC9dL8YO.js'),true              ?[]:void 0,import.meta.url));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-VJBlLoUQ.js'),true              ?[]:void 0,import.meta.url));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-Bp5EYkzP.js'),true              ?[]:void 0,import.meta.url));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-DASPOB36.js'),true              ?[]:void 0,import.meta.url));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DMsxxY7T.js'),true              ?[]:void 0,import.meta.url));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-B8JeVrqY.js'),true              ?[]:void 0,import.meta.url));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-BAJNFGv8.js'),true              ?[]:void 0,import.meta.url));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-BzxcyBwx.js'),true              ?[]:void 0,import.meta.url));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-DCe_na9d.js'),true              ?[]:void 0,import.meta.url));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-BBTSDIN9.js').then(n => n.cS),true              ?[]:void 0,import.meta.url));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-GRE-pP28.js'),true              ?[]:void 0,import.meta.url));
