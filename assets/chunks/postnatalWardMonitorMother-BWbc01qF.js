import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, a2 as onMounted, n as nextTick, ck as onBeforeUnmount, O as createBlock, af as IonRow, aH as IonAccordionGroup, aG as IonAccordion, ap as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, f as ref, aK as useRouter, aF as IonContent, bX as chevronBackOutline, J as Fragment, R as renderList, S as withDirectives, c2 as resolveDynamicComponent, T as vShow, bt as IonPage } from './vendor-BIA1Qh8a.js';
import { _ as _sfc_main$4 } from './Wizard.vue_vue_type_script_setup_true_lang-DD9LQwFF.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, l as PreviousVitals, t as toastWarning, J as savePatientRecord, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-CoTAfgAo.js';
import { D as DemographicBar } from './DemographicBar-ByDJgShx.js';
import { u as useFormWizard } from './useFormWizard-0FdySBB4.js';
import { u as useHeightWeightForm } from './useHeightWeightForm-Btmlbl3t.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-rMQeshxp.js';
