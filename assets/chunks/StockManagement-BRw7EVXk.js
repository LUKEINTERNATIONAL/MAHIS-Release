import { q as defineComponent, a5 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, J as modalController, aG as menuController, bp as pulseOutline, b9 as checkmark, v as resolveComponent, x as createElementBlock, y as openBlock, z as createVNode, B as withCtx, a4 as createTextVNode, C as toDisplayString, A as createBaseVNode, H as Fragment, bm as IonPopover, M as IonButton, dB as IonFabList, dC as IonFabButton, dD as IonFab, K as IonIcon, bJ as IonCard, ay as IonCol, ae as IonRow, bs as IonPage, cu as IonMenuButton, r as ref, d2 as person, d3 as add, ch as medkit, d4 as globe, d5 as document, d6 as colorPalette, d7 as chevronUpCircle, d8 as chevronForwardCircle, d9 as chevronDownCircle, da as grid, bW as chevronBackOutline, N as createBlock, G as createCommentVNode, Q as renderList, a3 as normalizeClass } from './vendor-Dvd0YFIr.js';
import { F as DynamicButton, l as PreviousVitals, B as BasicInputField, a0 as DrugService, a1 as modifyFieldValue, a2 as getFieldValue, H as HisDate, t as toastWarning, G as toastSuccess, L as useWorkerStore, u as useDemographicsStore, n as icons, _ as _export_sfc, a3 as ToolbarSearch, T as Toolbar, d as _sfc_main$3, o as createModal, g as getPouchDBRecords, a4 as popoverConfirmation, f as useStatusStore } from '../index-BQO1lu0i.js';
import { I as ImmunizationGroupGraph, a as ImmunizationTrendsGraph } from './ImmunizationGroupGraph-CKaYum9n.js';
import { m as mapState, d as defineStore } from './pinia-CBckhk5W.js';
import { u as useStockStore } from './StockStore-ChnqxRWP.js';
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  _ctx.apiStatus ? (openBlock(), createElementBlock("div", _hoisted_8, [
                    _ctx.checkExpired(item) && item.current_quantity > 0 ? (openBlock(), createBlock(_component_ion_button, {
                      ...
                      _: 2,
                      __: [16]
                    }, 1032, ["onClick"])) : (openBlock(), createBlock(_component_ion_button, {
                      key: 1,
                      size: "small",
                      color: "danger",
                      name: "Discard Stock",
