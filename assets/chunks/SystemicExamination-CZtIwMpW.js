import { cI as __vitePreload, s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, bt as IonPage, aF as IonContent, aK as useRouter, eU as provide, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-BIA1Qh8a.js';
import { s as storeToRefs } from './pinia-BgytB2RM.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-Dy9Id4fM.js';
import { s as neonatalSystemicExaminationFormKey, N as NeonatalStepper, v as useSystemicExaminationStore } from './NeonatalStepper-BQws8ts5.js';
import { N as NeonatalService } from './neonatal_service-C2t3gZgP.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-zqTuksxK.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-zqTuksxK.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-zqTuksxK.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-zqTuksxK.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
