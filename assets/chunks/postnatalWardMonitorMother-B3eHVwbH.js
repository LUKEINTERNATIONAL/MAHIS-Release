import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, bd as IonCardContent, bK as IonCard, O as createBlock, H as createCommentVNode, f as ref, a2 as onMounted, n as nextTick, cj as onBeforeUnmount, af as IonRow, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, aL as useRouter, aG as IonContent, bX as chevronBackOutline, J as Fragment, R as renderList, S as withDirectives, c1 as resolveDynamicComponent, T as vShow, bu as IonPage } from './vendor-DfJM8N3R.js';
import { _ as _sfc_main$5, u as useFormWizard } from './useFormWizard-Bd4oXaWi.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, _ as _export_sfc, l as PreviousVitals, t as toastWarning, J as savePatientRecord, T as Toolbar, F as DynamicButton } from '../index-Cao9ROvV.js';
...
import { _ as _sfc_main$4 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-BPVz5Eap.js';
import { s as syncChildUIs } from './StandardUtils-CB1NXgjt.js';
import { u as useHeightWeightForm } from './useHeightWeightForm-C3tIuLWq.js';
import { u as useBloodPressureForm, a as useTemperaturePulseRateForm, b as useRespiratoryRateOxygenForm } from './useRespiratoryRateOxygenForm-C2RdeBv6.js';
  ...
  const otherExamsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        condition: (allFormValues) => {
          return ["heavy", "offensive", "Offensive smell"].includes(allFormValues["Status of lochia"]);
        }
      },
      {
        componentType: "inputField",
