import { q as defineComponent, r as ref, d as computed, a1 as onMounted, x as createElementBlock, y as openBlock, A as createBaseVNode, a3 as normalizeClass, z as createVNode, E as unref, d2 as person, K as IonIcon, C as toDisplayString, a4 as createTextVNode, h as inject, w as watch, N as createBlock, a2 as onUnmounted, G as createCommentVNode, H as Fragment, Q as renderList, aP as medicalOutline, b5 as calendarOutline, bS as trashOutline, bz as createStaticVNode, aa as checkmarkOutline, cj as onBeforeUnmount, R as withDirectives, S as vShow, cz as E, bD as QRCode, cA as autoTable, M as IonButton, aD as IonContent, bs as IonPage, aI as useRouter, a_ as printOutline, eT as provide, v as resolveComponent, B as withCtx } from './vendor-Cd5ziTxG.js';
import { s as storeToRefs } from './pinia-UguK66WW.js';
import { u as useDemographicsStore, H as HisDate, cj as InputField, P as PatientService, _ as _export_sfc, K as ObservationService, C as StandardForm, ck as SearchableDropdown, cl as DateInputField, ab as useUserStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-CKTz1PXB.js';
import { N as NeonatalService } from './neonatal_service-tcfx2RvJ.js';
import { D as DemographicBar } from './DemographicBar-CG1DJaK8.js';
import { g as neonatalDischargeFormKey, h as neonatalDischargeSections, i as neonatalAdmissionOutcomesFormKey, j as neonatalAdmissionSignOffSections, k as useNeonatalDischargeStore, N as NeonatalStepper } from './NeonatalStepper-nFV0R9Qa.js';
import { u as useAdmissionSignOff } from './useAdmissionSignOff-CZBT6wDt.js';

const _hoisted_1$7 = { class: "profile-card" };
const _hoisted_2$5 = { class: "profile-content" };
const _hoisted_3$5 = { class: "avatar-column" };
...
const ProfileInformation = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-cfe6341c"]]);

const _hoisted_1$6 = { class: "vitals-header" };
const _hoisted_2$4 = { class: "detail-row" };
const _hoisted_3$4 = { class: "detail-value status-value" };
const _hoisted_4$4 = { class: "detail-row" };
const _hoisted_5$3 = { class: "weight-box" };
const _hoisted_6$2 = { class: "weight-value" };
const _hoisted_7$2 = { class: "weight-date" };
const _hoisted_8$2 = { class: "section-subtitle" };
const SECTION_INDEX$1 = 0;
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  __name: "DischargeVitals",
  setup(__props, { expose: __expose }) {
    const sectionConfig = neonatalDischargeSections[SECTION_INDEX$1];
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1$6, [
          createBaseVNode("div", _hoisted_2$4, [
            ...
            createBaseVNode("span", _hoisted_3$4, toDisplayString(hivStatus.value || "Loading..."), 1)
          ]),
...
const DischargeVitals = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-07673321"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const qrDataUrl = ref("");
    const neotreeLogoUrl = new URL("/assets/neotree.4QnvY_lU.png", import.meta.url).href;
...
const _sfc_main = defineComponent({
  ...
  components: {
    ...
    NeonatalStepper,
    DischargeVitals,
    DischargeDiagnosis: _sfc_main$8,
    DischargeMedications: _sfc_main$7,
    ClinicFollowUp,
    HealthEducation,
    DischargeOutcome,
    SignOff,
...
const NeonatalDischarge = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a5305ce2"]]);
