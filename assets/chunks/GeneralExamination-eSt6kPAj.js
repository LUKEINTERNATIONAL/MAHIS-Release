import { s as defineComponent, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, aG as IonContent, bu as IonPage, aL as useRouter, eW as provide, c as computed, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-CHJxKtY0.js';
import { s as storeToRefs } from './pinia-DvUiFzi9.js';
import { u as useDemographicsStore, a6 as useUserStore, G as toastSuccess, am as router, x as toastDanger, aY as AppEncounterService, z as StandardForm, _ as _export_sfc, T as Toolbar, t as toastWarning } from '../index-eygbwbqc.js';
import { D as DemographicBar } from './DemographicBar-DLk2Dd1d.js';
import { u as useNeonatalExamStore, c as congenitalAbnormalityLabels, n as neonatalGeneralExaminationSections, N as NeonatalStepper, a as neonatalGeneralExaminationFormKey } from './NeonatalStepper-BxRGQY5s.js';
import { S as SummarySection } from './SummarySection-Dr3xNvXD.js';
...
const saveCongenitalAbnormalities = async (physical_examination_service) => {
  try {
    ...
    if (store.congenitalAbnormalityType) {
      const typeLabel = congenitalAbnormalityLabels[store.congenitalAbnormalityType] || store.congenitalAbnormalityType;
      const abnormalityTypeObservation = await physical_examination_service.buildValueText(
        "Congenital abnormality type",
        typeLabel
      );
      CongenitalAbnormalitiesData.congenitalAbnormalitiesObservation.obs.child.push(abnormalityTypeObservation);
    }
    ...
    store.setCongenitalAbnormalityType(null);
...
const ActivityAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-ac0b0041"]]);
...
const HeadAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-4aef5988"]]);
...
const CardiovascularAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-4929920c"]]);
...
const GenitalAndAnusAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-94b28256"]]);
...
const CleftLipPalateForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5d6bdac9"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const syncFormValues = (values) => {
      if (values.hasCongenitalAbnormalities !== void 0) {
        examStore.setHasCongenitalAbnormalities(
          values.hasCongenitalAbnormalities === "yes" ? true : values.hasCongenitalAbnormalities === "no" ? false : null
        );
      }
      examStore.setCongenitalAbnormalityType(values.congenitalAbnormalitiesType || null);
...
const CongenitalAbnormalitiesForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-0d72b32f"]]);
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const generalExaminationFormData = computed(() => {
      const yesNo = (value) => {
        if (value === true) return "yes";
        if (value === false) return "no";
        return void 0;
      };
      const cleftLipPalateAssessment = (() => {
        if (examStore.hasCleftLip === null && examStore.hasCleftPalate === null && examStore.cleftAssessment === null) {
          return void 0;
        }
        if (examStore.hasCleftLip && examStore.hasCleftPalate) return "cleft_lip_and_palate";
        if (examStore.hasCleftLip) return "cleft_lip";
        if (examStore.hasCleftPalate) return "cleft_palate";
        if (examStore.cleftAssessment === "absent") return "normal";
        return void 0;
      })();
      return {
        activityAssessment: examStore.activityAssessment ?? void 0,
        fontanelleAssessment: examStore.fontanelleAssessment ?? void 0,
        massInHeadAssessment: examStore.massInHeadAssessment ?? void 0,
        isBabyYellow: yesNo(examStore.isBabyYellow),
        isBabyPallorPink: yesNo(examStore.isBabyPallorPink),
        hasBabyCyanosis: yesNo(examStore.hasBabyCyanosis),
        hasBabyOedema: yesNo(examStore.hasBabyOedema),
        heartSoundsAssessment: examStore.heartSoundsAssessment ?? void 0,
        femoralPulses: examStore.femoralPulses ?? void 0,
        hasCardiacAbnormality: yesNo(examStore.hasCardiacAbnormality),
        genitaliaAssessment: examStore.genitaliaAssessment ?? void 0,
        anusPatent: examStore.anusAssessment ?? void 0,
        hasMeconiumPassed: yesNo(examStore.hasMeconiumPassed),
        cleftLipPalateAssessment,
        hasCongenitalAbnormalities: yesNo(examStore.hasCongenitalAbnormalities),
        congenitalAbnormalitiesType: examStore.congenitalAbnormalityType ?? void 0,
        congenitalAbnormalitiesDescription: examStore.abnormalitiesNotes || void 0
      };
    });
...
const GeneralExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-056d5d2d"]]);
