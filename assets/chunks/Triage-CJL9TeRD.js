import { c as computed, s as defineComponent, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, bd as IonCardContent, f as ref, a2 as onMounted, x as resolveComponent, z as createElementBlock, H as createCommentVNode, C as createBaseVNode, aq as IonItem, a5 as createTextVNode, J as Fragment, aL as useRouter, ct as useRoute, w as watch, aG as IonContent, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage, ab as checkmarkOutline } from './vendor-6OQ3r7Vr.js';
import { s as storeToRefs } from './pinia-BATJJgGh.js';
import { y as StandardValidations, z as StandardForm, a_ as List, F as DynamicButton, C as useExposeFromStandardForm, a1 as modifyFieldValue, S as Service, K as ObservationService, b as EncounterTypeId, t as toastWarning, G as toastSuccess, n as icons, _ as _export_sfc, bm as useVitalsStore, u as useDemographicsStore, bn as useInvestigationStore, bc as useDiagnosisStore, b2 as useTreatmentPlanStore, bi as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, b7 as getOfflineSavedUnsavedData, bo as MedicationSelectionHasValues, J as savePatientRecord, bp as resetNCDPatientData, aq as ConceptService, bq as useAllegyStore, a6 as useUserStore } from '../index-CgCYPred.js';
import { D as DemographicBar } from './DemographicBar-BwzjUM_M.js';
import { V as Vitals } from './Vitals-LCPApiwa.js';
import { _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CMHPpob4.js';
...
import { _ as _sfc_main$6 } from './Wizard.vue_vue_type_script_setup_true_lang-CTguhryK.js';
...
import { s as stageAllergies } from './treatment-BiC-ZeNh.js';
