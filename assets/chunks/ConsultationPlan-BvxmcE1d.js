import { v as defineComponent, w as watch, a3 as onMounted, y as resolveComponent, z as openBlock, A as createElementBlock, D as createBaseVNode, B as createVNode, G as unref, R as alertCircleOutline, c5 as checkmarkCircleOutline, K as Fragment, S as renderList, b7 as calendarOutline, E as toDisplayString, a5 as normalizeClass, aa as chevronDownOutline, J as createCommentVNode, f as ref, c as computed, M as IonIcon, eB as bodyOutline, eC as scanOutline, bH as addOutline, br as pulseOutline, eD as moveOutline, eE as fitnessOutline, df as manOutline, eF as happyOutline, eG as earOutline, eH as nutritionOutline, dk as eyeOutline, c4 as warningOutline, aR as medicalOutline, aU as femaleOutline, x as documentTextOutline, n as nextTick, P as createBlock, C as withCtx, a8 as IonLabel, a6 as createTextVNode, au as IonToggle, ap as IonItem, ag as IonRow, aG as IonAccordion, O as IonButton, a9 as withModifiers, aH as IonAccordionGroup, ao as IonList, at as script, a7 as IonInput, bI as saveOutline, H as closeCircleOutline, ca as clipboardOutline, ae as IonTextarea, az as IonCol, aK as useRouter, cv as useRoute, N as IonSpinner, dH as IonLoading, aF as IonContent, bY as chevronBackOutline, T as withDirectives, U as vShow, bu as IonPage, eI as lockClosedOutline, ac as checkmarkOutline } from './vendor-Cbv9TWZo.js';
import { s as storeToRefs, m as mapState } from './pinia-C6LE2xz6.js';
import { _ as _sfc_main$a, u as useFormWizard } from './useFormWizard-BrIrlDIt.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, o as createModal, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, v as usePatientList, r as closeVisit } from '../index-DiiZviOj.js';
import { D as DemographicBar } from './DemographicBar-CRHj9Ufc.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-D-gVjqB0.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-CGmD2yjF.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-D5VQbUZy.js';
import { I as Investigations } from './Investigations-qYDpmvLq.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CZT53wdm.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-Il4gKT8c.js';
import { P as PreviousTreatment } from './treatment-9boOyetR.js';
import { l as lodashExports } from './lodash-CxXqq_k7.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-D02TQuZw.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-jzeylTXs.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-MkIec1v2.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-RsKq5z-y.js';
...
const ConsultationPlan = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-53b5d35f"]]);
