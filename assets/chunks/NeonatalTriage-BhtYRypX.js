import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, cj as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, ct as useRoute, fc as onIonViewWillEnter, bX as chevronBackOutline, r as reactive, eV as provide } from './vendor-CIi-jrCy.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, co as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ck as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-COGk33Kr.js';
import { D as DemographicBar } from './DemographicBar-QxkK8g7f.js';
import { o as neonatalTriageSections, f as neonatalTriageFormKey, i as useNeonatalTriageStore, N as NeonatalStepper, C as triageConceptMapping, D as defaultNeonatalTriageForm } from './NeonatalStepper-DwPAuZkt.js';
import { S as SummarySection } from './SummarySection-BqFY2KCV.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-BEcE23Nq.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-C2dcsBZQ.js';
