import { K as modalController, s as defineComponent, y as openBlock, O as createBlock, a3 as onMounted, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, be as IonCardContent, N as IonButton, L as IonIcon, bI as addOutline, a5 as createTextVNode, f as ref, z as createElementBlock, M as IonSpinner, J as Fragment, S as renderList, bM as IonCard, Q as normalizeClass, D as toDisplayString, bW as trashOutline, H as createCommentVNode, X as alertController, cC as toastController, a7 as IonLabel, aB as IonCol, aq as IonItem, x as resolveComponent, w as watch, ec as time, ak as IonDatetime, bb as IonCardTitle, bc as IonCardHeader, af as IonRow, au as script, eg as pencilOutline, bJ as saveOutline, G as closeCircleOutline, b1 as locationOutline, bx as personCircleOutline, ae as IonCheckbox, dA as phonePortraitOutline, aT as medicalOutline, c as computed, ap as IonList, aE as IonToolbar, aF as IonTitle, bf as IonButtons, I as IonHeader, aH as IonContent, bg as IonFooter, aM as useRouter, cJ as idCardOutline, R as alertCircleOutline, a6 as IonInput, bA as IonText, P as normalizeStyle, dB as domtoimage, Y as Capacitor } from './vendor-XNfOCpdb.js';
import { b5 as confirmModal, u as useDemographicsStore, y as StandardValidations, n as icons, z as StandardForm, r as StandardModal, C as useExposeFromStandardForm, b6 as RelationshipService, G as toastSuccess, t as toastWarning, o as createModal, _ as _export_sfc, k as alertConfirmation, a5 as popoverConfirmation, B as BasicInputField, b4 as useOutcomeStore, g as getPouchDBRecords, aI as _sfc_main$f, F as DynamicButton, a0 as SelectFacility, X as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aC as ListPicker, ak as ProgramService, S as Service, H as HisDate, c as HorizontalLine, aD as areFieldsValid, x as toastDanger, aE as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, J as savePatientRecord, $ as printLabel, aM as PrintoutService, b7 as printArtVisitLbl } from '../index-DjgSdAC3.js';
import { R as Registration, u as useRelationships } from './Registration-BqRCWBO6.js';
import { s as storeToRefs } from './pinia-CtfxbWof.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-CgWO45cA.js';
import { u as useWardsStore } from './wardsStore-awANVtw6.js';
