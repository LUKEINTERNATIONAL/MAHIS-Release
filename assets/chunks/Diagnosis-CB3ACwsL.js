import { _ as _export_sfc, u as useDemographicsStore, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-xpeKIrss.js';
import { q as defineComponent, ar as script, x as createElementBlock, y as openBlock, G as createCommentVNode, B as createBaseVNode, z as createVNode, D as renderSlot, A as withCtx, a5 as createTextVNode, C as toDisplayString, E as unref, r as ref, w as watch, d as computed, O as createBlock, a4 as normalizeClass, cD as mergeProps, fg as draggable, c0 as resolveDynamicComponent, J as Fragment, R as renderList, bO as withKeys, a8 as withModifiers, aF as useRouter, H as IonContent, bq as IonPage } from './vendor-BK8x96Ok.js';
import { u as useNeonatalTriageStore, N as NeonatalStepper } from './NeonatalStepper-DVqIYm9a.js';
import { d as defineStore, s as storeToRefs } from './pinia-C47my0-I.js';
import { I as IMAGES } from './images-DXWMAjRl.js';
import { u as useNeonatalVitalsStore } from './useNeonatalVitalsStore-DJ3-BkyB.js';
import { u as useReviewOfSystemsStore } from './useReviewOfSystemsStore-DLtPBmng.js';
import { u as useNeonatalExamStore } from './useNeonatalExamStore-DhMQ-2iW.js';
import { u as useSystemicExaminationStore } from './useSystemicExaminationStore-DUtZ1z0X.js';
import { u as useSignsSymptomsStore } from './useSignsSymptomsStore-DpPtwIbi.js';
