import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, N as createBlock, G as createCommentVNode, bs as IonPage, aD as IonContent, aI as useRouter, eS as provide, v as resolveComponent, B as withCtx } from './vendor-sqYZJ6fK.js';
import { s as storeToRefs } from './pinia-B_NbVBpS.js';
import { C as StandardForm, _ as _export_sfc, co as Alert, cp as SummaryField, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-_N7CIn5p.js';
import { x as neonatalReviewOfSystemsSections, y as neonatalReviewOfSystemsFormKey, N as NeonatalStepper, z as useReviewOfSystemsStore } from './NeonatalStepper-CxQhVATI.js';
