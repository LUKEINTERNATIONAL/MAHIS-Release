...
import { n as icons, H as HisDate, S as Service, y as StandardValidations, M as ConceptService, u as useDemographicsStore, E as EncounterService, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-CSwHlLdx.js';
import { S as SaveProgressModal } from './SaveProgressModal-Dt1jxyj6.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-DGP6k-fI.js';
import { getInfographicByKey } from './infographics-DNaiQNcP.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-DCuAaz2F.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-DhJmwO-5.js';
import { d as defineStore } from './pinia-mn-Ihgn9.js';
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("EmergencyManagement"))
      }
    ],
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("WarmTheBody"))
      }
    ],
    skipCondition: (vitalsData) => {
    ...
    formData: [
      {
        ...
        displayMode: "visual",
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("RespiratoryDistress"))
      }
    ],
    skipCondition: (vitalsData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReconsiderDischarge"))
      }
    ],
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("JaundiceManagement"))
      },
      {
        componentType: "listSelectionField",
    ...
    formData: [
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("NeurologicalMoroReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "moroReflex",
...
const _sfc_main = defineComponent({
  ...
  setup(props) {
    ...
    if (props.flowType === "enrollment") {
      ...
      getNextSectionIndex = (index) => index < props.StepperData.length - 1 ? index + 1 : null;
      getPreviousSectionIndex = (index) => index > 0 ? index - 1 : null;
      formData = void 0;
    }
    return {
      chevronBackOutline,
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d9533f83"]]);

export { getDischargeSectionIndexByName as A, defaultNeonatalTriageForm as B, getSystemicExaminationSectionById as C, useSystemicExaminationStore as D, useSignsSymptomsStore as E, useReviewOfSystemsStore as F, neonatalClinicalReviewOutcomeSections as G, useNeonatalClinicalReviewOutcomesStore as H, useTreatmentPlanStore as I, NeonatalStepper as N, neonatalSignsSymptomsFormKey as a, neonatalClinicalReviewOutcomesFormKey as b, neonatalTriageFormKey as c, neonatalSystemicExaminationFormKey as d, neonatalTreatmentPlanFormKey as e, neonatalReviewOfSystemsSections as f, neonatalSignsSymptomsSections as g, neonatalEnrollmentSections as h, neonatalClinicalReviewOutcomesSections as i, neonatalSystemicExaminationSections as j, neonatalTreatmentPlanSections as k, neonatalInvestigationSections as l, useDiagnosisStore as m, neonatalReviewOfSystemsFormKey as n, useSuggestedDiagnosisStore as o, extractOptionValue as p, normalizeTextValue as q, extractMultiSelectValues as r, neonatalVitalsSections as s, neonatalVitalsFormKey as t, useNeonatalExamStore as u, useNeonatalVitalsStore as v, getDischargeSectionByName as w, neonatalDischargeFormKey as x, neonatalDischargeSections as y, useNeonatalDischargeStore as z };
