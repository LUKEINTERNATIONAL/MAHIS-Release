import { q as defineComponent, bc as IonFooter, aC as IonMenu, bs as IonPage, a6 as IonLabel, du as IonImg, e2 as IonAvatar, am as IonList, an as IonItem, aB as IonTitle, aA as IonToolbar, aD as IonContent, I as IonHeader, bE as IonModal, M as IonButton, bb as IonButtons, J as modalController, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, z as createVNode, A as createBaseVNode, C as toDisplayString, a4 as createTextVNode, x as createElementBlock, H as Fragment, Q as renderList, aI as useRouter, r as ref, d as computed, w as watch, a1 as onMounted, G as createCommentVNode, ct as useRoute, f as toRef, bn as V, cZ as DataTable, n as nextTick, E as unref } from './vendor-DUNDjU_C.js';
import { s as storeToRefs } from './pinia-CzgPmrQI.js';
import { F as DynamicButton, _ as _export_sfc, u as useDemographicsStore, v as usePatientList, y as StandardValidations, n as icons, q as StandardModal, C as StandardForm, S as Service, g as getPouchDBRecords, O as OrderService, t as toastWarning, G as toastSuccess, bJ as StagesService, x as toastDanger, aq as ConceptService, J as savePatientRecord, bm as useInvestigationStore, o as createModal, k as alertConfirmation, H as HisDate, bK as PatientLabService, a as useProgramStore, a4 as popoverConfirmation } from '../index-cEgpSt1H.js';
import { E as EnterLabResultsModal } from './EnterLabResultsModal-CUQrYKZN.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const modalTitle = computed(() => {
      return isHivTest() ? "Add HIV Test" : "Add Lab Test";
    });
    ...
    const hivTestForm = computed(() => {
      return [
        ...
        },
        {
          ...
          value: selectedTest.value == "Hepatitis C Test"
        }
      ];
    });
    ...
    const isHivTest = () => {
      if (selectedTest.value == "HIV test" || selectedTest.value == "Syphilis" || selectedTest.value == "Hepatitis B Test" || selectedTest.value == "Hepatitis C Test") {
        return true;
      } else {
        return false;
      }
...
const AddLabTestModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5cf5d632"]]);
    ...
    onMounted(async () => {
      ...
      nextTick(() => {
        ...
        table.on("click", ".result-btn", async (e) => {
          ...
          await createModal(EnterLabResultsModal, { class: "mediumAutoHeightModal" }, true, { test_data: JSON.parse(test_data) });
        });
...
const LabOrdersList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-054ff036"]]);
