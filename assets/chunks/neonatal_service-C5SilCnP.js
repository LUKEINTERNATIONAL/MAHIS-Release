...
import { S as Service, u as useDemographicsStore, J as savePatientRecord, K as ObservationService, b as EncounterTypeId, H as HisDate, ak as ProgramService, L as ProgramId, aY as AppEncounterService, M as ConceptService, a7 as useUserStore } from '../index-D-gMOJ4F.js';
...
class NeonatalService extends Service {
  ...
  static async getPatientSummary(patientId, date = HisDate.sessionDate()) {
    if (Service.getPouchDbStatus() || Service.getLanConnectionStatus()) {
      ...
      const { default: NeonatalOfflineService } = await __vitePreload(async () => { const { default: NeonatalOfflineService } = await import('./neonatal_offline_service--ideu9mB.js');return { default: NeonatalOfflineService }},true              ?[]:void 0);
