import { s as defineComponent, aM as useRouter, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aH as IonContent, C as createBaseVNode, bM as IonCard, be as IonCardContent, dv as IonImg, aF as IonTitle, z as createElementBlock, a5 as createTextVNode, D as toDisplayString, a6 as IonInput, a7 as IonLabel, d3 as person, bT as withKeys, bz as eye, by as eyeOff, N as IonButton, a8 as withModifiers, H as createCommentVNode, Q as normalizeClass, bw as IonPage, f as ref, c as computed } from './vendor-D71W8bKc.js';
import { N as useWorkerStore, a7 as useUserStore, ad as isPasswordValid, t as toastWarning, W as UserService, G as toastSuccess, ae as InvalidCredentialsError, x as toastDanger, af as FirstTimeLoginError, ag as PasswordNeedsUpdateError, ah as MIUMService, ai as setSessionDate, S as Service, a as useProgramStore, aj as AuthService, _ as _export_sfc } from '../index-zVTyLhXp.js';
import { i as img } from './Img-RarZMYTn.js';
import { p as pseudo_recordCurrentLogin, g as getUserFacility } from './userService-a8W8bxGL.js';
  ...
  setup(__props) {
    ...
    const LoginAction = async () => {
      ...
      if (emrSuccess) {
        ...
        try {
          const memisScheme = MIUMService.getMemisScheme();
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e678c306"]]);
