import { O as OrderService, bq as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, br as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, ba as SelectionPopover, S as Service, g as getPouchDBRecords, aq as ConceptService, bm as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, V as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, aa as useConfigStore, q as StandardModal, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-BDC92_36.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-DWumH6Ru.js';
import LabOrdersList from './LabOrdersList-B3Hi_p0y.js';
import { v as validateInputFiledData } from './group_validation-Dpq16XNw.js';
import { u as useRadiologyStore } from './RadiologyStore-B3lHi4kV.js';
import { B as BasicForm } from './BasicForm-DN1kZ-iw.js';
import { v as defineComponent, a3 as onMounted, y as resolveComponent, z as openBlock, P as createBlock, C as withCtx, B as createVNode, D as createBaseVNode, A as createElementBlock, K as Fragment, S as renderList, G as unref, J as createCommentVNode, f as ref, w as watch, bo as IonPopover, a7 as IonInput, aC as IonToolbar, aD as IonTitle, aE as IonMenu, ao as IonList, ap as IonItem, I as IonHeader, aF as IonContent, br as pulseOutline, bb as checkmark, a6 as createTextVNode, c as computed, bL as IonCard, aA as IonGrid, ag as IonRow, az as IonCol, aH as IonAccordionGroup, aG as IonAccordion, a8 as IonLabel, E as toDisplayString, bP as IonChip, af as IonCheckbox, by as IonText, bc as IonCardContent, r as reactive, q as dayjs, aK as useRouter, cv as useRoute, T as withDirectives, U as vShow, L as modalController } from './vendor-B3kX1Pjg.js';
import { l as lodashExports } from './lodash-etvHaEVn.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-Dlguiu_6.js';
import { D as DashBox } from './DashBox-DneOso_j.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-DXV2no6R.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-HsRIvrdz.js';
import { P as PatientComplaintsService } from './patient_complaints_service-CH1X1jXU.js';
import { _ as _sfc_main$8 } from './Wizard.vue_vue_type_script_setup_true_lang-CxCJzlsh.js';
import { u as useFormWizard } from './useFormWizard-tFv_fd8M.js';
import { a as isClinician } from './user_role_management-BVRgXmWr.js';
...
const RadiologyInvestigation = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-5ab54fe8"]]);
