import { s as defineComponent, y as openBlock, O as createBlock, c as computed, a7 as IonLabel, aA as IonCol, aq as IonItem, x as resolveComponent, z as createElementBlock, R as renderList, B as withCtx, A as createVNode, a5 as createTextVNode, D as toDisplayString, C as createBaseVNode, a4 as normalizeClass, J as Fragment, w as watch, F as unref, eb as time, ak as IonDatetime, H as createCommentVNode, f as ref, a2 as onMounted, bK as IonCard, ba as IonCardTitle, bb as IonCardHeader, af as IonRow, au as script, ef as pencilOutline, bH as saveOutline, G as closeCircleOutline, bd as IonCardContent, N as IonButton, K as modalController, b0 as locationOutline, bv as personCircleOutline, ae as IonCheckbox, dz as phonePortraitOutline, aS as medicalOutline, ap as IonList, aD as IonToolbar, aE as IonTitle, be as IonButtons, L as IonIcon, I as IonHeader, aG as IonContent, bf as IonFooter, aL as useRouter, cI as idCardOutline, Q as alertCircleOutline, a6 as IonInput, by as IonText, P as normalizeStyle, dA as domtoimage, X as Capacitor } from './vendor-D523m2MA.js';
import { k as alertConfirmation, a4 as popoverConfirmation, n as icons, _ as _export_sfc, B as BasicInputField, b3 as useOutcomeStore, g as getPouchDBRecords, aI as _sfc_main$e, F as DynamicButton, t as toastWarning, $ as SelectFacility, V as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aB as ListPicker, ai as ProgramService, o as createModal, b4 as confirmModal, S as Service, H as HisDate, G as toastSuccess, c as HorizontalLine, aC as areFieldsValid, x as toastDanger, aD as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, u as useDemographicsStore, J as savePatientRecord, Z as printLabel, aM as PrintoutService, b5 as printArtVisitLbl } from '../index-6cYhgLOM.js';
import { R as Registration } from './Registration-0sp0tBjY.js';
import { R as ReusableDataTable } from './ReusableDataTable-ZlRRbPlj.js';
import { u as useWardsStore } from './wardsStore-BCDbYxFE.js';
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const sampleRelationships = [
      {
        ...
        personB: 486,
        creator: 51,
        dateCreated: "2024-07-05 05:56:19"
      },
      {
        relationshipId: 2,
        personA: 488,
        ...
        personB: 489,
        creator: 51,
        dateCreated: "2024-07-05 05:58:29"
      },
      {
        relationshipId: 3,
        personA: 490,
        ...
        personB: 491,
        creator: 60,
        dateCreated: "2024-07-05 06:02:14"
      },
      {
        relationshipId: 4,
        personA: 492,
        ...
        personB: 493,
        creator: 51,
        dateCreated: "2024-07-05 06:03:12"
      },
      {
        relationshipId: 5,
        personA: 495,
        ...
        personB: 496,
        creator: 51,
        dateCreated: "2024-07-05 06:05:33"
      }
    ];
    const headers = computed(() => {
      if (!Array.isArray(sampleRelationships) || sampleRelationships.length === 0) {
        return [];
      }
      const firstItem = sampleRelationships[0];
    ...
    const tableData = computed(() => {
      ...
      const keys = Object.keys(sampleRelationships[0]);
      return sampleRelationships.map((item) => keys.map((key) => item[key] ?? ""));
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(ReusableDataTable, {
...
const ReferToAnotherClinic = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-1c69adf9"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const validateFormAndSave = async () => {
      ...
      if (!phone_number_value.value?.phoneNumber) {
        phone_config.value.error = true;
        isPhoneValid = false;
      }
      if (!isNotesValid || !isDatesValid || !isTimesValid || !isListsValid || !isPhoneValid) {
...
const deadOutcome = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-7bd2baa1"]]);
...
function usePatientProfile() {
  ...
  const openRelationshipManagement = () => {
    createModal(_sfc_main$c, { class: "fullScreenModal" });
  };
  const openOutCome = () => {
...
export { AdmittedforShortStayOutcomef as A, DynamicDispositionList as D, Outcome as O, ReferredOutCome as R, _sfc_main$d as _, DischargedHome as a, ReferToAnotherClinic as b, deadOutcome as d, usePatientProfile as u };
