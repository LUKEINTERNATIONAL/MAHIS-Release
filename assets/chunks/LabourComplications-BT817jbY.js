...
const LabourWomanBehaviour = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-0613ea5d"]]);
...
const LabourAllergies = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-635fdbf0"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      const data = formRef.value?.getFormValues();
      if (Object.keys(data || {}).length === 0) return;
      if (await ObservationService.buildSaveObs(data, EncounterTypeId.LABOUR_ASSESSMENT)) toastSuccess("Past Surgeries data saved successfully");
      formRef.value?.resetForm();
    };
    __expose({
      onSubmit,
...
const LabourPastSurgeries = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-711a54a5"]]);
