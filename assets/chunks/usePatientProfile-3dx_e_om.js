import { K as modalController, s as defineComponent, y as openBlock, O as createBlock, a3 as onMounted, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, bf as IonCardContent, N as IonButton, L as IonIcon, bJ as addOutline, a5 as createTextVNode, f as ref, z as createElementBlock, M as IonSpinner, J as Fragment, S as renderList, bN as IonCard, Q as normalizeClass, D as toDisplayString, bX as trashOutline, H as createCommentVNode, X as alertController, cD as toastController, a7 as IonLabel, aB as IonCol, aq as IonItem, x as resolveComponent, w as watch, ed as time, ak as IonDatetime, bc as IonCardTitle, bd as IonCardHeader, af as IonRow, au as script, eh as pencilOutline, bK as saveOutline, G as closeCircleOutline, b2 as locationOutline, by as personCircleOutline, ae as IonCheckbox, dB as phonePortraitOutline, aU as medicalOutline, c as computed, ap as IonList, aE as IonToolbar, aF as IonTitle, bg as IonButtons, I as IonHeader, aI as IonContent, bh as IonFooter, aN as useRouter, cK as idCardOutline, R as alertCircleOutline, a6 as IonInput, bB as IonText, P as normalizeStyle, dC as domtoimage, Y as Capacitor } from './vendor-Cddp3aFV.js';
import { b6 as confirmModal, u as useDemographicsStore, y as StandardValidations, n as icons, z as StandardForm, r as StandardModal, C as useExposeFromStandardForm, b7 as RelationshipService, G as toastSuccess, t as toastWarning, o as createModal, _ as _export_sfc, k as alertConfirmation, a6 as popoverConfirmation, B as BasicInputField, b5 as useOutcomeStore, g as getPouchDBRecords, aJ as _sfc_main$f, F as DynamicButton, a1 as SelectFacility, Y as LocationService, aZ as AppEncounterService, a as useProgramStore, aL as useClinicalDaysStore, aM as setValueProps, aD as ListPicker, al as ProgramService, S as Service, H as HisDate, c as HorizontalLine, aE as areFieldsValid, x as toastDanger, aF as getFieldsValuesObj, K as ObservationService, b as EncounterTypeId, P as PatientService, J as savePatientRecord, a0 as printLabel, aN as PrintoutService, b8 as printArtVisitLbl } from '../index-CKPE6QZm.js';
import { R as Registration, u as useRelationships } from './Registration-DyOv9ds_.js';
import { s as storeToRefs } from './pinia-CiqjRcEG.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-K1tZiXu5.js';
import { u as useWardsStore } from './wardsStore-D3addzUQ.js';
...
const _hoisted_21 = { style: { "border": "1px solid black" } };
        ...
        currentMedications.value.length > 0 ? (openBlock(), createElementBlock("table", _hoisted_15, [
          currentPage.value === 0 ? (openBlock(), createElementBlock("thead", _hoisted_16, [..._cache[4] || (_cache[4] = [
            createBaseVNode("tr", null, [
              ...
              createBaseVNode("th", { style: { "border": "1px solid black" } }, "Dur"),
          ...
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(currentMedications.value, (drug, index) => {
              return openBlock(), createElementBlock("tr", { key: index }, [
                ...
                createBaseVNode("td", _hoisted_20, toDisplayString(drug?.duration || ""), 1),
                createBaseVNode("td", _hoisted_21, toDisplayString(drug?.quantity || ""), 1)
              ]);
            }), 128))
          ])
        ])) : createCommentVNode("", true)
...
const NCDVisitLbl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a0d267c1"]]);
