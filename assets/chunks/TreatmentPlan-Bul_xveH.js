import { q as defineComponent, ay as IonToolbar, az as IonTitle, aA as IonMenu, am as IonList, an as IonItem, I as IonHeader, H as IonContent, K as modalController, bn as pulseOutline, b6 as checkmark, v as resolveComponent, x as createElementBlock, y as openBlock, B as createBaseVNode, z as createVNode, bk as V, bj as IonPopover, a6 as IonInput, A as withCtx, a5 as createTextVNode, J as Fragment, r as ref, cr as useRoute, w as watch, a2 as onMounted, n as nextTick, R as renderList, C as toDisplayString, E as unref, cX as DataTable, aF as useRouter, L as IonIcon, a7 as IonLabel, bM as IonChip, aw as IonCol, af as IonRow, bq as IonPage, cs as IonMenuButton, aU as medkitOutline, G as createCommentVNode, O as createBlock, a4 as normalizeClass, bH as IonCard, au as searchOutline, ae as IonCheckbox, b7 as IonCardContent, b4 as IonCardTitle, N as IonButton, b5 as IonCardHeader, d as computed, b0 as cubeOutline, F as closeCircleOutline, Q as alertCircleOutline, d9 as timeOutline, ep as moon, eq as partlySunny, er as sunny, cg as medkit, ar as script, b9 as IonFooter, aC as IonAccordionGroup, aB as IonAccordion, c7 as clipboardOutline, ad as IonTextarea, df as IonSegmentButton, de as IonSegment } from './vendor-Cy_N32Zh.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, bh as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bc as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bi as checkIfSamePatient, bj as setCurrentPatientID, bk as getAntiHypertensivesMedication, bl as getDiabetesDrugs, bm as clearMedicationData, bd as useNCDMedicationsStore, bn as useOtherNCDMedicationStore, bo as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$f, bp as addOtherMedicationToNCDMedicationList, T as Toolbar } from '../index-B2p2mVqz.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BLnsrhoE.js';
...
import { f as formatInputFiledData } from './formatServerData-vTu6TxbF.js';
import { v as validateInputFiledData } from './group_validation-BECQVxNM.js';
import { u as useComplicationsStore } from './ComplicationsStore-C7Gv4xsW.js';
import { g as getNCDDiagnosis, P as PreviousTreatment } from './nonPharmaTherapyStore-d1JfaxFV.js';
import { D as DynamicList, a as NonPharmacologicalIntervention, A as Allergies } from './NextAppointment-DsXm4RNQ.js';
