import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, bL as IonCard, f as ref, aL as useRouter, a2 as onMounted, O as createBlock, aG as IonContent, C as createBaseVNode, bY as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage } from './vendor-DoVhRvhx.js';
import { _ as _sfc_main$2 } from './Wizard.vue_vue_type_script_setup_true_lang-D_W_LZs0.js';
import { z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-DQSL37yM.js';
import { D as DemographicBar } from './DemographicBar-DyGITKGp.js';
import { u as useFormWizard } from './useFormWizard-EXvNEIAn.js';
import { S as SecondStageDelivery, T as ThirdStageDelivery } from './ThirdStageDelivery-DGvM-Lwu.js';
