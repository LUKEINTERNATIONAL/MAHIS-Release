import { s as defineComponent, I as IonHeader, be as IonFooter, eY as IonItemOptions, eZ as IonItemOption, e_ as IonItemSliding, bS as IonSearchbar, cE as IonCardSubtitle, bI as IonBadge, e2 as IonAvatar, L as IonIcon, N as IonButton, ae as IonCheckbox, bc as IonCardContent, b9 as IonCardTitle, bt as IonPage, ba as IonCardHeader, bK as IonCard, a7 as IonLabel, ap as IonItem, ao as IonList, az as IonCol, af as IonRow, aA as IonGrid, aF as IonContent, b_ as chevronUp, bZ as chevronDown, e$ as linkOutline, f0 as location, f1 as fingerPrint, ds as calendar, ce as personCircle, f as ref, c as computed, f2 as male, f3 as female, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, R as renderList, C as createBaseVNode, a4 as normalizeClass, D as toDisplayString, a5 as createTextVNode, H as createCommentVNode } from './vendor-Wwszy5sF.js';
import { N as NavigationMenu } from './NavigationMenu-CpG2IvwB.js';
import { B as BottomNavBar } from './bottomNavBar-CMCmRl4Y.js';
import { P as PatientService, G as toastSuccess, t as toastWarning, _ as _export_sfc } from '../index-8Y6Qmz3g.js';
...
const _sfc_main = defineComponent({
  ...
  watch: {
    $route: {
      handler(to) {
        if (to.name === "immunizationDeduplicateClients") {
          this.initNavData();
        }
      },
      immediate: true
...
const deduplicateClients = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0c78f46c"]]);
