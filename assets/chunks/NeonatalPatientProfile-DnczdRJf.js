...
import { _ as _sfc_main$6 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-QVgYHu_x.js';
...
const NeonatalCare = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-792f3341"]]);
...
const _hoisted_10$1 = ["onClick", "onKeydown"];
const _hoisted_11$1 = { class: "encounter-card__header" };
const _hoisted_12$1 = { class: "encounter-card__date" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$2, [
        ...
        isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
          (openBlock(), createElementBlock(Fragment, null, renderList(skeletonCount, (index) => {
            return createBaseVNode("article", {
              ...
              _cache[3] || (_cache[3] = createBaseVNode("div", { class: "skeleton-row skeleton-title shimmer" }, null, -1)),
        ...
        ])) : !hasEncounters.value ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
          !hasWorkflowInvestigation.value ? (openBlock(), createElementBlock("span", _hoisted_7$1, " Please complete the clinical review workflow first before adding more investigations. ")) : (openBlock(), createElementBlock("span", _hoisted_8$1, " No completed investigation encounters recorded yet. "))
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(orderedLabOrders.value, (order) => {
            return openBlock(), createElementBlock("article", {
              ...
              createBaseVNode("header", _hoisted_11$1, [
                createBaseVNode("div", null, [
                  createBaseVNode("p", _hoisted_12$1, toDisplayString(formatOrderDate(order)), 1)
                ])
              ]),
                    ...
                    createBaseVNode("span", _hoisted_15$1, [
                      isTestPending(test) ? (openBlock(), createBlock(unref(IonButton), {
                        ...
                        default: withCtx(() => [
                          ...
                          _cache[4] || (_cache[4] = createTextVNode(" Enter Result ", -1))
                        ]),
                        _: 1
...
const InvestigationTab = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-514df466"]]);
...
const NeonatalPatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-af67b774"]]);
