import { s as defineComponent, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, c as computed, aG as IonContent, bu as IonPage, aL as useRouter, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-DoVhRvhx.js';
import { s as storeToRefs } from './pinia-CTgeSI8R.js';
import { u as useDemographicsStore, a6 as useUserStore, G as toastSuccess, am as router, x as toastDanger, aY as AppEncounterService, z as StandardForm, _ as _export_sfc, T as Toolbar, t as toastWarning } from '../index-BVAFc2zM.js';
import { D as DemographicBar } from './DemographicBar-CPlLHEo6.js';
import { u as useNeonatalExamStore, c as congenitalAbnormalityLabels, n as neonatalGeneralExaminationSections, N as NeonatalStepper } from './NeonatalStepper-BxTg-GXh.js';
