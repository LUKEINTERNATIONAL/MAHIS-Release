import { c as computed, f as ref, s as defineComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, v as documentTextOutline, K as modalController, aL as useRouter, a2 as onMounted, aG as IonContent, bY as chevronBackOutline, ds as calendar, eQ as paperPlaneOutline, eR as checkmarkDoneOutline, z as createElementBlock, J as Fragment, R as renderList, bu as IonPage, c9 as clipboardOutline, eA as bodyOutline, cc as flask, ci as medkit, eS as chatbubbles } from './vendor-DlXvc2CI.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, q as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-BiecqvPL.js';
import { D as DemographicBar } from './DemographicBar-BSmmDBIL.js';
import { D as DashboardCards } from './DashboardCards-7C_60AGK.js';
import { s as storeToRefs } from './pinia-DxIh5T-z.js';
import { N as NextAppointmentModal } from './NextAppointment-BM4kLFy9.js';
