import { c as computed, f as ref, v as defineComponent, z as openBlock, P as createBlock, C as withCtx, D as createBaseVNode, B as createVNode, G as unref, x as documentTextOutline, L as modalController, aK as useRouter, a3 as onMounted, aF as IonContent, bY as chevronBackOutline, dt as calendar, eR as paperPlaneOutline, eS as checkmarkDoneOutline, A as createElementBlock, K as Fragment, S as renderList, bu as IonPage, ca as clipboardOutline, eB as bodyOutline, cd as flask, cj as medkit, eT as chatbubbles } from './vendor-B3kX1Pjg.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, q as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-BDC92_36.js';
import { D as DemographicBar } from './DemographicBar-CuKAVuTT.js';
import { D as DashboardCards } from './DashboardCards-C4Vy3B8a.js';
import { s as storeToRefs } from './pinia-DWumH6Ru.js';
import { N as NextAppointmentModal } from './NextAppointment-aeFm2glR.js';
import { u as useLocation } from './useLocation-BYo9e4re.js';
