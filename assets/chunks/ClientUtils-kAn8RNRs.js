import { s as defineComponent, f as ref, w as watch, y as openBlock, z as createElementBlock, J as Fragment, S as renderList, A as createVNode, F as unref, af as IonRow, B as withCtx, aB as IonCol, Q as normalizeClass, a7 as IonLabel, a5 as createTextVNode, D as toDisplayString, C as createBaseVNode, O as createBlock, eh as pencilOutline, eF as trashBinOutline, H as createCommentVNode, a3 as onMounted, bN as IonCard, bd as IonCardHeader, L as IonIcon, R as alertCircleOutline, bf as IonCardContent, a6 as IonInput, N as IonButton, G as closeCircleOutline, c as computed, aq as IonItem, ae as IonCheckbox, a8 as withModifiers, bL as IonBadge, ak as IonDatetime, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, I as IonHeader, aI as IonContent, ba as calendarOutline, x as resolveComponent } from './vendor-8vOj_QAN.js';
...
import { a as useConfirm } from './usePatientProfile-4xgJeVsI.js';
import { l as lodashExports } from './lodash-DZHX9O7j.js';
import { u as useNonPharmaTherapyStore, g as getOPDMedicationRunOutDate } from './nonPharmaTherapyStore-CgyoQ3nH.js';
import { m as mapState } from './pinia-Drf8jDfn.js';
...
const _hoisted_1$3 = { class: "route-label" };
                ...
                default: withCtx(() => [
                  createVNode(unref(IonLabel), { class: "details-text" }, {
                    default: withCtx(() => [
                      ...
                      createBaseVNode("span", _hoisted_1$3, toDisplayString(item.route_name), 1)
                    ]),
                    _: 2
                  }, 1024)
                ]),
...
const DynamicList = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a4af995f"]]);
