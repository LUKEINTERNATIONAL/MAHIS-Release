import { O as OrderService, bp as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bq as getCheckboxSelectedValue, aV as modifyRadioValue, a2 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a_ as List, B as BasicInputField, br as SelectionPopover, S as Service, g as getPouchDBRecords, M as ConceptService, bj as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, X as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, ab as useConfigStore, r as StandardModal, a3 as getFieldValue, bl as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-HUvHuTRi.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-CBCkT7wa.js';
import LabOrdersList from './LabOrdersList-CERUcG0z.js';
import { v as validateInputFiledData } from './group_validation-CM12hrhw.js';
import { u as useRadiologyStore } from './RadiologyStore-Br7QLK8W.js';
import { B as BasicForm } from './BasicForm-BuP3-_yb.js';
import { s as defineComponent, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aH as IonContent, bt as pulseOutline, bd as checkmark, a5 as createTextVNode, c as computed, bM as IonCard, aC as IonGrid, af as IonRow, aB as IonCol, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, D as toDisplayString, bR as IonChip, ae as IonCheckbox, bA as IonText, be as IonCardContent, r as reactive, p as dayjs, aM as useRouter, bN as useRoute, T as withDirectives, U as vShow, K as modalController } from './vendor-CZkQjgFf.js';
import { l as lodashExports } from './lodash-BwW3y_1X.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-Bg_H1tGf.js';
import { D as DashBox } from './DashBox-BpVulcor.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-BBWEM6c4.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-C_KeKPZB.js';
import { P as PatientComplaintsService } from './patient_complaints_service-B2fxBlIQ.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-hl6mfJEw.js';
import { i as isClinician } from './Registration-GuaJPVlw.js';
