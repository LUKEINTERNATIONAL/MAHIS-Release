import { s as defineComponent, y as openBlock, O as createBlock, f as ref, c as computed, w as watch, x as resolveComponent, B as withCtx, A as createVNode, F as unref, z as createElementBlock, H as createCommentVNode, bM as IonCard, J as Fragment, bH as IonModal, I as IonHeader, aE as IonToolbar, aF as IonTitle, C as createBaseVNode, L as IonIcon, eY as eggOutline, a5 as createTextVNode, D as toDisplayString, bf as IonButtons, N as IonButton, G as closeCircleOutline, a7 as IonLabel, aH as IonContent, bg as IonFooter, bJ as saveOutline, S as renderList, Q as normalizeClass, cp as checkmarkCircle, e4 as createOutline, bI as addOutline, a$ as medkitOutline, a3 as onMounted, aM as useRouter, b_ as chevronBackOutline, T as withDirectives, U as vShow, be as IonCardContent, bw as IonPage } from './vendor-CvMfV7DM.js';
import { x as toastDanger, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, u as useDemographicsStore, _ as _export_sfc, t as toastWarning, F as DynamicButton, C as useExposeFromStandardForm, S as Service, ar as ConceptService, J as savePatientRecord, o as createModal, y as StandardValidations, T as Toolbar } from '../index-C5FwKd58.js';
import { D as DemographicBar } from './DemographicBar-Dioi8897.js';
import { _ as _sfc_main$k, u as useFormWizard } from './useFormWizard-Ba3AloW3.js';
import { V as Vitals } from './Vitals-B4zygB56.js';
import { s as syncChildUIs } from './StandardUtils-CB1NXgjt.js';
import { d as defineStore, s as storeToRefs } from './pinia-OlYjPPGt.js';
import { A as AddLabTestModal } from './AddLabTestModal-C-lcKSwB.js';
import { _ as _sfc_main$j } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-IAnSBu2q.js';
  ...
  setup(__props, { expose: __expose }) {
      ...
      return [
        {
          ...
          onChange: (value) => {
            if (value) {
              const updates = {};
              breastFindingsKeys.slice(1).forEach((k) => updates[k] = false);
        ...
        },
        {
          ...
          validation: validateAtLeastOne,
          onChange: (value) => {
            const updates = value ? { None: false } : { "Other general exam findings": "" };
            return updates;
          }
        },
        {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Breast Examinations.");
        }
      }
    });
    return (_ctx, _cache) => {
...
const VulvaInspection = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-a288ec07"]]);
    ...
    const onSubmit = async () => {
      try {
        const results = [
          ...
          await vulvaInspectionRef.value?.onSubmit?.(),
...
const MaternalExam = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-2384e2e4"]]);
...
const addFetus = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-89645d63"]]);
...
const FetusModal = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-a2a0422e"]]);
...
const FetusSelector = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-10b5a9e9"]]);
...
const AbdominalInspection = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-b6af126d"]]);
...
const respiratoryExamFindings = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-535d251f"]]);
...
const MUAC = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c39448dc"]]);
...
const GeneralExamination = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-752ce4bd"]]);
  ...
  setup(__props) {
    ...
    const getActiveTabs = () => {
      return [
        ...
        { title: "Abnormal Inspection", icon: "" },
    ...
    const onChangeCurrentTab = async (index, _oldIndex) => {
      ...
      if (value == "Abnormal Inspection") AbdominalExaminationRef.value?.validateForm();
            ...
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_1, [
                unref(patient) && unref(patient).patientID ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  showWizard.value ? (openBlock(), createBlock(_sfc_main$k, {
                    key: 0,
                    ref: "wizard",
...
const PhysicalExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ef9d127"]]);
