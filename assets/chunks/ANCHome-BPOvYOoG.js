import { c as computed, f as ref, s as defineComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, v as documentTextOutline, K as modalController, aM as useRouter, a3 as onMounted, aH as IonContent, b_ as chevronBackOutline, ds as calendar, eZ as paperPlaneOutline, e_ as checkmarkDoneOutline, z as createElementBlock, J as Fragment, S as renderList, bw as IonPage, ca as clipboardOutline, ev as bodyOutline, cd as flask, cj as medkit, e$ as chatbubbles } from './vendor-CZkQjgFf.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-C1knEXPM.js';
import { D as DemographicBar } from './DemographicBar-R4e-G4Oz.js';
import { D as DashboardCards } from './DashboardCards-Ce-LSVXg.js';
import { s as storeToRefs } from './pinia-CBCkT7wa.js';
import { N as NextAppointmentModal } from './NextAppointment-DfwbCJT1.js';
  ...
  const ANCReferralForm = computed(() => {
    return [
      ...
      },
      {
        ...
        obsValueType: "value_text",
        grid: { s: "6" },
        validation: (value) => StandardValidations.isMWPhoneNumber(value?.phoneNumber)
      },
      {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const gravida = ref("");
    const cardsData = [
      { title: "Symptoms and Follow Up", path: "/anc/symptoms-follow-up", icon: clipboardOutline, isSaved: false },
      { title: "Physical Examination", path: "/anc/physical-examination", icon: bodyOutline, isSaved: false },
      { title: "Lab Tests and Imaging", path: "/anc/lab-tests", icon: flask, isSaved: false },
      { title: "Diagnosis and Treatment", path: "/anc/diagnosis-treatment", icon: medkit, isSaved: false },
      { title: "Education and Counselling", path: "/anc/counselling", icon: chatbubbles, isSaved: false }
    ];
...
const ANCHome = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3656f434"]]);
