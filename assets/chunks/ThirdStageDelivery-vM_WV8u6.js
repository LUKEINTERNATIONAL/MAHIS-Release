    ...
    return [
      ...
      },
      {
        ...
        condition: (allFormValues) => {
          const birthWeight = parseInt(allFormValues["Weight"]);
  ...
  const deliveryNewbornDetailsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        options: [
          { label: "2nd degree", value: "2nd degree" },
          { label: "3rd degree", value: "3rd degree" },
          { label: "4th degree", value: "4th degree" }
        ]
      },
      {
        componentType: "inputField",
      ...
      },
      {
        ...
        name: "Specify other obstetric care provided",
        obsValueType: "value_text",
        icon: icons.editPen,
        grid: { s: "10" },
        offset: "2",
