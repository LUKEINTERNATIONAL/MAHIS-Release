import { q as defineComponent, r as ref, a1 as onMounted, a2 as onUnmounted, d as computed, x as createElementBlock, y as openBlock, N as createBlock, G as createCommentVNode, A as createBaseVNode, E as unref, M as IonButton, B as withCtx, z as createVNode, a4 as createTextVNode, fk as menu, K as IonIcon, bR as IonSearchbar, H as Fragment, Q as renderList, bY as chevronDown, bj as chevronForward, C as toDisplayString, a3 as normalizeClass, aD as IonContent, fl as book, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { _ as _export_sfc, T as Toolbar, cn as InfographicDisplay } from '../index-_N7CIn5p.js';
import { neonatalInfographics } from './infographics-CvsizS9R.js';
                ...
                category.expanded ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(category.items, (item) => {
                    return openBlock(), createElementBlock("a", {
                      key: item.key,
                      href: `#guide-${item.key}`,
                      class: normalizeClass(["toc-item", { active: _ctx.activeGuide === item.key }]),
...
const NeonatalGuides = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a21ca9ed"]]);
