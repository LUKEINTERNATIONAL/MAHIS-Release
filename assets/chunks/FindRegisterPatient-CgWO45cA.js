import { s as defineComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, f as ref, K as modalController, bN as useRoute, a3 as onMounted, z as createElementBlock, F as unref, bV as IonSearchbar, L as IonIcon, ex as qrCode, N as IonButton, bI as addOutline, a5 as createTextVNode, H as createCommentVNode, bR as IonChip, a7 as IonLabel, J as Fragment, S as renderList, D as toDisplayString, ey as cloudOfflineOutline, ez as callOutline, b_ as chevronBackOutline, dg as chevronForwardOutline, aw as searchOutline, cP as closeCircle, be as IonCardContent, c as computed } from './vendor-XNfOCpdb.js';
import { n as icons, y as StandardValidations, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, V as useGlobalPropertyStore, a as useProgramStore, D as PatientSearchService, S as Service, b9 as scannedData, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-DjgSdAC3.js';
import { R as Registration } from './Registration-BqRCWBO6.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    relativeRegistration: { type: Boolean, default: true }
  },
  setup(__props) {
    const props = __props;
    ...
    regForm.value = [
      ...
      },
      {
        ...
        mode: "standard",
        validation: (value) => {
          return value?.value || value ? null : "Select gender";
        }
      }
    ];
    const handleFinish = async () => {
      if (formRef.value?.validateForm() == null) {
        ...
        await modalController.dismiss(await new RegistrationService().saveRegistrationData(data, props.relativeRegistration));
        return;
      }
  ...
  setup(__props, { emit: __emit }) {
    ...
    const goToRegistration = async () => {
      ...
      if (Service.getProgramID() == 38 || props.isMinimalRegistration) {
        patientData = await createModal(_sfc_main$1, { class: "mediumModal" }, false, { relativeRegistration: false });
      } else {
...
const FindRegisterPatient = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9cdc0a4d"]]);
