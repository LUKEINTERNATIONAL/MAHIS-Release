import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, H as Fragment, Q as renderList, A as createBaseVNode, C as toDisplayString, v as resolveComponent, N as createBlock, B as withCtx, G as createCommentVNode, af as close, K as IonIcon, P as alertCircleOutline, a4 as createTextVNode, M as IonButton, cj as onBeforeUnmount, aD as IonContent, bs as IonPage, aI as useRouter, ct as useRoute, a as reactive, fe as onIonViewWillEnter, bW as chevronBackOutline, eT as provide } from './vendor-wM1cIaYi.js';
import { s as storeToRefs } from './pinia-Czqxf__w.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-Cd3-tqLQ.js';
import { D as DemographicBar } from './DemographicBar-BgSZJbsG.js';
import { l as neonatalTriageSections, m as neonatalTriageFormKey, o as useNeonatalTriageStore, N as NeonatalStepper, p as defaultNeonatalTriageForm, t as triageConceptMapping } from './NeonatalStepper-is4HYcSG.js';
...
const VitalBloodSugar = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-1e252810"]]);
      ...
      if (currentIndex === summaryStepIndex && hasPatient2 || shouldSaveOnDemographics || isFinalStep && hasPatient2) {
        return async () => {
          try {
            ...
            source2 == "dashboard" ? router.push("/NeonatalHome") : router.push("/patientProfile");
          } catch (error) {
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-15b8e9c5"]]);
