import { c as computed, eF as create$3, eG as create$5, eH as create$6, i as isRef, s as defineComponent, a2 as onMounted, n as nextTick, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, H as createCommentVNode, F as unref, a$ as personOutline, f as ref, K as modalController, w as watch, z as createElementBlock, bd as IonCardContent, a7 as IonLabel, a5 as createTextVNode, D as toDisplayString, J as Fragment, R as renderList, bK as IonCard, a4 as normalizeClass, bb as IonCardHeader, ba as IonCardTitle, L as IonIcon, Q as alertCircleOutline, by as IonText, N as IonButton, e3 as createOutline, bG as addOutline, x as resolveComponent } from './vendor-DpSS1aB1.js';
import { bW as getAgeInDays, n as icons, P as PatientService, K as ObservationService, b as EncounterTypeId, z as StandardForm, F as DynamicButton, r as StandardModal, t as toastWarning, H as HisDate, G as toastSuccess, u as useDemographicsStore, C as useExposeFromStandardForm, b5 as RelationshipService, J as savePatientRecord, ar as ConceptService, _ as _export_sfc, a2 as getFieldValue } from '../index-BZggDy3W.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-B5K5AG5a.js';
import { l as lodashExports } from './lodash-D-_KzUJJ.js';
import { u as useBabyDetails } from './useBabyDetails-DY9Lw4dM.js';
import { s as storeToRefs, d as defineStore } from './pinia-CbGjwPb6.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const fetchAndPrefillDeliveryDetails = async () => {
      ...
      const [dateOfDelivery, timeOfDelivery, modeOfDelivery, placeOfDelivery, staffConductingDelivery, babyCondition, numberOfBabies] = await Promise.all([
        getFirstObs(labourObs, "Date of delivery"),
        getFirstObs(labourObs, "Time of delivery"),
        getFirstObs(labourObs, "Mode of delivery"),
        getFirstObs(labourObs, "Place of delivery"),
        getFirstObs(labourObs, "Staff conducting delivery"),
        getFirstObs(labourObs, "Baby general condition at birth"),
        getFirstObs(labourObs, "Number of babies")
      ]);
      if (dateOfDelivery) formRef.value.setFormValue("Date of delivery", dateOfDelivery);
      if (timeOfDelivery) {
        const timeVal = formatTimeForInput(String(timeOfDelivery)) ?? timeOfDelivery;
      ...
      if (staffConductingDelivery) {
        ...
        const knownOptions = ["md/co/ma/nurse midwife/cma", "pa/wa/hsa/other/none", "skilled birth attendant", "unskilled birth attendant", "other"];
        const match = knownOptions.find((opt) => raw.toLowerCase() === opt.toLowerCase());
        formRef.value.setFormValue("Staff conducting delivery", match ?? "other");
        if (!match) formRef.value.setFormValue("otherStaff", raw);
      }
      if (babyCondition) {
    ...
    const loadData = async () => {
      ...
      await fetchAndPrefillDeliveryDetails();
    };
    watch(
...
const DeliveryDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-748a00ba"]]);
