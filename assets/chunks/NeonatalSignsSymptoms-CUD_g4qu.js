import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, c as computed, aI as IonContent, bx as IonPage, aN as useRouter, f3 as provide, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-8vOj_QAN.js';
import { s as storeToRefs } from './pinia-Drf8jDfn.js';
import { z as StandardForm, _ as _export_sfc, N as ConceptService, T as Toolbar, u as useDemographicsStore, t as toastWarning, H as HisDate, G as toastSuccess } from '../index-Bn2sysQf.js';
import { N as NeonatalService } from './neonatal_service-B4jFS-vh.js';
import { D as DemographicBar } from './DemographicBar-CJWnjE0e.js';
import { h as neonatalSignsSymptomsSections, a as neonatalSignsSymptomsFormKey, N as NeonatalStepper, K as useSignsSymptomsStore } from './NeonatalStepper-B5xdyoOw.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const getPresentingComplaintOptions = async (query, page = 1, pageSize = 40) => {
      ...
      if (!all) {
        try {
          ...
          console.log("[PresentingComplaintsSection] Loaded presenting complaints:", records.length, "records");
          ...
          const withoutOther = mapped.filter((opt) => String(opt.value).toLowerCase() !== "other");
          const merged = [...withoutOther, { label: "Other", value: "other" }];
          ...
          console.error("[PresentingComplaintsSection] Failed to load presenting complaints:", error);
          all = [{ label: "Other", value: "other" }];
          complaintsCache.set(cacheKey, all);
        }
      }
    ...
    const syncFormValues = (values) => {
      ...
      signsForm.presenting_complaints_other = values.presenting_complaints_other || "";
    };
    watch(
      () => formRef.value?.formValues,
      (values) => {
...
const PresentingComplaintsSection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7f9cfd97"]]);
...
const NeonatalSignsSymptoms = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-899c777f"]]);
