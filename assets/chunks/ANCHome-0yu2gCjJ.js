import { c as computed, f as ref, s as defineComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, v as documentTextOutline, K as modalController, aL as useRouter, a2 as onMounted, aG as IonContent, bX as chevronBackOutline, dr as calendar, eR as paperPlaneOutline, eS as checkmarkDoneOutline, z as createElementBlock, J as Fragment, R as renderList, bu as IonPage, c8 as clipboardOutline, eF as bodyOutline, cb as flask, ch as medkit, eT as chatbubbles } from './vendor-CIi-jrCy.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-COGk33Kr.js';
import { D as DemographicBar } from './DemographicBar-CPtM0sIB.js';
import { D as DashboardCards } from './DashboardCards-Bt0HLrLF.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { N as NextAppointmentModal } from './NextAppointment-DIRws0PN.js';
