...
import { q as defineComponent, r as ref, d as computed, x as createElementBlock, y as openBlock, bP as withKeys, a3 as normalizeClass, a7 as withModifiers, A as createBaseVNode, z as createVNode, H as Fragment, Q as renderList, O as normalizeStyle, B as withCtx, E as unref, ay as IonCol, K as IonIcon, a6 as IonLabel, C as toDisplayString, ae as IonRow, v as resolveComponent, a4 as createTextVNode, J as modalController, a1 as onMounted, N as createBlock, G as createCommentVNode, bB as modalController$1, M as IonButton, bj as chevronForward, bN as IonChip, an as IonItem, d3 as add, aI as useRouter, w as watch, d2 as person, e0 as ellipsisVerticalSharp, aF as IonAccordionGroup, aE as IonAccordion, am as IonList, as as IonToggle, bm as IonPopover } from './vendor-DUNDjU_C.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { n as icons, _ as _export_sfc, y as StandardValidations, C as StandardForm, H as HisDate, S as Service, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, q as StandardModal, t as toastWarning, aq as ConceptService, bq as LabOrderService, o as createModal, O as OrderService, F as DynamicButton, l as PreviousVitals, P as PatientService } from '../index-77Br-hAb.js';
import { N as NextAppointment } from './vaccines_service-0FikMFiw.js';
import { u as usePatientProfile } from './usePatientProfile-B7siHYsW.js';
import WeightHeightChart from './WeightHeightChart-BT_XvQLD.js';
import { O as OtherVitals, w as weightAndHeight } from './weightAndHeight-CjQYn83k.js';

const _hoisted_1$8 = ["onKeydown"];
const _hoisted_2$7 = { class: "ripple-container" };
const _hoisted_3$4 = ["onAnimationend"];
const _hoisted_4$4 = { class: "status-badge" };
            ...
            createVNode(unref(IonCol), { class: "ion-text-center" }, {
              default: withCtx(() => [
                createVNode(unref(IonLabel), null, {
                  default: withCtx(() => [
                    createBaseVNode("span", _hoisted_4$4, toDisplayString(__props.status), 1)
                  ]),
                  _: 1
                })
              ]),
...
const ReferralCard = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-3af6644b"]]);

const _hoisted_1$7 = { style: { "padding-left": "10px", "padding-right": "10px" } };
const _hoisted_2$6 = { style: { "display": "flex", "justify-content": "space-between", "padding": "10px" } };
...
const RiskCategoryFollowUpModal = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-fdbc4375"]]);

const _hoisted_1$6 = { style: { "padding-left": "10px", "padding-right": "10px" } };
const _hoisted_2$5 = { class: "content" };
const _hoisted_3$3 = { style: { "margin-top": "10px" } };
...
const OutcomeSummaryModal = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-62e554aa"]]);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const determineNextStep = () => {
      ...
      console.log("🚀 ~ determineNextStep ~ testType:", testType);
    ...
    const continueToNext = async () => {
      ...
      switch (nextStep.value) {
        case "risk_category":
          ...
          break;
        case "unigold":
          await formRef.value?.resetForm(["test_type", "test_kit_serial_number"]);
        ...
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1$5, [
            ...
            createBaseVNode("div", _hoisted_2$4, [
              _cache[3] || (_cache[3] = createBaseVNode("span", null, "Reported by: ", -1)),
...
const HIVTestingModal = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f82b3090"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_ion_button = resolveComponent("ion-button");
      return openBlock(), createBlock(StandardModal, {
        title: __props.order.value_text + " Testing",
        subtitle: ""
      }, {
        "top-buttons": withCtx(() => [
          createVNode(_component_ion_button, {
...
const HepatitisModal = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f8b8aa04"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(StandardModal, { title: "Select Test and Date" }, {
        "top-buttons": withCtx(() => [
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const openWhichTestModal = async () => {
      await createModal(_sfc_main$3, { class: "otherVitalsModal" }, true);
    };
...
const PastTestResults = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-33b6a7b5"]]);
  ...
  setup(__props) {
    ...
    const openHIVTestingModal = async (order) => {
      ...
      if (testName == "Syphilis" || testName == "Hepatitis B Test" || testName == "Hepatitis C Test") {
        await createModal(HepatitisModal, { class: "base-content-modal" }, true, { order });
      }
    };
    const isChild = () => {
...
const HTSPatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec2db7e9"]]);
