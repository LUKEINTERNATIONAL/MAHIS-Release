import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, bc as IonCardHeader, B as withCtx, L as IonIcon, aw as searchOutline, cE as IonCardSubtitle, a5 as createTextVNode, bb as IonCardTitle, be as IonCardContent, bV as IonSearchbar, N as IonButton, bn as chevronForward, J as Fragment, S as renderList, D as toDisplayString, H as createCommentVNode, cP as closeCircle, f as ref, c as computed, a3 as onMounted, cI as __vitePreload, O as createBlock, aM as useRouter, bN as useRoute, ac as IonNote, ex as qrCode, bI as addOutline, ez as callOutline, b_ as chevronBackOutline, dg as chevronForwardOutline, fw as barcode, b9 as calendarOutline, G as closeCircleOutline, R as alertCircleOutline, aH as IonContent, bw as IonPage, f1 as provide, x as resolveComponent } from './vendor-XNfOCpdb.js';
import { s as storeToRefs } from './pinia-CtfxbWof.js';
import { u as useDemographicsStore, D as PatientSearchService, ck as Banner, S as Service, P as PatientService, _ as _export_sfc, X as LocationService, M as ConceptService, z as StandardForm, t as toastWarning, H as HisDate, o as createModal, r as StandardModal, cm as infoAlert, T as Toolbar, a8 as RelationsService, ar as SetProgramService, G as toastSuccess, x as toastDanger } from '../index-DjgSdAC3.js';
import { N as NeonatalService } from './neonatal_service-BvbwyxIB.js';
import { D as DemographicBar } from './DemographicBar-C6xRBdRR.js';
import { i as neonatalEnrollmentSections, r as extractOptionValue, s as normalizeTextValue, t as extractMultiSelectValues, v as motherEnrollmentRules, N as NeonatalStepper } from './NeonatalStepper-CCDDeUs3.js';
import { n as neonatalEnrollmentFormKey, u as useNeonatalEnrollmentStore } from './useNeonatalEnrollmentStore-CZsriE-x.js';
import { I as IMAGES } from './images-_va7dFSn.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-frcYiJ8v.js';
import { S as SummarySection } from './SummarySection-B0dlJFpg.js';
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return showTwinSearch.value ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
...
const TwinSearch = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-6b9f1217"]]);

const _hoisted_1$2 = { class: "birth-details-wrapper" };
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function prefillBirthWeightFromTriage() {
      ...
      try {
        ...
        if (isOfflineMode) {
          ...
          console.log("[BirthDetails] Offline birth weight (grams):", offlineWeightInGrams);
        ...
        formRef.value?.setFormValue("birthWeight", weightInGrams.toString());
        if (enrollmentForm) {
          enrollmentForm.birthWeight = weightInGrams.toString();
        }
        birthWeightLocked.value = true;
      } catch (error) {
    ...
    async function getOfflineBirthWeightInGrams(patientId) {
      try {
        ...
        console.log("[BirthDetails] Offline observations count:", observations.length);
        if (!Array.isArray(observations) || observations.length === 0) return null;
        let conceptId = null;
        try {
          conceptId = await ConceptService.getConceptID("Birth weight", true);
          console.log("[BirthDetails] Concept ID for Birth weight:", conceptId);
        } catch {
          conceptId = null;
        }
        const matches = observations.filter((obs) => {
        ...
        console.log("[BirthDetails] Matching birth weight obs:", matches);
        ...
        console.log("[BirthDetails] Latest birth weight obs raw value:", rawValue, "latest:", latest);
...
const BirthDetails = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-fe62e3bf"]]);
...
const _hoisted_1$1 = { class: "mother-search-container" };
...
const MotherSearch = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6d04fba3"]]);
...
const MotherEnrollmentDetails = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8fa60502"]]);
...
const Enrollment = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-cca3cd4c"]]);
