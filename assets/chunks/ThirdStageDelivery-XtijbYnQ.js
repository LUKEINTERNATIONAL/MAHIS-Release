...
import { u as useBabyDetails } from './useBabyDetails-G3PA0g4R.js';
  ...
  const deliveryNewbornDetailsFormSection = computed(() => {
    return [
      ...
      },
      {
        ...
        offset: "2",
        type: "inline",
        condition: (formValues) => !isStillbirth(formValues) && !isNeonatalDeath(formValues) && formValues["Obstetric complications"] == "Perineal tear (2nd, 3rd or 4th degree)",
        options: [
