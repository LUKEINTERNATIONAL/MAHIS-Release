import { q as defineComponent, a2 as onMounted, r as ref, x as createElementBlock, y as openBlock, B as createBaseVNode, z as createVNode, A as withCtx, a5 as createTextVNode, C as toDisplayString, E as unref, a7 as IonLabel, by as createStaticVNode, fn as I1, N as IonButton, J as Fragment, K as modalController, fo as IonAlert, v as resolveComponent, O as createBlock, am as IonList, an as IonItem, ai as IonRadio, ah as IonRadioGroup, R as renderList, af as IonRow, ay as IonCol, a6 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, I as IonHeader, H as IonContent, S as withDirectives, G as createCommentVNode, T as vShow, bD as IonModal, aE as IonAccordionGroup, aD as IonAccordion, b6 as IonCardTitle, cC as IonCardSubtitle, b7 as IonCardHeader, b9 as IonCardContent, bI as IonCard, br as IonPage, ct as IonMenuButton, bb as IonFooter, L as IonIcon, ab as checkmarkOutline, F as closeCircleOutline, d as computed, fp as folderOpenOutline, ar as script, di as Navigation, dj as Pagination, dk as Slide, dl as Carousel, c8 as clipboardOutline, d1 as person, d$ as ellipsisVerticalSharp, b8 as checkmark, bW as chevronBackOutline, a4 as normalizeClass } from './vendor-BPW-J91F.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, ab as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, C as StandardForm, F as DynamicButton, K as ObservationService, cm as PatientRegistrationService, a6 as RelationsService, x as toastDanger, cL as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bT as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-C6u5KmBv.js';
...
import { m as mapState, s as storeToRefs } from './pinia-D-q2_lrU.js';
import { S as Stepper } from './Stepper-DtnNJREv.js';
import { T as Treatment } from './nonPharmaTherapyStore-Dc4ocmKe.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-CKgbxOJy.js';
import WeightHeightChart from './WeightHeightChart-DxiUaGCw.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-BQ8p1bwU.js';
import { c as customDatePicker } from './customDatePicker-DIgOE6rm.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, N as NextAppointment } from './vaccines_service-BUElpUUF.js';
import { S as StockService } from './stock_service-CybdBcrS.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-DSALFDkv.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-I08T236T.js';
...
import { _ as _sfc_main$e } from './usePatientProfile-CMtVReWS.js';
