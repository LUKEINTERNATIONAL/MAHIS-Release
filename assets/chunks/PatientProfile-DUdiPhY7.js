import { q as defineComponent, w as watch, N as createBlock, y as openBlock, E as unref, bJ as IonCard, B as withCtx, z as createVNode, b7 as IonCardTitle, x as createElementBlock, f as ref, dY as IonSkeletonText, a4 as createTextVNode, K as IonIcon, aP as medicalOutline, H as Fragment, b8 as IonCardHeader, am as IonList, Q as renderList, an as IonItem, a6 as IonLabel, b5 as calendarOutline, A as createBaseVNode, C as toDisplayString, cI as idCardOutline, c6 as folderOutline, c3 as checkmarkCircleOutline, ba as IonCardContent, l as dayjs, a1 as onMounted, ax as IonGrid, ae as IonRow, ay as IonCol, a3 as normalizeClass, dZ as checkboxOutline, G as createCommentVNode, c8 as clipboardOutline, d_ as statsChartOutline, J as modalController, aI as useRouter, ct as useRoute, v as resolveComponent, aD as IonContent, cP as defineAsyncComponent, c as computed, d$ as ellipsisVerticalSharp, d2 as person, aF as IonAccordionGroup, aE as IonAccordion, O as normalizeStyle, F as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, aY as personOutline, s as documentTextOutline, a_ as printOutline, d3 as add, bs as IonPage, cH as __vitePreload } from './vendor-xvx_X2hj.js';
import { s as storeToRefs } from './pinia-CiVhHi9d.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, aa as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-D5ZuGc-h.js';
import { u as useUserActivities } from './useUserActivities-ChSYUVaG.js';
...
import { i as isTaskPermitted } from './tasks-CPiaapwC.js';
import { A as ANCRedirection } from './anc_service-BynHnbXC.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-CG3XWZte.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BF0G8P19.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CbT92tu5.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-B1VQRblq.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-C_qYdzsZ.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-C6VEk8zh.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-XONkMgo9.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-CUftiA1U.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-BANkza7w.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-Dbvg5F5-.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-95pGVvgg.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-D5ZuGc-h.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-3-PjBXhF.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-BgcneZ1e.js'),true              ?[]:void 0));
