import { s as defineComponent, w as watch, a2 as onMounted, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, Q as alertCircleOutline, c3 as checkmarkCircleOutline, J as Fragment, R as renderList, b8 as calendarOutline, D as toDisplayString, a4 as normalizeClass, a9 as chevronDownOutline, H as createCommentVNode, f as ref, c as computed, L as IonIcon, eG as bodyOutline, eH as scanOutline, bG as addOutline, br as pulseOutline, eI as moveOutline, eJ as fitnessOutline, dd as manOutline, eK as happyOutline, eL as earOutline, eM as nutritionOutline, di as eyeOutline, c2 as warningOutline, aS as medicalOutline, aV as femaleOutline, v as documentTextOutline, n as nextTick, O as createBlock, B as withCtx, a7 as IonLabel, a5 as createTextVNode, dE as IonToggle, aq as IonItem, af as IonRow, aH as IonAccordion, N as IonButton, a8 as withModifiers, aI as IonAccordionGroup, ap as IonList, au as script, a6 as IonInput, bH as saveOutline, G as closeCircleOutline, c8 as clipboardOutline, ad as IonTextarea, aA as IonCol, aL as useRouter, ct as useRoute, M as IonSpinner, dG as IonLoading, aG as IonContent, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage, eE as lockClosedOutline, ab as checkmarkOutline } from './vendor-CHJxKtY0.js';
import { s as storeToRefs, m as mapState } from './pinia-DvUiFzi9.js';
import { _ as _sfc_main$a, u as useFormWizard } from './useFormWizard-Dw7SfebS.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bq as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bn as useInvestigationStore, b_ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bH as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bK as StagesService, q as usePatientList, v as closeVisit } from '../index-eygbwbqc.js';
import { D as DemographicBar } from './DemographicBar-DLk2Dd1d.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-C_BQxbHs.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-DM-rUCAi.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-BrwXrm1D.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-AOu_pu9s.js';
import { I as Investigations } from './Investigations-B8FZXu9M.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-B5dQDVTF.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-CjxC6Rlg.js';
import { P as PreviousTreatment } from './treatment-9_q1eBRX.js';
import { l as lodashExports } from './lodash-DVS_Ha8A.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DNCtwzlh.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-BryIqPEN.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-O4_0-U3H.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Vd3jy_0-.js';
...
const OPDTreatmentPlan = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9c144526"]]);
