import { e as useGeneralStore, u as useDemographicsStore, z as StandardForm, l as PreviousVitals, t as toastWarning, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, _ as _export_sfc } from '../index-CQh6ahck.js';
...
import { s as defineComponent, f as ref, w as watch, a3 as onMounted, n as nextTick, cm as onBeforeUnmount, y as openBlock, z as createElementBlock, O as createBlock, A as createVNode, B as withCtx, F as unref, aK as IonAccordionGroup, aJ as IonAccordion, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, C as createBaseVNode, af as IonRow, J as Fragment, c as computed } from './vendor-DdMq-dB8.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isAllDisabled = ref(generalStore.vitalsTogglePreference);
    const toggleDisableAll = (value) => {
      isAllDisabled.value = value !== void 0 ? value : !isAllDisabled.value;
      formKey.value++;
    };
    ...
    const onSubmit = async () => {
      if (isAllDisabled.value) {
        toastWarning("Skipped all vitals", 600);
        return true;
      }
      if (!formRef.value) {
    ...
    const vitalsForm = computed(() => {
      ...
      return mergedForm.map((element) => {
        const originalDisabled = element.disabled;
        return {
          ...element,
          disabled: (allFormValues) => {
            if (isAllDisabled.value) return true;
            if (typeof originalDisabled === "function") {
              return originalDisabled(allFormValues);
            }
...
const Vitals = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-efa1578d"]]);
