import { s as defineComponent, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, c as computed, aI as IonContent, bx as IonPage, aN as useRouter, f3 as provide, x as resolveComponent, O as createBlock, B as withCtx } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { z as StandardForm, _ as _export_sfc, u as useDemographicsStore, T as Toolbar, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { u as useNeonatalExamStore, N as NeonatalStepper } from './NeonatalStepper-DJUdVdam.js';
import { n as neonatalGeneralExaminationSections, a as neonatalGeneralExaminationFormKey } from './neonatal_service-Ba63sn1T.js';
...
const ActivityAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-67fd561e"]]);
...
const HeadAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-2bf9e992"]]);
...
const CardiovascularAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f70db478"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const baseFormData = neonatalGeneralExaminationSections[3].formData;
    const examStore = useNeonatalExamStore();
    ...
    const filterGenitaliaOptionsByGender = (options) => {
      if (!Array.isArray(options)) return options;
      return options.filter((opt) => {
        const label = String(opt?.label || "");
        const isMaleOpt = /\bmale\b/i.test(label);
        const isFemaleOpt = /\bfemale\b/i.test(label);
        if (gender.value === "M") {
          return !isFemaleOpt;
        }
        if (gender.value === "F") {
        ...
        return !isMaleOpt && !isFemaleOpt;
      });
    };
    const formData = computed(() => {
      return baseFormData.map((field) => {
        if (field.name === "genitaliaAssessment" && Array.isArray(field.options)) {
          return {
            ...field,
            options: filterGenitaliaOptionsByGender(field.options)
          };
        }
        return field;
      });
    ...
    watch(
      gender,
      () => {
        const current = formRef.value?.getFormValues?.()?.genitaliaAssessment;
        if (!current) return;
        const options = (formData.value || []).find((f) => f.name === "genitaliaAssessment")?.options || [];
        const stillValid = options.some((opt) => opt.value === current || opt.label === current);
        if (!stillValid) {
          formRef.value?.setFormValue?.("genitaliaAssessment", null);
        }
      },
      { immediate: true }
    );
...
const GenitalAndAnusAssessmentForm = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-13c0ec5d"]]);
...
const CleftLipPalateForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2a260b83"]]);
...
const CongenitalAbnormalitiesForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a6ec243e"]]);
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const syncExaminationForm = () => {
      ...
      examStore.initializeExamForm(patientId || null);
    };
    syncExaminationForm();
    watch(
...
const GeneralExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-f93d007a"]]);
