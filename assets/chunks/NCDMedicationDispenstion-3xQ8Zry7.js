import { f as ref, s as defineComponent, w as watch, y as openBlock, z as createElementBlock, J as Fragment, R as renderList, C as createBaseVNode, D as toDisplayString, F as unref, a4 as normalizeClass, A as createVNode, B as withCtx, L as IonIcon, c3 as checkmarkCircleOutline, N as IonButton, di as eyeOutline, aS as medicalOutline, H as createCommentVNode, c as computed, bT as trashOutline, O as createBlock, af as IonRow, aA as IonCol, K as modalController, aL as useRouter, ct as useRoute, cj as onBeforeUnmount, a2 as onMounted, aG as IonContent, Q as alertCircleOutline, bK as IonCard, ch as medkit, a5 as createTextVNode, a6 as IonInput, bf as IonFooter, bu as IonPage } from './vendor-CLJC7Gvp.js';
import { s as storeToRefs } from './pinia-D5Z686-t.js';
import { E as EIRreportsStore } from './EIRreportsStore-CP8FhV2o.js';
import { N as NavigationMenu } from './NavigationMenu-CN-dDb9Q.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-DtAxdS7V.js';
import { aq as ConceptService, b as EncounterTypeId, a as useProgramStore, H as HisDate, _ as _export_sfc, aY as AppEncounterService, P as PatientService, S as Service, u as useDemographicsStore, J as savePatientRecord, G as toastSuccess, bX as toastDanger, bH as DrugOrderService, y as StandardValidations, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, k as alertConfirmation, t as toastWarning, e as useGeneralStore, q as usePatientList, o as createModal, aM as PrintoutService, v as closeVisit, x as toastDanger$1, bY as checkLiveAPIStatus, g as getPouchDBRecords } from '../index-CF3vw6TQ.js';
import { a as DRUG_FREQUENCIES } from './drug_prescription_service-T3d0Jxcv.js';
...
const _hoisted_15 = { class: "flex justify-end items-center gap-2" };
const _hoisted_16 = {
  key: 2,
  style: { "margin-left": "10px", "margin-right": "10px" },
  class: "p-4"
};
const _hoisted_17 = { class: "program-title" };
const _hoisted_18 = { class: "card-date-section" };
const _hoisted_19 = { class: "date-label" };
const _hoisted_20 = {
  key: 0,
...
const _hoisted_22 = { style: { "position": "absolute", "top": "-5px", "right": "-5px" } };
const _hoisted_23 = { class: "card-med-title" };
const _hoisted_24 = { style: { "padding-right": "25px" } };
const _hoisted_25 = { class: "card-details" };
const _hoisted_26 = { class: "text-subtle" };
const _hoisted_27 = {
  key: 0,
  class: "error-text"
};
            ...
            default: withCtx(() => [
              activeDynamicButton.value === "diagnosis" ? (openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                Object.keys(medicationsByProgram.value).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_2, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(medicationsByProgram.value, (medications2, programName) => {
                    return openBlock(), createElementBlock(Fragment, { key: programName }, [
                      createBaseVNode("h2", _hoisted_17, toDisplayString(programName), 1),
                      (openBlock(true), createElementBlock(Fragment, null, renderList(groupMedicationsByDate(medications2), (medicationGroup, date) => {
                        return openBlock(), createElementBlock(Fragment, { key: date }, [
                          createBaseVNode("div", _hoisted_18, [
                            createBaseVNode("h3", _hoisted_19, toDisplayString(formatHeaderDate(date)), 1),
                            unref(diagnosesByDate)[date] ? (openBlock(), createElementBlock("div", _hoisted_20, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(diagnosesByDate)[date], (diag) => {
                                return openBlock(), createElementBlock("span", {
                                  key: diag.concept_id,
                                      ...
                                      default: withCtx(() => [
                                        createBaseVNode("div", _hoisted_21, [
                                          ...
                                          createBaseVNode("div", _hoisted_23, [
                                            ...
                                            createBaseVNode("span", _hoisted_24, toDisplayString(medication.drug_name), 1)
                                          ]),
                                          createBaseVNode("div", _hoisted_25, [
                                            createBaseVNode("p", _hoisted_26, toDisplayString(getFrequencyLabel(medication.frequency)), 1),
                                            createVNode(unref(IonInput), {
                                              type: "number",
                                              placeholder: "Qty",
                                              modelValue: medication.amountToDispense,
                                            ...
                                            medication.error ? (openBlock(), createElementBlock("div", _hoisted_27, toDisplayString(medication.error), 1)) : createCommentVNode("", true)
                                          ]),
                                          createVNode(unref(IonButton), {
                                            expand: "block",
                                            color: "success",
...
const NCDMedicationDispenstion = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ed2b127"]]);
