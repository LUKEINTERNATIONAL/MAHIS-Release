import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, H as Fragment, Q as renderList, A as createBaseVNode, C as toDisplayString, v as resolveComponent, N as createBlock, B as withCtx, G as createCommentVNode, af as close, K as IonIcon, P as alertCircleOutline, a4 as createTextVNode, M as IonButton, aj as onBeforeUnmount, aD as IonContent, bs as IonPage, aI as useRouter, cs as useRoute, a as reactive, bW as chevronBackOutline, eS as provide } from './vendor-sqYZJ6fK.js';
import { s as storeToRefs } from './pinia-B_NbVBpS.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-_N7CIn5p.js';
import { D as DemographicBar } from './DemographicBar-C1AiU9D7.js';
import { l as neonatalTriageSections, m as neonatalTriageFormKey, o as useNeonatalTriageStore, N as NeonatalStepper, p as defaultNeonatalTriageForm, t as triageConceptMapping } from './NeonatalStepper-CxQhVATI.js';
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const allStepperData = [
      ...
      // Index 36
      { title: "Demographics", value: "29", component: BabyDemographics, configIndex: 31 }
      // Index 31
    ];
      ...
      if (currentIndex === summaryStepIndex && hasPatient2 || shouldSaveOnDemographics || isFinalStep && hasPatient2) {
        return async () => {
          try {
            ...
            source2 == "dashboard" ? router.push("/home") : router.push("/patientProfile");
          } catch (error) {
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c6ecd95c"]]);
