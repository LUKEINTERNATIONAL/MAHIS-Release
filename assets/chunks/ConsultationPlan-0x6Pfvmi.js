...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bI as StagesService, q as usePatientList, v as closeVisit } from '../index-CSKZEueZ.js';
import { D as DemographicBar } from './DemographicBar-BZiRzpvP.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DjDlgVPG.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BVGja62Z.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-BXtHJZv8.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CBUprHU1.js';
import { I as Investigations } from './Investigations-DiKOK6LB.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-DGU2tg-y.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-B28DJ6i-.js';
import { P as PreviousTreatment } from './treatment-C1TZ7Kx8.js';
import { l as lodashExports } from './lodash-Dm7Pej-A.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-Ca3weQ7V.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CvosDhwN.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CPXbCO8U.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-rh9zRnOS.js';
