...
import { H as HisDate, aq as ConceptService, b as EncounterTypeId, _ as _export_sfc, n as icons, aY as AppEncounterService, P as PatientService, S as Service, u as useDemographicsStore, J as savePatientRecord, G as toastSuccess, bY as toastDanger, bI as DrugOrderService, e as useGeneralStore, q as usePatientList, aM as PrintoutService, v as closeVisit, k as alertConfirmation, x as toastDanger$1, o as createModal, bZ as checkLiveAPIStatus, g as getPouchDBRecords } from '../index-U74EcRLP.js';
import { a as DRUG_FREQUENCIES } from './drug_prescription_service-BautYMtS.js';
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(filteredDiagnoses.value[date], (diagnosis, index) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_8$1, [
                    createBaseVNode("p", _hoisted_9$1, toDisplayString(diagnosis.program || "NCD PROGRAM"), 1),
...
const DiagnosisSummary = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d1e2d811"]]);
