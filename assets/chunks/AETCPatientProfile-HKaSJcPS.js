import { q as defineComponent, aI as useRouter, ct as useRoute, r as ref, d as computed, a1 as onMounted, w as watch, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, z as createVNode, E as unref, aD as IonContent, G as createCommentVNode, A as createBaseVNode, ae as IonRow, ay as IonCol, bJ as IonCard, ba as IonCardContent, K as IonIcon, e0 as ellipsisVerticalSharp, a3 as normalizeClass, d2 as person, C as toDisplayString, a4 as createTextVNode, x as createElementBlock, F as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, a6 as IonLabel, O as normalizeStyle, cP as defineAsyncComponent, an as IonItem, aY as personOutline, s as documentTextOutline, cI as idCardOutline, a_ as printOutline, H as Fragment, Q as renderList, d3 as add, bs as IonPage, cH as __vitePreload } from './vendor-DUNDjU_C.js';
import { s as storeToRefs } from './pinia-CzgPmrQI.js';
import { A as ArtCard } from './PatientProfile-CdakSXJA.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, ap as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, an as iconBMI, k as alertConfirmation, ao as openVisit, v as usePatientList, G as toastSuccess, r as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-cEgpSt1H.js';
...
import { C as CPR } from './CPR-DgfVcAor.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CFkjh9sk.js'),true              ?[]:void 0));
