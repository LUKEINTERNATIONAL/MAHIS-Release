...
import { n as icons, H as HisDate, S as Service, u as useDemographicsStore, y as StandardValidations, M as ConceptService, E as EncounterService, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, o as createModal, _ as _export_sfc } from '../index-BM8B4uT5.js';
import { S as SaveProgressModal } from './SaveProgressModal-9dcPciDo.js';
import { u as useNeonatalTriageStore, g as getPreviousSectionIndex$2, a as getNextSectionIndex$2 } from './triage-DhehoX9W.js';
import { getInfographicByKey, getAllInfographicKeys } from './infographics-CkN5l58X.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-CrpKvxoK.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-CWCDJE6h.js';
import { d as defineStore } from './pinia-CBCkT7wa.js';
...
const neonatalEnrollmentSections = [
  {
    ...
    formData: [
      ...
      },
      {
        ...
        header: "Date and time of birth",
        name: "birthTime",
        padding: true,
        helperText: "Defaults to today's date and time; adjust if this is different",
        displayFormat: "DD MMM, YYYY HH:mm",
        initialValue: HisDate.todayDateFormatted(),
        maxDateTime: HisDate.todayDateFormatted(),
        validation: (value) => value ? null : "Capture the date and time of birth"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    formData: [
      ...
      {
        componentType: "dateTimeInputField",
        header: "Onset of labor (date & time)",
        name: "onsetOfLabor",
        padding: true,
        helperText: "Enter the actual date/time even if labor started before today or at the referring facility.",
        displayFormat: "DD MMM, YYYY HH:mm",
        maxDateTime: HisDate.todayDateFormatted(),
        validation: (value) => value ? null : "Enter onset of labor date and time"
      },
      {
        componentType: "radioButtonField",
...
const motherEnrollmentRules = [
  ...
  {
    id: "hiv-unknown-retest-dialog",
    name: "HIV unknown status - retest required",
    condition: (formValues) => {
      const hivStatus = formValues.motherHivStatus?.value || formValues.motherHivStatus;
  ...
  {
    id: "syphilis-unknown-retest-dialog",
    name: "Syphilis unknown status - retest required",
    condition: (formValues) => {
      const vdrlResult = formValues.motherVdrlResult?.value || formValues.motherVdrlResult;
  ...
  {
    id: "hepatitis-unknown-retest-dialog",
    name: "Hepatitis unknown status - retest required",
    condition: (formValues) => {
      const hepatitisResult = formValues.motherHepatitisResult?.value || formValues.motherHepatitisResult;
...
const diagnosisOptions = [
  ...
  { label: "Bowel Obstruction", value: "bowel_obstruction" },
  { label: "Birth Injury/Trauma", value: "birth_injury_trauma" },
  { label: "Congenital Abnormality", value: "congenital_abnormality" },
  { label: "Congenital Heart Disease", value: "congenital_heart_disease" },
  { label: "Dehydration", value: "dehydration" },
  { label: "Difficulty Feeding", value: "difficulty_feeding" },
  { label: "Abandoned Baby", value: "abandoned_baby" },
  { label: "HIV Low Risk", value: "hiv_low_risk" },
  { label: "HIV High Risk", value: "hiv_high_risk" },
  { label: "HIV Unknown", value: "hiv_unknown" },
  { label: "Hypoglycaemia (NOT symptomatic)", value: "hypoglycaemia_not_symptomatic" },
  { label: "Hypoglycaemia (symptomatic)", value: "hypoglycaemia_symptomatic" },
  { label: "At Risk of Hypoglycaemia", value: "at_risk_hypoglycaemia" },
  ...
  { label: "Risk factors for sepsis (Not symptomatic)", value: "risk_factors_sepsis" },
  { label: "Prematurity with Respiratory Distress", value: "prematurity_respiratory_distress" },
  { label: "Physiological Jaundice", value: "physiological_jaundice" },
  { label: "Transient Tachypnoea of Newborn (TTN)", value: "ttn" },
  { label: "Umbilical Hernia", value: "umbilical_hernia" },
  { label: "Meningitis", value: "meningitis" },
  { label: "Ambiguous Genitalia", value: "ambiguous_genitalia" },
  { label: "Apnoea of prematurity", value: "apnoea_prematurity" },
  { label: "Low Birth Weight (1500-2499g)", value: "low_birth_weight" },
  { label: "Very Low Birth Weight (1000-1499g)", value: "very_low_birth_weight" },
  { label: "Extremely Low Birth Weight (<1000g)", value: "extremely_low_birth_weight" },
  { label: "Very Premature (28-31 weeks)", value: "very_premature" },
  { label: "Extremely Premature (<28 weeks)", value: "extremely_premature" },
  { label: "Convulsions", value: "convulsions" },
  { label: "Mild Hypothermia", value: "mild_hypothermia" },
  { label: "Moderate Hypothermia", value: "moderate_hypothermia" },
  { label: "Severe Hypothermia", value: "severe_hypothermia" },
  { label: "Hyperthermia", value: "hyperthermia" },
  { label: "Term baby with Respiratory Distress", value: "term_respiratory_distress" },
  { label: "Pathological Jaundice", value: "pathological_jaundice" },
  { label: "Hypoxic Ischaemic Encephalopathy/ Birth Asphyxia", value: "hie_birth_asphyxia" },
  { label: "Suspected Hypoxic Ischaemic Encephalopathy", value: "suspected_hie" },
  { label: "Prolonged Jaundice", value: "prolonged_jaundice" },
  { label: "Cleft lip and/or palate", value: "cleft_lip_palate" },
  ...
  { label: "Mild Talipes (club foot)", value: "mild_talipes" },
  { label: "Moderate Talipes (club foot)", value: "moderate_talipes" },
  { label: "Pneumonia", value: "pneumonia" },
  { label: "Bronchiolitis", value: "bronchiolitis" },
  { label: "Syphilis exposed (asymptomatic)", value: "syphilis_exposed" },
  { label: "Suspected congenital syphilis", value: "suspected_congenital_syphilis" },
  { label: "Hydrocephalus", value: "hydrocephalus" },
  { label: "Microcephaly", value: "microcephaly" },
  { label: "Fracture", value: "fracture" },
  { label: "Tracheoesphageal fistula", value: "tracheoesphageal_fistula" },
  { label: "Born before arrival", value: "born_before_arrival" },
  { label: "Normal Baby", value: "normal_baby" },
  { label: "Necrotising enterocolitis", value: "necrotising_enterocolitis" },
  { label: "Meconium exposure (asymptomatic baby)", value: "meconium_exposure" },
  { label: "Premature (32-36+6 weeks)", value: "premature" },
  { label: "Safekeeping", value: "safekeeping" },
  { label: "High Birth Weight (>4000g at birth)", value: "high_birth_weight" },
  { label: "Haemorrhagic disease of the newborn", value: "haemorrhagic_disease" },
...
const normalizePatientId$1 = (rawId) => {
...
const useNeonatalVitalsStore = defineStore("neonatalVitalsStore", {
  ...
  actions: {
    ...
    initializeForRawPatientId(rawPatientId) {
      const patientId = normalizePatientId$1(rawPatientId);
...
const useReviewOfSystemsStore = defineStore("neonatalReviewOfSystemsStore", {
  ...
  actions: {
    ...
    async syncForRawPatientId(rawPatientId) {
      const patientId = this.initializeForRawPatientId(rawPatientId);
      try {
        await this.prefillWeightTrendForPatient(patientId);
    ...
    async prefillWeightTrendForPatient(patientId) {
      if (patientId == null) {
        return { ok: false, reason: "no_patient" };
      }
      const triageStore = useNeonatalTriageStore();
      const birthWeight = Number(triageStore.formValues.birth_weight);
      const currentWeight = Number(triageStore.formValues.current_weight);
      const hasTriageData = Number.isFinite(birthWeight) && birthWeight > 0 && Number.isFinite(currentWeight) && currentWeight > 0;
      if (hasTriageData) {
        const birthWeightKg = birthWeight >= 100 ? birthWeight / 1e3 : birthWeight;
        const currentWeightKg = currentWeight >= 100 ? currentWeight / 1e3 : currentWeight;
      ...
      } else if (calculatedPercentage === null) {
...
const useSystemicExaminationStore = defineStore("neonatalSystemicExaminationStore", {
  ...
  actions: {
    ...
    initializeForRawPatientId(rawPatientId) {
      ...
      const normalized = Number.isFinite(patientId) ? patientId : null;
...
const applyTriageStoreData = (formValues, patientData) => {
  ...
  if (formValues.blood_sugar) {
    const key = formValues.bloodSugar_unit === "mmol/L" ? "BloodSugarmmol" : "BloodSugarmg";
...
const useTreatmentPlanStore = defineStore("treatmentPlan", () => {
  ...
  async function saveAssessment(patientId) {
    if (isSaving.value) return { ok: false, reason: "saving" };
    if (!Number.isFinite(patientId) || patientId <= 0) return { ok: false, reason: "missing_patient" };
    if (!hasAnyData()) return { ok: false, reason: "no_data" };
    try {
      isSaving.value = true;
      ...
      if (observations.length === 0) return { ok: false, reason: "no_data" };
