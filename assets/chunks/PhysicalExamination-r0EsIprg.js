import { v as defineComponent, z as openBlock, P as createBlock, f as ref, c as computed, a3 as onMounted, A as createElementBlock, B as createVNode, C as withCtx, G as unref, bL as IonCard, K as Fragment, bG as IonModal, I as IonHeader, aC as IonToolbar, aD as IonTitle, D as createBaseVNode, M as IonIcon, eQ as eggOutline, a6 as createTextVNode, E as toDisplayString, bd as IonButtons, O as IonButton, H as closeCircleOutline, a8 as IonLabel, aF as IonContent, J as createCommentVNode, be as IonFooter, bI as saveOutline, ap as IonItem, bO as IonSelect, S as renderList, bN as IonSelectOption, aK as useRouter, a5 as normalizeClass, bY as chevronBackOutline, T as withDirectives, U as vShow, bu as IonPage } from './vendor-D3hawxEQ.js';
import { z as StandardForm, n as icons, _ as _export_sfc, F as DynamicButton, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, t as toastWarning, y as StandardValidations, u as useDemographicsStore, T as Toolbar, J as savePatientRecord } from '../index-DeiarqPy.js';
import { D as DemographicBar } from './DemographicBar-BBYXMYgA.js';
import { _ as _sfc_main$i, u as useFormWizard } from './useFormWizard-DiAlVtWI.js';
...
import { _ as _sfc_main$h } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CdgmVHxm.js';
...
const PhysicalExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2f9364e1"]]);
