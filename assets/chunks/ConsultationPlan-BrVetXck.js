import { v as defineComponent, aC as IonToolbar, aD as IonTitle, aE as IonMenu, ao as IonList, ap as IonItem, I as IonHeader, aF as IonContent, L as modalController, br as pulseOutline, bb as checkmark, y as resolveComponent, z as openBlock, A as createElementBlock, D as createBaseVNode, B as createVNode, bp as V, bo as IonPopover, a7 as IonInput, C as withCtx, a6 as createTextVNode, K as Fragment, cv as useRoute, w as watch, a3 as onMounted, n as nextTick, S as renderList, E as toDisplayString, G as unref, f as ref, c$ as DataTable, aK as useRouter, M as IonIcon, a8 as IonLabel, bP as IonChip, az as IonCol, ag as IonRow, bu as IonPage, cw as IonMenuButton, aZ as medkitOutline, P as createBlock, a5 as normalizeClass, J as createCommentVNode, bL as IonCard, aw as searchOutline, af as IonCheckbox, bc as IonCardContent, b9 as IonCardTitle, O as IonButton, ba as IonCardHeader, b5 as cubeOutline, H as closeCircleOutline, R as alertCircleOutline, dd as timeOutline, es as moon, et as partlySunny, eu as sunny, cj as medkit, c as computed, at as script, be as IonFooter, aH as IonAccordionGroup, aG as IonAccordion, ca as clipboardOutline, ae as IonTextarea, dj as IonSegmentButton, di as IonSegment, bY as chevronBackOutline, T as withDirectives, U as vShow, ac as checkmarkOutline } from './vendor-B3kX1Pjg.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-DWumH6Ru.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$g, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-BDC92_36.js';
import { D as DemographicBar } from './DemographicBar-DPsRx6_S.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BV0dCTn_.js';
import { D as DashBox } from './DashBox-DneOso_j.js';
import { B as BasicForm } from './BasicForm-DN1kZ-iw.js';
import { l as lodashExports } from './lodash-etvHaEVn.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-Dlguiu_6.js';
import { v as validateInputFiledData } from './group_validation-Dpq16XNw.js';
import { u as useComplicationsStore } from './ComplicationsStore-qTFp1xWM.js';
import { I as Investigations, _ as _sfc_main$j, i as isQualifiedAHD } from './Investigations-CY0K6K4g.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-DWYAMlU2.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CA9gwDw4.js';
import { _ as _sfc_main$i } from './RiskAssessment.vue_vue_type_script_setup_true_lang-CDyVFyrn.js';
import { V as Vitals } from './Vitals-Dmbr6HZZ.js';
import { _ as _sfc_main$h } from './Wizard.vue_vue_type_script_setup_true_lang-CxCJzlsh.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-B5IPQggP.js';
import { u as useFormWizard } from './useFormWizard-tFv_fd8M.js';
import { u as usePatientProfile } from './usePatientProfile-z9BQb9gL.js';
...
const _hoisted_1$c = { class: "modal_wrapper" };
...
const previousDiagnosis = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$8], ["__scopeId", "data-v-5665ae64"]]);
...
const AddDiagnosisModal = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$7], ["__scopeId", "data-v-a39d0e4b"]]);

const _hoisted_1$a = { class: "table-responsive" };
...
const DiagnosisComponent = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-13544ebc"]]);

const _hoisted_1$9 = { class: "sub_item_body" };
const _hoisted_2$8 = {
  class: "ion-padding",
  slot: "content"
};
...
const ComplicationsScreening = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-f3420ad0"]]);
...
const _hoisted_2$7 = { class: "heading" };
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_ion_col = resolveComponent("ion-col");
  const _component_ion_row = resolveComponent("ion-row");
  return _ctx.diagnoses.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
...
const PreviousNCDDiagnosis = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$6], ["__scopeId", "data-v-2bd0f8ca"]]);
...
const MedicationSearchInput = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$5]]);
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    _ctx.activeMedications.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$7, [
      _ctx.showErrorMessage ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
        createVNode(_component_ion_icon, {
...
const Medication = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$4], ["__scopeId", "data-v-c9584f56"]]);
...
const OPDMedications = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$3], ["__scopeId", "data-v-e33f5b73"]]);
...
const _hoisted_1$6 = { class: "medication-list" };
const _hoisted_2$5 = { class: "modal_wrapper" };
...
const AddOtherOPDMedication = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$2], ["__scopeId", "data-v-dee50533"]]);
...
const MedicationHistory = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$1], ["__scopeId", "data-v-1db96250"]]);
...
const NCDMedication = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render], ["__scopeId", "data-v-a4ad7088"]]);

const _hoisted_1$4 = { style: { "margin-top": "14px", "margin-left": "10px" } };
const _hoisted_2$3 = {
  class: "ion-padding",
  slot: "content"
};
...
const PreviousNotes = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-994df42d"]]);
...
const NonPharmalogicalTherapyAndOtherNotes = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-fd19ec21"]]);
                  ...
                  createBaseVNode("div", _hoisted_1$2, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(FirstPreviousAllegies.value, (item, index) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        index == 1 ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
                          createBaseVNode("div", null, [
                            createVNode(unref(IonLabel), { class: "previousLabelDate" }, {
                              default: withCtx(() => [
...
const PreviousAllergies = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-358c5959"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onChangeCurrentTab = async (index, _oldIndex) => {
      ...
      if (newTabTitle == "Investigations") {
        ...
        if (response == true) {
          await createModal(_sfc_main$j, { class: "fullScreenModal" }, true, { closeModalOnFinish: true });
        }
      }
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_1, [
                showWizard.value ? (openBlock(), createBlock(_sfc_main$h, {
                  key: 0,
                  ref: "wizard",
