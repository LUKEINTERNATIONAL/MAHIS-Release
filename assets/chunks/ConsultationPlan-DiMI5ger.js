...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bj as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bl as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-NSeNS5TF.js';
import { D as DemographicBar } from './DemographicBar-Dli36Yxm.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-C_Q7fZmf.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BOIgz2VS.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-BUf2R623.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-2G_AU48m.js';
import { I as Investigations } from './Investigations-DEiCbb-o.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-BlukZDZZ.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-CjcAd7V2.js';
import { P as PreviousTreatment } from './treatment-DVghnMAm.js';
import { l as lodashExports } from './lodash-Ba28qa7J.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DsAV96rj.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DDdD07vO.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-C_yxvRg_.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Dc1rg9gc.js';
