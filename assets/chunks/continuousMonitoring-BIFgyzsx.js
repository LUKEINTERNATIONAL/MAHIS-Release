import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, bK as IonCard, f as ref, a2 as onMounted, aL as useRouter, O as createBlock, aG as IonContent, C as createBaseVNode, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage } from './vendor-C-pvji42.js';
import { n as icons, y as StandardValidations, z as StandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-Bs77YW3d.js';
...
import { u as useContinuousMonitoringStore, O as OtherExams } from './OtherExams-_Hj2lI3u.js';
    ...
    const progressFormData = computed(() => {
      ...
      const patched = progressOfLabourForm.value.reduce((acc, field) => {
        ...
        if (field.name === "Cervical dilation") {
          acc.push(dueAlert(240, "Cervical dilation and Fetal station (every 4 hours)"));
        }
...
const ContinuousMonitoringProgressOfLabour = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9e8c090c"]]);
