import { v as defineComponent, aK as useRouter, z as openBlock, P as createBlock, C as withCtx, B as createVNode, G as unref, aF as IonContent, D as createBaseVNode, bY as chevronBackOutline, A as createElementBlock, K as Fragment, S as renderList, T as withDirectives, c3 as resolveDynamicComponent, U as vShow, bu as IonPage, f as ref, c as computed } from './vendor-Cbv9TWZo.js';
import { _ as _sfc_main$1, u as useFormWizard } from './useFormWizard-BrIrlDIt.js';
import { T as Toolbar, F as DynamicButton } from '../index-BWK4lXtd.js';
import { D as DemographicBar } from './DemographicBar-CbtjXmkF.js';
import { b as _sfc_main$2, _ as _sfc_main$3, a as _sfc_main$4 } from './FirstVaginalExamination.vue_vue_type_script_setup_true_lang-BwLv1kkn.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const COMPONENTS = [
      { name: "PhysicalExamination", component: _sfc_main$2 },
      { name: "FirstVaginalExamination", component: _sfc_main$3 },
      { name: "PelvicAssessment", component: _sfc_main$4 }
    ];
