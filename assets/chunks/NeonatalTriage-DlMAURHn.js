import { q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, d as computed, H as Fragment, Q as renderList, A as createBaseVNode, C as toDisplayString, v as resolveComponent, N as createBlock, B as withCtx, G as createCommentVNode, af as close, K as IonIcon, P as alertCircleOutline, a4 as createTextVNode, M as IonButton, aj as onBeforeUnmount, aD as IonContent, bs as IonPage, aI as useRouter, cs as useRoute, a as reactive, bW as chevronBackOutline, eT as provide } from './vendor-DGIzCW4f.js';
import { s as storeToRefs } from './pinia-Bmkga1nW.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-D_1ZD1MC.js';
import { D as DemographicBar } from './DemographicBar-ZlD63UIC.js';
import { l as neonatalTriageSections, m as neonatalTriageFormKey, u as useNeonatalTriageStore, N as NeonatalStepper, o as defaultNeonatalTriageForm, t as triageConceptMapping } from './NeonatalStepper-gJVDjU6C.js';
...
const VitalSectionFour = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-e193a482"]]);
...
const TemperatureHigh = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-f0da4c09"]]);
...
const VitalBloodSugar = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-f9a0ee2c"]]);
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[props.configIndex ?? 32];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const triageStore = useNeonatalTriageStore();
...
const BabyDemographics = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-46e8f0da"]]);
...
const HypoglycemiaSymptomatic = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-4b47085d"]]);
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const props = __props;
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[props.configIndex ?? 30];
    const formData = sectionConfig.formData;
    const conditionalRules = sectionConfig.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const HypoglycemiaAsymptomatic = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-639021ed"]]);
...
const EmergencyManagementEight = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-473d3043"]]);
...
const _sfc_main = defineComponent({
  ...
  setup() {
    ...
    const allStepperData = [
      ...
      { title: "Danger Signs", value: "9", component: DangerSignsSection, configIndex: 12 },
      // Index 12: DangerSignsAssessment
      // Selection page: Trunk feels cold, Capillary refill time > 3 seconds, Weak femoral pulses
      { title: "Danger Signs 2", value: "10", component: SelectPresentSignsSection, configIndex: 13 },
      // Index 13
      ...
      { title: "Respiratory Distress", value: "20", component: BabyRecoveredStillSevereRespiratory, configIndex: 24 },
      // Index 24: "Respiratory Distress" (Baby Recovered)
      { title: "Vital Signs", value: "21", component: VitalSectionThree, configIndex: 25 },
      ...
      { title: "Temperature High", value: "23", component: TemperatureHigh, configIndex: 27 },
      // Index 27
      {
      ...
      { title: "Hypoglycemia Symptomatic", value: "25", component: HypoglycemiaSymptomatic, configIndex: 29 },
      // Index 29
      {
      ...
      { title: "Vital Signs", value: "27", component: VitalSectionFour, configIndex: 31 },
      // Index 31: Vital Signs Four
      { title: "Triage Summary", value: "28", component: SummarySection, configIndex: 38 },
      // Index 38
      { title: "Demographics", value: "29", component: BabyDemographics, configIndex: 32 }
      // Index 32
    ];
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c1525e50"]]);
