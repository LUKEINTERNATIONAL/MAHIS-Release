import { c as computed, s as defineComponent, f as ref, w as watch, y as openBlock, O as createBlock, F as unref, bM as IonCard, B as withCtx, A as createVNode, z as createElementBlock, J as Fragment, S as renderList, C as createBaseVNode, H as createCommentVNode, be as IonCardContent, P as normalizeStyle, D as toDisplayString, aM as useRouter, bN as useRoute, a3 as onMounted, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage, ab as checkmarkOutline } from './vendor-XNfOCpdb.js';
import { s as storeToRefs } from './pinia-CtfxbWof.js';
import { n as icons, z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, _ as _export_sfc, bj as useVitalsStore, u as useDemographicsStore, bk as useInvestigationStore, bl as useDiagnosisStore, b3 as useTreatmentPlanStore, bf as useNCDMedicationsStore, e as useGeneralStore, b4 as useOutcomeStore, i as useEnrollementStore, ab as useConfigStore, f as useStatusStore, T as Toolbar, a3 as getFieldValue, H as HisDate, a_ as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, M as ConceptService, G as toastSuccess, bo as useAllegyStore, a7 as useUserStore, S as Service } from '../index-DjgSdAC3.js';
import { D as DemographicBar } from './DemographicBar-C6xRBdRR.js';
import { _ as _sfc_main$4 } from './Medications.vue_vue_type_script_setup_true_lang-Di47CWXO.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-CHTmU_LN.js';
