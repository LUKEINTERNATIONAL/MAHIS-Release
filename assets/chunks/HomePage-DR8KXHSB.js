import { s as defineComponent, c_ as addIcons, aL as useRouter, w as watch, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, a4 as normalizeClass, D as toDisplayString, H as createCommentVNode, A as createVNode, F as unref, a6 as IonInput, L as IonIcon, a5 as createTextVNode, J as Fragment, R as renderList, f as ref, c as computed, c$ as arrowBackOutline, cd as personAddOutline, Q as alertCircleOutline, ao as informationCircleOutline, ax as searchOutline, c9 as clipboardOutline, bv as personCircleOutline, bp as V, x as resolveComponent, O as createBlock, B as withCtx, cu as useRoute, bM as m, n as nextTick, aJ as menuController, d0 as clipboard, d1 as thermometer, aN as people, d2 as person, d3 as add, ci as medkit, d4 as globe, d5 as document$1, d6 as colorPalette, d7 as chevronUpCircle, d8 as chevronForwardCircle, d9 as chevronDownCircle, da as grid, bc as checkmark, bY as chevronBackOutline, bd as IonCardContent, ba as IonCardTitle, bb as IonCardHeader, bL as IonCard, aA as IonCol, N as IonButton, af as IonRow, aD as IonToolbar, bu as IonPage, I as IonHeader, aG as IonContent, aC as todayOutline, db as timeOutline, b0 as locationOutline, dc as womanOutline, dd as manOutline, cI as idCardOutline, a$ as personOutline, cN as openOutline, b8 as calendarOutline, r as reactive, P as normalizeStyle, de as gridOutline, b4 as peopleOutline, a_ as medkitOutline, S as withDirectives, az as vModelText, df as chevronForwardOutline, p as dayjs, dg as IonSegment, dh as IonSegmentButton, a7 as IonLabel, di as eyeOutline, ab as checkmarkOutline, bJ as IonBadge, au as script, aE as IonTitle, aF as IonMenu, ap as IonList, aq as IonItem, K as modalController, br as pulseOutline, dj as Navigation, dk as Pagination, dl as Slide, dm as Carousel, ae as IonCheckbox, al as IonPopover, ck as onBeforeUnmount, cF as createSlots, G as closeCircleOutline, T as vShow, dn as checkmarkDoneCircleOutline, bn as search, be as IonButtons, dp as personAdd, ag as close, dq as skullOutline, dr as calendar, cc as flask, ds as refresh, dt as lockClosed, a3 as onUnmounted, c2 as resolveDynamicComponent } from './vendor-CL0dVHZq.js';
import { S as Service, u as useDemographicsStore, _ as _export_sfc, P as PatientService, t as toastWarning, a as useProgramStore, E as EncounterService, H as HisDate, g as getPouchDBRecords, b as EncounterTypeId, A as AppointmentService, c as HorizontalLine, d as _sfc_main$v, e as useGeneralStore, f as useStatusStore, h as useWindowSize, i as useEnrollementStore, R as ReportService, p as parameterizeUrl, j as STANDARD_DATE_FORMAT, k as alertConfirmation, O as OrderService, l as PreviousVitals, B as BasicInputField, m as useAdministerVaccineStore, n as icons, o as createModal, q as usePatientList, r as StandardModal, s as isPatientDeceased, v as closeVisit, w as getTodaysVisits, x as toastDanger, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, D as PatientSearchService, F as DynamicButton, G as toastSuccess, I as alertConfirmationIonic, J as savePatientRecord, K as ObservationService, T as Toolbar, L as useWorkerStore, M as checkAndsetSessionDate, N as resetDemographics, Q as useGlobalPropertyStore, U as UserService, V as LocationService, W as ProgramId, X as modal } from '../index-WCwjUkov.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-e5upVPR3.js';
import { A as Appointment } from './ncd_appointment_service-u2L77YdB.js';
import { D as DateInputField } from './DateInputField-BiI1jbf1.js';
import { u as useActionButtonStore, _ as _sfc_main$D, M as ModulePicker } from './ActionButtons.vue_vue_type_script_setup_true_lang-BvPTVeVh.js';
import { V as ViewToggleComponent } from './ViewToggleComponent-ValTsLHW.js';
import { B as BottomNavBar } from './bottomNavBar-DcEpPkBJ.js';
import { P as PatientReportService } from './patient_report_service-BPJ6-OIa.js';
import { l as lodashExports } from './lodash-Ba28qa7J.js';
import { B as BasicForm } from './BasicForm-BkxPSo-s.js';
import { B as BasicCard } from './BasicCard-qxUqKCR7.js';
import { u as useAdministerOtherVaccineStore } from './AdministerOtherVaccinesStore-DvYnUKXO.js';
import { c as customDatePicker } from './customDatePicker-DqnyxkQA.js';
import { s as saveVaccineAdministeredDrugs } from './vaccines_service-D8uZZ0rb.js';
import { g as getVaccinesData } from './dashboard_service-D3wT-Tiz.js';
import { i as img } from './Img-B85mlUNz.js';
import { R as ReusableDataTable } from './ReusableDataTable-DvUC-c_O.js';
import { u as useRegistrationPagination, a as useSetRegistrationValues, _ as _sfc_main$w, b as _sfc_main$x, c as _sfc_main$y, d as _sfc_main$z, e as _sfc_main$A, f as _sfc_main$B, g as _sfc_main$C, R as RegistrationService } from './useSetRegistrationValues-CxEVvaeq.js';
import { u as useUserActivities } from './useUserActivities-D6GX-Tom.js';
import { L as LandingPage } from './LandingPage-B5IJt9DI.js';
