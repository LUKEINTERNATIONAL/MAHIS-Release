import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bq as V, c_ as DataTable, bN as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aM as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bR as IonChip, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bw as IonPage, cv as IonMenuButton, I as IonHeader, aH as IonContent, a$ as medkitOutline, Q as normalizeClass, H as createCommentVNode, bM as IonCard, a6 as IonInput, aw as searchOutline, ae as IonCheckbox, be as IonCardContent, bb as IonCardTitle, N as IonButton, bc as IonCardHeader, b7 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dc as timeOutline, eA as moon, eB as partlySunny, eC as sunny, cj as medkit, au as script, al as IonPopover, aG as IonMenu, bg as IonFooter, bd as checkmark, ca as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, b_ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-OAxQVBFs.js';
import { s as storeToRefs, m as mapState } from './pinia-mn-Ihgn9.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, M as ConceptService, b9 as checkIfSamePatient, ba as setCurrentPatientID, bb as getAntiHypertensivesMedication, bc as getDiabetesDrugs, bd as clearMedicationData, B as BasicInputField, be as useNCDMedicationsStore, bf as useOtherNCDMedicationStore, bg as formMedicationObject, x as toastDanger, b2 as useTreatmentPlanStore, a1 as DrugService, d as _sfc_main$f, bh as addOtherMedicationToNCDMedicationList, T as Toolbar, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, ab as useConfigStore, f as useStatusStore, a3 as getFieldValue, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, bo as useAllegyStore, a7 as useUserStore, S as Service } from '../index-C8gFA36J.js';
import { D as DemographicBar } from './DemographicBar-DAaROyOa.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BHxQkztz.js';
import { u as useComplicationsStore } from './ComplicationsStore-BydxIVUG.js';
import { B as BasicForm } from './BasicForm-BCmWJxPI.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-CUlZqjyf.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-wX-bl9FE.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CMEz3dL_.js';
import { P as PreviousAllergies } from './PreviousAllergies-1t655N7W.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-g3Yc86Pp.js';
import { V as Vitals } from './Vitals-D4dTKXxN.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-D-Lz0xN9.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-B_OE30sr.js';
import { l as lodashExports } from './lodash-g4UnlAkj.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-DdiZA3QS.js';
