import { s as defineComponent, aN as useRouter, f as ref, w as watch, y as openBlock, O as createBlock, B as withCtx, z as createElementBlock, A as createVNode, F as unref, M as IonSpinner, C as createBaseVNode, H as createCommentVNode, aI as IonContent, b$ as chevronBackOutline, av as b, bb as homeOutline, eV as playSkipForwardOutline, ab as checkmarkOutline, bx as IonPage, c as computed } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { u as useDemographicsStore, e as useGeneralStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, bK as StagesService, q as usePatientList, x as toastDanger, _ as _export_sfc } from '../index-Biv93APm.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const vitalsToggle = ref(generalStore.vitalsTogglePreference);
    ...
    watch(vitalsRef, (newRef) => {
      if (newRef) {
        newRef.toggleDisableAll(generalStore.vitalsTogglePreference);
      }
    });
    const handleVitalsToggleChange = () => {
      generalStore.setVitalsTogglePreference(vitalsToggle.value);
...
const Vitals = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-56d51989"]]);
