import { w as watch, f as ref, c as computed, s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, F as unref, A as createVNode, B as withCtx, aA as IonCol, a5 as createTextVNode, af as IonRow, J as Fragment, R as renderList, O as createBlock, D as toDisplayString, N as IonButton, L as IonIcon, di as eyeOutline, H as createCommentVNode, fw as TransitionGroup, bU as trashOutline, aR as syncOutline, fx as Transition, bG as addOutline, I as IonHeader, aD as IonToolbar, aE as IonTitle, be as IonButtons, aG as IonContent, bF as IonModal, aL as useRouter, bL as useRoute, fj as onIonViewWillEnter, f0 as provide, bu as IonPage } from './vendor-DpSS1aB1.js';
import { u as useDemographicsStore, S as Service, g as getPouchDBRecords, O as OrderService, ar as ConceptService, J as savePatientRecord, aY as AppEncounterService, b as EncounterTypeId, t as toastWarning, z as StandardForm, o as createModal, _ as _export_sfc, T as Toolbar } from '../index-DaPMVlha.js';
import { l as neonatalInvestigationSections, N as NeonatalStepper } from './NeonatalStepper-y4FaGfi3.js';
import { d as defineStore, s as storeToRefs } from './pinia-CbGjwPb6.js';
import { _ as _sfc_main$2 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-B-p4gmU6.js';
import { b as neonatalInvestigationFormKey, S as SummarySection } from './SummarySection-DqzkC6cq.js';
