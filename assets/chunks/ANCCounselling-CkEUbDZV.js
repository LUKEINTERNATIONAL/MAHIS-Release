import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, bM as IonCard, f as ref, x as resolveComponent, aM as useRouter, a3 as onMounted, O as createBlock, aH as IonContent, C as createBaseVNode, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-DvGYa1v4.js';
import { _ as _sfc_main$7, u as useFormWizard } from './useFormWizard-D3YqA_zw.js';
import { n as icons, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, c6 as toastSuccess$1, T as Toolbar, F as DynamicButton } from '../index-B8ztKi9t.js';
import { D as DemographicBar } from './DemographicBar-BRg28hNJ.js';
            ...
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Behavior Counselling Done",
...
const BehaviourCounselling = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-7e0c51e3"]]);
            ...
            createVNode(unref(IonCardContent), null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Physiological Counselling Done",
...
const PhysiologicalCounseling = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-7028f7dd"]]);
            ...
            createVNode(_component_ion_card_content, null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Diet Counselling Done",
...
const DietCounselling = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a8324add"]]);
            ...
            createVNode(_component_ion_card_content, null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Clinical Counselling Done",
...
const ClinicalCounselling = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c01f9809"]]);
            ...
            createVNode(_component_ion_card_content, null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Preventative Counselling Done",
...
const PreventativeCounselling = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fac889a9"]]);

const useClientEducationAndCounsellingForm = () => {
  const useClientEducationAndCounsellingFormSection = computed(() => {
    return [
      {
        componentType: "checkboxField",
        ...
        options: [
          ...
          { label: "Rest and exercise in pregnancy", value: "Rest and exercise in pregnancy" },
          { label: "Personal hygiene", value: "Personal hygiene" },
          { label: "Danger signs in pregnancy", value: "Danger signs in pregnancy" },
          { label: "Use of medicine in pregnancy", value: "Use of medicine in pregnancy" },
          { label: "Effects of STIs / HIV", value: "Effects of STIs/HIV" },
          { label: "Exclusive breastfeeding", value: "Exclusive breastfeeding" },
          { label: "Birth preparedness / delivery plan", value: "Birth preparedness" },
          { label: "Postpartum period and care", value: "Postpartum care" },
          { label: "Postpartum family planning", value: "Postpartum family planning" },
          {
            label: "Harmful habits (smoking, alcohol, drugs, local pitocin)",
            value: "Harmful habits"
          },
          {
            label: "Drug compliance (FeFo, Albendazole, MMN, SP/Antimalarial)",
            value: "Drug compliance counselling"
          },
          {
      ...
      {
        componentType: "checkboxField",
        header: "Reason if any maternal counselling was not done?",
        name: "Reason maternal counselling not done",
        type: "multiple",
        value: [],
        obsValueType: "value_coded",
        condition: (allFormValues) => {
          return allFormValues["Maternal counselling"] == "None";
        },
        grid: { xs: "12", sm: "12" },
        options: [
          {
      ...
      {
        name: "_Reason maternal counselling not done",
        header: "Other (specify)",
        componentType: "inputField",
        obsValueType: "value_text",
        icon: icons.editPen,
        ...
        grid: { xs: "12", sm: "12" },
        condition: (allFormValues) => {
          return allFormValues["Reason maternal counselling not done"]?.includes("Other");
        }
      }
    ];
  });
  return {
    useClientEducationAndCounsellingFormSection
  };
};

const _hoisted_1$1 = { class: "container" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "EducationCounselling",
  setup(__props, { expose: __expose }) {
    const clinicalComposable = useClientEducationAndCounsellingForm();
    const formRef = ref(null);
    const educationCounsellingForm = computed(() => {
      return clinicalComposable.useClientEducationAndCounsellingFormSection.value;
    });
    const onSubmit = async () => {
      const data = formRef.value?.getFormValues();
      if (Object.keys(data || {}).length === 0) return;
            ...
            createVNode(_component_ion_card_content, null, {
              default: withCtx(() => [
                createVNode(StandardForm, {
                  ref_key: "formRef",
                  ref: formRef,
                  subtitle: "Maternal Counselling Provided",
                  "form-data": educationCounsellingForm.value
                }, null, 8, ["form-data"])
              ]),
              _: 1
            })
...
const EducationCounselling = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-15c92cfb"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const educationCounsellingRef = ref(null);
    ...
    const getActiveComponent = () => {
      ...
      switch (currentTab) {
        ...
        case "Education & Counselling":
          return "EducationCounselling";
        default:
          return null;
      }
    };
              ...
              createBaseVNode("div", _hoisted_1, [
                createVNode(_sfc_main$7, {
                  ...
                  default: withCtx(() => [
                    ...
                    withDirectives(createBaseVNode("div", null, [
                      createVNode(EducationCounselling, {
                        ref_key: "educationCounsellingRef",
                        ref: educationCounsellingRef
                      }, null, 512)
                    ], 512), [
                      [vShow, getActiveComponent() == "EducationCounselling"]
                    ])
                  ]),
                  _: 1
