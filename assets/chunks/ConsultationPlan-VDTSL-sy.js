import { s as defineComponent, w as watch, a2 as onMounted, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, Q as alertCircleOutline, c3 as checkmarkCircleOutline, J as Fragment, R as renderList, b8 as calendarOutline, D as toDisplayString, a4 as normalizeClass, a9 as chevronDownOutline, H as createCommentVNode, f as ref, c as computed, L as IonIcon, eH as bodyOutline, eI as scanOutline, bG as addOutline, br as pulseOutline, eJ as moveOutline, eK as fitnessOutline, dd as manOutline, eL as happyOutline, eM as earOutline, eN as nutritionOutline, di as eyeOutline, c2 as warningOutline, aS as medicalOutline, aV as femaleOutline, v as documentTextOutline, n as nextTick, O as createBlock, B as withCtx, a7 as IonLabel, a5 as createTextVNode, dE as IonToggle, aq as IonItem, af as IonRow, aH as IonAccordion, N as IonButton, a8 as withModifiers, aI as IonAccordionGroup, ap as IonList, au as script, a6 as IonInput, bH as saveOutline, G as closeCircleOutline, c8 as clipboardOutline, ad as IonTextarea, aA as IonCol, aL as useRouter, ct as useRoute, M as IonSpinner, dG as IonLoading, aG as IonContent, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage, eF as lockClosedOutline, ab as checkmarkOutline } from './vendor-74dOmGLc.js';
import { s as storeToRefs, m as mapState } from './pinia-DUPmLFD0.js';
import { _ as _sfc_main$a, u as useFormWizard } from './useFormWizard-DwW-7eqF.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, br as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bo as useInvestigationStore, b$ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bI as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b7 as getOfflineSavedUnsavedData, J as savePatientRecord, c0 as resetOPDPatientData, bL as StagesService, q as usePatientList, v as closeVisit } from '../index-C7zo43Se.js';
import { D as DemographicBar } from './DemographicBar-nq_5lbQU.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-Ciu4uFLs.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-Wd3diRm6.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-y0xB21Rv.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-BBzN8Mt6.js';
import { I as Investigations } from './Investigations-BXCw7DeM.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CRjkEVTK.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-CZS_CLSM.js';
import { P as PreviousTreatment } from './treatment-DN5y6yHM.js';
import { l as lodashExports } from './lodash-BTFCkoWp.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DHV49wpr.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-Vt_tvWAd.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-Or3hxWYL.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BIre5Ere.js';
...
const OPDTreatmentPlan = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bcdc09ad"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const triggerPreSave = () => {
      treatmentPlanRef.value?.validateAndSave();
    };
...
const ConsultationPlan = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9f2ff4e7"]]);
