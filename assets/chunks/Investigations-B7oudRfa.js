import { O as OrderService, bp as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, bq as getCheckboxSelectedValue, aV as modifyRadioValue, a2 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, F as DynamicButton, a$ as List, B as BasicInputField, br as SelectionPopover, S as Service, g as getPouchDBRecords, M as ConceptService, bk as useInvestigationStore, H as HisDate, u as useDemographicsStore, z as StandardForm, C as useExposeFromStandardForm, y as StandardValidations, aY as AppEncounterService, X as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, ab as useConfigStore, r as StandardModal, a3 as getFieldValue, a_ as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-sMFid8qH.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-DdQ9BIp0.js';
import LabOrdersList from './LabOrdersList-AxC1JHxT.js';
import { v as validateInputFiledData } from './group_validation-Bz7M5gM9.js';
import { u as useRadiologyStore } from './RadiologyStore-BVsqmnJW.js';
import { B as BasicForm } from './BasicForm-g1N6bFmm.js';
import { s as defineComponent, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, F as unref, H as createCommentVNode, f as ref, w as watch, al as IonPopover, a6 as IonInput, aE as IonToolbar, aF as IonTitle, aG as IonMenu, ap as IonList, aq as IonItem, I as IonHeader, aH as IonContent, bt as pulseOutline, bd as checkmark, a5 as createTextVNode, c as computed, bM as IonCard, aC as IonGrid, af as IonRow, aB as IonCol, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, D as toDisplayString, bR as IonChip, ae as IonCheckbox, bA as IonText, be as IonCardContent, r as reactive, p as dayjs, aM as useRouter, bN as useRoute, T as withDirectives, U as vShow, K as modalController } from './vendor-BcieWP-_.js';
import { l as lodashExports } from './lodash-C07Grsj7.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-ADGfX48c.js';
import { D as DashBox } from './DashBox-TUz-w9vu.js';
import { _ as _sfc_main$7 } from './SetUserRole.vue_vue_type_script_lang-C2IPOiGd.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-xUcU-KCP.js';
import { P as PatientComplaintsService } from './patient_complaints_service-DyyB5giC.js';
import { _ as _sfc_main$8, u as useFormWizard } from './useFormWizard-CPvOj5Ol.js';
import { i as isClinician } from './Registration-D0ZF0TQU.js';
