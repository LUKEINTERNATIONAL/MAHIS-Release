import { s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, a5 as createTextVNode, D as toDisplayString, F as unref, a7 as IonLabel, fl as I1, bB as createStaticVNode, N as IonButton, J as Fragment, f as ref, K as modalController, fm as IonAlert, x as resolveComponent, O as createBlock, ap as IonList, aq as IonItem, ai as IonRadio, ah as IonRadioGroup, R as renderList, af as IonRow, aA as IonCol, a6 as IonInput, aD as IonToolbar, aE as IonTitle, aF as IonMenu, I as IonHeader, aG as IonContent, S as withDirectives, T as vShow, H as createCommentVNode, bG as IonModal, aI as IonAccordionGroup, aH as IonAccordion, ba as IonCardTitle, cE as IonCardSubtitle, bb as IonCardHeader, bd as IonCardContent, bL as IonCard, bu as IonPage, cv as IonMenuButton, bf as IonFooter, L as IonIcon, ab as checkmarkOutline, G as closeCircleOutline, fn as folderOpenOutline, c as computed, au as script, dk as Navigation, dl as Pagination, dm as Slide, dn as Carousel, c9 as clipboardOutline, d3 as person, e0 as ellipsisVerticalSharp, bc as checkmark, bY as chevronBackOutline, a4 as normalizeClass } from './vendor-Dw8g_yFL.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, z as StandardForm, F as DynamicButton, K as ObservationService, cl as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cK as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, cL as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-CIYQg2Yf.js';
...
import { m as mapState, s as storeToRefs } from './pinia-zB_ge_8G.js';
import { S as Stepper } from './Stepper-COPgvNiS.js';
import { T as Treatment } from './treatment-BBrVYGuj.js';
import { l as lodashExports } from './lodash-C_bsc44c.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-DGjKDNza.js';
import WeightHeightChart from './WeightHeightChart-BedVfZ-y.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-CQCjsbSb.js';
import { c as customDatePicker } from './customDatePicker-BfMWqI22.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, n as nextAppointMent } from './vaccines_service-CTFuJlsP.js';
import { S as StockService } from './stock_service-DdT8MnKr.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-CF91GLHc.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-B52JyhqO.js';
...
import { O as Outcome, _ as _sfc_main$e } from './usePatientProfile-Dv6GdR8_.js';
