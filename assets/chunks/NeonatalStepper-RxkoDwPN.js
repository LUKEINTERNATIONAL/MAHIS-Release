...
import { n as icons, H as HisDate, S as Service, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, bH as DrugOrderService, F as DynamicButton, t as toastWarning, k as alertConfirmation, u as useDemographicsStore, o as createModal, _ as _export_sfc } from '../index-NBMrpwEk.js';
import { S as SaveProgressModal } from './SaveProgressModal-2AKttL3a.js';
import { d as defineStore } from './pinia-D87PMWkd.js';
import { getInfographicByKey } from './infographics-c_0oATqD.js';
import { f as feedingTypeLabels, b as feedingModeLabels, c as feedingFrequencyLabels, d as feedingEffortLabels, m as meconiumTimingLabels, s as stoolColorLabels, e as stoolConsistencyLabels, u as urineColorLabels, w as weightTrendLabels, g as umbilicalConditionLabels, h as musculoskeletalDeformityLabels, i as skinFindingLabels, t as toneAssessmentLabels, j as suckReflexLabels, k as graspReflexLabels, l as moroReflexLabels, N as NeonatalService, o as getNextGeneralExaminationSectionIndex, p as getPreviousGeneralExaminationSectionIndex } from './neonatal_service-BphUn4pD.js';
import { u as useNeonatalEnrollmentStore, n as neonatalEnrollmentFormKey } from './useNeonatalEnrollmentStore-BlM5cxAw.js';
...
const neonatalEnrollmentSections = [
  ...
  },
  {
    ...
    skipCondition: (formValues) => {
      const motherHivStatus = formValues.motherHivStatus?.value || formValues.motherHivStatus;
      const babyGivenNvp = formValues.babyGivenNvp;
...
const NeonatalStepper = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-fad2826f"]]);

export { defaultNeonatalTriageForm as A, getSystemicExaminationSectionById as B, useSystemicExaminationStore as C, useSignsSymptomsStore as D, useReviewOfSystemsStore as E, neonatalClinicalReviewOutcomeSections as F, useNeonatalClinicalReviewOutcomesStore as G, neonatalInvestigationSections as H, useTreatmentPlanStore as I, NeonatalStepper as N, neonatalSignsSymptomsFormKey as a, neonatalClinicalReviewOutcomesFormKey as b, neonatalTriageFormKey as c, neonatalSystemicExaminationFormKey as d, neonatalTreatmentPlanFormKey as e, useNeonatalTriageStore as f, neonatalReviewOfSystemsSections as g, neonatalSignsSymptomsSections as h, neonatalEnrollmentSections as i, neonatalClinicalReviewOutcomesSections as j, neonatalTriageSections as k, neonatalSystemicExaminationSections as l, neonatalTreatmentPlanSections as m, neonatalReviewOfSystemsFormKey as n, useDiagnosisStore as o, useSuggestedDiagnosisStore as p, neonatalVitalsSections as q, neonatalVitalsFormKey as r, useNeonatalVitalsStore as s, getDischargeSectionByName as t, useNeonatalExamStore as u, neonatalDischargeFormKey as v, neonatalDischargeSections as w, useNeonatalDischargeStore as x, getDischargeSectionIndexByName as y, triageConceptMapping as z };
