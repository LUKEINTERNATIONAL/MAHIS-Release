import { s as defineComponent, y as openBlock, O as createBlock, F as unref, bK as IonCard, a4 as normalizeClass, B as withCtx, A as createVNode, bd as IonCardContent, C as createBaseVNode, z as createElementBlock, H as createCommentVNode, D as toDisplayString, a5 as createTextVNode, N as IonButton, a8 as withModifiers, L as IonIcon, e3 as createOutline, c as computed, bF as IonModal, I as IonHeader, aD as IonToolbar, aE as IonTitle, be as IonButtons, ag as close, aG as IonContent, E as renderSlot, aL as useRouter, f as ref, a2 as onMounted, af as IonRow, J as Fragment, R as renderList, aA as IonCol, aB as IonGrid, dZ as IonSkeletonText, a9 as chevronDownOutline } from './vendor-CLJC7Gvp.js';
import { _ as _export_sfc, u as useDemographicsStore } from '../index-CCiw40xR.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const visibleNeonates = computed(() => {
      return recentNeonates.value.slice(0, visibleLimit.value);
    });
    const handleSeeMore = () => {
      visibleLimit.value += 5;
    };
    const hasMoreNeonates = computed(() => {
      return visibleLimit.value < recentNeonates.value.length;
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_6, [
          _cache[3] || (_cache[3] = createBaseVNode("h2", { class: "section-title" }, "Recent Neonates", -1)),
          isLoadingNeonates.value ? (openBlock(), createElementBlock("div", _hoisted_7, [
            ...
            hasMoreNeonates.value ? (openBlock(), createElementBlock("div", _hoisted_10, [
              createVNode(unref(IonButton), {
                fill: "clear",
                onClick: handleSeeMore
              }, {
                default: withCtx(() => [
                  _cache[2] || (_cache[2] = createTextVNode(" See more ", -1)),
                  createVNode(unref(IonIcon), {
                    slot: "end",
          ...
          ])) : (openBlock(), createElementBlock("div", _hoisted_11, "No recent neonates to display."))
        ]),
...
const LandingPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4a05aa0e"]]);
