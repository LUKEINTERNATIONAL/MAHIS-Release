import { s as defineComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, I as IonHeader, aE as IonToolbar, C as createBaseVNode, aF as IonTitle, a5 as createTextVNode, aH as IonContent, af as IonRow, aB as IonCol, bw as IonPage, c as computed, K as modalController, bN as useRoute, w as watch, a3 as onMounted, z as createElementBlock, bq as V, f as ref, n as nextTick, M as IonSpinner, H as createCommentVNode, aq as IonItem, a7 as IonLabel, dF as IonToggle, ap as IonList, J as Fragment, S as renderList, D as toDisplayString, N as IonButton, Q as normalizeClass } from './vendor-DvGYa1v4.js';
import { F as DynamicButton, z as StandardForm, C as useExposeFromStandardForm, t as toastWarning, S as Service, a6 as postIntoPouchDB, n as icons, y as StandardValidations, _ as _export_sfc, g as getPouchDBRecords, x as toastDanger, o as createModal, G as toastSuccess, aM as PrintoutService, T as Toolbar } from '../index-B8ztKi9t.js';
  ...
  setup(__props) {
    ...
    const addPrinter = async () => {
      ...
      if (Service.getPouchDbStatus() || Service.getLanConnectionStatus()) {
        ...
        await Service.postJson("/printer_configurations", data);
      }
      modalController.dismiss();
    };
    return (_ctx, _cache) => {
...
const AddWebPrinter = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9737fa9c"]]);
      ...
      try {
        ...
        if (Service.getPouchDbStatus() || Service.getLanConnectionStatus()) {
          printers = await getPouchDBRecords("printer_configurations", {
            selector: { location_id: { $eq: locationId } }
          });
        } else {
          const response = await Service.getJson("/printer_configurations", {
            location_id: locationId
          });
          printers = Array.isArray(response) ? response : response?.data ?? response?.printers ?? [];
        }
        if (!printers || printers.length === 0) {
          tableData.value = [];
          return;
        }
        tableData.value = printers.map((p) => ({
          _id: p._id,
          _rev: p._rev,
    ...
    const deletePrinter = async (printer) => {
      ...
      try {
        if (Service.getPouchDbStatus() || Service.getLanConnectionStatus()) {
          ...
          await Service.delete(`/printer_configurations/${printer._id}`, printer._id);
        }
...
const ManageIPPrinters = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-52cc6b17"]]);
