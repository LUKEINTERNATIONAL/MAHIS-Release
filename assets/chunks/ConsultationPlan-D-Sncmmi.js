import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bq as V, c_ as DataTable, bN as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aM as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bR as IonChip, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bw as IonPage, cv as IonMenuButton, I as IonHeader, aH as IonContent, a$ as medkitOutline, Q as normalizeClass, H as createCommentVNode, bM as IonCard, a6 as IonInput, aw as searchOutline, ae as IonCheckbox, be as IonCardContent, bb as IonCardTitle, N as IonButton, bc as IonCardHeader, b7 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dc as timeOutline, eA as moon, eB as partlySunny, eC as sunny, cj as medkit, au as script, al as IonPopover, aG as IonMenu, bg as IonFooter, bd as checkmark, ca as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, b_ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-XNfOCpdb.js';
import { s as storeToRefs, m as mapState } from './pinia-CtfxbWof.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, M as ConceptService, ba as checkIfSamePatient, bb as setCurrentPatientID, bc as getAntiHypertensivesMedication, bd as getDiabetesDrugs, be as clearMedicationData, B as BasicInputField, bf as useNCDMedicationsStore, bg as useOtherNCDMedicationStore, bh as formMedicationObject, x as toastDanger, b3 as useTreatmentPlanStore, a1 as DrugService, d as _sfc_main$f, bi as addOtherMedicationToNCDMedicationList, T as Toolbar, bj as useVitalsStore, bk as useInvestigationStore, bl as useDiagnosisStore, e as useGeneralStore, b4 as useOutcomeStore, i as useEnrollementStore, ab as useConfigStore, f as useStatusStore, a3 as getFieldValue, a_ as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b5 as confirmModal, bo as useAllegyStore, a7 as useUserStore, S as Service } from '../index-DjgSdAC3.js';
import { D as DemographicBar } from './DemographicBar-C6xRBdRR.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-frcYiJ8v.js';
import { u as useComplicationsStore } from './ComplicationsStore-Cv16YwX4.js';
import { B as BasicForm } from './BasicForm-gzC4uz5j.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-quPrrS3t.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-IdEOVRJC.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-D9j3oE2s.js';
import { P as PreviousAllergies } from './PreviousAllergies-BmFKwpWx.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-C-yeXhfD.js';
import { V as Vitals } from './Vitals-Bq6mnQ8s.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-CHTmU_LN.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DCbXOpfy.js';
import { l as lodashExports } from './lodash-BKeU9_05.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-0Z3bLZSD.js';
import { u as usePatientProfile } from './usePatientProfile-BHnO0lpm.js';

const _hoisted_1$a = { class: "" };
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "AddDiagnosisModal",
  setup(__props) {
    ...
    const save = async () => {
      if (formRef.value?.validateForm() == null) {
        ObservationService.buildSaveObs(formRef.value?.getFormValues(), EncounterTypeId.DIAGNOSIS);
        toastSuccess("Diagnosis successfully saved");
        modalController.dismiss();
      } else {
        toastSuccess("Please fill in the required fields");
      }
    };
    onMounted(async () => {
      await getDiagnosis("");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(StandardModal, { title: "Add Diagnosis" }, {
        "top-buttons": withCtx(() => [
...
const AddDiagnosisModal = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-d91652f3"]]);
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const setListData = async () => {
      const diagnosisData = await ObservationService.getObsByEncounterId(EncounterTypeId.DIAGNOSIS);
      const observations = diagnosisData?.[0]?.obs || [];
...
const DiagnosisComponent = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-9bcae50c"]]);
...
const FootScreening = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-6a885eee"]]);

const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "ComplicationsScreening",
  setup(__props) {
    const FootScreeningRef = ref(null);
    return (_ctx, _cache) => {
      return openBlock(), createBlock(FootScreening, {
        ref_key: "FootScreeningRef",
        ref: FootScreeningRef
      }, null, 512);
    };
  }
});
