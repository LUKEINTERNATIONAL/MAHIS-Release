...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, aq as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a0 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aB as ListPicker, bm as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, b6 as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bI as StagesService, q as usePatientList, v as closeVisit } from '../index-CA5gZ8gz.js';
import { D as DemographicBar } from './DemographicBar-BCK9KPjc.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-S8U8tWTk.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-D4XKcDmV.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-D9hSdUfO.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-Cv6WTfQ1.js';
import { I as Investigations } from './Investigations-BA_JaUiD.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-U8YyrsOR.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-CXgnlwM_.js';
import { P as PreviousTreatment } from './treatment-Ba-sjiJj.js';
import { l as lodashExports } from './lodash-Dm7Pej-A.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, a as DischargedHome, d as deadOutcome, b as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DErEPWuk.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CufrBfmS.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-DEsrJCpi.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-UdQcc0L5.js';
