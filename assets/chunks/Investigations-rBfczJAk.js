import { s as defineComponent, h as inject, y as openBlock, z as createElementBlock, A as createVNode, F as unref, aq as IonItem, B as withCtx, ae as IonCheckbox, a7 as IonLabel, C as createBaseVNode, D as toDisplayString, L as IonIcon, eU as chevronUpOutline, a9 as chevronDownOutline, S as withDirectives, J as Fragment, R as renderList, O as createBlock, a5 as createTextVNode, T as vShow, c as computed, f as ref, M as IonSpinner, H as createCommentVNode, eV as provide, x as resolveComponent, a2 as onMounted, aL as useRouter, ct as useRoute, w as watch, aG as IonContent, bX as chevronBackOutline, bu as IonPage, ab as checkmarkOutline } from './vendor-CIi-jrCy.js';
import { s as storeToRefs } from './pinia-DG0V88rF.js';
import { _ as _export_sfc, F as DynamicButton, n as icons, y as StandardValidations, z as StandardForm, bm as useVitalsStore, u as useDemographicsStore, bn as useInvestigationStore, bc as useDiagnosisStore, b2 as useTreatmentPlanStore, bi as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, b7 as getOfflineSavedUnsavedData, bo as MedicationSelectionHasValues, J as savePatientRecord, bp as resetNCDPatientData, t as toastWarning, aq as ConceptService, G as toastSuccess, bq as useAllegyStore, a6 as useUserStore, S as Service } from '../index-COGk33Kr.js';
...
import { _ as _sfc_main$6, u as useFormWizard } from './useFormWizard-ZJugK8XM.js';
import { u as useComplicationsStore } from './ComplicationsStore-D0_wMsXe.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-BUb5VKfl.js';
import { s as stageAllergies } from './treatment-DN1KUSrw.js';
import { l as lodashExports } from './lodash-ClZFDeT4.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-Dl04mOvS.js';
