import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, C as createBaseVNode, bK as IonCard, f as ref, aL as useRouter, a3 as onMounted, O as createBlock, aG as IonContent, bY as chevronBackOutline, T as withDirectives, U as vShow, bu as IonPage } from './vendor-ltMrzBmS.js';
import { _ as _sfc_main$2, u as useFormWizard } from './useFormWizard-DioG1Hne.js';
import { z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton, t as toastWarning } from '../index-BztXY-eR.js';
import { D as DemographicBar } from './DemographicBar-DtId4lB1.js';
import { S as SecondStageDelivery, T as ThirdStageDelivery } from './ThirdStageDelivery-BQGaphgB.js';
  ...
  setup(__props) {
    ...
    const saveData = async () => {
      ...
      for (const component of componentRefs) {
        if (component.ref.value && typeof component.ref.value.validateForm === "function") {
          const errors = component.ref.value.validateForm();
