import { u as useDemographicsStore, z as StandardForm, _ as _export_sfc, E as EncounterService, S as Service, a6 as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-04qmWBeT.js';
import { s as defineComponent, f as ref, w as watch, y as openBlock, z as createElementBlock, A as createVNode, C as createBaseVNode, D as toDisplayString, O as createBlock, B as withCtx, Q as normalizeClass, H as createCommentVNode, F as unref, L as IonIcon, bW as trashOutline, cG as mergeProps, fu as draggable, c as computed, a3 as onMounted, x as resolveComponent, T as withDirectives, U as vShow, a5 as createTextVNode, R as alertCircleOutline, c5 as checkmarkCircleOutline, J as Fragment, S as renderList, bT as withKeys, a8 as withModifiers, fv as addCircle, G as closeCircleOutline, co as refreshOutline, aM as useRouter, aH as IonContent, bw as IonPage, f1 as provide } from './vendor-CvMfV7DM.js';
import { m as useDiagnosisStore, o as useSuggestedDiagnosisStore, N as NeonatalStepper } from './NeonatalStepper-ukjdQxVn.js';
import { n as neonatalDiagnosisSections, S as SummarySection, a as neonatalDiagnosisFormKey } from './SummarySection-R42K17oT.js';
...
const DiagnosisSelection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7b063f54"]]);
...
const SelectedDiagnosisDisplay = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0ab7bab2"]]);
...
function getSuggestedDiagnoses(data) {
  ...
  const hasValidTemp = Number.isFinite(temp);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const extractClinicalDataFromJSON = (observations) => {
      ...
      const numericNameMap = /* @__PURE__ */ new Map([
        ...
        ["Weight (kg)", (value) => data.BirthWeight = value ? value * 1e3 : 0],
      ...
      observations.forEach((obs) => {
        ...
        numericNameMap.get(primaryName)?.(valNum);
        textNameMap.get(primaryName)?.(valText);
      });
      return data;
    };
      ...
      try {
        ...
        encounters.forEach((encounter) => {
          ...
          Object.keys(extracted).forEach((key) => {
            ...
            const isValid = newVal !== null && newVal !== void 0 && newVal !== "" && newVal !== 0;
            applyWhen(isValid, () => {
...
const SystemsSuggestions = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e9584ee6"]]);
