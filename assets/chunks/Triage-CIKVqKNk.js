import { d as computed, q as defineComponent, r as ref, O as createBlock, y as openBlock, E as unref, bH as IonCard, A as withCtx, z as createVNode, b7 as IonCardContent, a2 as onMounted, v as resolveComponent, x as createElementBlock, G as createCommentVNode, B as createBaseVNode, an as IonItem, a5 as createTextVNode, J as Fragment, aF as useRouter, cr as useRoute, w as watch, H as IonContent, S as withDirectives, bV as chevronBackOutline, T as vShow, bq as IonPage, ab as checkmarkOutline } from './vendor-Cy_N32Zh.js';
import { s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { y as StandardValidations, C as StandardForm, n as icons, z as useExposeFromStandardForm, a_ as List, F as DynamicButton, a1 as modifyFieldValue, S as Service, K as ObservationService, b as EncounterTypeId, t as toastWarning, G as toastSuccess, _ as _export_sfc, ba as useVitalsStore, u as useDemographicsStore, bb as useInvestigationStore, bc as useDiagnosisStore, b2 as useTreatmentPlanStore, bd as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, a9 as useConfigStore, f as useStatusStore, T as Toolbar, a2 as getFieldValue, H as HisDate, b5 as getOfflineSavedUnsavedData, be as MedicationSelectionHasValues, J as savePatientRecord, bf as resetNCDPatientData, aq as ConceptService, bg as useAllegyStore, ab as useUserStore } from '../index-B2p2mVqz.js';
import { D as DemographicBar } from './DemographicBar-ChySBBij.js';
import { V as Vitals } from './Vitals-DKsCIw9l.js';
import { _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-CFzg7YiH.js';
...
import { u as useFormWizard, _ as _sfc_main$6 } from './useFormWizard-t34pEOVg.js';
import { u as useComplicationsStore } from './ComplicationsStore-C7Gv4xsW.js';
import { s as stageAllergies, c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-d1JfaxFV.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-vTu6TxbF.js';
