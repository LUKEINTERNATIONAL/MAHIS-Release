...
const usePastObstetricHistoryForm = (options) => {
  ...
  const perinealTearOptions = [
    ...
    { value: "3rd degree", label: "3rd degree" },
    { value: "4th degree", label: "4th degree" }
  ];
...
const TetanusImmunizationTable = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-09b0f8ff"]]);

const useCurrentPregnancyForm = (isStockout) => {
  const resetForm = () => {
  };
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const formKey = ref(0);
    const isStockout = computed(() => tetanusRef.value?.isStockout ?? false);
    const currentPregnancyComposable = useCurrentPregnancyForm(isStockout);
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    watch(
      () => patient.value?.patientID,
...
const CurrentPregnancy = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-256cb0a8"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      if (validationErrors || surgeriesErrors) {
        toastWarning("Please fix validation errors before submitting");
        console.log("Validation errors:", validationErrors);
        console.log("Validation errors:", surgeriesErrors);
        return false;
      }
    ...
    const processGynaecology = async (data) => {
      ...
      for (const [key, value] of Object.entries(data)) {
        if (!value || value === false || value === "") continue;
        if (key === "Length of menstrual flow") {
          const unit = data[key + "_unit"];
          let conceptKey = key;
          if (unit === "Weeks") {
            conceptKey = key + " weeks";
          } else {
            conceptKey = key + " days";
          }
          observations.push(await ObservationService.buildValueText(conceptKey, String(value)));
          continue;
        }
        if (Array.isArray(value)) {
          for (const item of value) {
...
const Gynaecology = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-44587bcf"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const getActiveComponent = () => {
      ...
      const componentMap = {
        ...
        "Gynecology History": "GynecologyHistory",
    ...
    const getComponentRef = (title) => {
      const componentRefs = {
        ...
        "Gynecology History": gynaecologyRef,
    ...
    const saveAllData = async () => {
      ...
      try {
        ...
        await router.push("/anc/quick-check");
      } catch (error) {
                ...
                showWizard.value ? (openBlock(), createBlock(_sfc_main$9, {
                  ...
                  default: withCtx(() => [
                    ...
                    withDirectives(createBaseVNode("div", null, [
                      ...
                      [vShow, getActiveComponent() == "GynecologyHistory"]
                    ]),
                    withDirectives(createBaseVNode("div", null, [
...
const Profile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7b46193"]]);
