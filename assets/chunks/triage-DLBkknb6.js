import { f as ref, c as computed, cI as __vitePreload } from './vendor-DOib3KBh.js';
import { d as defineStore } from './pinia-X75jUKgt.js';
import { n as icons } from '../index-C1gVG2MQ.js';
...
const neonatalTriageSections = [
    ...
    formData: [
      {
        ...
        name: "crying",
        header: "Look at the baby",
        subtitle: "Is the baby crying?",
        titleStyle: "tonal",
        type: "single",
        padding: true,
        allowDeselect: false,
    ...
    formData: [
      {
        ...
        helperText: "Read and continue to the next page...",
        displayMode: "visual",
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("DangerSignsAssessment"))
      }
    ]
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GruntingSevereChestIndrawings"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("CentralCyanosis"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ConsulvionsTwitching"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("GruntingIndrawingManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.observations;
      if (!observations || !Array.isArray(observations)) return true;
      return !observations.includes("grunting");
    }
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("CentralCyanosisManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.observations;
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ConvulsionsManagement"))
      }
    ],
    skipCondition: (triageData) => {
      const observations = triageData.observations;
      if (!observations || !Array.isArray(observations)) return true;
      return !observations.includes("Convulsions_twitching");
    }
  },
  {
    title: "Danger Signs",
  ...
  },
  {
    ...
    skipCondition: (triageData) => {
      return !triageData.observations?.includes("trunk_cold");
    }
  },
  {
    ...
    formData: [
      {
        ...
        padding: true,
        showStepNumber: true,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("KeepTheBodyWarm"))
      }
    ],
    skipCondition: (triageData) => {
      const hasShockIndicators = triageData.observations?.includes("capillary_refill_time") || triageData.observations?.includes("weak_fast_femoral_pulses");
    ...
    formData: [
      {
        ...
        displayMode: "cards",
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("ReferralInstructions"))
      }
    ],
    skipCondition: (triageData) => {
    ...
    formData: [
      {
        ...
        showStepNumber: false,
        infographicData: () => __vitePreload(() => import('./infographics-DNaiQNcP.js'),true              ?[]:void 0).then((m) => m.getInfographicByKey("BabyRecoveredStillSevereRespiratory"))
      }
    ],
    skipCondition: (triageData) => {
      const satsO2 = Number(triageData.saturation_in_oxygen);
