import { q as defineComponent, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, J as modalController, bp as pulseOutline, b9 as checkmark, v as resolveComponent, x as createElementBlock, y as openBlock, A as createBaseVNode, z as createVNode, bn as V, bm as IonPopover, a5 as IonInput, B as withCtx, a4 as createTextVNode, H as Fragment, r as ref, ct as useRoute, w as watch, a1 as onMounted, n as nextTick, Q as renderList, C as toDisplayString, E as unref, cZ as DataTable, aI as useRouter, K as IonIcon, a6 as IonLabel, bN as IonChip, ay as IonCol, ae as IonRow, bs as IonPage, cu as IonMenuButton, aX as medkitOutline, G as createCommentVNode, N as createBlock, a3 as normalizeClass, bJ as IonCard, au as searchOutline, ad as IonCheckbox, ba as IonCardContent, b7 as IonCardTitle, M as IonButton, b8 as IonCardHeader, d as computed, b3 as cubeOutline, F as closeCircleOutline, P as alertCircleOutline, db as timeOutline, eq as moon, er as partlySunny, es as sunny, ch as medkit, ar as script, bc as IonFooter, aF as IonAccordionGroup, aE as IonAccordion, c8 as clipboardOutline, ac as IonTextarea, dh as IonSegmentButton, dg as IonSegment, R as withDirectives, bW as chevronBackOutline, S as vShow, aa as checkmarkOutline } from './vendor-CyoemPPl.js';
import { d as defineStore, m as mapState, s as storeToRefs } from './pinia-DNgegnBS.js';
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$g, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, a9 as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, ab as useUserStore, S as Service } from '../index-QeoU54UC.js';
import { D as DemographicBar } from './DemographicBar-BnuKIioE.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BesWt_m8.js';
import { D as DashBox } from './DashBox-BoXNk8Vj.js';
import { B as BasicForm } from './BasicForm-scNfmAp4.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-uaaiA1JB.js';
import { v as validateInputFiledData } from './group_validation-BbS3Ep7t.js';
import { u as useComplicationsStore } from './ComplicationsStore-BU814E1l.js';
import { I as Investigations, _ as _sfc_main$j, i as isQualifiedAHD } from './Investigations-DVBee4OH.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-B7bsiM3N.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CPm36BpN.js';
import { _ as _sfc_main$i } from './RiskAssessment.vue_vue_type_script_setup_true_lang-iD7L8ErI.js';
import { V as Vitals } from './Vitals-B2OUMxBv.js';
import { u as useFormWizard, _ as _sfc_main$h } from './useFormWizard-Ccc6K_TV.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-C4jyyH8z.js';
import { u as usePatientProfile } from './usePatientProfile-CVlCKcXT.js';
