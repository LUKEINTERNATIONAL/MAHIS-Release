import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bM as IonCard, B as withCtx, A as createVNode, bb as IonCardTitle, d_ as IonSkeletonText, z as createElementBlock, L as IonIcon, aT as medicalOutline, a5 as createTextVNode, J as Fragment, bc as IonCardHeader, ap as IonList, S as renderList, aq as IonItem, a7 as IonLabel, b9 as calendarOutline, C as createBaseVNode, D as toDisplayString, cJ as idCardOutline, c8 as folderOutline, c5 as checkmarkCircleOutline, be as IonCardContent, f as ref, p as dayjs, a3 as onMounted, aC as IonGrid, af as IonRow, aB as IonCol, Q as normalizeClass, d$ as checkboxOutline, H as createCommentVNode, ca as clipboardOutline, e0 as statsChartOutline, K as modalController, aM as useRouter, bN as useRoute, aH as IonContent, e1 as ellipsisVerticalSharp, d3 as person, aJ as IonAccordionGroup, aI as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, al as IonPopover, b0 as personOutline, v as documentTextOutline, b2 as printOutline, d4 as add, bw as IonPage, cS as defineAsyncComponent, cI as __vitePreload, c as computed } from './vendor-NYNX75Tj.js';
import { s as storeToRefs } from './pinia-Byno_K7k.js';
import { ak as ProgramService, _ as _export_sfc, P as PatientService, al as PatientProgramService, ac as GlobalPropertyService, r as StandardModal, o as createModal, am as _sfc_main$3, an as ArtTasks, K as ObservationService, b as EncounterTypeId, u as useDemographicsStore, k as alertConfirmation, J as savePatientRecord, G as toastSuccess, ao as router, t as toastWarning, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, L as ProgramId, S as Service, F as DynamicButton, ap as iconBMI, aq as openVisit, q as usePatientList, v as closeVisit, ar as SetProgramService, M as ConceptService, as as getActiveVisit } from '../index-DRy1cgfg.js';
...
import { i as isTaskPermitted } from './tasks-D1mLtlcO.js';
import { A as ANCRedirection } from './anc_service-Dt6Vn2Zy.js';
...
const LabourRedirection = async () => {
  ...
  if (shouldShowEnrollmentModal) {
    const personInfo = useDemographicsStore().getPatient()?.personInformation;
    const name = personInfo ? `${personInfo.given_name || ""} ${personInfo.family_name || ""}`.trim() : "this patient";
    ...
    if (result) {
      ...
      const patient = await ObservationService.addObsToEncounterPatient([obs], EncounterTypeId.LABOUR_ENROLLMENT);
...
const PNCRedirection = async () => {
  ...
  if (shouldShowEnrollmentModal) {
    ...
    if (result) {
      const obs = await ObservationService.buildValueCoded("Patient enrolled", "Yes");
      const patient = await ObservationService.addObsToEncounterPatient([obs], EncounterTypeId.PNC_ENROLLMENT);
      await savePatientRecord(patient);
      toastSuccess("Patient enrolled successful");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-OrhxoX9b.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Cj4pZbtH.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-eMmcgsei.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-oPJ1EmgV.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-Cj94MyFZ.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-CBn8z9A7.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-CGgrpz_6.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-C16g0QkI.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-63MMhVMT.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-CEya-7IR.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-DrJX4fDN.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-DRy1cgfg.js').then(n => n.cU),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-CAg9v09d.js'),true              ?[]:void 0));
