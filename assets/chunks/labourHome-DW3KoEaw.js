import { d as computed, q as defineComponent, N as createBlock, y as openBlock, B as withCtx, A as createBaseVNode, z as createVNode, E as unref, s as documentTextOutline, J as modalController, aI as useRouter, r as ref, a1 as onMounted, aD as IonContent, bW as chevronBackOutline, eQ as paperPlaneOutline, eR as checkmarkDoneOutline, x as createElementBlock, H as Fragment, Q as renderList, c8 as clipboardOutline, eU as notificationsOutline, eV as documentText, cn as checkmarkCircle, bs as IonPage } from './vendor-Cd5ziTxG.js';
import { y as StandardValidations, n as icons, z as useExposeFromStandardForm, C as StandardForm, F as DynamicButton, q as StandardModal, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-CKTz1PXB.js';
import { D as DemographicBar } from './DemographicBar-CmMe7QOI.js';
import { D as DashboardCards } from './DashboardCards-CaUu6PkO.js';
    ...
    return [
      ...
      },
      {
        ...
        validation: (value) => {
          ...
          if (isNaN(Number(value))) return "Phone number can only be a number";
          if (Number(value) < 0) return "Phone number must be positive";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const gravida = ref("");
    const cardsData = [
      { title: "Labour Assessment", path: "/labourAssessment", icon: clipboardOutline, isSaved: false },
      { title: "Continuous Monitoring", path: "/continuousMonitoring", icon: notificationsOutline, isSaved: false },
      { title: "Delivery Details", path: "/labourDeliveryDetails", icon: documentText, isSaved: false },
      { title: "Immediate Postnatal Checks", path: "/postnatalChecks", icon: checkmarkCircle, isSaved: false }
    ];
...
const labourHome = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4dac837"]]);
