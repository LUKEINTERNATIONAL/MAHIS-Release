import { O as OrderService, bq as LabOrderService, t as toastWarning, b as EncounterTypeId, n as icons, _ as _export_sfc, br as getCheckboxSelectedValue, aV as modifyRadioValue, a1 as modifyFieldValue, aX as modifyCheckboxValue, K as ObservationService, G as toastSuccess, S as Service, F as DynamicButton, a_ as List, B as BasicInputField, ba as SelectionPopover, g as getPouchDBRecords, aq as ConceptService, bm as useInvestigationStore, H as HisDate, u as useDemographicsStore, y as StandardValidations, z as useExposeFromStandardForm, C as StandardForm, aY as AppEncounterService, W as LocationService, bs as CONTRADICTING_STAGE_DEFINITIONS_ALERTS, bt as ADULT_WHO_STAGE_CRITERIA, bu as CHILD_WHO_STAGE_CRITERIA, bv as ADULT_ART_ELIGIBILITY, bw as CHILD_ART_ELIGIBILITY, bx as RECOMMENDED_ADULT_STAGING_CONDITIONS, by as RECOMMENDED_CHILD_STAGING_CONDITIONS, P as PatientService, bz as BasicYesNoSelect, bA as BasicDateInput, bB as BasicSelect, bC as BasicInput, bD as BasicFacilitySelector, x as toastDanger, e as useGeneralStore, a9 as useConfigStore, q as StandardModal, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, k as alertConfirmation, o as createModal, J as savePatientRecord } from '../index-77Br-hAb.js';
import { s as storeToRefs, d as defineStore, m as mapState } from './pinia-CzgPmrQI.js';
import LabOrdersList from './LabOrdersList-CWjldBiu.js';
import { v as validateInputFiledData } from './group_validation-BofnqMUx.js';
import { u as useRadiologyStore } from './RadiologyStore-BI3xR3s3.js';
import { B as BasicForm } from './BasicForm-loVWBinx.js';
import { q as defineComponent, r as ref, a1 as onMounted, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, z as createVNode, A as createBaseVNode, x as createElementBlock, H as Fragment, Q as renderList, G as createCommentVNode, E as unref, w as watch, bm as IonPopover, a5 as IonInput, aA as IonToolbar, aB as IonTitle, aC as IonMenu, am as IonList, an as IonItem, I as IonHeader, aD as IonContent, bp as pulseOutline, b9 as checkmark, a4 as createTextVNode, d as computed, a as reactive, bJ as IonCard, ax as IonGrid, ae as IonRow, ay as IonCol, aF as IonAccordionGroup, aE as IonAccordion, a6 as IonLabel, C as toDisplayString, bN as IonChip, ad as IonCheckbox, bw as IonText, ba as IonCardContent, l as dayjs, aI as useRouter, ct as useRoute, R as withDirectives, S as vShow, J as modalController } from './vendor-DUNDjU_C.js';
import { l as lodashExports } from './lodash-D1CNaELN.js';
import { b as formatCheckBoxData, c as formatRadioButtonData, f as formatInputFiledData } from './formatServerData-jJAZlRgZ.js';
import { D as DashBox } from './DashBox-HaSi9NoB.js';
import { u as usePresentingComplaintsStore, p as previousComplaints } from './previousComplaints-dMJXsELk.js';
import { P as PatientComplaintsService } from './patient_complaints_service-C9LA9Ug8.js';
import { u as useFormWizard, _ as _sfc_main$8 } from './useFormWizard-DUXSPTrm.js';
import { a as isClinician } from './user_role_management-DtNfvwaF.js';
...
const RadiologyInvestigation = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-5ab54fe8"]]);
...
const AHDPastMedicalHistory = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-e5153372"]]);
...
const Investigations = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9ab30198"]]);

export { Investigations as I, LabOrder as L, _sfc_main$1 as _, _sfc_main$5 as a, isQualifiedAHD as i };
