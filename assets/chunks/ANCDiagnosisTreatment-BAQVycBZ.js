import { s as defineComponent, a2 as onMounted, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, B as withCtx, F as unref, bd as IonCardContent, c as computed, f as ref, bK as IonCard, aL as useRouter, O as createBlock, aG as IonContent, bX as chevronBackOutline, S as withDirectives, T as vShow, bu as IonPage } from './vendor-CjPalcaW.js';
import { _ as _sfc_main$5, u as useFormWizard } from './useFormWizard-CJEhYfdl.js';
import { z as StandardForm, C as useExposeFromStandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, u as useDemographicsStore, y as StandardValidations, J as savePatientRecord, t as toastWarning, a0 as DrugService, T as Toolbar, F as DynamicButton } from '../index-CiFY4gw2.js';
    ...
    const diagnosesForm = computed(
      () => [
        ...
        },
        {
          ...
          obsValueType: "value_coded",
          condition: (data) => {
            return data["diagnosisCheckboxes"]?.includes("Other");
          }
        }
      ]
    );
