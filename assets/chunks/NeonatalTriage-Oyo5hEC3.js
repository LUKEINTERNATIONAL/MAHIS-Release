import { s as defineComponent, h as inject, w as watch, y as openBlock, z as createElementBlock, A as createVNode, F as unref, f as ref, x as resolveComponent, O as createBlock, B as withCtx, D as toDisplayString, H as createCommentVNode, C as createBaseVNode, ck as onBeforeUnmount, c as computed, L as IonIcon, N as IonButton, aG as IonContent, bu as IonPage, aL as useRouter, cu as useRoute, fj as onIonViewWillEnter, bY as chevronBackOutline, r as reactive, f0 as provide } from './vendor-CL0dVHZq.js';
import { s as storeToRefs } from './pinia-e5upVPR3.js';
import { z as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cn as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ch as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-yRu5EhmF.js';
import { D as DemographicBar } from './DemographicBar-0uNt3MoR.js';
import { k as neonatalTriageSections, c as neonatalTriageFormKey, f as useNeonatalTriageStore, N as NeonatalStepper, z as triageConceptMapping, A as defaultNeonatalTriageForm } from './NeonatalStepper-DPfWNmNE.js';
import { S as SummarySection } from './SummarySection-DA0YO-qa.js';
import { T as TriageConfirmDialog } from './TriageConfirmDialog-Biqrcok6.js';
import { F as FindRegisterPatient } from './FindRegisterPatient-1GUvnMO0.js';
