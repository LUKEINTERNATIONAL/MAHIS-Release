import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, C as createBaseVNode, bM as IonCard, f as ref, aM as useRouter, a3 as onMounted, O as createBlock, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-OAxQVBFs.js';
import { _ as _sfc_main$2, u as useFormWizard } from './useFormWizard-D-Lz0xN9.js';
import { n as icons, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton, t as toastWarning } from '../index-CYKriPuU.js';
import { D as DemographicBar } from './DemographicBar-DImdwYjM.js';
import { S as SecondStageDelivery, T as ThirdStageDelivery } from './ThirdStageDelivery-DbMdJ9Su.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const saveData = async () => {
      const componentRefs = [{ ref: secondStageDeliveryRef }, { ref: thirdStageDeliveryRef }, { ref: obstetricComplications }];
      let hasError = false;
      for (const component of componentRefs) {
        const ref2 = component.ref.value;
        if (!ref2) continue;
        if (typeof ref2.validateForm === "function") {
          const errors = ref2.validateForm();
          if (errors && Object.keys(errors).length > 0) {
            toastWarning("Please fix the validation errors before continuing.");
            return;
          }
        }
        if (typeof ref2.onSubmit === "function") {
          try {
            await ref2.onSubmit();
          } catch (error) {
