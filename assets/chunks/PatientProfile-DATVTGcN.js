import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bK as IonCard, B as withCtx, A as createVNode, ba as IonCardTitle, dZ as IonSkeletonText, z as createElementBlock, L as IonIcon, aS as medicalOutline, a5 as createTextVNode, J as Fragment, bb as IonCardHeader, ap as IonList, R as renderList, aq as IonItem, a7 as IonLabel, b8 as calendarOutline, C as createBaseVNode, D as toDisplayString, cI as idCardOutline, c7 as folderOutline, c4 as checkmarkCircleOutline, bd as IonCardContent, f as ref, p as dayjs, a2 as onMounted, aB as IonGrid, af as IonRow, aA as IonCol, a4 as normalizeClass, d_ as checkboxOutline, H as createCommentVNode, c9 as clipboardOutline, d$ as statsChartOutline, K as modalController, aL as useRouter, bL as useRoute, x as resolveComponent, aG as IonContent, e0 as ellipsisVerticalSharp, d2 as person, aI as IonAccordionGroup, aH as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dg as IonSegment, dh as IonSegmentButton, a$ as personOutline, v as documentTextOutline, b1 as printOutline, d3 as add, bu as IonPage, cR as defineAsyncComponent, cH as __vitePreload, c as computed } from './vendor-DpSS1aB1.js';
import { s as storeToRefs } from './pinia-CbGjwPb6.js';
import { aj as ProgramService, _ as _export_sfc, P as PatientService, ak as PatientProgramService, ab as GlobalPropertyService, r as StandardModal, o as createModal, al as _sfc_main$3, am as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, an as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, ao as iconBMI, ap as openVisit, q as usePatientList, v as closeVisit, aq as SetProgramService, ar as ConceptService, as as getActiveVisit } from '../index-D9jmStal.js';
...
import { i as isTaskPermitted } from './tasks-VGKwpvGw.js';
import { A as ANCRedirection } from './anc_service-BaFDKJZL.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-Bw5gsv22.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BSET_NVM.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BkQqfE_d.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-C_jUTkLa.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CaQ9Kh0Y.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-D688CXlR.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DcDtmDS8.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-ppm5SChq.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-B7YWFXa0.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-Bs_6zq3X.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-PD8ZM0w3.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-D9jmStal.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-Ccx9qvSA.js'),true              ?[]:void 0));
...
const PatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-39fb1a2c"]]);
