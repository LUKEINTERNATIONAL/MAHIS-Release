import { c as computed, s as defineComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, be as IonCardContent, bM as IonCard, f as ref, a3 as onMounted, aM as useRouter, O as createBlock, aH as IonContent, C as createBaseVNode, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage } from './vendor-BcieWP-_.js';
import { n as icons, y as StandardValidations, z as StandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, _ as _export_sfc, T as Toolbar, F as DynamicButton } from '../index-sMFid8qH.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-CPvOj5Ol.js';
import { D as DemographicBar } from './DemographicBar-BhEbcaYG.js';
import { V as Vitals } from './Vitals-C6gjb6dT.js';
import { u as useContinuousMonitoringStore, O as OtherExams } from './OtherExams-DMsRk7Qd.js';
  ...
  const painManagementForm = computed(() => [
    {
      ...
      options: [
        ...
        { label: "Pethidine", value: "Pethidine" },
...
const useContinuousMonitoringProgressOfLabourForm = () => {
  const progressOfLabourForm = computed(() => [
    ...
    { componentType: "Dashes", grid: { s: "12" } },
    {
      componentType: "inputField",
      name: "Contractions",
      header: "Contractions (in 10 mins)",
      unit: "/10 mins",
    ...
    { componentType: "Dashes", grid: { s: "12" } },
    {
      ...
      options: [
        { label: "None", value: "none", exclusive: true },
        {
          label: "Category - 1 (Anti-hypertensive)\nHydralazine, Nifedipine, Methyldopa, Labetolol, Amlodipine",
          value: "anti_hypertensive"
        },
        {
          label: "Category - 2 (Anticonvulsant)\nMagnesium sulphate, Diazepam, Phenobarbitol",
          value: "anticonvulsant"
        },
        {
          label: "Category - 3 (Corticosteroid)\nBeclomethasone, Dexamethasone, Prednisolone",
          value: "corticosteroid"
        },
        {
          label: "Category - 4 (Blood Transfusion)\nWhole blood, Fresh blood, Fresh frozen plasma, Platelets",
          value: "blood_transfusion"
        },
        {
          label: "Category - 5\nOxytocin, Misoprostol, Cabitocin",
          value: "uterotonics"
        },
        {
          // Not provided in the prompt text, but this value existed previously in the form.
          label: "Category - 6 (Anti-fibrinolytic)\nTranexaemic acid",
          value: "anti_fibrinolytic"
        },
        { label: "Other", value: "other" }
      ]
    },
    {
      ...
      obsValueType: "value_coded",
      grid: { xs: "12", md: "12" },
      condition: (vals) => isSelected(vals?.["Obstetric care provided"], "corticosteroid"),
      validation: (value, vals) => {
        if (!isSelected(vals?.["Obstetric care provided"], "corticosteroid")) return null;
        return StandardValidations.required(value);
      },
      options: [
        { label: "Yes", value: "yes" },
  ...
  const progressUrineForm = computed(() => [
    ...
    {
      componentType: "inputField",
      name: "_color of urine",
      header: "Specify urine color",
      type: "text",
      icon: icons.editPen,
      obsValueType: "value_text",
      grid: { s: "12" },
      condition: (vals) => vals?.["color of urine"] === "others",
      validation: (value, vals) => {
        if (value.length < 3) return "Other color of urine must be at least 3 characters long";
        return null;
      }
    }
  ]);
