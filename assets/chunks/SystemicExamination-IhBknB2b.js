...
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-C6u5KmBv.js';
import { N as NeonatalStepper } from './NeonatalStepper-5TUHzpWu.js';
...
import { N as NeonatalService } from './neonatal_service-DUjOMSh1.js';
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-BxhHHs8v.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-BxhHHs8v.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-BxhHHs8v.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-BxhHHs8v.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
