import { q as defineComponent, x as createElementBlock, y as openBlock, A as createBaseVNode, aI as useRouter, r as ref, fd as onIonViewWillEnter, N as createBlock, B as withCtx, z as createVNode, E as unref, aX as medkitOutline, aD as IonContent, G as createCommentVNode, L as IonSpinner, K as IonIcon, eF as lockClosedOutline, M as IonButton, a4 as createTextVNode, H as Fragment, bs as IonPage } from './vendor-sqYZJ6fK.js';
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        !_ctx.url ? (openBlock(), createElementBlock("div", _hoisted_2$1, _cache[0] || (_cache[0] = [
          createBaseVNode("p", null, "No URL provided", -1)
        ]))) : (openBlock(), createElementBlock("iframe", {
          key: 1,
          src: _ctx.url,
          title: _ctx.title || "MEMIS",
          class: "report-iframe",
          frameborder: "0",
          allowfullscreen: ""
        }, null, 8, _hoisted_3$1))
