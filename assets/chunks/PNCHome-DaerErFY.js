import { c as computed, v as defineComponent, z as openBlock, P as createBlock, C as withCtx, D as createBaseVNode, B as createVNode, G as unref, x as documentTextOutline, L as modalController, aK as useRouter, a3 as onMounted, aF as IonContent, bY as chevronBackOutline, eR as paperPlaneOutline, dt as calendar, eS as checkmarkDoneOutline, A as createElementBlock, K as Fragment, S as renderList, eY as heart, cf as personCircle, aM as people, eZ as calendarNumber, bu as IonPage, f as ref } from './vendor-D3hawxEQ.js';
import { n as icons, z as StandardForm, F as DynamicButton, q as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-DeiarqPy.js';
import { D as DemographicBar } from './DemographicBar-sXgiyx7_.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const gravida = ref("");
    const cardsData = [
      { title: "Postnatal details", path: "/pnc/postnatal-details", icon: heart, isSaved: false },
      { title: "Postnatal ward monitoring for mother", path: "/pnc/ward-monitoring", icon: personCircle, isSaved: false },
      { title: "Postnatal ward monitoring for baby", path: "/pnc/baby-status", icon: people, isSaved: false },
      { title: "Postnatal visit", path: "/pnc/visit", icon: calendarNumber, isSaved: false }
    ];
...
const PNCHome = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8529d582"]]);
