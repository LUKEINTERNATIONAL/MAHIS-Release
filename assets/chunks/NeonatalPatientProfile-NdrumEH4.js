...
import { s as defineComponent, aL as useRouter, a3 as onMounted, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, aB as IonGrid, B as withCtx, af as IonRow, aA as IonCol, bK as IonCard, O as createBlock, bI as IonBadge, a5 as createTextVNode, D as toDisplayString, H as createCommentVNode, bd as IonCardContent, du as IonImg, by as IonText, Q as normalizeClass, f as ref, c as computed, aG as IonContent, J as Fragment, S as renderList, dZ as IonSkeletonText, L as IonIcon, cG as arrowForward, N as IonButton, fk as reloadOutline, bR as withKeys, a8 as withModifiers, d3 as add, v as documentTextOutline, P as normalizeStyle, a9 as chevronDownOutline, a$ as personOutline, aV as femaleOutline, aS as medicalOutline, R as alertCircleOutline, aW as heartOutline, br as pulseOutline, a_ as medkitOutline, eM as scanOutline, fl as restaurantOutline, fm as flaskOutline, es as thermometerOutline, fn as bandageOutline, aX as flagOutline, d2 as person, e0 as ellipsisVerticalSharp, fo as maleFemaleOutline, b8 as calendarOutline, b0 as locationOutline, fp as qrCodeOutline, dh as IonSegmentButton, d$ as statsChartOutline, a7 as IonLabel, dg as IonSegment, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, al as IonPopover } from './vendor-ltMrzBmS.js';
import { l as lodashExports } from './lodash-B_R-xRJh.js';
import { u as usePatientProfile } from './usePatientProfile-D2ZSVPA5.js';
import { u as useDemographicsStore, b as EncounterTypeId, E as EncounterService, S as Service, t as toastWarning, _ as _export_sfc, l as PreviousVitals, r as StandardModal, H as HisDate, o as createModal, k as alertConfirmation, bp as LabOrderService, K as ObservationService, P as PatientService } from '../index-D1sAwkPe.js';
...
import { _ as _sfc_main$6 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-2VACNYlZ.js';
        ...
        try {
          ...
          if (type === "clinical") {
            ...
            if (!hasTriage || completedCount < steps.length || !hasOutcome) {
              await showIncompleteWorkflowAlert("Clinical Review");
              return;
            }
            router.push({ name: "neonatalClinicalReviewSignoff", query: { showReport: "true" } });
          } else {
            const hasDischarge = combined.some((e) => e.toUpperCase().trim() === "NEONATAL DISCHARGE");
            if (!hasDischarge) {
              await showIncompleteWorkflowAlert("Discharge");
              return;
            }
            router.push({ name: "neonatalDischarge", query: { showReport: "true" } });
          }
        } catch (error) {
...
const NeonatalPatientProfile = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-09ee636e"]]);
