import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bq as V, c_ as DataTable, bN as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aM as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aJ as IonAccordionGroup, aI as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bR as IonChip, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bw as IonPage, cv as IonMenuButton, I as IonHeader, aH as IonContent, a$ as medkitOutline, Q as normalizeClass, H as createCommentVNode, bM as IonCard, a6 as IonInput, aw as searchOutline, ae as IonCheckbox, be as IonCardContent, bb as IonCardTitle, N as IonButton, bc as IonCardHeader, b7 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dc as timeOutline, eA as moon, eB as partlySunny, eC as sunny, cj as medkit, au as script, al as IonPopover, aG as IonMenu, bg as IonFooter, bd as checkmark, ca as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, b_ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-BcieWP-_.js';
import { s as storeToRefs, m as mapState } from './pinia-DdQ9BIp0.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, M as ConceptService, ba as checkIfSamePatient, bb as setCurrentPatientID, bc as getAntiHypertensivesMedication, bd as getDiabetesDrugs, be as clearMedicationData, B as BasicInputField, bf as useNCDMedicationsStore, bg as useOtherNCDMedicationStore, bh as formMedicationObject, x as toastDanger, b3 as useTreatmentPlanStore, a1 as DrugService, d as _sfc_main$f, bi as addOtherMedicationToNCDMedicationList, T as Toolbar, bj as useVitalsStore, bk as useInvestigationStore, bl as useDiagnosisStore, e as useGeneralStore, b4 as useOutcomeStore, i as useEnrollementStore, ab as useConfigStore, f as useStatusStore, a3 as getFieldValue, a_ as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b5 as confirmModal, bo as useAllegyStore, a7 as useUserStore, S as Service } from '../index-sMFid8qH.js';
import { D as DemographicBar } from './DemographicBar-BI0P5tk9.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-rrkEansi.js';
import { u as useComplicationsStore } from './ComplicationsStore-CKteNsqX.js';
import { B as BasicForm } from './BasicForm-g1N6bFmm.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-B7oudRfa.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-Ci7vt2EC.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CS9B51KI.js';
import { P as PreviousAllergies } from './PreviousAllergies-D92thMCg.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-DYv_OXIF.js';
import { V as Vitals } from './Vitals-C6gjb6dT.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-CPvOj5Ol.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-5bPPuiUf.js';
import { l as lodashExports } from './lodash-C07Grsj7.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-ADGfX48c.js';
