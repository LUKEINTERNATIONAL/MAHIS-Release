import { s as defineComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, z as createElementBlock, F as unref, bK as IonCard, Q as normalizeClass, D as toDisplayString, H as createCommentVNode, w as watch, J as Fragment, S as renderList, aI as IonAccordionGroup, aq as IonItem, a7 as IonLabel, a5 as createTextVNode, N as IonButton, a8 as withModifiers, aH as IonAccordion, L as IonIcon, cG as arrowForward, aL as useRouter, a3 as onMounted, aG as IonContent, bY as chevronBackOutline, T as withDirectives, U as vShow, bu as IonPage } from './vendor-ltMrzBmS.js';
import { bK as useVitals, z as StandardForm, F as DynamicButton, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, bO as iconBloodPressure, _ as _export_sfc, u as useDemographicsStore, b5 as RelationshipService, T as Toolbar } from '../index-D1sAwkPe.js';
import { D as DemographicBar } from './DemographicBar-BXMFuYkw.js';
import { _ as _sfc_main$m, u as useFormWizard } from './useFormWizard-DioG1Hne.js';
import { s as storeToRefs } from './pinia-CSbxcXdD.js';

const _hoisted_1$3 = { class: "add-bp-button" };
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isFirstBPReadingSaved = ref(false);
    ...
    function isBloodPressureFilled(values) {
      const { systolic, diastolic } = getBloodPressureFromForm(values);
    ...
    function canShowAddSecondReadingButton(values) {
      if (!isBloodPressureFilled(values) || isFirstBPReadingSaved.value) return false;
      const { systolic, diastolic } = getBloodPressureFromForm(values);
      return isBloodPressureOutsideNormalRange(systolic, diastolic);
    }
    ...
    async function saveFirstReadingAndRequestSecond() {
      if (!formRef.value) return;
      const values = await formRef.value.getFormValues();
      const { systolic, diastolic } = getBloodPressureFromForm(values);
      if (systolic == null || systolic === "" || diastolic == null || diastolic === "") {
        toastWarning("Please enter valid first blood pressure readings.");
        return;
      }
      if (!areBloodPressureValuesValid(systolic, diastolic)) {
        toastWarning("Please enter valid first blood pressure readings.");
        return;
      }
      if (!isBloodPressureOutsideNormalRange(systolic, diastolic)) {
        toastWarning("First reading is within normal range. No need to add a second reading.");
        return;
      }
      const payload = {
        [FIELD_SYSTOLIC_BP]: Number(systolic),
        [FIELD_DIASTOLIC_BP]: Number(diastolic),
        obsValueType: { ...BP_OBS_VALUE_TYPES }
      };
      const patient = await ObservationService.buildSaveObs(payload, EncounterTypeId.IMMEDIATE_POSTNATAL_CHECKS_MOTHER);
      if (!patient) return;
      isFirstBPReadingSaved.value = true;
      formRef.value?.setFormValue(FIELD_SYSTOLIC_BP, "");
      formRef.value?.setFormValue(FIELD_DIASTOLIC_BP, "");
      toastSuccess("First BP reading saved. Enter second reading in the same fields above.");
    }
    const formConfig = computed(() => {
      const isSecondAttempt = isFirstBPReadingSaved.value;
      return [
        {
          header: isSecondAttempt ? `${FIELD_SYSTOLIC_BP} (2nd reading)` : FIELD_SYSTOLIC_BP,
          name: FIELD_SYSTOLIC_BP,
          label: isSecondAttempt ? "Systolic pressure (2nd attempt)" : "Systolic pressure",
        ...
        {
          header: isSecondAttempt ? `${FIELD_DIASTOLIC_BP} (2nd reading)` : FIELD_DIASTOLIC_BP,
          name: FIELD_DIASTOLIC_BP,
          label: isSecondAttempt ? "Diastolic pressure (2nd attempt)" : "Diastolic pressure",
          componentType: "inputField",
        ...
        },
        {
          ...
          position: "left",
          grid: { xs: "12" },
          condition: (formValues) => canShowAddSecondReadingButton(formValues)
        },
        {
          componentType: "Alert",
          grid: { xs: "12" },
          condition: async (formValues) => {
            if (!isFirstBPReadingSaved.value || !isBloodPressureFilled(formValues)) return null;
            const { systolic, diastolic } = getBloodPressureFromForm(formValues);
            if (!isBloodPressureOutsideNormalRange(systolic, diastolic)) return null;
            return getBloodPressureTriggerAlertConfig(systolic, diastolic);
          }
        },
    ...
    async function getValues() {
      ...
      if (!isFirstBPReadingSaved.value) return values;
      const { [FIELD_SYSTOLIC_BP]: systolic, [FIELD_DIASTOLIC_BP]: diastolic, obsValueType = {}, ...rest } = values;
      return {
        ...rest,
        [FIELD_SYSTOLIC_BP_SECOND_READING]: systolic,
        [FIELD_DIASTOLIC_BP_SECOND_READING]: diastolic,
        obsValueType: {
          ...obsValueType,
    ...
    function resetForm() {
      isFirstBPReadingSaved.value = false;
      formKey.value += 1;
    }
    async function onSubmit() {
      const data = await getValues();
      if (!data || Object.keys(data).filter((k) => k !== "obsValueType").length === 0) return;
      const saved = await ObservationService.buildSaveObs(
        data,
        EncounterTypeId.IMMEDIATE_POSTNATAL_CHECKS_MOTHER
      );
      if (saved) {
        ...
        "add-bp": withCtx(() => [
          createBaseVNode("div", _hoisted_1$3, [
            createVNode(DynamicButton, {
              name: "Add Second Reading",
              iconSlot: "start",
              fill: "outline",
              onClick: saveFirstReadingAndRequestSecond
            })
          ])
        ]),
        _: 1
...
const ImmidiateMotherCheck = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-914a9204"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createVNode(unref(IonCard), { class: "m-card" }, {
          default: withCtx(() => [
            createVNode(ImmidiateMotherCheck, {
...
const ForMother = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-fdfdd077"]]);
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const baseFormConfig = [
      ...
      },
      {
        ...
        onChange: (value, allFormValues) => {
          if (value) {
            const nextValues = { "HIV Test Date": "" };
            if (!isNegativeWithPositiveTest(allFormValues)) {
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const validateRespiratoryRate = (value) => {
      ...
      if (wholeNumberError) return "Respiratory rate must be a whole number.";
  ...
  setup(__props, { expose: __expose }) {
    ...
    const validateRef = async () => {
      ...
      switch (activeAccordion.value) {
        ...
        case "abdomen":
          return await validateComponent(childAbdomentAssesment);
        case "genital":
    ...
    const saveDataForCurrentStep = async () => {
      ...
      switch (activeAccordion.value) {
        ...
        case "chest_back":
          ...
          break;
        case "abdomen":
          dataToSave = await getCompValues(childAbdomentAssesment);
          break;
        case "genital":
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        hasChildren.value ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
          ...
          selectedChild.value ? (openBlock(), createBlock(unref(IonAccordionGroup), {
                  ...
                  createBaseVNode("div", _hoisted_11, [
                    createVNode(unref(IonCard), { class: "m-card" }, {
                      default: withCtx(() => [
                        ...
                        _cache[18] || (_cache[18] = createBaseVNode("h5", { class: "section-title" }, "Lips/mouth", -1)),
              ...
              createVNode(unref(IonAccordion), {
                ...
                default: withCtx(() => [
                  ...
                  createBaseVNode("div", _hoisted_15, [
                    createVNode(unref(IonCard), { class: "m-card" }, {
                      default: withCtx(() => [
                        _cache[27] || (_cache[27] = createBaseVNode("h5", { class: "section-title" }, "Abdomen", -1)),
                  ...
                  createBaseVNode("div", _hoisted_19, [
                    createVNode(unref(IonCard), { class: "m-card" }, {
                      default: withCtx(() => [
                        ...
                        _cache[34] || (_cache[34] = createBaseVNode("hr", { class: "dashed-hr" }, null, -1)),
                      ...
                      default: withCtx(() => [
                        ...
                        createBaseVNode("div", _hoisted_22, [
                          ...
                          isLast.value && hasNextChild.value ? (openBlock(), createBlock(unref(IonButton), {
                            ...
                            default: withCtx(() => [
                              _cache[37] || (_cache[37] = createTextVNode(" Next Child ", -1)),
            ...
            _: 1
          }, 8, ["modelValue"])) : (openBlock(), createElementBlock("div", _hoisted_23, [..._cache[39] || (_cache[39] = [
            createBaseVNode("div", { class: "empty-content" }, [
              createBaseVNode("p", null, "Please select a child above to begin the assessment.")
            ], -1)
          ])]))
        ])) : (openBlock(), createElementBlock("div", _hoisted_24, [..._cache[40] || (_cache[40] = [
          createBaseVNode("div", { class: "empty-content" }, [
...
const ForChild = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bbaa77e9"]]);
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_1, [
                showWizard.value ? (openBlock(), createBlock(_sfc_main$m, {
                  key: 0,
                  ref: "wizard",
