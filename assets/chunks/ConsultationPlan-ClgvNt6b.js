import { s as defineComponent, a2 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bp as V, cZ as DataTable, ct as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, R as renderList, D as toDisplayString, F as unref, aL as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bO as IonChip, aA as IonCol, af as IonRow, aD as IonToolbar, aE as IonTitle, bu as IonPage, cu as IonMenuButton, I as IonHeader, aG as IonContent, a_ as medkitOutline, a4 as normalizeClass, H as createCommentVNode, bK as IonCard, a6 as IonInput, ax as searchOutline, ae as IonCheckbox, bd as IonCardContent, ba as IonCardTitle, N as IonButton, bb as IonCardHeader, b6 as cubeOutline, G as closeCircleOutline, Q as alertCircleOutline, db as timeOutline, ez as moon, eA as partlySunny, eB as sunny, ch as medkit, au as script, al as IonPopover, aF as IonMenu, bf as IonFooter, bc as checkmark, c8 as clipboardOutline, ad as IonTextarea, dh as IonSegmentButton, dg as IonSegment, bX as chevronBackOutline, S as withDirectives, T as vShow, ab as checkmarkOutline } from './vendor-BFWX6OWQ.js';
import { s as storeToRefs, m as mapState } from './pinia-CjkeFwdd.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, ar as ConceptService, b9 as checkIfSamePatient, ba as setCurrentPatientID, bb as getAntiHypertensivesMedication, bc as getDiabetesDrugs, bd as clearMedicationData, B as BasicInputField, be as useNCDMedicationsStore, bf as useOtherNCDMedicationStore, bg as formMedicationObject, x as toastDanger, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$f, bh as addOtherMedicationToNCDMedicationList, T as Toolbar, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DJqGAImg.js';
import { D as DemographicBar } from './DemographicBar-BAZsXSKk.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-BSUceuqC.js';
import { u as useComplicationsStore } from './ComplicationsStore-COk-WH4X.js';
import { B as BasicForm } from './BasicForm-BajacZzq.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-BhFJj6YI.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-CrS8-rCK.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DsSDXyUq.js';
import { P as PreviousAllergies } from './PreviousAllergies-DPbyr-0g.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-CKnLRaw5.js';
import { V as Vitals } from './Vitals-BqpWBrz9.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-B6_3zidv.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-C3xfGwE7.js';
import { l as lodashExports } from './lodash-BkpaWb85.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-DeTlXp8E.js';
import { u as usePatientProfile } from './usePatientProfile-6uKMe7uS.js';
