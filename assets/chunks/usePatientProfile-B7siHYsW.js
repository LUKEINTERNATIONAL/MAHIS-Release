import { q as defineComponent, N as createBlock, y as openBlock, a6 as IonLabel, ay as IonCol, an as IonItem, v as resolveComponent, x as createElementBlock, Q as renderList, B as withCtx, z as createVNode, a4 as createTextVNode, C as toDisplayString, A as createBaseVNode, a3 as normalizeClass, H as Fragment, r as ref, w as watch, E as unref, eb as time, G as createCommentVNode, b$ as IonDatetime, a1 as onMounted, bJ as IonCard, b7 as IonCardTitle, b8 as IonCardHeader, ae as IonRow, ar as script, ef as pencilOutline, bG as saveOutline, F as closeCircleOutline, ba as IonCardContent, M as IonButton, d as computed, am as IonList, aA as IonToolbar, aB as IonTitle, bb as IonButtons, K as IonIcon, I as IonHeader, aD as IonContent, bc as IonFooter, J as modalController, aI as useRouter, cI as idCardOutline, P as alertCircleOutline, a5 as IonInput, bw as IonText, aZ as locationOutline, O as normalizeStyle, dA as domtoimage, W as Capacitor } from './vendor-DUNDjU_C.js';
import { k as alertConfirmation, a4 as popoverConfirmation, n as icons, _ as _export_sfc, B as BasicInputField, b3 as useOutcomeStore, t as toastWarning, g as getPouchDBRecords, aI as _sfc_main$c, F as DynamicButton, $ as SelectFacility, W as LocationService, aY as AppEncounterService, a as useProgramStore, aK as useClinicalDaysStore, aL as setValueProps, aC as ListPicker, ai as ProgramService, o as createModal, b4 as confirmModal, S as Service, H as HisDate, G as toastSuccess, u as useDemographicsStore, P as PatientService, J as savePatientRecord, Z as printLabel, aM as PrintoutService, b5 as printArtVisitLbl } from '../index-77Br-hAb.js';
import { R as Registration } from './Registration-DkhsT36P.js';
import { u as useWardsStore } from './wardsStore-lQssrcXT.js';
...
const DynamicDispositionList = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render], ["__scopeId", "data-v-4346bf77"]]);
...
const AdmittedforShortStayOutcomef = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-2508fb5d"]]);
...
const ReferredOutCome = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-7b6ec0cf"]]);
...
const DischargedHome = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-e39df163"]]);

const _hoisted_1$4 = { class: "date-results-container" };
const _hoisted_2$4 = { class: "date-buttons-container" };
const _hoisted_3$3 = {
  key: 0,
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$4, [
    ...
    (validationError.value)
      ? (openBlock(), createElementBlock("p", _hoisted_3$3, " ⚠️ Please select an available date to proceed. "))
      : createCommentVNode("", true)
  ]))
}
}
...
const DatePillSelector = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-1e34f199"]]);
...
const ReferToAnotherClinic = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-721c6ae2"]]);
...
const Outcome = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2873182f"]]);
...
function usePatientProfile() {
  ...
  const openPIM = () => {
    createModal(_sfc_main$b, { class: "fullScreenModal" });
  };
  const openOutCome = () => {
...
export { AdmittedforShortStayOutcomef as A, DynamicDispositionList as D, Outcome as O, ReferredOutCome as R, _sfc_main$9 as _, DischargedHome as a, ReferToAnotherClinic as b, _sfc_main$b as c, usePatientProfile as u };
