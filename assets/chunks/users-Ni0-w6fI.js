import { s as defineComponent, L as IonIcon, bA as IonText, M as IonSpinner, bg as IonFooter, a7 as IonLabel, aq as IonItem, ap as IonList, be as IonCardContent, bb as IonCardTitle, cE as IonCardSubtitle, bc as IonCardHeader, bM as IonCard, aB as IonCol, af as IonRow, aC as IonGrid, bw as IonPage, aH as IonContent, a3 as onMounted, w as watch, cc as appsOutline, e4 as createOutline, bx as personCircleOutline, f as ref, r as reactive, c as computed, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, O as createBlock, C as createBaseVNode, D as toDisplayString, J as Fragment, S as renderList, a5 as createTextVNode, F as unref, b0 as personOutline, H as createCommentVNode, b5 as peopleOutline, au as script, e6 as keyOutline, bH as IonModal, I as IonHeader, aE as IonToolbar, aF as IonTitle, ce as personAddOutline, bf as IonButtons, N as IonButton, G as closeCircleOutline, bJ as saveOutline, K as modalController, aw as searchOutline, b_ as chevronBackOutline } from './vendor-CvMfV7DM.js';
import { az as editUserModal, U as UserService, _ as _export_sfc, a6 as useUserStore, aj as ProgramService, V as LocationService, B as BasicInputField, aA as sselectionList, aB as userPhoneInput, aC as ListPicker, aD as areFieldsValid, ac as isPasswordValid, aE as getFieldsValuesObj, aF as getGenderCode, x as toastDanger, aG as PersonService, G as toastSuccess, T as Toolbar, an as router } from '../index-C5FwKd58.js';
...
import { T as TableSkeletonLoader } from './TableSkeletonLoader-DFkqliYf.js';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const disableDistrictSelection = ref(true);
    ...
    function selectedLocationF(data) {
      ...
      getDistrictFacilities({ name: selectedLocation.district }, false);
    }
    ...
    async function getDistrictFacilities(district, clearFL = true) {
      locationData.value = [];
      try {
      ...
      try {
        ...
        if (user) {
          ...
          if (findUserRoleByName("Superuser,Superuser,") == true) {
            disableDistrictSelection.value = false;
            disableFacilitySelection.value = false;
          } else {
            user_roles.value = findAndRemoveRole(user_roles.value, "Superuser,Superuser,");
            user_roles.value = findAndRemoveRole(user_roles.value, "District Superuser");
            if (findUserRoleByName("District Superuser") == true) {
              disableFacilitySelection.value = false;
              disableDistrictSelection.value = true;
            }
          }
        }
      } catch (error) {
    ...
    function findAndRemoveRole(data, role_name) {
      const index = data.findIndex((role) => typeof role.name === "string" && role.name.toLowerCase() === role_name.toLowerCase());
      if (index !== -1) {
        data.splice(index, 1);
      }
      return data;
                    ...
                    true ? (openBlock(), createBlock(unref(IonCol), { key: 0 }, {
                      default: withCtx(() => [
                        ...
                        createVNode(unref(script), {
                          ...
                          disabled: disableDistrictSelection.value
...
const adduser = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a4c2127f"]]);
