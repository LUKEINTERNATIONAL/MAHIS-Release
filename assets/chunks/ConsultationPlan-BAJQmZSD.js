...
import { n as icons, a_ as List, H as HisDate, K as ObservationService, b0 as iconList, a$ as iconGraph, u as useDemographicsStore, _ as _export_sfc, F as DynamicButton, B as BasicInputField, ba as SelectionPopover, a1 as modifyFieldValue, g as getPouchDBRecords, J as savePatientRecord, G as toastSuccess, x as toastDanger, bb as useDiagnosisStore$1, o as createModal, a4 as popoverConfirmation, aq as ConceptService, bc as checkIfSamePatient, bd as setCurrentPatientID, be as getAntiHypertensivesMedication, bf as getDiabetesDrugs, bg as clearMedicationData, bh as useNCDMedicationsStore, bi as useOtherNCDMedicationStore, bj as formMedicationObject, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$f, bk as addOtherMedicationToNCDMedicationList, T as Toolbar, bl as useVitalsStore, bm as useInvestigationStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, b6 as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, b as EncounterTypeId, bp as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DzmFphVR.js';
import { D as DemographicBar } from './DemographicBar-BF84h_Ah.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-DQKwQZsf.js';
import { D as DashBox } from './DashBox-CWXERAOQ.js';
import { B as BasicForm } from './BasicForm-D9OL6ZX0.js';
import { l as lodashExports } from './lodash-CFXvmrwU.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-Bi9iXFa6.js';
import { v as validateInputFiledData } from './group_validation-LXsqQDE3.js';
import { u as useComplicationsStore } from './ComplicationsStore-ifJX8D_F.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-D6mpHJz_.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-B6O8N7HH.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CGkpK2ac.js';
import { P as PreviousAllergies } from './PreviousAllergies-D6gAWDEd.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-NPpUe-xZ.js';
import { V as Vitals } from './Vitals-BozDLl1R.js';
import { _ as _sfc_main$g } from './Wizard.vue_vue_type_script_setup_true_lang-C1KyuL1q.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-ChYtNE7f.js';
import { u as useFormWizard } from './useFormWizard-CmlzzR47.js';
import { u as usePatientProfile } from './usePatientProfile-30kRKB4g.js';
