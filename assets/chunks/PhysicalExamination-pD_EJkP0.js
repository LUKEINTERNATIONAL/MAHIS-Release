import { s as defineComponent, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, f as ref, c as computed, z as createElementBlock, H as createCommentVNode, bN as IonCard, J as Fragment, bI as IonModal, I as IonHeader, aE as IonToolbar, aF as IonTitle, C as createBaseVNode, L as IonIcon, e_ as eggOutline, a5 as createTextVNode, D as toDisplayString, bg as IonButtons, N as IonButton, G as closeCircleOutline, a7 as IonLabel, aI as IonContent, bh as IonFooter, bK as saveOutline, S as renderList, Q as normalizeClass, cq as checkmarkCircle, e5 as createOutline, bJ as addOutline, b0 as medkitOutline, a3 as onMounted, aN as useRouter, b$ as chevronBackOutline, T as withDirectives, U as vShow, bf as IonCardContent, bx as IonPage } from './vendor-8vOj_QAN.js';
import { u as useDemographicsStore, x as toastDanger, z as StandardForm, K as ObservationService, b as EncounterTypeId, G as toastSuccess, n as icons, _ as _export_sfc, t as toastWarning, F as DynamicButton, C as useExposeFromStandardForm, S as Service, N as ConceptService, J as savePatientRecord, o as createModal, y as StandardValidations, T as Toolbar } from '../index-Bn2sysQf.js';
import { D as DemographicBar } from './DemographicBar-CJWnjE0e.js';
import { _ as _sfc_main$n, u as useFormWizard } from './useFormWizard-BpEGdcvr.js';
import { V as Vitals } from './Vitals-B6_xxtvm.js';
import { s as syncChildUIs } from './StandardUtils-CB1NXgjt.js';
import { d as defineStore, s as storeToRefs } from './pinia-Drf8jDfn.js';
import { A as AddLabTestModal } from './AddLabTestModal-lJNqEtS_.js';
import { _ as _sfc_main$m } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-q9bCRpHW.js';

const useVulvaInspectionStore = defineStore("vulvaInspectionStore", {
  state: () => ({
    formData: {},
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  __name: "VulvaInspection",
  setup(__props, { expose: __expose }) {
    const vulvaStore = useVulvaInspectionStore();
    ...
    watch(
      ...
      (newPatient, oldPatient) => {
        if (newPatient?.patientID !== oldPatient?.patientID) {
          vulvaStore.setCurrentPatientID(newPatient?.patientID);
        }
      },
    ...
    const handleFieldChange = (event) => {
      vulvaStore.setFormData({ [event.fieldName]: event.value });
    };
    const handleFormReady = (refs) => {
      syncChildUIs(refs, vulvaStore.formData);
    };
    ...
    const vulvaInspectionSchema = computed(() => {
      return [
        {
        ...
        },
        {
          ...
          condition: (vals) => vals["Genital examination normal"] === "No"
        },
        {
          componentType: "checkboxField",
          header: "What are the vulva inspection abnormalities?",
          ...
          grid: { s: "12" },
          condition: (allFormValues) => allFormValues["Genital examination normal"] === "No",
          validation: (val, allVals) => {
            if (allVals["Genital examination normal"] === "No" && (!val || val.length === 0)) {
              return "Please select at least one abnormality";
            }
            return null;
          }
        },
        {
          ...
          icon: icons.editPen,
          grid: { s: "12" },
          condition: (allFormValues) => allFormValues["Genital examination normal"] === "No" && Array.isArray(allFormValues["Vulva inspection abnormalities"]) && allFormValues["Vulva inspection abnormalities"].includes("Other"),
          validation: (val, allVals) => {
            if (allVals["Vulva inspection abnormalities"]?.includes("Other") && !val) {
              return "Please specify the abnormality";
            }
            return null;
          }
        }
    ...
    const onSubmit = async () => {
      ...
      if (errors) {
        toastDanger("Please correct the highlighted errors.");
        return;
      }
      ...
      try {
        ...
        vulvaStore.resetFormData();
        formRef.value.resetForm();
        formKey.value++;
        toastSuccess("Vulva inspection saved successfully");
      } catch (e) {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Vulva Inspection.");
        }
      }
    });
    return (_ctx, _cache) => {
          ...
          createVNode(_component_ion_card_content, null, {
            default: withCtx(() => [
              (openBlock(), createBlock(StandardForm, {
                subtitle: "Genital examination",
                formData: vulvaInspectionSchema.value,
                allFormValues: unref(vulvaStore).formData,
...
const VulvaInspection = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-902ccc32"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    const vaginalInspection = computed(() => {
      return [
        ...
        {
          componentType: "Dashes",
          condition: (vals) => vals["Other findings"] === true
        },
        {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Vaginal Inspection.");
        }
      }
    });
    return (_ctx, _cache) => {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isPallorPresent = computed(() => {
      return [
        ...
        {
          componentType: "Dashes",
          condition: (vals) => vals["Is vaginal examination done?"] === "Yes"
        },
        {
          name: "Digital",
          label: "Digital",
          componentType: "checkboxField",
          header: "Select vaginal examination type",
          type: "single",
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Vaginal Examination.");
        }
      }
    });
    return (_ctx, _cache) => {
      return showForm.value ? (openBlock(), createElementBlock("div", _hoisted_1$b, [
        (openBlock(), createBlock(StandardForm, {
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const inspectionStore = useVaginalInspectionStore();
    const vulvaInspectionRef = ref(null);
    ...
    const onSubmit = async () => {
      try {
        const results = [await vulvaInspectionRef.value?.onSubmit?.(), await vaginalInspection2Ref.value?.onSubmit?.()];
    ...
    const validateForm = () => {
      breastExaminationsResultsRef.value?.validateForm?.();
      vulvaInspectionRef.value?.validateForm?.();
      vaginalInspection2Ref.value?.validateForm?.();
      vaginalExaminationDoneRef.value?.validateForm?.();
    };
    __expose({
      validateForm,
      onSubmit
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(VulvaInspection, {
          ref_key: "vulvaInspectionRef",
          ref: vulvaInspectionRef
        }, null, 512),
...
const MaternalExam = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-709474d3"]]);
...
const _hoisted_1$a = { class: "add-fetus-container" };
const _hoisted_2$4 = {
  key: 0,
  class: "ultrasound-prompt"
};
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const shouldPromptUltrasound = computed(() => {
      return currentFetusValues.value["Fetal heartbeat present?"] === "No" && gestationWeeks.value !== null && gestationWeeks.value < 12;
    });
    const handleFieldChange = (event) => {
    ...
    const getNumericObsValue = (obs) => {
      const rawValue = obs?.value_numeric ?? obs?.value_text ?? obs?.value_coded;
    ...
    const loadGestationWeeks = async () => {
      const currentPregnancyEncounters = await ObservationService.getObsByEncounterId(EncounterTypeId.CURRENT_PREGNANCY, "", patient.value);
      const latestObsMap = /* @__PURE__ */ new Map();
      currentPregnancyEncounters.flatMap((encounter) => encounter?.obs || []).forEach((obs) => {
        ...
        if (!existingObs || obsDatetime >= new Date(existingObs?.obs_datetime || 0).getTime()) {
          latestObsMap.set(conceptName, obs);
        }
      });
      const gestationConcepts = [
        "Gestation weeks",
        "Gestation age",
        "lmnpGestationAge",
        "Gestation in weeks",
        "Gestation age from ultrasound",
        "Gestation age by palpation"
      ];
      gestationWeeks.value = null;
      for (const conceptName of gestationConcepts) {
        const parsedValue = getNumericObsValue(latestObsMap.get(conceptName));
        if (parsedValue !== null) {
          gestationWeeks.value = parsedValue;
          return;
        }
      }
    };
    const validateFetalRate = (val) => {
      ...
      if (num < 120 || num > 160) return "Warning: Rate is outside normal range (120-160 BPM)";
      return null;
    };
    ...
    watch(shouldPromptUltrasound, (shouldPrompt, wasPrompted) => {
      if (shouldPrompt && !wasPrompted) {
        toastWarning("Fetal heartbeat absent before 12 weeks. Prompt client for an ultrasound.");
      }
    });
    __expose({
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        ...
        shouldPromptUltrasound.value ? (openBlock(), createElementBlock("div", _hoisted_2$4, " Fetal heartbeat is absent and gestation is less than 12 weeks. Prompt client for an ultrasound. ")) : createCommentVNode("", true)
      ]);
    };
  }
});

const addFetus = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-89645d63"]]);

const _hoisted_1$9 = { class: "header-content" };
      ...
      return openBlock(), createBlock(unref(IonModal), {
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(IonContent), { class: "ion-padding" }, {
            default: withCtx(() => [
              unref(selectedFetusNumber) ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
                createVNode(addFetus, {
...
const FetusModal = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-a2a0422e"]]);
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        __props.showSelector ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
          ...
          createBaseVNode("div", _hoisted_2$2, [
            (openBlock(), createElementBlock(Fragment, null, renderList(8, (num) => {
              ...
              }, toDisplayString(num), 11, _hoisted_3$1);
            }), 64))
          ]),
          numFetuses.value ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
...
const FetusSelector = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-10b5a9e9"]]);

const _hoisted_1$7 = { style: { "padding": "20px" } };
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
      ...
      return [
        {
          ...
          validation: (value) => {
            ...
            if (sfh < 12 || sfh > 42) return "Value out of physiological range (12-42cm)";
            return null;
          }
        },
        {
    ...
    const onSubmit = async () => {
      ...
      try {
        const assessmentObs = await ObservationService.buildObsValues(formValues) || [];
        const knownFetusCountObservation = {
          "concept_id": await ConceptService.getConceptID("Number of fetuses", true),
          "concept_name": "Number of fetuses",
          "value_numeric": fetalStore.totalFetuses,
          "obs_datetime": Service.getSessionDate(),
          "location_id": Service.getUserLocationId()
        };
        assessmentObs.push(knownFetusCountObservation);
        const fetusObsArray = await Promise.all(
          Object.entries(allFetuses || {}).map(async ([key, fetus]) => {
            return {
              "concept_id": await ConceptService.getConceptID("Fetus number", true),
              "concept_name": "Fetus number",
              "value_text": key,
              "obs_datetime": Service.getSessionDate(),
              "location_id": Service.getUserLocationId(),
              "child": fetus
        ...
        assessmentObs.push(...fetusObsArray);
        console.log("Final payload for saving:", JSON.parse(JSON.stringify(assessmentObs)));
        const savedEncounter = await ObservationService.addObsToEncounterPatient(
          assessmentObs,
          EncounterTypeId.ABDOMINAL_EXAMINATION
        );
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Fetal Assessment.");
        }
      }
    });
    return (_ctx, _cache) => {
...
const useAbdominalStore = defineStore("abdominalStore", {
  state: () => ({
    // Stores inspection fields: Symmetrical, Size, Shape, Scars, etc.
    formData: {},
  ...
  actions: {
    ...
    /**
     * Updates the patient ID context.
     * If the patient changes, we reset data to prevent cross-contamination.
     */
    setCurrentPatientID(patientID) {
      if (this.current_patient_ID !== patientID) {
        this.current_patient_ID = patientID;
    ...
    /**
     * Clears all stored Abdominal data
     */
    resetFormData() {
      this.formData = {};
    },
    /**
     * Returns the current form data for submission logic
     */
    getFormData() {
      return this.formData;
    }
  },
  // Enables automatic persistence (requires pinia-plugin-persistedstate)
  persist: true
});

const _hoisted_1$6 = { style: { "padding": "20px" } };
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "AbdominalInspection",
  setup(__props, { expose: __expose }) {
    const abdominalStore = useAbdominalStore();
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    watch(
      () => patient.value,
      (newPatient, oldPatient) => {
        if (newPatient?.patientID !== oldPatient?.patientID) {
          abdominalStore.setCurrentPatientID(newPatient?.patientID);
        }
      },
      { deep: true, immediate: true }
    );
    ...
    const formRef = ref(null);
    const handleFieldChange = (event) => {
      abdominalStore.setFormData({ [event.fieldName]: event.value });
    };
    const handleFormReady = (refs) => {
      syncChildUIs(refs, abdominalStore.formData);
    };
    const validateRequired = (val) => {
    ...
    const abdominalInspectionSchema = computed(() => {
      return [
        {
          header: "Symmetrical",
          name: "Symmetrical",
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Pendulous", value: "Pendulous" },
        ...
        },
        {
          ...
          onChange: (value) => {
            if (value === "Not present") {
              return { "Due to previous C/S?": "" };
            }
          },
          validation: validateRequired
        },
        {
          name: "Due to previous C/S?",
          componentType: "radioButtonField",
          header: "Due to previous C/S?",
          obsValueType: "value_coded",
          condition: (allFormValues) => allFormValues["Scar"] === "Present",
          options: [
            { label: "Yes", value: "Yes" },
            { label: "No", value: "No" }
          ],
          type: "inline",
          grid: { s: "5", md: "6" },
          // Validation only runs if the field is visible (condition is met)
          validation: (val, allVals) => {
            if (allVals["Scar"] === "Present" && !val) return "Please specify if due to C/S";
            return null;
          }
        },
        // {
        //     componentType: "Slot",
        //     slotName: "alert_slot",
        //     condition: (allFormValues: any) => allFormValues["Scar"] === "Present" && allFormValues["Due to previous C/S?"] === "Yes",
        // },
        {
          componentType: "Alert",
          value: "Book for high risk ANC Clinic",
          backgroundColor: "#fedf89",
          textColor: "#B54708",
          condition: (allFormValues) => allFormValues["Scar"] === "Present" && allFormValues["Due to previous C/S?"] === "Yes",
          type: "inline",
          grid: { s: "5", md: "6" }
        }
      ];
    ...
    const onSubmit = async () => {
      ...
      const errors = formRef.value.validateForm();
      if (errors) {
        toastDanger("Please correct the highlighted errors in the abdominal examination.");
        return;
      }
      const formValues = formRef.value.getFormValues();
      try {
        await ObservationService.buildAddObsToEncounterPatient(formValues, EncounterTypeId.ABDOMINAL_EXAMINATION);
        abdominalStore.resetFormData();
        formRef.value.resetForm();
        formKey.value++;
        toastSuccess("Abdominal examination saved successfully");
      } catch (e) {
        console.error("Save Error:", e);
        toastDanger("An error occurred while saving the abdominal examination.");
      }
    };
    __expose({
      onSubmit,
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Abdominal Examination.");
        }
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        (openBlock(), createBlock(StandardForm, {
          subtitle: "Abdominal Inspection",
          formData: abdominalInspectionSchema.value,
          allFormValues: unref(abdominalStore).formData,
          onFieldChanged: handleFieldChange,
          onReady: handleFormReady,
          key: formKey.value,
          ref_key: "formRef",
...
const AbdominalInspection = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-77a673a1"]]);

const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "AbdominalExamination",
  setup(__props, { expose: __expose }) {
    const fetalAssessmentRef = ref(null);
    const AbdominalInspectionRef = ref(null);
    const onSubmit = async () => {
      await fetalAssessmentRef.value?.onSubmit();
      await AbdominalInspectionRef.value?.onSubmit();
    };
    const validateForm = async () => {
      await fetalAssessmentRef.value?.validateForm();
      await AbdominalInspectionRef.value?.validateForm();
    };
    __expose({
      onSubmit,
      validateForm
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(IonCard), { class: "m-card" }, {
          default: withCtx(() => [
            createVNode(AbdominalInspection, {
              ref_key: "AbdominalInspectionRef",
              ref: AbdominalInspectionRef
            }, null, 512)
          ]),
          _: 1
        }),
        createVNode(unref(IonCard), { style: { "margin-top": "20px" } }, {
          default: withCtx(() => [
...
const _hoisted_1$5 = { style: { "padding": "20px" } };
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const violenceKeys = ["Physical violence", "Sexual violence", "Psychological/emotional abuse", "Physiological violence", "Stalking", "Other"];
    ...
    const presentingSignsOrConditionsForIPV = computed(() => {
      return [
        ...
        },
        {
          ...
          onChange: (value) => {
            if (value === "No") {
              ...
              updates["Specify the form of Violence"] = "";
              return updates;
            }
          }
        },
        ...
        },
        {
          ...
          onChange: (value) => {
            if (!value) {
              return { "Specify the form of Violence": "" };
            }
          }
        },
        {
          header: "Specify the form of Violence",
          name: "Specify the form of Violence",
          componentType: "inputField",
          obsValueType: "value_text",
          icon: icons.editPen,
          condition: (allFormValues) => allFormValues["Other"] === true,
          validation: (val, allVals) => allVals["Other"] === true && !val ? "Please specify the form of violence" : null
        }
      ];
    });
    const onSubmit = async () => {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Presenting signs for IPV.");
        }
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(IonCard), null, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$5, [
            (openBlock(), createBlock(StandardForm, {
              subtitle: "Presenting Signs for IPV Screening",
  ...
  setup(__props, { expose: __expose }) {
    ...
    const isPallorPresent = computed(() => {
      return [
        ...
        {
          componentType: "Dashes",
          condition: (vals) => vals["Is pallor present?"] === "Yes"
        },
        {
        ...
        {
          componentType: "Dashes",
          condition: (vals) => vals["Any action taken?"] === "Yes"
        },
        {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Pallor Assessment.");
        }
      }
    });
    return (_ctx, _cache) => {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const oedemaPresense = computed(() => {
      return [
        ...
        {
          componentType: "Dashes",
          condition: (vals) => vals["Is oedema present?"] === "Yes"
        },
        {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in General Examination.");
        }
      }
    });
    return (_ctx, _cache) => {
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formKey = ref(0);
    const formRef = ref(null);
    const isTestMade = ref(false);
    const primaryFindingKeys = ["Cough", "Rapid breathing", "Slow breathing", "Wheezing", "Rales", "Respiratory distress", "Other findings"];
    ...
    const handleTBTesting = async () => {
      const result = await createModal(AddLabTestModal, { class: "large-medium-width-modal" }, true);
      if (result && result.saved) {
        console.log("A TB test was saved!", result.data);
        isTestMade.value = true;
      } else {
        toastWarning("Modal was closed without saving.");
      }
    };
      ...
      return [
        {
          ...
          header: "Respiratory exam findings",
          type: "multiple",
          componentType: "checkboxField",
          grid: { s: "12" },
          obsValueType: "value_coded",
          ...
          options: [
            ...
            { label: "Slow breathing", value: "Slow breathing" },
            { label: "Wheezing", value: "Wheezing" },
            { label: "Rales", value: "Rales" },
            { label: "Respiratory distress", value: "Respiratory distress" },
            { label: "Other findings", value: "Other findings" }
          ],
          validation: (value, allFormValues) => {
            if (value.length === 0) {
              return "Respiratory exam findings are required";
            }
            if (allFormValues["Respiratory exam findings"] === true) {
              return validateAtLeastOneFinding(value, allFormValues);
            }
            return null;
          }
        },
        {
          ...
          obsValueType: "value_text",
          icon: icons.editPen,
          condition: (allFormValues) => allFormValues["Respiratory exam findings"].includes("Other findings")
        },
        {
          componentType: "Dashes",
          grid: { s: "12" },
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Respiratory Exam Findings.");
        }
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(StandardForm, {
        subtitle: "Respiratory exam",
        ...
        header: withCtx(() => [..._cache[1] || (_cache[1] = [
          createBaseVNode("div", { class: "section-subtitle" }, "TB Screening", -1)
        ])]),
        tb_button_slot: withCtx(({ formValues }) => [
          createVNode(DynamicButton, {
            name: "Send for TB testing",
            onClick: _cache[0] || (_cache[0] = ($event) => handleTBTesting()),
            fill: "solid",
            iconSlot: "start",
            icon: unref(medkitOutline),
            class: "action-button",
            color: "success",
            disabledValue: isTestMade.value
          }, null, 8, ["icon", "disabledValue"])
        ]),
        _: 1
      }, 8, ["formData"]);
    };
...
const respiratoryExamFindings = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-63195990"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in Appearance.");
        }
      }
    });
    return (_ctx, _cache) => {
...
const _hoisted_1$4 = { class: "warning-title" };
  ...
  setup(__props, { expose: __expose }) {
    ...
    __expose({
      ...
      validateForm: () => {
        const errors = formRef.value?.validateForm();
        if (errors != null) {
          toastDanger("Please complete the required fields in MUAC.");
        }
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(StandardForm, {
        ...
        muac_warning_slot: withCtx(({ formValues }) => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_1$4, " Nutritional Status: " + toDisplayString(getMuacStatus(formValues["MUAC"]).label), 1),
...
const MUAC = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-c39448dc"]]);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const validateForm = async () => {
      await MUACref.value?.validateForm?.();
      await apperanceRef.value?.validateForm?.();
      await respiratoryExamFindingsRef.value?.validateForm?.();
      await isPallorPresentRef.value?.validateForm?.();
      await oedemaPresentRef.value?.validateForm?.();
    };
    __expose({
      validateForm,
      onSubmit
...
const GeneralExamination = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-752ce4bd"]]);

const useInspectionStore = defineStore("chestInspection", () => {
  const formData = ref({});
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const inspectionSchema = computed(() => {
      return [
        {
          header: "Symmetrical",
          name: "Symmetrical",
        ...
        {
          header: "Visible Vessels",
          name: "Visible Vessels",
          componentType: "radioButtonField",
          obsValueType: "value_coded",
          options: [
            { label: "Yes", value: "Yes" },
        ...
        },
        {
          ...
          name: "_shape",
          componentType: "inputField",
          condition: (allFormValues) => allFormValues.Shape && allFormValues.Shape.includes("Other"),
          grid: { s: "12" }
        },
        {
          header: "Use of accessory muscle",
          name: "Use of accessory muscle",
          componentType: "radioButtonField",
          obsValueType: "value_coded",
          options: [
            { label: "Yes", value: "Yes" },
    ...
    const onSubmit = async () => {
      ...
      const errors = formRef.value.validateForm();
      if (errors) {
        toastDanger("Please complete the required fields in Inspection.");
        return;
      }
      const formValues = formRef.value.getFormValues();
      try {
        ...
        formRef.value.resetForm();
        formKey.value++;
        toastSuccess("Inspection results saved successfully");
      } catch (e) {
        toastDanger("Error saving inspection results");
      }
    };
    __expose({
      onSubmit,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        (openBlock(), createBlock(StandardForm, {
          subtitle: "Heart",
          formData: inspectionSchema.value,
          allFormValues: unref(inspectionStore).formData,
          onFieldChanged: handleFieldChange,
          onReady: handleFormReady,
          key: formKey.value,
...
const useAuscultationStore = defineStore("auscultation", () => {
  const formData = ref({});
  const setFormData = (data) => {
    formData.value = { ...formData.value, ...data };
  };
...
const _hoisted_1$2 = { style: { "padding": "20px" } };
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "Auscultation",
  setup(__props, { expose: __expose }) {
    const auscultationStore = useAuscultationStore();
    const formKey = ref(0);
    const formRef = ref(null);
    const handleFieldChange = (event) => {
      auscultationStore.setFormData({ [event.fieldName]: event.value });
    };
    const handleFormReady = (refs) => {
      syncChildUIs(refs, auscultationStore.formData);
    };
    const auscultationSchema = computed(() => {
      return [
        {
          header: "Normal air entry",
          name: "Normal air entry",
          componentType: "radioButtonField",
          obsValueType: "value_coded",
          options: [
            { label: "Yes", value: "Yes" },
        ...
        },
        {
          ...
          onChange: (value) => {
            if (value === "No") {
              return {
                "Added sound type": [],
                "Added sound other specify": ""
              };
            }
          }
        },
        {
          header: "Added sound type",
          name: "Added sound type",
          componentType: "checkboxField",
          type: "multiple",
          obsValueType: "value_coded",
          condition: (allFormValues) => allFormValues["Added sound"] === "Yes",
          options: [
          ...
          onChange: (value) => {
            if (!Array.isArray(value) || !value.includes("Other")) {
              return { "Added sound other specify": "" };
            }
          }
        },
        {
          header: "Other (specify)",
          name: "_Added sound type",
          componentType: "inputField",
          obsValueType: "value_text",
          condition: (allFormValues) => allFormValues["Added sound"] === "Yes" && Array.isArray(allFormValues["Added sound type"]) && allFormValues["Added sound type"].includes("Other"),
          grid: { s: "12" }
        }
      ];
    });
    const onSubmit = async () => {
      ...
      const errors = formRef.value.validateForm();
      if (errors) {
        toastDanger("Please complete the required fields in Auscultation.");
        return;
      }
      const formValues = formRef.value.getFormValues();
      try {
        await ObservationService.buildAddObsToEncounterPatient(formValues, EncounterTypeId.PHYSICAL_EXAMINATION);
        auscultationStore.resetFormData();
        formRef.value.resetForm();
        formKey.value++;
        toastSuccess("Auscultation results saved successfully");
      } catch (e) {
        toastDanger("Error saving auscultation results");
      }
    };
    __expose({
      onSubmit,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        (openBlock(), createBlock(StandardForm, {
          subtitle: "Lungs",
          formData: auscultationSchema.value,
          allFormValues: unref(auscultationStore).formData,
          onFieldChanged: handleFieldChange,
          onReady: handleFormReady,
          key: formKey.value,
          ref_key: "formRef",
...
const useBreastStore = defineStore("breast", () => {
  const formData = ref({});
  const setFormData = (data) => {
    formData.value = { ...formData.value, ...data };
  };
...
const _hoisted_1$1 = { style: { "padding": "20px" } };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "Breast",
  setup(__props, { expose: __expose }) {
    const breastStore = useBreastStore();
    const formKey = ref(0);
    const formRef = ref(null);
    const handleFieldChange = (event) => {
      breastStore.setFormData({ [event.fieldName]: event.value });
    };
    const handleFormReady = (refs) => {
      syncChildUIs(refs, breastStore.formData);
    };
      ...
      return [
        {
          ...
          onChange: (value) => {
            if (value === "Normal") {
              return { "Breast Exam findings": [] };
            }
          }
        },
        {
          header: "Breast Exam findings",
          name: "Breast Exam findings",
          componentType: "checkboxField",
          type: "multiple",
          obsValueType: "value_coded",
          condition: (allFormValues) => allFormValues["Breast Exam"] === "Abnormal",
          options: [
            { label: "Bleeding", value: "Bleeding" },
            { label: "Tenderness", value: "Tenderness" },
            { label: "Discharge", value: "Discharge" },
            { label: "Sores", value: "Sores" },
            { label: "Nipple Abnormalities", value: "Nipple Abnormalities" }
          ],
          grid: { s: "12" }
        }
      ];
    ...
    const onSubmit = async () => {
      ...
      const errors = formRef.value.validateForm();
      if (errors) {
        toastDanger("Please complete the required fields in Breast examination.");
        return;
      }
      const formValues = formRef.value.getFormValues();
      try {
        await ObservationService.buildAddObsToEncounterPatient(formValues, EncounterTypeId.PHYSICAL_EXAMINATION);
        breastStore.resetFormData();
        formRef.value.resetForm();
        formKey.value++;
        toastSuccess("Breast examination results saved successfully");
      } catch (e) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        (openBlock(), createBlock(StandardForm, {
          subtitle: "Breast",
          formData: breastSchema.value,
          allFormValues: unref(breastStore).formData,
          onFieldChanged: handleFieldChange,
          onReady: handleFormReady,
          key: formKey.value,
          ref_key: "formRef",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "ChestExamination",
  setup(__props, { expose: __expose }) {
    const inspectionRef = ref(null);
    const auscultationRef = ref(null);
    const breastRef = ref(null);
    const onSubmit = async () => {
      try {
        const results = [await inspectionRef.value?.onSubmit?.(), await auscultationRef.value?.onSubmit?.(), await breastRef.value?.onSubmit?.()];
        return results;
      } catch (error) {
        console.error("Error submitting Chest Examination:", error);
        throw error;
      }
    };
    const validateForm = () => {
      const errors = [inspectionRef.value?.validateForm?.(), auscultationRef.value?.validateForm?.(), breastRef.value?.validateForm?.()].filter(
        Boolean
      );
...
const _hoisted_3 = {
  key: 1,
  class: "no-patient-container"
};
const _hoisted_4 = { class: "action-section" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const ChestExaminationRef = ref(null);
    const demographicsStore = useDemographicsStore();
    const { patient } = storeToRefs(demographicsStore);
    watch(
      () => patient.value,
    ...
    const getActiveComponent = () => {
      ...
      switch (currentTab) {
        ...
        case "Chest Examination":
          return "ChestExamination";
    ...
    const getActiveTabs = () => {
      return [
        { title: "Vital Signs", icon: "" },
        { title: "General Examination", icon: "" },
        { title: "Chest Examination", icon: "" },
        { title: "Abdominal Examination", icon: "" },
        { title: "Maternal Exam", icon: "" },
        { title: "Presenting signs for IPV", icon: "" }
      ];
    };
    ...
    const onChangeCurrentTab = async (index, _oldIndex) => {
      ...
      if (value == "Vital Signs") vitalsRef.value?.validateForm();
      if (value == "General Examination") GeneralExaminationRef.value?.validateForm();
      if (value == "Chest Examination") ChestExaminationRef.value?.validateForm();
      if (value == "Abdominal Examination") AbdominalExaminationRef.value?.validateForm();
      if (value == "Maternal Exam") MaternalExamRef.value?.validateForm();
      if (value == "Presenting signs for IPV") PresentingSignsRef.value?.validateForm();
    };
    onMounted(async () => {
    ...
    const saveData = async () => {
      ...
      try {
        ...
        await AbdominalExaminationRef.value?.onSubmit();
        await MaternalExamRef.value?.onSubmit();
        await PresentingSignsRef.value?.onSubmit();
        openBackController();
      } catch (error) {
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_1, [
                unref(patient) && unref(patient).patientID ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  showWizard.value ? (openBlock(), createBlock(_sfc_main$n, {
                    key: 0,
                    ref: "wizard",
                    ...
                    default: withCtx(() => [
                      ...
                      withDirectives(createBaseVNode("div", null, [
                        createVNode(_sfc_main$1, {
                          ref_key: "ChestExaminationRef",
                          ref: ChestExaminationRef
                        }, null, 512)
                      ], 512), [
                        [vShow, getActiveComponent() == "ChestExamination"]
                      ])
                    ]),
                    _: 1
                  }, 8, ["doneButton", "custom-tabs", "beforeChange"])) : createCommentVNode("", true)
                ], 64)) : (openBlock(), createElementBlock("div", _hoisted_3, [
                  createVNode(unref(IonCard), { class: "error-card" }, {
                    default: withCtx(() => [
                      createVNode(unref(IonCardContent), { class: "error-content" }, {
                        default: withCtx(() => [
                          _cache[3] || (_cache[3] = createBaseVNode("div", { class: "message-section" }, [
                            createBaseVNode("h2", null, "Patient/Client not selected"),
                            createBaseVNode("p", null, "Please register or search for a patient in the search bar to proceed.")
                          ], -1)),
                          createBaseVNode("div", _hoisted_4, [
                            createVNode(DynamicButton, {
                              name: "Go to Home Page",
                              onClick: _cache[2] || (_cache[2] = ($event) => openBackController()),
                              fill: "solid",
                              color: "primary"
                            })
                          ])
...
const PhysicalExamination = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58f7d7ce"]]);
