import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, bp as V, c_ as DataTable, bM as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aL as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aI as IonAccordionGroup, aH as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bQ as IonChip, aA as IonCol, af as IonRow, aD as IonToolbar, aE as IonTitle, bv as IonPage, cv as IonMenuButton, I as IonHeader, aG as IonContent, a_ as medkitOutline, Q as normalizeClass, H as createCommentVNode, bL as IonCard, a6 as IonInput, ax as searchOutline, ae as IonCheckbox, bd as IonCardContent, ba as IonCardTitle, N as IonButton, bb as IonCardHeader, b6 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dc as timeOutline, eA as moon, eB as partlySunny, eC as sunny, cj as medkit, au as script, al as IonPopover, aF as IonMenu, bf as IonFooter, bc as checkmark, ca as clipboardOutline, ad as IonTextarea, di as IonSegmentButton, dh as IonSegment, bZ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-DOib3KBh.js';
import { s as storeToRefs, m as mapState } from './pinia-X75jUKgt.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, ar as ConceptService, b9 as checkIfSamePatient, ba as setCurrentPatientID, bb as getAntiHypertensivesMedication, bc as getDiabetesDrugs, bd as clearMedicationData, B as BasicInputField, be as useNCDMedicationsStore, bf as useOtherNCDMedicationStore, bg as formMedicationObject, x as toastDanger, b2 as useTreatmentPlanStore, a0 as DrugService, d as _sfc_main$f, bh as addOtherMedicationToNCDMedicationList, T as Toolbar, bi as useVitalsStore, bj as useInvestigationStore, bk as useDiagnosisStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, a2 as getFieldValue, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b4 as confirmModal, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-C1gVG2MQ.js';
import { D as DemographicBar } from './DemographicBar-DeiuinFW.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-eQatVhKs.js';
import { u as useComplicationsStore } from './ComplicationsStore-0u30bzOS.js';
import { B as BasicForm } from './BasicForm-DDQPO59z.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-DUUf7sk9.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-BLGBO4zd.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-CxYE-LXI.js';
import { P as PreviousAllergies } from './PreviousAllergies-BiBN-YUG.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-DfW4Mi6d.js';
import { V as Vitals } from './Vitals-B2pHnYoJ.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-0fJ5qylF.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-D1ZPfWuA.js';
import { l as lodashExports } from './lodash-DGAubbbX.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-BEkjKS6m.js';
import { u as usePatientProfile } from './usePatientProfile-oAUy-6lO.js';
