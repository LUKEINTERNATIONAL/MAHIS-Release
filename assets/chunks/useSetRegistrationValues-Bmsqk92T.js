import { n as icons, y as StandardValidations, z as StandardForm, C as useExposeFromStandardForm, H as HisDate, _ as _export_sfc, S as Service, g as getPouchDBRecords, ab as PatientDemographicsExchangeService, o as createModal, P as PatientService, u as useDemographicsStore, Q as useWorkerStore, K as ObservationService, b as EncounterTypeId, x as toastDanger, J as savePatientRecord, G as toastSuccess, k as alertConfirmation, aN as PrintoutService, ad as GlobalPropertyService } from '../index-Bn2sysQf.js';
import { u as useLocation } from './useLocation-DnR_Hwqr.js';
import { f as ref, c as computed, s as defineComponent, y as openBlock, O as createBlock, F as unref, N as IonButton, L as IonIcon, aq as IonItem, ap as IonList, aB as IonCol, dw as IonImg, af as IonRow, e4 as IonAvatar, a7 as IonLabel, K as modalController, x as resolveComponent, z as createElementBlock, A as createVNode, C as createBaseVNode, H as createCommentVNode, B as withCtx, D as toDisplayString, J as Fragment, S as renderList, a5 as createTextVNode, p as dayjs, a3 as onMounted, a4 as onUnmounted } from './vendor-8vOj_QAN.js';
import { g as getOfflineVaccineSchedule } from './vaccines_service-COqvbA4u.js';
...
class RegistrationService extends Service {
  ...
  async saveRegistrationData(data, isRelativeRegistration = false) {
    ...
    const patientData = await savePatientRecord(patientRecord, isRelativeRegistration);
    if (patientData) {
  ...
  async printBarcode() {
    ...
    if (response) await new PrintoutService().printData("barcode");
  }
    ...
    return [
      ...
      },
      {
        ...
        options: [
          ...
          { id: 6, name: "Hired Car" },
          { id: 7, name: "Private transport" },
          { id: 8, name: "Police vehicle" },
          { id: 9, name: "Company vehicle" },
          { id: 10, name: "Bicycle" },
          { id: 11, name: "Helicopter" }
        ]
      }
    ];
  });
...
function useRegistrationPagination() {
  ...
  const totalComponents = Service.getProgramID() === 30 ? 5 : 4;
...
function useSetRegistrationValues() {
  ...
  const setFormValues = (allFormRef) => {
    const { personalInformationRef, socialHistoryRef, guardianInformationRef } = allFormRef.value;
    ...
    setPatientLocation(allFormRef);
    setGuardianInformation(guardianInformationRef);
  };
  const setPatientLocation = (locationRef) => {
    const personInformation = patient?.value?.personInformation;
    const { countryRef, currentLocationRef, homeLocationRef } = locationRef.value;
...
export { RegistrationService as R, _sfc_main$4 as _, useSetRegistrationValues as a, _sfc_main as b, _sfc_main$2 as c, _sfc_main$5 as d, _sfc_main$7 as e, _sfc_main$6 as f, _sfc_main$1 as g, createSameAsCurrentHandler as h, useRegistrationPagination as u };
