import { q as defineComponent, r as ref, v as resolveComponent, N as createBlock, y as openBlock, B as withCtx, A as createBaseVNode, z as createVNode, a4 as createTextVNode, C as toDisplayString, E as unref, s as documentTextOutline, J as modalController, d as computed, aI as useRouter, c8 as clipboardOutline, ey as bodyOutline, cb as flask, ch as medkit, eO as chatbubbles, a1 as onMounted, aD as IonContent, bW as chevronBackOutline, dq as calendar, eP as paperPlaneOutline, eQ as checkmarkDoneOutline, x as createElementBlock, H as Fragment, Q as renderList, bs as IonPage } from './vendor-sqYZJ6fK.js';
import { S as Service, u as useDemographicsStore, F as DynamicButton, q as StandardModal, K as ObservationService, H as HisDate, b as EncounterTypeId, G as toastSuccess, J as savePatientRecord, _ as _export_sfc, y as StandardValidations, n as icons, z as useExposeFromStandardForm, C as StandardForm, t as toastWarning, T as Toolbar, o as createModal } from '../index-_N7CIn5p.js';
import { D as DemographicBar } from './DemographicBar-VTj-fkwj.js';
import { D as DashboardCards } from './DashboardCards-Bet3yRSj.js';
import { s as storeToRefs } from './pinia-B_NbVBpS.js';
import { u as useLocation } from './useLocation-hzYMMN7J.js';
