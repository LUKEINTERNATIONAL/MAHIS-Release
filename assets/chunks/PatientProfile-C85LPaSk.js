import { v as defineComponent, w as watch, P as createBlock, A as openBlock, G as unref, bL as IonCard, D as withCtx, B as createVNode, b9 as IonCardTitle, z as createElementBlock, f as ref, d_ as IonSkeletonText, a6 as createTextVNode, M as IonIcon, aR as medicalOutline, K as Fragment, ba as IonCardHeader, ao as IonList, S as renderList, ap as IonItem, a8 as IonLabel, b7 as calendarOutline, C as createBaseVNode, E as toDisplayString, cK as idCardOutline, c8 as folderOutline, c5 as checkmarkCircleOutline, bc as IonCardContent, q as dayjs, a3 as onMounted, az as IonGrid, ag as IonRow, aA as IonCol, a5 as normalizeClass, d$ as checkboxOutline, J as createCommentVNode, ca as clipboardOutline, e0 as statsChartOutline, L as modalController, aK as useRouter, cv as useRoute, y as resolveComponent, aF as IonContent, cR as defineAsyncComponent, c as computed, e1 as ellipsisVerticalSharp, d4 as person, aH as IonAccordionGroup, aG as IonAccordion, Q as normalizeStyle, H as closeCircleOutline, di as IonSegment, dj as IonSegmentButton, a_ as personOutline, x as documentTextOutline, b0 as printOutline, d5 as add, bu as IonPage, cJ as __vitePreload } from './vendor-CJ5LqAxe.js';
import { s as storeToRefs } from './pinia-BmV_6_tV.js';
import { ai as ProgramService, _ as _export_sfc, P as PatientService, aj as PatientProgramService, ab as GlobalPropertyService, q as StandardModal, o as createModal, ak as _sfc_main$3, al as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, am as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, an as iconBMI, ao as openVisit, v as usePatientList, r as closeVisit, ap as SetProgramService, aq as ConceptService, ar as getActiveVisit } from '../index-DihysMBN.js';
...
import { i as isTaskPermitted } from './tasks-16E-uooQ.js';
import { A as ANCRedirection } from './anc_service-DUDVnThQ.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-D_xVuDQ5.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-CNPTHDfh.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-ByIQzGbR.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-FKTOQohG.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CRXEwCNN.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-D4ynD9Q4.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DLRTxdBw.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-Cq1A2Z-A.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-9R9hhwlP.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-Dy0KPZL5.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-C8W3H7rJ.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-DihysMBN.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DoWRXr2K.js'),true              ?[]:void 0));
    const PNCEnrollmentModal = defineAsyncComponent(() => __vitePreload(() => import('./PNCEnrollmentModal-DSBw4YXs.js'),true              ?[]:void 0));
