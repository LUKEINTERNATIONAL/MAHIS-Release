import { cF as __vitePreload, q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, bq as IonPage, H as IonContent, aF as useRouter, eT as provide, v as resolveComponent, O as createBlock, A as withCtx } from './vendor-Cy_N32Zh.js';
import { s as storeToRefs } from './pinia-Bqc2Rgok.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-CZxb0S4T.js';
import { N as NeonatalStepper } from './NeonatalStepper-De2iEpYL.js';
import { n as neonatalSystemicExaminationFormKey, u as useSystemicExaminationStore } from './useSystemicExaminationStore-CHRGmGkn.js';
import { N as NeonatalService } from './neonatal_service-BeQX_Mek.js';
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-B05_BPEd.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
