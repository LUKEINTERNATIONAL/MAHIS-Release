import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bL as IonCard, B as withCtx, A as createVNode, ba as IonCardTitle, d_ as IonSkeletonText, z as createElementBlock, L as IonIcon, aS as medicalOutline, a5 as createTextVNode, J as Fragment, bb as IonCardHeader, ap as IonList, S as renderList, aq as IonItem, a7 as IonLabel, b8 as calendarOutline, C as createBaseVNode, D as toDisplayString, cJ as idCardOutline, c8 as folderOutline, c5 as checkmarkCircleOutline, bd as IonCardContent, f as ref, p as dayjs, a3 as onMounted, aB as IonGrid, af as IonRow, aA as IonCol, Q as normalizeClass, d$ as checkboxOutline, H as createCommentVNode, ca as clipboardOutline, e0 as statsChartOutline, K as modalController, aL as useRouter, bM as useRoute, aG as IonContent, e1 as ellipsisVerticalSharp, d3 as person, aI as IonAccordionGroup, aH as IonAccordion, P as normalizeStyle, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, al as IonPopover, a$ as personOutline, v as documentTextOutline, b1 as printOutline, d4 as add, bv as IonPage, cS as defineAsyncComponent, cI as __vitePreload, c as computed } from './vendor-BRtiyW5a.js';
import { s as storeToRefs } from './pinia-BGmPTYET.js';
import { aj as ProgramService, _ as _export_sfc, P as PatientService, ak as PatientProgramService, ab as GlobalPropertyService, r as StandardModal, o as createModal, al as _sfc_main$3, am as ArtTasks, k as alertConfirmation, K as ObservationService, b as EncounterTypeId, J as savePatientRecord, G as toastSuccess, an as router, t as toastWarning, u as useDemographicsStore, a as useProgramStore, h as useWindowSize, H as HisDate, T as Toolbar, W as ProgramId, S as Service, F as DynamicButton, ao as iconBMI, ap as openVisit, q as usePatientList, v as closeVisit, aq as SetProgramService, ar as ConceptService, as as getActiveVisit } from '../index-BI42oy7j.js';
...
import { i as isTaskPermitted } from './tasks-7MiiXQMo.js';
import { A as ANCRedirection } from './anc_service-CDh3i6Qd.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-BHbUwgOA.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Ch8KNo1Y.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BEegMnl1.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-CyDWL3UE.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-Bcvc1nNp.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-C-73nFyF.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-D7e6djJ3.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-BhSVmiTI.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-B0OBHkRv.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-CD6LPhqm.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-CRP3nUCs.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-BI42oy7j.js').then(n => n.cS),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DNZFO7iF.js'),true              ?[]:void 0));
