import { y as StandardValidations, n as icons, z as StandardForm, K as ObservationService, H as HisDate, aq as ConceptService, _ as _export_sfc } from '../index-C5Wp79uq.js';
import { c as computed, v as defineComponent, a3 as onMounted, n as nextTick, z as openBlock, A as createElementBlock, D as createBaseVNode, B as createVNode, G as unref, f as ref } from './vendor-Cbv9TWZo.js';
...
function useLabourQuickCheckForm() {
  ...
  const reasonForComingOptions = [
    ...
    { label: "Delivered on the way to the facility", value: "Delivered on the way to the facility" },
    ...
    { label: "Other medical/obstetric conditions (specify)", value: "Other medical/obstetric conditions (specify)" }
  ];
