import { v as defineComponent, a3 as onMounted, z as openBlock, A as createElementBlock, D as createBaseVNode, B as createVNode, C as withCtx, a6 as createTextVNode, E as toDisplayString, G as unref, a8 as IonLabel, fm as I1, bB as createStaticVNode, O as IonButton, K as Fragment, f as ref, L as modalController, fn as IonAlert, y as resolveComponent, P as createBlock, ao as IonList, ap as IonItem, aj as IonRadio, ai as IonRadioGroup, S as renderList, ag as IonRow, az as IonCol, a7 as IonInput, aC as IonToolbar, aD as IonTitle, aE as IonMenu, I as IonHeader, aF as IonContent, T as withDirectives, U as vShow, J as createCommentVNode, bG as IonModal, aH as IonAccordionGroup, aG as IonAccordion, b9 as IonCardTitle, cF as IonCardSubtitle, ba as IonCardHeader, bc as IonCardContent, bL as IonCard, bu as IonPage, cw as IonMenuButton, be as IonFooter, M as IonIcon, ac as checkmarkOutline, H as closeCircleOutline, fo as folderOpenOutline, c as computed, at as script, dl as Navigation, dm as Pagination, dn as Slide, dp as Carousel, ca as clipboardOutline, d4 as person, e1 as ellipsisVerticalSharp, bb as checkmark, bY as chevronBackOutline, a5 as normalizeClass } from './vendor-B3kX1Pjg.js';
import { m as useAdministerVaccineStore, _ as _export_sfc, t as toastWarning, l as PreviousVitals, B as BasicInputField, a6 as useUserStore, S as Service, H as HisDate, u as useDemographicsStore, n as icons, o as createModal, G as toastSuccess, g as getPouchDBRecords, z as StandardForm, F as DynamicButton, K as ObservationService, cm as PatientRegistrationService, a7 as RelationsService, x as toastDanger, cL as PatientPrintoutService, P as PatientService, a3 as ToolbarSearch, T as Toolbar, bU as VitalsService, bH as DrugOrderService, aj as PatientProgramService, b3 as useOutcomeStore, b2 as useTreatmentPlanStore, b1 as useVitalsStore } from '../index-BDC92_36.js';
...
import { m as mapState, s as storeToRefs } from './pinia-DWumH6Ru.js';
import { S as Stepper } from './Stepper-C3MEeNaJ.js';
import { T as Treatment } from './treatment-DWYAMlU2.js';
import { l as lodashExports } from './lodash-etvHaEVn.js';
import { D as DrugPrescriptionService, a as DRUG_FREQUENCIES } from './drug_prescription_service-vycIIYoJ.js';
import WeightHeightChart from './WeightHeightChart-Ds5mwnyp.js';
import { w as weightAndHeight, O as OtherVitals } from './weightAndHeight-B613HgWP.js';
import { c as customDatePicker } from './customDatePicker-BVu6LA9T.js';
import { i as checkDrugName, s as saveVaccineAdministeredDrugs, j as voidVaccine, A as Appointment, n as nextAppointMent } from './vaccines_service-t9XhGRkC.js';
import { S as StockService } from './stock_service-BQByJm0w.js';
import { u as useRelationships, _ as _sfc_main$d } from './Registration-D4gvJJuW.js';
import { a as useSetRegistrationValues } from './useSetRegistrationValues-B8iwNyvq.js';
...
import { O as Outcome, _ as _sfc_main$e } from './usePatientProfile-z9BQb9gL.js';
