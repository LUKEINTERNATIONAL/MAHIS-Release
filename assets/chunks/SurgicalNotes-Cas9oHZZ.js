import { s as defineComponent, w as watch, y as openBlock, O as createBlock, F as unref, bN as IonCard, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, a5 as createTextVNode, H as createCommentVNode, N as IonButton, L as IonIcon, af as IonRow, bd as IonCardHeader, bc as IonCardTitle, bf as IonCardContent, f as ref, c as computed, aq as IonItem, ae as IonCheckbox, a7 as IonLabel, Q as normalizeClass, a6 as IonInput, r as reactive, a3 as onMounted, ap as IonList, T as withDirectives, U as vShow, cT as defineAsyncComponent, cJ as __vitePreload, aN as useRouter, bO as useRoute, aI as IonContent, b$ as chevronBackOutline, bx as IonPage, ab as checkmarkOutline } from './vendor-QOXikrLM.js';
import { s as storeToRefs } from './pinia-BRP2SQHv.js';
import { z as StandardForm, F as DynamicButton, C as useExposeFromStandardForm, n as icons, y as StandardValidations, _ as _export_sfc, b0 as List, u as useDemographicsStore, bk as useVitalsStore, bl as useInvestigationStore, bm as useDiagnosisStore, b4 as useTreatmentPlanStore, bg as useNCDMedicationsStore, e as useGeneralStore, b5 as useOutcomeStore, i as useEnrollementStore, ac as useConfigStore, f as useStatusStore, T as Toolbar, a4 as getFieldValue, H as HisDate, a$ as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, N as ConceptService, G as toastSuccess, bp as useAllegyStore, a8 as useUserStore, S as Service } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { _ as _sfc_main$d, u as useFormWizard } from './useFormWizard-DB5Ppn00.js';
...
import { _ as _sfc_main$e, C as CirculationAssessment, D as DisabilityAssessment, E as ExposureAssessment } from './ExposureAssessment-DsakFo85.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const PrescribedMedicationList = defineAsyncComponent(() => __vitePreload(() => import('./Medications-jdBq_3nb.js'),true              ?[]:void 0));
    const CONCEPTS = {
