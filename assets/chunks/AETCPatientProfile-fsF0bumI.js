import { s as defineComponent, aL as useRouter, bM as useRoute, a3 as onMounted, w as watch, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, F as unref, aG as IonContent, H as createCommentVNode, C as createBaseVNode, af as IonRow, aA as IonCol, bL as IonCard, bd as IonCardContent, L as IonIcon, e1 as ellipsisVerticalSharp, Q as normalizeClass, d3 as person, D as toDisplayString, a5 as createTextVNode, G as closeCircleOutline, dh as IonSegment, di as IonSegmentButton, a7 as IonLabel, z as createElementBlock, P as normalizeStyle, aq as IonItem, a$ as personOutline, v as documentTextOutline, cJ as idCardOutline, b1 as printOutline, J as Fragment, S as renderList, d4 as add, bv as IonPage, cS as defineAsyncComponent, cI as __vitePreload, f as ref, c as computed } from './vendor-CL83uZHJ.js';
import { s as storeToRefs } from './pinia-CtPjMI11.js';
import { A as ArtCard } from './PatientProfile-DzSL3nNX.js';
import { u as useDemographicsStore, a as useProgramStore, h as useWindowSize, aq as SetProgramService, P as PatientService, T as Toolbar, S as Service, F as DynamicButton, H as HisDate, ao as iconBMI, k as alertConfirmation, ap as openVisit, q as usePatientList, G as toastSuccess, v as closeVisit, cP as PatientOpdList, o as createModal, K as ObservationService, _ as _export_sfc } from '../index-sOpwMpcu.js';
...
import { C as CPR } from './CPR-DoEwTBvl.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const AllergiesContraindication = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-D0tMRft9.js'),true              ?[]:void 0));
