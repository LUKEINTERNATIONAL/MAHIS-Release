import { c as computed, s as defineComponent, x as resolveComponent, y as openBlock, z as createElementBlock, A as createVNode, B as withCtx, F as unref, w as watch, f as ref, aM as useRouter, O as createBlock, aH as IonContent, C as createBaseVNode, b_ as chevronBackOutline, J as Fragment, S as renderList, T as withDirectives, c4 as resolveDynamicComponent, U as vShow, bw as IonPage } from './vendor-NYNX75Tj.js';
import { _ as _sfc_main$3, u as useFormWizard } from './useFormWizard-CPfmUxeA.js';
import { n as icons, y as StandardValidations, H as HisDate, z as StandardForm, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, J as savePatientRecord, T as Toolbar, F as DynamicButton } from '../index-DRy1cgfg.js';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const onSubmit = async () => {
      ...
      const data = formRef.value?.getFormValues();
      if (Object.keys(data || {}).length === 0) return;
      const patientRecord = await ObservationService.buildAddObsToEncounterPatient(data, EncounterTypeId.PNC_VISIT);
      if (!patientRecord) return;
      syncImmunizationsToEirRecord(patientRecord, data);
      if (await savePatientRecord(patientRecord)) toastSuccess("Postnatal visit for baby data saved successfully");
      formRef.value?.resetForm();
    };
    __expose({
      onSubmit
