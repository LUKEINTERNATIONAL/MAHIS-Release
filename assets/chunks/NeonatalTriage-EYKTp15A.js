...
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, cm as PatientRegistrationService, t as toastWarning, H as HisDate, K as ObservationService, ci as saveEncounterData, b as EncounterTypeId, G as toastSuccess, k as alertConfirmation } from '../index-Be0fRy6M.js';
import { D as DemographicBar } from './DemographicBar-CoJpuQR1.js';
import { l as neonatalTriageFormKey, u as useNeonatalTriageStore, m as neonatalTriageSections, N as NeonatalStepper, o as defaultNeonatalTriageForm, t as triageConceptMapping } from './NeonatalStepper-BRKo3iim.js';
...
const SummarySection = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-e1755e89"]]);
...
const VitalSectionFour = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-7ac50723"]]);
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const formRef = ref(null);
    const sectionConfig = neonatalTriageSections[23] || neonatalTriageSections[24];
    const formData = sectionConfig?.formData || [];
    const conditionalRules = sectionConfig?.conditionalRules || [];
    const triageForm = inject(neonatalTriageFormKey);
    const syncFormValues = (values) => {
...
const BabyRecoveredStillSevereRespiratory = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-d853bdf2"]]);
...
const NeonatalTriage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-f5ef0250"]]);
