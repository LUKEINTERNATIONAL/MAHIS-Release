import { s as defineComponent, a3 as onMounted, x as resolveComponent, y as openBlock, O as createBlock, B as withCtx, A as createVNode, C as createBaseVNode, z as createElementBlock, S as renderList, J as Fragment, F as unref, H as createCommentVNode, f as ref, aL as useRouter, bM as useRoute, w as watch, aG as IonContent, bZ as chevronBackOutline, T as withDirectives, U as vShow, bv as IonPage, c as computed, ab as checkmarkOutline } from './vendor-BC7lQdfR.js';
import { s as storeToRefs } from './pinia-DLl5biJx.js';
import { n as icons, _ as _export_sfc, bi as useVitalsStore, u as useDemographicsStore, bj as useInvestigationStore, bk as useDiagnosisStore, b2 as useTreatmentPlanStore, be as useNCDMedicationsStore, e as useGeneralStore, b3 as useOutcomeStore, i as useEnrollementStore, aa as useConfigStore, f as useStatusStore, T as Toolbar, F as DynamicButton, a2 as getFieldValue, H as HisDate, bl as getOfflineSavedUnsavedData, bm as MedicationSelectionHasValues, J as savePatientRecord, bn as resetNCDPatientData, t as toastWarning, ar as ConceptService, G as toastSuccess, bo as useAllegyStore, a6 as useUserStore, S as Service } from '../index-DcmYecLG.js';
import { D as DemographicBar } from './DemographicBar-TcmkDGe-.js';
import { B as BedsidePlan, _ as _sfc_main$3 } from './LabOrderPlan.vue_vue_type_script_setup_true_lang-C6PtLOlN.js';
