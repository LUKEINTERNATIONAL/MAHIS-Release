import { cG as __vitePreload, q as defineComponent, r as ref, h as inject, w as watch, x as createElementBlock, y as openBlock, z as createVNode, E as unref, br as IonPage, H as IonContent, aH as useRouter, eT as provide, v as resolveComponent, O as createBlock, A as withCtx } from './vendor-BPW-J91F.js';
import { s as storeToRefs } from './pinia-D-q2_lrU.js';
import { C as StandardForm, _ as _export_sfc, T as Toolbar, u as useDemographicsStore, t as toastWarning, G as toastSuccess, x as toastDanger } from '../index-D7kYL7Nj.js';
import { N as NeonatalStepper } from './NeonatalStepper-tbKvYTpQ.js';
import { n as neonatalSystemicExaminationFormKey, u as useSystemicExaminationStore } from './useSystemicExaminationStore-BJ-vZFBj.js';
import { N as NeonatalService } from './neonatal_service-WKoObU21.js';
...
const neonatalSystemicExaminationSections = [
  {
    ...
    subtitle: "",
    description: "The app will aid you to do a complete head to toe examination",
    formData: [
      {
        componentType: "Alert",
        name: "systemic_examination_overview_alert",
        ...warningAlertStyle,
        message: "The app will aid you to do a complete head to toe examination."
      },
      {
        componentType: "infographicField",
        name: "systemic_examination_overview",
        header: "Systemic Examination",
        displayMode: "cards",
        showStepNumber: true,
        cardVariant: "summary",
        infographicData: {
          ...
          sections: [
            {
              ...
              content: "Neurological Systemic Examination",
              bullets: [
                "Tone Assessment",
                "Suck Reflex",
                "Grasp Reflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        header: "Select ALL that are applicable",
        subtitle: "",
        titleStyle: "tonal",
        type: "multiple",
        allowDeselect: true,
  ...
  },
  {
    ...
    formData: [
      {
        componentType: "Alert",
        name: "chest_summary_info",
        ...warningAlertStyle,
        message: "Review the following chest examination findings. You can go back to edit if needed."
      },
      {
        componentType: "summaryField",
        name: "chestSummaryComputed",
        title: "Chest examination summary",
  ...
  {
    title: "Abdomen Findings",
    subtitle: "Evaluate distension, perfusion, and organomegaly",
    formData: [
      {
        componentType: "Alert",
  ...
  {
    title: "Abdomen Summary",
    subtitle: "Summary of abdominal examination findings",
    description: "Review the abdominal examination findings before proceeding",
    formData: [
      {
        componentType: "Alert",
    ...
    formData: [
      {
        ...
        ...warningAlertStyle,
        message: "Weigh the baby completely naked. What will you do then:\n1. Check the tone as below.\n2. Check the spine for spina bifida.\n3. Check the face for dysmorphism."
      },
      {
        componentType: "infographicField",
        name: "tone_assessment_infographic",
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalToneAssessment"))
      },
      {
        componentType: "listSelectionField",
        name: "toneAssessment",
  ...
  },
  {
    title: "Neurological Systemic Examination",
    subtitle: "Suck Reflex",
    description: "Test the baby's suck reflex",
    formData: [
      {
        componentType: "Alert",
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalSuckReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "suckReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalGraspReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "graspReflex",
  ...
  },
  {
    ...
    formData: [
      ...
      },
      {
        ...
        displayMode: "visual",
        subtitle: "Neurological Systemic Examination",
        infographicData: () => __vitePreload(() => import('./infographics-DfFaYKH0.js'),true              ?[]:void 0,import.meta.url).then((m) => m.getInfographicByKey("NeurologicalMoreReflex"))
      },
      {
        componentType: "listSelectionField",
        name: "MoreReflex",
  ...
  },
  {
    ...
    subtitle: "Summary of musculoskeletal & Thompson findings",
    description: "Review your musculoskeletal findings and Thompson score",
    formData: [
      {
        componentType: "Alert",
        name: "musculoskeletal_summary_notice",
        ...warningAlertStyle,
        message: "Review the following musculoskeletal and Thompson assessments. Return to edit if needed."
      },
      {
        componentType: "summaryField",
