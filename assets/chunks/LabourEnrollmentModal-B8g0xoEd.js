import { q as defineComponent, L as IonIcon, H as IonContent, N as IonButton, ba as IonButtons, aB as IonTitle, aA as IonToolbar, I as IonHeader, bD as IonModal, bb as IonFooter, a7 as IonLabel, af as IonRow, ay as IonCol, F as closeCircleOutline, K as modalController, v as resolveComponent, O as createBlock, y as openBlock, A as withCtx, z as createVNode, a5 as createTextVNode, B as createBaseVNode, C as toDisplayString } from './vendor-BPW-J91F.js';
import { F as DynamicButton, _ as _export_sfc } from '../index-NXBj2cdM.js';
import { f as _sfc_main$1, e as _sfc_main$2, _ as _sfc_main$4, c as _sfc_main$5 } from './useSetRegistrationValues-Hmisc3NI.js';
import { _ as _sfc_main$3 } from './Registration-DvQFImw1.js';
import { m as mapState } from './pinia-D-q2_lrU.js';
import { u as useANCEnrollmentStore } from './PatientProfile-ZzaeojuE.js';
        ...
        default: withCtx(() => [
          createVNode(_component_ion_title, { class: "modalTitle" }, {
            default: withCtx(() => [..._cache[1] || (_cache[1] = [
              createTextVNode("Enroll client in Labour and delivery program", -1)
            ])]),
            _: 1
          })
        ]),
...
const LabourEnrollmentModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-7278453b"]]);

export { LabourEnrollmentModal as default };
