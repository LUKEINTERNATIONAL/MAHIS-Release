import { s as defineComponent, a3 as onMounted, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, f as ref, c as computed, K as modalController, br as V, c$ as DataTable, bO as useRoute, w as watch, n as nextTick, z as createElementBlock, J as Fragment, S as renderList, D as toDisplayString, F as unref, aN as useRouter, x as resolveComponent, aq as IonItem, ap as IonList, aK as IonAccordionGroup, aJ as IonAccordion, a7 as IonLabel, a5 as createTextVNode, L as IonIcon, bS as IonChip, aB as IonCol, af as IonRow, aE as IonToolbar, aF as IonTitle, bx as IonPage, cw as IonMenuButton, I as IonHeader, aI as IonContent, b0 as medkitOutline, Q as normalizeClass, H as createCommentVNode, bN as IonCard, a6 as IonInput, aw as searchOutline, ae as IonCheckbox, bf as IonCardContent, bc as IonCardTitle, N as IonButton, bd as IonCardHeader, b8 as cubeOutline, G as closeCircleOutline, R as alertCircleOutline, dd as timeOutline, eC as moon, eD as partlySunny, eE as sunny, ck as medkit, au as script, al as IonPopover, aG as IonMenu, bh as IonFooter, be as checkmark, cb as clipboardOutline, ad as IonTextarea, dj as IonSegmentButton, di as IonSegment, b$ as chevronBackOutline, T as withDirectives, U as vShow, ab as checkmarkOutline } from './vendor-QOXikrLM.js';
import { s as storeToRefs, m as mapState } from './pinia-BRP2SQHv.js';
import { z as StandardForm, F as DynamicButton, r as StandardModal, K as ObservationService, b as EncounterTypeId, G as toastSuccess, y as StandardValidations, n as icons, _ as _export_sfc, u as useDemographicsStore, o as createModal, H as HisDate, N as ConceptService, bb as checkIfSamePatient, bc as setCurrentPatientID, bd as getAntiHypertensivesMedication, be as getDiabetesDrugs, bf as clearMedicationData, B as BasicInputField, bg as useNCDMedicationsStore, bh as useOtherNCDMedicationStore, bi as formMedicationObject, x as toastDanger, b4 as useTreatmentPlanStore, a2 as DrugService, d as _sfc_main$f, bj as addOtherMedicationToNCDMedicationList, T as Toolbar, bk as useVitalsStore, bl as useInvestigationStore, bm as useDiagnosisStore, e as useGeneralStore, b5 as useOutcomeStore, i as useEnrollementStore, ac as useConfigStore, f as useStatusStore, a4 as getFieldValue, a$ as getOfflineSavedUnsavedData, bn as MedicationSelectionHasValues, J as savePatientRecord, bo as resetNCDPatientData, t as toastWarning, k as alertConfirmation, b6 as confirmModal, bp as useAllegyStore, a8 as useUserStore, S as Service } from '../index-SKNIAGXC.js';
import { D as DemographicBar } from './DemographicBar-BwC0pNqP.js';
import { P as PatientDiagnosisService } from './patient_diagnosis_service-DaubbYIE.js';
import { u as useComplicationsStore } from './ComplicationsStore-BQZ5Uspj.js';
import { B as BasicForm } from './BasicForm-ClINxl6R.js';
import { I as Investigations, _ as _sfc_main$i, i as isQualifiedAHD } from './Investigations-DgnP1gsQ.js';
import { g as getNCDDiagnosis, P as PreviousTreatment, s as stageAllergies } from './treatment-D-DGkqNV.js';
import { D as DynamicList, N as NonPharmacologicalIntervention, A as Allergies, p as patientSessionManager, a as NextAppointment } from './ClientUtils-DXAAQRTI.js';
import { P as PreviousAllergies } from './PreviousAllergies-C47ogmVr.js';
import { _ as _sfc_main$h } from './RiskAssessment.vue_vue_type_script_setup_true_lang-Bx725nwO.js';
import { V as Vitals } from './Vitals-D_fuLJEd.js';
import { _ as _sfc_main$g, u as useFormWizard } from './useFormWizard-DB5Ppn00.js';
import { c as createNCDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-fbJDg5x6.js';
import { l as lodashExports } from './lodash-CVfF-l1v.js';
import { f as formatInputFiledData, a as formatGroupRadioButtonData } from './formatServerData-B6pnHK5P.js';
