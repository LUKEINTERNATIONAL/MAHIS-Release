import { c as computed, f as ref, s as defineComponent, y as openBlock, O as createBlock, B as withCtx, C as createBaseVNode, A as createVNode, F as unref, v as documentTextOutline, K as modalController, aL as useRouter, a3 as onMounted, aG as IonContent, bY as chevronBackOutline, dr as calendar, eY as paperPlaneOutline, eZ as checkmarkDoneOutline, z as createElementBlock, J as Fragment, S as renderList, bu as IonPage, c9 as clipboardOutline, eu as bodyOutline, cc as flask, ci as medkit, e_ as chatbubbles } from './vendor-ltMrzBmS.js';
import { y as StandardValidations, n as icons, z as StandardForm, F as DynamicButton, r as StandardModal, C as useExposeFromStandardForm, t as toastWarning, K as ObservationService, b as EncounterTypeId, G as toastSuccess, u as useDemographicsStore, T as Toolbar, o as createModal, _ as _export_sfc } from '../index-BztXY-eR.js';
import { D as DemographicBar } from './DemographicBar-DtId4lB1.js';
import { D as DashboardCards } from './DashboardCards-Yrbarqj9.js';
import { s as storeToRefs } from './pinia-CSbxcXdD.js';
import { N as NextAppointmentModal } from './NextAppointment-C_EapItC.js';
