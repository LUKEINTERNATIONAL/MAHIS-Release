import { _ as _export_sfc, u as useDemographicsStore, ab as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-D7kYL7Nj.js';
import { q as defineComponent, ar as script, x as createElementBlock, y as openBlock, G as createCommentVNode, B as createBaseVNode, z as createVNode, D as renderSlot, A as withCtx, a5 as createTextVNode, C as toDisplayString, E as unref, r as ref, w as watch, d as computed, O as createBlock, a4 as normalizeClass, cE as mergeProps, fg as draggable, c1 as resolveDynamicComponent, J as Fragment, R as renderList, bP as withKeys, a8 as withModifiers, aH as useRouter, H as IonContent, br as IonPage } from './vendor-BPW-J91F.js';
import { u as useNeonatalTriageStore, N as NeonatalStepper } from './NeonatalStepper-tbKvYTpQ.js';
import { d as defineStore, s as storeToRefs } from './pinia-D-q2_lrU.js';
import { I as IMAGES } from './images-DXWMAjRl.js';
import { u as useNeonatalVitalsStore } from './useNeonatalVitalsStore-DWUHsgRF.js';
import { u as useReviewOfSystemsStore } from './useReviewOfSystemsStore-C_MRpbzN.js';
import { u as useNeonatalExamStore } from './useNeonatalExamStore-DdAuZOJi.js';
import { u as useSystemicExaminationStore } from './useSystemicExaminationStore-BJ-vZFBj.js';
import { u as useSignsSymptomsStore } from './useSignsSymptomsStore-BEjSwASM.js';
