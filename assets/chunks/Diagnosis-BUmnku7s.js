import { u as useDemographicsStore, z as StandardForm, _ as _export_sfc, E as EncounterService, S as Service, a6 as useUserStore, G as toastSuccess, x as toastDanger, aY as AppEncounterService, T as Toolbar } from '../index-IMekKFel.js';
import { s as defineComponent, f as ref, w as watch, y as openBlock, z as createElementBlock, A as createVNode, C as createBaseVNode, D as toDisplayString, O as createBlock, B as withCtx, a4 as normalizeClass, F as unref, H as createCommentVNode, cF as mergeProps, fn as draggable, c as computed, a2 as onMounted, a5 as createTextVNode, J as Fragment, R as renderList, bQ as withKeys, a8 as withModifiers, aL as useRouter, aG as IonContent, bu as IonPage, f0 as provide } from './vendor-CjPalcaW.js';
import { p as useDiagnosisStore, q as useSuggestedDiagnosisStore, N as NeonatalStepper } from './NeonatalStepper-BXh7-gr0.js';
import { n as neonatalDiagnosisSections, S as SummarySection, a as neonatalDiagnosisFormKey } from './SummarySection-z8xLqCgv.js';
    ...
    const formData = ref(
      sectionConfig.formData.map((field) => {
        if (field.name === "workingDiagnosis") {
          return { ...field, initialValue: diagnosisStore.workingDiagnosis, pageSize: 20, onSearchChange: getDiagnosisOptions };
        }
        if (field.name === "differentialDiagnoses") {
          return { ...field, initialValue: diagnosisStore.differentialDiagnoses, pageSize: 20, onSearchChange: getDiagnosisOptions };
        }
        return field;
      })
    );
...
const DiagnosisSelection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ba4b6a63"]]);
...
const SelectedDiagnosisDisplay = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4d12549a"]]);
...
const SystemsSuggestions = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-46c31755"]]);
