...
import { s as defineComponent, aL as useRouter, a2 as onMounted, w as watch, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, aB as IonGrid, B as withCtx, af as IonRow, aA as IonCol, bK as IonCard, O as createBlock, bI as IonBadge, a5 as createTextVNode, D as toDisplayString, H as createCommentVNode, bd as IonCardContent, du as IonImg, by as IonText, a4 as normalizeClass, f as ref, c as computed, L as IonIcon, fd as reloadOutline, N as IonButton, J as Fragment, R as renderList, bQ as withKeys, a8 as withModifiers, d3 as add, x as resolveComponent, d2 as person, e0 as ellipsisVerticalSharp, dh as IonSegmentButton, a7 as IonLabel, dg as IonSegment, aI as IonAccordionGroup, aH as IonAccordion, aq as IonItem, ap as IonList, dE as IonToggle, al as IonPopover } from './vendor-CCA5uLDN.js';
import { l as lodashExports } from './lodash-Dm7Pej-A.js';
import { u as usePatientProfile } from './usePatientProfile-CLGCd1SE.js';
import { u as useDemographicsStore, b as EncounterTypeId, E as EncounterService, t as toastWarning, _ as _export_sfc, l as PreviousVitals, H as HisDate, o as createModal, b2 as useTreatmentPlanStore, r as StandardModal, bq as LabOrderService, S as Service, K as ObservationService, P as PatientService } from '../index-Bpb3_0mI.js';
...
import { _ as _sfc_main$5 } from './EnterLabResultsModal.vue_vue_type_script_setup_true_lang-P_9XDs5y.js';
import { L as LabViewResultsModal } from './LabViewResultsModal-DbatU5rl.js';

const _hoisted_1$4 = { class: "neonatal-home-component" };
...
const NeonatalCare = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e69cce31"]]);

const _hoisted_1$3 = { class: "weight-height-tab" };
...
const WeightHeightTab = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-718eba9d"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const openAddResultModal = async (order) => {
      ...
      if (!payload) return;
      try {
        await createModal(_sfc_main$5, { class: "large-medium-width-modal" }, true, { test_data: payload });
      } finally {
    ...
    const openResultsDialog = async (test) => {
      ...
      await createModal(LabViewResultsModal, { class: "large-medium-width-modal" }, true, { content: payload });
    };
...
const InvestigationTab = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4dd1fbae"]]);
