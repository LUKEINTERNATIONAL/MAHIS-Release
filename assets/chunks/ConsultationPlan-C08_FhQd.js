import { s as defineComponent, w as watch, a3 as onMounted, x as resolveComponent, y as openBlock, z as createElementBlock, C as createBaseVNode, A as createVNode, F as unref, R as alertCircleOutline, J as Fragment, S as renderList, Q as normalizeClass, b9 as calendarOutline, D as toDisplayString, a9 as chevronDownOutline, H as createCommentVNode, f as ref, c as computed, L as IonIcon, ev as bodyOutline, eO as scanOutline, bI as addOutline, bt as pulseOutline, eP as moveOutline, eQ as fitnessOutline, de as manOutline, eR as happyOutline, eS as earOutline, eT as nutritionOutline, dj as eyeOutline, ay as warningOutline, aT as medicalOutline, aW as femaleOutline, v as documentTextOutline, n as nextTick, O as createBlock, B as withCtx, a7 as IonLabel, a5 as createTextVNode, dF as IonToggle, aq as IonItem, af as IonRow, aI as IonAccordion, N as IonButton, a8 as withModifiers, aJ as IonAccordionGroup, ap as IonList, au as script, a6 as IonInput, bJ as saveOutline, G as closeCircleOutline, ca as clipboardOutline, ad as IonTextarea, aB as IonCol, aM as useRouter, bN as useRoute, M as IonSpinner, dH as IonLoading, aH as IonContent, b_ as chevronBackOutline, T as withDirectives, U as vShow, bw as IonPage, eM as lockClosedOutline, ab as checkmarkOutline } from './vendor-CXFd4I0A.js';
import { s as storeToRefs, m as mapState } from './pinia-eByuf_Uz.js';
import { _ as _sfc_main$a, u as useFormWizard } from './useFormWizard-DS74CJ9q.js';
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, N as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b4 as useTreatmentPlanStore, F as DynamicButton, a2 as DrugService, b6 as confirmModal, b5 as useOutcomeStore, aD as ListPicker, bl as useInvestigationStore, b_ as useOPDDiagnosisStore, e as useGeneralStore, b3 as useVitalsStore, bH as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, a$ as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bK as StagesService, q as usePatientList, v as closeVisit } from '../index-D3ME6BhP.js';
import { D as DemographicBar } from './DemographicBar-Dvo3jz4r.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-zgvA3XDL.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BNT0juCD.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-CIJaLwh6.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-BQbeYfey.js';
import { I as Investigations } from './Investigations-DOpAMfx5.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-CRuaxVVG.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-D5oiYEcR.js';
import { P as PreviousTreatment } from './treatment-4ROpvugY.js';
import { l as lodashExports } from './lodash-CbOIehv2.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-Zx8mtqMG.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-DRqjIS5h.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-C8ZFK1y8.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-BGtVuQGm.js';
...
const _hoisted_3$3 = { class: "allergy-accordion" };
const _hoisted_4$3 = ["onClick"];
const _hoisted_5$3 = { class: "acc-left" };
const _hoisted_6$3 = { class: "acc-title" };
const _hoisted_7$3 = { class: "acc-count" };
const _hoisted_8$3 = {
  key: 0,
  class: "accordion-body"
};
const _hoisted_9$3 = { class: "item-label" };
const _hoisted_10$3 = { class: "item-value" };
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      ...
      return hasAllergies.value ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_5$3, [
                  ...
                  createBaseVNode("span", _hoisted_6$3, toDisplayString(formatDateHeader(date)), 1),
                  createBaseVNode("span", _hoisted_7$3, "(" + toDisplayString(group.length) + ")", 1)
                ]),
                createVNode(_component_ion_icon, {
              ...
              expandedGroups.value[date] ? (openBlock(), createElementBlock("div", _hoisted_8$3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(group, (allergy, idx) => {
                  return openBlock(), createElementBlock("div", {
                    class: "allergy-item",
                    key: idx
                  }, [
                    createBaseVNode("span", _hoisted_9$3, toDisplayString(allergy.name) + ":", 1),
                    createBaseVNode("span", _hoisted_10$3, toDisplayString(allergy.displayValue), 1)
                  ]);
                }), 128))
...
const AllergiesListing = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-32be6c1b"]]);
...
const _sfc_main$5 = defineComponent({
  ...
  computed: {
    ...
    hasAnyData() {
      return this.hasLevelOfConsciousness || this.hasPresentingComplaints || this.hasPregnancyData || this.hasPastMedicalHistory || this.hasAllergies || this.hasPhysicalExam;
    }
  },
  methods: {
    async updateData() {
      ...
      try {
        await Promise.all([
          this.loadPresentingComplaints(),
          this.loadPastMedicalHistory(),
          this.loadLevelOfConsciousness(),
          this.loadPregnancyStatus(),
          this.loadPhysicalExam(),
          this.loadAllergies()
        ]);
      } catch (error) {
    ...
    async loadPresentingComplaints() {
      try {
        ...
        for (const complaint of parentComplaints) {
          ...
          let complaintName = await ConceptService.getConceptName(complaint.value_coded);
          if (typeof duration === "string" && duration.includes("|")) {
            const [specifiedComplaint, ...durationParts] = duration.split("|");
            const cleanedComplaint = specifiedComplaint?.trim();
            const cleanedDuration = durationParts.join("|").trim();
            if (cleanedComplaint) {
              complaintName = cleanedComplaint;
            }
            if (cleanedDuration) {
...
const _hoisted_4$2 = {
  key: 2,
  class: "visit-sections"
};
const _hoisted_5$2 = {
  key: 0,
  class: "visit-section"
};
const _hoisted_6$2 = { class: "section-header" };
const _hoisted_7$2 = { class: "section-content" };
const _hoisted_8$2 = {
  key: 0,
  class: "info-item"
};
...
const _hoisted_13$2 = { class: "info-value" };
const _hoisted_14$1 = {
  key: 3,
  class: "info-item"
};
const _hoisted_15$1 = { class: "info-value highlight" };
const _hoisted_16$1 = {
  key: 1,
  class: "visit-section"
};
const _hoisted_17$1 = { class: "section-header" };
const _hoisted_18$1 = { class: "complaints-container" };
const _hoisted_19$1 = { class: "complaint-name" };
const _hoisted_20$1 = { class: "complaint-duration" };
const _hoisted_21$1 = {
  key: 2,
  class: "visit-section"
};
const _hoisted_22$1 = { class: "section-header" };
const _hoisted_23$1 = { class: "section-content" };
const _hoisted_24$1 = {
  key: 0,
  class: "info-item"
};
...
const _hoisted_27 = { class: "info-value highlight" };
const _hoisted_28 = {
  key: 3,
  class: "visit-section"
};
const _hoisted_29 = { class: "section-header" };
const _hoisted_30 = { class: "tags-container" };
const _hoisted_31 = {
  key: 4,
  class: "visit-section"
};
const _hoisted_32 = { class: "section-header" };
const _hoisted_33 = { class: "tags-container" };
const _hoisted_34 = {
  key: 5,
  class: "visit-section"
};
const _hoisted_35 = { class: "section-header" };
const _hoisted_36 = { class: "exam-section" };
const _hoisted_37 = {
  key: 0,
  class: "exam-category"
};
const _hoisted_38 = { class: "exam-category-header" };
const _hoisted_39 = { class: "exam-items" };
const _hoisted_40 = {
  key: 1,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$4, [
    _cache[14] || (_cache[14] = createBaseVNode("div", { class: "visit-header" }, [
      createBaseVNode("h5", null, "Patient's Clinical Assessment Summary")
    ], -1)),
    _ctx.isLoading ? (openBlock(), createElementBlock("div", _hoisted_2$4, [..._cache[0] || (_cache[0] = [
      createBaseVNode("div", { class: "loader-wrapper" }, [
        createBaseVNode("div", { class: "spinner" }),
        createBaseVNode("p", { class: "loading-text" }, "Loading clinical assessment...")
      ], -1)
    ])])) : !_ctx.hasAnyData ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
      createVNode(_component_ion_icon, {
        icon: _ctx.documentTextOutline,
        class: "empty-icon"
      }, null, 8, ["icon"]),
      _cache[1] || (_cache[1] = createBaseVNode("p", { class: "empty-text" }, "No clinical assessment data available", -1))
    ])) : (openBlock(), createElementBlock("div", _hoisted_4$2, [
      _ctx.hasLevelOfConsciousness ? (openBlock(), createElementBlock("div", _hoisted_5$2, [
        createBaseVNode("div", _hoisted_6$2, [
          createVNode(_component_ion_icon, {
            icon: _ctx.alertCircleOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[2] || (_cache[2] = createBaseVNode("h3", null, "Level of Consciousness", -1))
        ]),
        createBaseVNode("div", _hoisted_7$2, [
          _ctx.levelOfConsciousness.eyeResponse ? (openBlock(), createElementBlock("div", _hoisted_8$2, [
            _cache[3] || (_cache[3] = createBaseVNode("span", { class: "info-label" }, "Eye Response:", -1)),
            createBaseVNode("span", _hoisted_9$2, toDisplayString(_ctx.levelOfConsciousness.eyeResponse), 1)
          ])) : createCommentVNode("", true),
          _ctx.levelOfConsciousness.verbalResponse ? (openBlock(), createElementBlock("div", _hoisted_10$2, [
            _cache[4] || (_cache[4] = createBaseVNode("span", { class: "info-label" }, "Verbal Response:", -1)),
            createBaseVNode("span", _hoisted_11$2, toDisplayString(_ctx.levelOfConsciousness.verbalResponse), 1)
          ])) : createCommentVNode("", true),
          _ctx.levelOfConsciousness.motorResponse ? (openBlock(), createElementBlock("div", _hoisted_12$2, [
            _cache[5] || (_cache[5] = createBaseVNode("span", { class: "info-label" }, "Motor Response:", -1)),
            createBaseVNode("span", _hoisted_13$2, toDisplayString(_ctx.levelOfConsciousness.motorResponse), 1)
          ])) : createCommentVNode("", true),
          _ctx.gcsScore ? (openBlock(), createElementBlock("div", _hoisted_14$1, [
            _cache[6] || (_cache[6] = createBaseVNode("span", { class: "info-label" }, "Score:", -1)),
            createBaseVNode("span", _hoisted_15$1, toDisplayString(_ctx.gcsScore), 1)
          ])) : createCommentVNode("", true)
        ])
      ])) : createCommentVNode("", true),
      _ctx.hasPresentingComplaints ? (openBlock(), createElementBlock("div", _hoisted_16$1, [
        createBaseVNode("div", _hoisted_17$1, [
          createVNode(_component_ion_icon, {
            icon: _ctx.documentTextOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[7] || (_cache[7] = createBaseVNode("h3", null, "Presenting Complaints", -1))
        ]),
        createBaseVNode("div", _hoisted_18$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.presentingComplaintsWithDuration, (complaint, index) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_19$1, toDisplayString(complaint.name), 1),
              createBaseVNode("div", _hoisted_20$1, toDisplayString(complaint.duration), 1)
            ]);
          }), 128))
        ])
      ])) : createCommentVNode("", true),
      _ctx.hasPregnancyData ? (openBlock(), createElementBlock("div", _hoisted_21$1, [
        createBaseVNode("div", _hoisted_22$1, [
          createVNode(_component_ion_icon, {
            icon: _ctx.femaleOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[8] || (_cache[8] = createBaseVNode("h3", null, "Pregnancy Status", -1))
        ]),
        createBaseVNode("div", _hoisted_23$1, [
          _ctx.pregnancy.patientPregnant ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
            _cache[9] || (_cache[9] = createBaseVNode("span", { class: "info-label" }, "Pregnant:", -1)),
            createBaseVNode("span", _hoisted_25$1, toDisplayString(_ctx.pregnancy.patientPregnant), 1)
          ])) : createCommentVNode("", true),
          _ctx.pregnancy.breastFeeding ? (openBlock(), createElementBlock("div", _hoisted_26, [
            _cache[10] || (_cache[10] = createBaseVNode("span", { class: "info-label" }, "Breastfeeding:", -1)),
            createBaseVNode("span", _hoisted_27, toDisplayString(_ctx.pregnancy.breastFeeding), 1)
          ])) : createCommentVNode("", true)
        ])
      ])) : createCommentVNode("", true),
      _ctx.hasPastMedicalHistory ? (openBlock(), createElementBlock("div", _hoisted_28, [
        createBaseVNode("div", _hoisted_29, [
          createVNode(_component_ion_icon, {
            icon: _ctx.medicalOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[11] || (_cache[11] = createBaseVNode("h3", null, "Medical History", -1))
        ]),
      ...
      _ctx.hasAllergies ? (openBlock(), createElementBlock("div", _hoisted_31, [
        createBaseVNode("div", _hoisted_32, [
          createVNode(_component_ion_icon, {
            icon: _ctx.warningOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[12] || (_cache[12] = createBaseVNode("h3", null, "Allergies", -1))
        ]),
      ...
      _ctx.hasPhysicalExam ? (openBlock(), createElementBlock("div", _hoisted_34, [
        createBaseVNode("div", _hoisted_35, [
          createVNode(_component_ion_icon, {
            icon: _ctx.bodyOutline,
            class: "section-icon"
          }, null, 8, ["icon"]),
          _cache[13] || (_cache[13] = createBaseVNode("h3", null, "Physical Examination", -1))
        ]),
        createBaseVNode("div", _hoisted_36, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.physicalExamCategories, (category, catName) => {
            return openBlock(), createElementBlock(Fragment, { key: catName }, [
              category.abnormalities.length > 0 || category.normal ? (openBlock(), createElementBlock("div", _hoisted_37, [
                ...
                createBaseVNode("div", _hoisted_39, [
                  ...
                  }), 128)) : category.normal ? (openBlock(), createElementBlock("div", _hoisted_40, "Normal examination")) : createCommentVNode("", true)
                ])
              ])) : createCommentVNode("", true)
            ], 64);
          }), 128))
...
const VisitHistory = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render], ["__scopeId", "data-v-7fe2ee8c"]]);
  ...
  const pastMedicalHistoryFormSection = computed(() => {
    return [
      ...
      // HIV
      {
        ...
        type: "inline",
        options: [
          { value: "HIV negative", label: "Negative (-)" },
          { value: "HIV Positive", label: "Positive (+)" },
...
const _hoisted_3$1 = { class: "nav-buttons" };
const _hoisted_4$1 = {
  class: "ion-padding",
  slot: "content"
};
  ...
  setup(__props, { expose: __expose }) {
    ...
    __expose({
      ...
      validateAndSave: async () => {
        presentingComplaintsFormRef.value?.validateAndSave();
        presentingComplaintsFormRef.value?.onSubmit(false);
      }
    });
    return (_ctx, _cache) => {
...
const ClinicalAssessment = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-120bc5e6"]]);

const _hoisted_1$2 = { class: "medication-section" };
const _hoisted_2$2 = { class: "medication-content" };
const _hoisted_3 = {
  key: 0,
...
const _hoisted_15 = { class: "notes-section" };
const _hoisted_16 = { class: "notes-content" };
const _hoisted_17 = { class: "notes-input-container" };
const _hoisted_18 = {
  class: "ion-padding",
  slot: "content"
};
const _hoisted_19 = { class: "notes-timeline" };
const _hoisted_20 = {
  key: 0,
  class: "note-entry"
};
const _hoisted_21 = { class: "note-date" };
const _hoisted_22 = { class: "note-content" };
const _hoisted_23 = {
  class: "ion-padding",
  slot: "content"
};
const _hoisted_24 = { class: "note-date" };
const _hoisted_25 = { class: "note-content" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    watch(
      () => selected_drug.value,
      (newValue) => {
        if (newValue) show_error_msg_for_drug.value = false;
      }
    );
    watch(
      () => selected_pres_method.value,
      (newValue) => {
        if (newValue) show_error_msg_for_pres_method.value = false;
      }
    );
    watch(
      () => selected_frequency.value,
      (newValue) => {
        if (newValue) show_error_msg_for_frequency.value = false;
      }
    );
    ...
    async function saveData(skipValidationMsgs = false) {
      try {
        const getDose = () => {
          const explicitDose = Number(dose.value);
          if (!Number.isNaN(explicitDose) && explicitDose > 0) {
            return explicitDose;
          }
        ...
        if (editingDrugItem.value !== null) {
          ...
          treatmentPlanStore.setSelectedMedicalDrugsList([updatedDrugObj]);
    ...
    function editItemAtIndex(index) {
      ...
      const fullDrugObject = OPDDrugList.value.find((drug) => drug.drug_id === originalItem.drug_id) || OPDDrugList.value.find((drug) => drug.name === originalItem.drugName) || {
        drug_id: originalItem.drug_id,
        name: originalItem.drugName,
        units: originalItem.units,
        dose_strength: originalItem.dose
      };
      selected_drug.value = fullDrugObject;
      currentDrugOb.value = fullDrugObject;
      selected_pres_method.value = {
          ...
          createBaseVNode("div", _hoisted_1$2, [
            ...
            createBaseVNode("div", _hoisted_2$2, [
              (openBlock(), createBlock(DynamicList, {
                ...
                show_actions_buttons: true
              }, null, 8, ["_selectedMedicalDrugsList"])),
              !addItemButton.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
                createBaseVNode("div", _hoisted_4, [
                  ...
                  createVNode(unref(script), {
                    ...
                    option: withCtx((props) => [
                      createBaseVNode("div", _hoisted_5, toDisplayString(props.option.name), 1)
                    ]),
                    _: 1
                  }, 8, ["modelValue", "options"]),
                  show_error_msg_for_drug.value ? (openBlock(), createElementBlock("div", _hoisted_6, toDisplayString(drugErrMsg.value), 1)) : createCommentVNode("", true)
                ]),
                createBaseVNode("div", _hoisted_7, [
                  createBaseVNode("div", _hoisted_8, [
                    ...
                    show_error_msg_for_pres_method.value ? (openBlock(), createElementBlock("div", _hoisted_9, toDisplayString(pres_methodErrMsg.value), 1)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_10, [
                    ...
                    show_error_msg_for_frequency.value ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(frequencyErrMsg.value), 1)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_12, [
                    ...
                    show_error_msg_for_duration.value ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString(durationErrMsg.value), 1)) : createCommentVNode("", true)
                  ])
                ]),
                        ...
                        createBaseVNode("div", _hoisted_19, [
                          (openBlock(true), createElementBlock(Fragment, null, renderList(FirstPreviousNotes.value, (item, index) => {
                            return openBlock(), createElementBlock(Fragment, { key: index }, [
                              index === 1 ? (openBlock(), createElementBlock("div", _hoisted_20, [
                                (openBlock(true), createElementBlock(Fragment, null, renderList(item, (note, noteIndex) => {
                                  return openBlock(), createElementBlock("div", { key: noteIndex }, [
                                    createBaseVNode("div", _hoisted_21, toDisplayString(note.date), 1),
                                    createBaseVNode("div", _hoisted_22, toDisplayString(note.notes), 1)
                                  ]);
                                }), 128))
                              ])) : createCommentVNode("", true)
                            ], 64);
                                    ...
                                    (openBlock(true), createElementBlock(Fragment, null, renderList(RestOfPreviousNotes.value, (item, index) => {
                                      return openBlock(), createElementBlock("div", {
                                        ...
                                        (openBlock(true), createElementBlock(Fragment, null, renderList(removeOuterArray(item), (note, noteIndex) => {
                                          return openBlock(), createElementBlock("div", { key: noteIndex }, [
                                            createBaseVNode("div", _hoisted_24, toDisplayString(note.date), 1),
                                            createBaseVNode("div", _hoisted_25, toDisplayString(note.notes), 1)
                                          ]);
                                        }), 128))
                                      ]);
                                    }), 128))
...
const OPDTreatmentPlan = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8d14865a"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isLabFollowUpFlow = computed(() => hasWaitingList("Waiting for Laboratory"));
    const demographicsStore = useDemographicsStore();
    ...
    const doneButtonOptions = computed(() => {
      return {
        text: isSaving.value ? "Saving..." : isLabFollowUpFlow.value ? "Send to Consultation" : "Finish",
    ...
    const triggerPreSave = async () => {
      await clinicalAssessmentRef.value?.validateAndSave?.();
      await treatmentPlanRef.value?.validateAndSave?.(true);
      await diagnosisRef.value?.validateAndSave?.();
    };
    const onChangeCurrentTab = async (index, oldIndex, runChangeTab) => {
      const currentTabTitle = tabs.value[oldIndex]?.title;
      if (currentTabTitle === "Treatment Plan") {
    ...
    const hasPrescribedMedications = () => {
      ...
      const prescribedMedications = patientData?.MedicationOrder?.unsaved || [];
      return prescribedMedications.length > 0;
    };
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(IonContent), { fullscreen: true }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", {
                class: normalizeClass(["consultation-plan-wizard", { "consultation-plan-wizard--lab-follow-up": isLabFollowUpFlow.value }])
              }, [
...
const ConsultationPlan = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c4c889b"]]);
